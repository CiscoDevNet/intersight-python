...
def lazy_import():
    ...
    globals()['MemoryPersistentMemoryGoalAllOf'] = MemoryPersistentMemoryGoalAllOf
    globals()['MoBaseComplexType'] = MoBaseComplexType


class MemoryPersistentMemoryGoal(ModelComposed):
    ...
    allowed_values = {
        ...
        ('persistent_memory_type',): {
            'DIRECT': "app-direct",
            'DIRECT-NON-INTERLEAVED': "app-direct-non-interleaved",
        },
        ('socket_id',): {
    ...
    def openapi_types():
        ...
        return {
            ...
            'memory_mode_percentage': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'memory_mode_percentage': 'MemoryModePercentage',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            socket_id (str): CPU Socket ID to which this goal will be applied. * `All Sockets` - All the CPU socket IDs in a server.. [optional] if omitted the server will use the default value of "All Sockets"  # noqa: E501
        """

        class_id = "memory.PersistentMemoryGoal" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "memory.PersistentMemoryGoal")
        object_type = "memory.PersistentMemoryGoal" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "memory.PersistentMemoryGoal")
