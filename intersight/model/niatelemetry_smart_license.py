...
class NiatelemetrySmartLicense(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "niatelemetry.SmartLicense" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "niatelemetry.SmartLicense")
        object_type = "niatelemetry.SmartLicense" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "niatelemetry.SmartLicense")
