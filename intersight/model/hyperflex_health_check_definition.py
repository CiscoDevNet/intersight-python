...
def lazy_import():
    ...
    globals()['HyperflexHealthCheckDefinitionAllOf'] = HyperflexHealthCheckDefinitionAllOf
...
class HyperflexHealthCheckDefinition(ModelComposed):
    ...
    allowed_values = {
        ...
        ('target_execution_type',): {
            ...
            'CURRENT_NODE': "EXECUTE_ON_CURRENT_NODE",
        },
    }
    ...
    read_only_vars = {
        'supported_hypervisor_type',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """HyperflexHealthCheckDefinition - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            minimum_hyper_flex_version (str): Minimum HyperFlex version that the check is supported on. Defaults to version 3.0.1.. [optional] if omitted the server will use the default value of "3"  # noqa: E501
        ...
        class_id = "hyperflex.HealthCheckDefinition" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "hyperflex.HealthCheckDefinition")
        object_type = "hyperflex.HealthCheckDefinition" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "hyperflex.HealthCheckDefinition")
