...
class MoBaseComplexType(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'hyperflex.BondState': HyperflexBondState,
            'hyperflex.DatastoreInfo': HyperflexDatastoreInfo,
            'hyperflex.DiskStatus': HyperflexDiskStatus,
