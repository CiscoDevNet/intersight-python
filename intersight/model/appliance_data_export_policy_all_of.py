...
class ApplianceDataExportPolicyAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApplianceDataExportPolicyAllOf - a model defined in OpenAPI
        ...
        class_id = "appliance.DataExportPolicy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "appliance.DataExportPolicy")
        object_type = "appliance.DataExportPolicy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "appliance.DataExportPolicy")
