...
class PciZoneAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PciZoneAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "pci.Zone", must be one of ["pci.Zone", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "pci.Zone", must be one of ["pci.Zone", ]  # noqa: E501
            ...
            name (str): The name of the PCIe endpoint zone, as reported by the platform software (BMC).. [optional]  # noqa: E501
            oper_reason ([str], none_type): [optional]  # noqa: E501
            oper_state (str): Operational state of the pcie node.. [optional]  # noqa: E501
            uri (str): The identifier of the PCIe endpoint zone as reported by the chassis expander module management controller.. [optional]  # noqa: E501
            zone_id (str): The identifier of the PCIe endpoint zone where all PCIe devices are logically connected.. [optional]  # noqa: E501
        ...
        class_id = "pci.Zone" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "pci.Zone")
        object_type = "pci.Zone" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "pci.Zone")
