...
def lazy_import():
    from intersight.model.apiproxy_allow_list_all_of import ApiproxyAllowListAllOf
    from intersight.model.display_names import DisplayNames
    from intersight.model.mo_base_mo import MoBaseMo
    from intersight.model.mo_base_mo_relationship import MoBaseMoRelationship
    from intersight.model.mo_tag import MoTag
    from intersight.model.mo_version_context import MoVersionContext
    globals()['ApiproxyAllowListAllOf'] = ApiproxyAllowListAllOf
...
class ApiproxyAllowList(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApiproxyAllowList - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "apiproxy.AllowList", must be one of ["apiproxy.AllowList", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "apiproxy.AllowList", must be one of ["apiproxy.AllowList", ]  # noqa: E501
        ...
        class_id = "apiproxy.AllowList" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "apiproxy.AllowList")
        object_type = "apiproxy.AllowList" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "apiproxy.AllowList")
