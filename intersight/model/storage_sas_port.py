...
def lazy_import():
    ...
    globals()['StorageSasPortAllOf'] = StorageSasPortAllOf


class StorageSasPort(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'end_point_id': (int,),  # noqa: E501
            'link_description': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'link_description': 'LinkDescription',  # noqa: E501
    ...
    read_only_vars = {
        'address',  # noqa: E501
        'disk_id',  # noqa: E501
        'end_point_id',  # noqa: E501
        'link_description',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StorageSasPort - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "storage.SasPort", must be one of ["storage.SasPort", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "storage.SasPort", must be one of ["storage.SasPort", ]  # noqa: E501
            ...
            address (str): The SAS Address assigned to storage port.. [optional]  # noqa: E501
            disk_id (int): The unique disk identifier.. [optional]  # noqa: E501
            end_point_id (int): The end-point Id assigned to storage port.. [optional]  # noqa: E501
            link_description (str): The description for the link.. [optional]  # noqa: E501
            link_speed (str): The link speed negotiated for communication.. [optional]  # noqa: E501
        ...
        class_id = "storage.SasPort" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "storage.SasPort")
        object_type = "storage.SasPort" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "storage.SasPort")
