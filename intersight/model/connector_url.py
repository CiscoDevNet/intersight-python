...
def lazy_import():
    ...
    globals()['ConnectorUrlAllOf'] = ConnectorUrlAllOf
    globals()['MoBaseComplexType'] = MoBaseComplexType


class ConnectorUrl(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ConnectorUrl - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "connector.Url", must be one of ["connector.Url", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "connector.Url", must be one of ["connector.Url", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "connector.Url")
        object_type = kwargs.get('object_type', "connector.Url")
