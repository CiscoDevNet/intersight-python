...
class BiosPolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'cbs_cmn_mem_dram_refresh_rate': (str,),  # noqa: E501
            ...
            'cbs_dbg_cpu_lapic_mode7xx2': (str,),  # noqa: E501
            'cbs_dbg_cpu_lapic_mode7xx3': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'cbs_cmn_mem_dram_refresh_rate': 'CbsCmnMemDramRefreshRate',  # noqa: E501
        ...
        'cbs_dbg_cpu_lapic_mode7xx2': 'CbsDbgCpuLapicMode7xx2',  # noqa: E501
        'cbs_dbg_cpu_lapic_mode7xx3': 'CbsDbgCpuLapicMode7xx3',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            cbs_cmn_mem_dram_refresh_rate (str): BIOS Token for setting DRAM Refresh Rate configuration. * `platform-default` - Default value used by the platform for the BIOS setting. * `3.9 usec` - Value - 3.9 usec for configuring CbsCmnMemDramRefreshRate token. * `7.8 usec` - Value - 7.8 usec for configuring CbsCmnMemDramRefreshRate token.. [optional] if omitted the server will use the default value of "platform-default"  # noqa: E501
            ...
            cbs_cpu_down_core_ctrl_bergamo (str): BIOS Token for setting Downcore Control configuration. * `platform-default` - Default value used by the platform for the BIOS setting. * `Auto` - Value - Auto for configuring CbsCpuDownCoreCtrlBergamo token. * `EIGHT (4 + 4)` - Value - EIGHT (4 + 4) for configuring CbsCpuDownCoreCtrlBergamo token. * `FOUR (2 + 2)` - Value - FOUR (2 + 2) for configuring CbsCpuDownCoreCtrlBergamo token. * `FOURTEEN (7 + 7)` - Value - FOURTEEN (7 + 7) for configuring CbsCpuDownCoreCtrlBergamo token. * `SIX (3 + 3)` - Value - SIX (3 + 3) for configuring CbsCpuDownCoreCtrlBergamo token. * `TEN (5 + 5)` - Value - TEN (5 + 5) for configuring CbsCpuDownCoreCtrlBergamo token. * `TWELVE (6 + 6)` - Value - TWELVE (6 + 6) for configuring CbsCpuDownCoreCtrlBergamo token. * `TWO (1 + 1)` - Value - TWO (1 + 1) for configuring CbsCpuDownCoreCtrlBergamo token.. [optional] if omitted the server will use the default value of "platform-default"  # noqa: E501
            cbs_cpu_down_core_ctrl_genoa (str): BIOS Token for setting CPU Downcore control F19 M10h-1Fh configuration. * `platform-default` - Default value used by the platform for the BIOS setting. * `Auto` - Value - Auto for configuring CbsCpuDownCoreCtrlGenoa token. * `FIVE (5 + 0)` - Value - FIVE (5 + 0) for configuring CbsCpuDownCoreCtrlGenoa token. * `FOUR (4 + 0)` - Value - FOUR (4 + 0) for configuring CbsCpuDownCoreCtrlGenoa token. * `ONE (1 + 0)` - Value - ONE (1 + 0) for configuring CbsCpuDownCoreCtrlGenoa token. * `SEVEN (7 + 0)` - Value - SEVEN (7 + 0) for configuring CbsCpuDownCoreCtrlGenoa token. * `SIX (6 + 0)` - Value - SIX (6 + 0) for configuring CbsCpuDownCoreCtrlGenoa token. * `THREE (3 + 0)` - Value - THREE (3 + 0) for configuring CbsCpuDownCoreCtrlGenoa token. * `TWO (2 + 0)` - Value - TWO (2 + 0) for configuring CbsCpuDownCoreCtrlGenoa token.. [optional] if omitted the server will use the default value of "platform-default"  # noqa: E501
            ...
            cbs_dbg_cpu_lapic_mode7xx2 (str): BIOS Token for setting Local APIC Mode 7xx2 configuration. * `platform-default` - Default value used by the platform for the BIOS setting. * `Auto` - Value - Auto for configuring CbsDbgCpuLapicMode7xx2 token. * `X2APIC` - Value - X2APIC for configuring CbsDbgCpuLapicMode7xx2 token. * `XAPIC` - Value - XAPIC for configuring CbsDbgCpuLapicMode7xx2 token.. [optional] if omitted the server will use the default value of "platform-default"  # noqa: E501
            cbs_dbg_cpu_lapic_mode7xx3 (str): BIOS Token for setting Local APIC Mode 7xx3 configuration. * `platform-default` - Default value used by the platform for the BIOS setting. * `Auto` - Value - Auto for configuring CbsDbgCpuLapicMode7xx3 token. * `Compatibility` - Value - Compatibility for configuring CbsDbgCpuLapicMode7xx3 token. * `X2APIC` - Value - X2APIC for configuring CbsDbgCpuLapicMode7xx3 token. * `XAPIC` - Value - XAPIC for configuring CbsDbgCpuLapicMode7xx3 token.. [optional] if omitted the server will use the default value of "platform-default"  # noqa: E501
