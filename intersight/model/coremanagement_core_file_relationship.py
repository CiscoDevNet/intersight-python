...
class CoremanagementCoreFileRelationship(ModelComposed):
    ...
    allowed_values = {
        ...
        ('status',): {
            ...
            'COMPLETED': "Completed",
            'FILEDOWNLOADURLCREATIONFAILED': "FileDownloadUrlCreationFailed",
            'COREREMOVEDDOWNLOADONLY': "CoreRemovedDownloadOnly",
        },
        ('object_type',): {
    ...
    def openapi_types():
        ...
        return {
            ...
            'core_file_download_url': (str,),  # noqa: E501
            'device_type': (str,),  # noqa: E501
            'endpoint_identifier': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'core_file_download_url': 'CoreFileDownloadUrl',  # noqa: E501
        'device_type': 'DeviceType',  # noqa: E501
        'endpoint_identifier': 'EndpointIdentifier',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'core_file_download_url',  # noqa: E501
        'device_type',  # noqa: E501
        'endpoint_identifier',  # noqa: E501
        'file_name',  # noqa: E501
        'file_size',  # noqa: E501
        'node_id',  # noqa: E501
        'pid',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CoremanagementCoreFileRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            admin_state (str): Admin state prop to trigger file upload. * `None` - Admin configured None State. * `Upload` - Admin configured Upload State.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            core_file_download_url (str): The Url to download the core file. It will be set only after successful completion of core file upload to storage service.. [optional]  # noqa: E501
            device_type (str): The device object type for the end point.. [optional]  # noqa: E501
            endpoint_identifier (str): Endpoint device identifier. In IMM devices, it will be Fabric Interconnect hostname.. [optional]  # noqa: E501
            file_name (str): The name of core file from endpoint device.. [optional]  # noqa: E501
            file_size (int): File size of core file in bytes.. [optional]  # noqa: E501
            node_id (str): Node id within cluster where core file is present.. [optional]  # noqa: E501
            pid (str): Product identification of the device.. [optional]  # noqa: E501
            reason (str): Reason for upload failure, if any. In successful upload case, it will be empty.. [optional]  # noqa: E501
            serial (str): Serial number of the device.. [optional]  # noqa: E501
            status (str): Status of core file upload. Valid values are InventoryComplete (default), UploadInProgress, Completed, UploadFailed, FileDownloadUrlCreationFailed, CoreRemovedDownloadOnly. * `InventoryComplete` - Default status for all mos before file upload is requested. * `UploadInProgress` - File upload is in progress. * `UploadFailed` - File upload to storage service failed. * `Completed` - File upload to storage service completed successfully. * `FileDownloadUrlCreationFailed` - File upload to storage service completed successfully but download url creation failed. * `CoreRemovedDownloadOnly` - File upload to storage service completed successfully but file removed from endpoint device.. [optional] if omitted the server will use the default value of "InventoryComplete"  # noqa: E501
