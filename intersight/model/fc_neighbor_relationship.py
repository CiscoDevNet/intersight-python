...
class FcNeighborRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            peer_device_capability (str): This field defines if neighbor is a switch or an NPV device. * `Switch` - Switch type neighbors of an interface. * `NPV` - N Port Virtualization neighbors of an interface.. [optional] if omitted the server will use the default value of "Switch"  # noqa: E501
