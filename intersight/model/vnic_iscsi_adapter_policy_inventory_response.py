...
class VnicIscsiAdapterPolicyInventoryResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """VnicIscsiAdapterPolicyInventoryResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'vnic.IscsiAdapterPolicyInventory' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
