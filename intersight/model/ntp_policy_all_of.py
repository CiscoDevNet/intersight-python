...
class NtpPolicyAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NtpPolicyAllOf - a model defined in OpenAPI
        ...
        class_id = "ntp.Policy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "ntp.Policy")
        object_type = "ntp.Policy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "ntp.Policy")
