...
def lazy_import():
    ...
    from intersight.model.workspace_folder_list import WorkspaceFolderList
    ...
    globals()['WorkspaceFolderList'] = WorkspaceFolderList
...
class MoBaseResponse(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'workspace.Folder.List': WorkspaceFolderList,
        }
        if not val:
            return None
