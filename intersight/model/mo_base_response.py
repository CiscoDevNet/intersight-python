...
def lazy_import():
    ...
    from intersight.model.acme_drawing_board_list import AcmeDrawingBoardList
    from intersight.model.acme_foo_list import AcmeFooList
    ...
    globals()['AcmeDrawingBoardList'] = AcmeDrawingBoardList
    globals()['AcmeFooList'] = AcmeFooList
...
class MoBaseResponse(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'acme.DrawingBoard.List': AcmeDrawingBoardList,
            'acme.Foo.List': AcmeFooList,
