...
def lazy_import():
    ...
    from intersight.model.vnic_eth_if_old_info_all_of import VnicEthIfOldInfoAllOf
    globals()['MoBaseComplexType'] = MoBaseComplexType
    globals()['MoMoRef'] = MoMoRef
    globals()['VnicEthIfOldInfoAllOf'] = VnicEthIfOldInfoAllOf


class VnicEthIfOldInfo(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'mac_lease': (MoMoRef,),  # noqa: E501
            'mac_pool': (MoMoRef,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VnicEthIfOldInfo - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "vnic.EthIfOldInfo", must be one of ["vnic.EthIfOldInfo", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "vnic.EthIfOldInfo", must be one of ["vnic.EthIfOldInfo", ]  # noqa: E501
            ...
            mac_address (str): Old MAC Address associated with the interface.. [optional]  # noqa: E501
            ...
            mac_lease (MoMoRef): [optional]  # noqa: E501
            mac_pool (MoMoRef): [optional]  # noqa: E501
            standby_vif_id (int): Old Standby Vif id that was associated with the interface.. [optional]  # noqa: E501
            ...
            vif_id (int): Old Vif id that was associated with the interface.. [optional]  # noqa: E501
        """

        class_id = "vnic.EthIfOldInfo" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "vnic.EthIfOldInfo")
        object_type = "vnic.EthIfOldInfo" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "vnic.EthIfOldInfo")
