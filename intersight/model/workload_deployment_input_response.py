...
def lazy_import():
    ...
    from intersight.model.workload_deployment_input_list import WorkloadDeploymentInputList
    ...
    globals()['WorkloadDeploymentInputList'] = WorkloadDeploymentInputList


class WorkloadDeploymentInputResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'workload.DeploymentInput.List': WorkloadDeploymentInputList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """WorkloadDeploymentInputResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'workload.DeploymentInput' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
