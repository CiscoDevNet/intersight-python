...
def lazy_import():
    ...
    from intersight.model.bulk_mo_cloner_list_all_of import BulkMoClonerListAllOf
    from intersight.model.mo_base_response import MoBaseResponse
    globals()['BulkMoCloner'] = BulkMoCloner
    globals()['BulkMoClonerListAllOf'] = BulkMoClonerListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class BulkMoClonerList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([BulkMoCloner], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """BulkMoClonerList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            results ([BulkMoCloner], none_type): The array of 'bulk.MoCloner' resources matching the request.. [optional]  # noqa: E501
        """
