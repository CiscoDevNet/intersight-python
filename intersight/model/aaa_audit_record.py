...
def lazy_import():
    ...
    globals()['AaaAuditRecordAllOf'] = AaaAuditRecordAllOf
...
class AaaAuditRecord(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'affected_object_type_label': (str,),  # noqa: E501
            'email': (str,),  # noqa: E501
            ...
            'sessions': (IamSessionRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'affected_object_type_label': 'AffectedObjectTypeLabel',  # noqa: E501
    ...
    read_only_vars = {
        'affected_object_type_label',  # noqa: E501
        'email',  # noqa: E501
        'inst_id',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AaaAuditRecord - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "aaa.AuditRecord", must be one of ["aaa.AuditRecord", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "aaa.AuditRecord", must be one of ["aaa.AuditRecord", ]  # noqa: E501
            ...
            affected_object_type_label (str): The user-friendly label for the object type that was changed.. [optional]  # noqa: E501
            email (str): The email of the associated user that made the change.  In case the user is later deleted, we still have some reference to the information.. [optional]  # noqa: E501
            inst_id (str): The instance id of AuditRecordLocal, which is used to identify if the comming AuditRecordLocal was already processed before.. [optional]  # noqa: E501
            ...
            source_ip (str): The source IP of the client.. [optional]  # noqa: E501
            timestamp (datetime): The creation time of AuditRecordLocal, which is the time when the affected MO was created/modified/deleted.. [optional]  # noqa: E501
            ...
            sessions (IamSessionRelationship): [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "aaa.AuditRecord")
        object_type = kwargs.get('object_type', "aaa.AuditRecord")
