...
class ComputePhysicalSummary(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            available_memory (int): Total memeory of the server in MB.. [optional]  # noqa: E501
            ...
            cooling_mode (str): Cooling mode representation of the server, supported modes include Air and Immersion. * `Air` - Cooling mode of the device is set to Air. * `Immersion` - Cooling mode of the device is set to Immersion.. [optional] if omitted the server will use the default value of "Air"  # noqa: E501
            ...
            num_cpu_cores (int): The total number of CPU cores enabled on the server.. [optional]  # noqa: E501
            ...
            package_version (str): Bundle version which the firmware belongs to.. [optional]  # noqa: E501
            ...
            source_object_type (str): Stores the source object type. This feild will either be RackUnit or Blade.. [optional]  # noqa: E501
        ...
        class_id = "compute.PhysicalSummary" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "compute.PhysicalSummary")
        object_type = "compute.PhysicalSummary" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "compute.PhysicalSummary")
