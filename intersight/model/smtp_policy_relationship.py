...
class SmtpPolicyRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'enable_auth': (bool,),  # noqa: E501
            'enable_tls': (bool,),  # noqa: E501
            'enabled': (bool,),  # noqa: E501
            'is_auth_password_set': (bool,),  # noqa: E501
            'min_severity': (str,),  # noqa: E501
            'sender_email': (str,),  # noqa: E501
            'smtp_port': (int,),  # noqa: E501
            'smtp_recipients': ([str], none_type,),  # noqa: E501
            'smtp_server': (str,),  # noqa: E501
            'user_name': (str,),  # noqa: E501
            'appliance_account': (IamAccountRelationship,),  # noqa: E501
            'certificate': (IamTrustPointRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'enable_auth': 'EnableAuth',  # noqa: E501
        'enable_tls': 'EnableTls',  # noqa: E501
        'enabled': 'Enabled',  # noqa: E501
        'is_auth_password_set': 'IsAuthPasswordSet',  # noqa: E501
        'min_severity': 'MinSeverity',  # noqa: E501
        'sender_email': 'SenderEmail',  # noqa: E501
        'smtp_port': 'SmtpPort',  # noqa: E501
        'smtp_recipients': 'SmtpRecipients',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SmtpPolicyRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            auth_password (str): Authorization password for the process.. [optional]  # noqa: E501
            enable_auth (bool): If enabled, lets user input username and password.. [optional] if omitted the server will use the default value of False  # noqa: E501
            enable_tls (bool): If enabled, lets user input valid CA certificates for authorization.. [optional] if omitted the server will use the default value of False  # noqa: E501
            enabled (bool): If enabled, controls the state of the SMTP client service on the managed device.. [optional] if omitted the server will use the default value of True  # noqa: E501
            ...
            min_severity (str): Minimum fault severity level to receive email notifications. Email notifications are sent for all faults whose severity is equal to or greater than the chosen level. * `critical` - Minimum severity to report is critical. * `condition` - Minimum severity to report is informational. * `warning` - Minimum severity to report is warning. * `minor` - Minimum severity to report is minor. * `major` - Minimum severity to report is major.. [optional] if omitted the server will use the default value of "critical"  # noqa: E501
            sender_email (str): The email address entered here will be displayed as the from address (mail received from address) of all the SMTP mail alerts that are received. If not configured, the hostname of the server is used in the from address field.. [optional]  # noqa: E501
            smtp_port (int): Port number used by the SMTP server for outgoing SMTP communication.. [optional] if omitted the server will use the default value of 25  # noqa: E501
            smtp_recipients ([str], none_type): [optional]  # noqa: E501
            smtp_server (str): IP address or hostname of the SMTP server. The SMTP server is used by the managed device to send email notifications.. [optional]  # noqa: E501
            user_name (str): SMTP username from which email notification is sent.. [optional]  # noqa: E501
            appliance_account (IamAccountRelationship): [optional]  # noqa: E501
            certificate (IamTrustPointRelationship): [optional]  # noqa: E501
