...
class ConnectorEncryptionTaskMessageAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConnectorEncryptionTaskMessageAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            public_encryption_key (str): The public encryption key in PEM format to use to encrypt the data. Data should be encrypted using RSA-OAEP with SHA-256 hashing function. For example, a device can use this key to encrypt data securely at rest and to transport it securely to Intersight. Intersight has the capability to decrypt this data. The encrypted data should be base64 encoded into a string format for persistence/transit.. [optional]  # noqa: E501
        """
