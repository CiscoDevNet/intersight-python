...
class ComputeBiosPostPolicyAllOf(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ComputeBiosPostPolicyAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "compute.BiosPostPolicy", must be one of ["compute.BiosPostPolicy", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "compute.BiosPostPolicy", must be one of ["compute.BiosPostPolicy", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "compute.BiosPostPolicy")
        object_type = kwargs.get('object_type', "compute.BiosPostPolicy")
