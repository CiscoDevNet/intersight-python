...
def lazy_import():
    ...
    globals()['WorkflowAbstractLoopTaskAllOf'] = WorkflowAbstractLoopTaskAllOf
...
class WorkflowAbstractLoopTask(ModelComposed):
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """WorkflowAbstractLoopTask - a model defined in OpenAPI
