...
def lazy_import():
    from intersight.model.equipment_expander_module_identity_list import EquipmentExpanderModuleIdentityList
    ...
    globals()['EquipmentExpanderModuleIdentityList'] = EquipmentExpanderModuleIdentityList
...
class EquipmentExpanderModuleIdentityResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'equipment.ExpanderModuleIdentity.List': EquipmentExpanderModuleIdentityList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """EquipmentExpanderModuleIdentityResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'equipment.ExpanderModuleIdentity' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
