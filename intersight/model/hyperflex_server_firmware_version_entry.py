...
class HyperflexServerFirmwareVersionEntry(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            server_platform (str): The server platform type that is applicable for the server firmware bundle version. * `M5` - M5 generation of UCS server. * `M3` - M3 generation of UCS server. * `M4` - M4 generation of UCS server.. [optional] if omitted the server will use the default value of "M5"  # noqa: E501
