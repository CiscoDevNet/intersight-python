...
def lazy_import():
    from intersight.model.metrics_configuration_list import MetricsConfigurationList
    ...
    globals()['MetricsConfigurationList'] = MetricsConfigurationList
...
class MetricsConfigurationResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'metrics.Configuration.List': MetricsConfigurationList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """MetricsConfigurationResponse - a model defined in OpenAPI
