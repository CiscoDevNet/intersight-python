...
def lazy_import():
    ...
    from intersight.model.virtualization_hxap_vm_configuration import VirtualizationHxapVmConfiguration
    globals()['MoBaseComplexType'] = MoBaseComplexType
    globals()['VirtualizationEsxiVmConfiguration'] = VirtualizationEsxiVmConfiguration
    globals()['VirtualizationHxapVmConfiguration'] = VirtualizationHxapVmConfiguration


class VirtualizationBaseVmConfiguration(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'virtualization.HxapVmConfiguration': VirtualizationHxapVmConfiguration,
        }
        if not val:
            return None
        return {'class_id': val}
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """VirtualizationBaseVmConfiguration - a model defined in OpenAPI
