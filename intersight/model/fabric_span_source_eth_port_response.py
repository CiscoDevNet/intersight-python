...
def lazy_import():
    from intersight.model.fabric_span_source_eth_port_list import FabricSpanSourceEthPortList
    ...
    globals()['FabricSpanSourceEthPortList'] = FabricSpanSourceEthPortList
...
class FabricSpanSourceEthPortResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'fabric.SpanSourceEthPort.List': FabricSpanSourceEthPortList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FabricSpanSourceEthPortResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'fabric.SpanSourceEthPort' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
