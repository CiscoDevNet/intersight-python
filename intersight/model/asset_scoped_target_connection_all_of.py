...
class AssetScopedTargetConnectionAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'full_validation': (bool,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'full_validation': 'FullValidation',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AssetScopedTargetConnectionAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            is_secure (bool): Indicates whether a connection to the target should be established using TLS.. [optional] if omitted the server will use the default value of True  # noqa: E501
        ...
        class_id = "asset.ScopedTargetConnection" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "asset.ScopedTargetConnection")
        object_type = "asset.ScopedTargetConnection" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "asset.ScopedTargetConnection")
