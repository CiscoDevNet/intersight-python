...
def lazy_import():
    ...
    globals()['KubernetesBaremetalNodeProfileAllOf'] = KubernetesBaremetalNodeProfileAllOf
    globals()['KubernetesConfigResultRelationship'] = KubernetesConfigResultRelationship
    ...
    globals()['KubernetesVersionRelationship'] = KubernetesVersionRelationship
...
class KubernetesBaremetalNodeProfile(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'kubernetes_nic': (str,),  # noqa: E501
            'network_info': (KubernetesBaremetalNetworkInfo,),  # noqa: E501
            ...
            'config_result': (KubernetesConfigResultRelationship,),  # noqa: E501
            'node_group': (KubernetesNodeGroupProfileRelationship,),  # noqa: E501
            'target': (AssetDeviceRegistrationRelationship,),  # noqa: E501
            'version': (KubernetesVersionRelationship,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'kubernetes_nic': 'KubernetesNic',  # noqa: E501
        'network_info': 'NetworkInfo',  # noqa: E501
        ...
        'node_group': 'NodeGroup',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """KubernetesBaremetalNodeProfile - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "kubernetes.BaremetalNodeProfile", must be one of ["kubernetes.BaremetalNodeProfile", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "kubernetes.BaremetalNodeProfile", must be one of ["kubernetes.BaremetalNodeProfile", ]  # noqa: E501
            ...
            kubernetes_nic (str): Network interface from NetworkInfo (by name) to use for kubernetes VIP.. [optional]  # noqa: E501
            network_info (KubernetesBaremetalNetworkInfo): [optional]  # noqa: E501
            ...
            cloud_provider (str): Cloud provider for this node profile. * `noProvider` - Enables the use of no cloud provider. * `external` - Out of tree cloud provider, e.g. CPI for vsphere.. [optional] if omitted the server will use the default value of "noProvider"  # noqa: E501
            config_result (KubernetesConfigResultRelationship): [optional]  # noqa: E501
            node_group (KubernetesNodeGroupProfileRelationship): [optional]  # noqa: E501
            target (AssetDeviceRegistrationRelationship): [optional]  # noqa: E501
            version (KubernetesVersionRelationship): [optional]  # noqa: E501
        """

        class_id = "kubernetes.BaremetalNodeProfile" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "kubernetes.BaremetalNodeProfile")
        object_type = "kubernetes.BaremetalNodeProfile" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "kubernetes.BaremetalNodeProfile")
