...
def lazy_import():
    ...
    from intersight.model.virtualization_iwe_host_interface_all_of import VirtualizationIweHostInterfaceAllOf
    ...
    globals()['VirtualizationIweHostInterfaceAllOf'] = VirtualizationIweHostInterfaceAllOf
...
class VirtualizationIweHostInterface(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VirtualizationIweHostInterface - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "virtualization.IweHostInterface", must be one of ["virtualization.IweHostInterface", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "virtualization.IweHostInterface", must be one of ["virtualization.IweHostInterface", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "virtualization.IweHostInterface")
        object_type = kwargs.get('object_type', "virtualization.IweHostInterface")
