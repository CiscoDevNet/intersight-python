...
def lazy_import():
    ...
    from intersight.model.niaapi_nd_metadata_software_download_list import NiaapiNdMetadataSoftwareDownloadList
    ...
    globals()['NiaapiNdMetadataSoftwareDownloadList'] = NiaapiNdMetadataSoftwareDownloadList


class NiaapiNdMetadataSoftwareDownloadResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'niaapi.NdMetadataSoftwareDownload.List': NiaapiNdMetadataSoftwareDownloadList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """NiaapiNdMetadataSoftwareDownloadResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'niaapi.NdMetadataSoftwareDownload' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
