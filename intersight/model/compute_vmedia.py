...
def lazy_import():
    ...
    globals()['ComputeVmediaAllOf'] = ComputeVmediaAllOf
...
class ComputeVmedia(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ComputeVmedia - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "compute.Vmedia", must be one of ["compute.Vmedia", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "compute.Vmedia", must be one of ["compute.Vmedia", ]  # noqa: E501
        ...
        class_id = "compute.Vmedia" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "compute.Vmedia")
        object_type = "compute.Vmedia" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "compute.Vmedia")
