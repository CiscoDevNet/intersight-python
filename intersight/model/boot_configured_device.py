...
def lazy_import():
    ...
    globals()['BootConfiguredDeviceAllOf'] = BootConfiguredDeviceAllOf
...
class BootConfiguredDevice(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'CDDDEVICE': "boot.CddDevice",
            'HDDDEVICE': "boot.HddDevice",
            'ISCSIDEVICE': "boot.IscsiDevice",
            'NVMEDEVICE': "boot.NvmeDevice",
            'PCHSTORAGEDEVICE': "boot.PchStorageDevice",
            'PXEDEVICE': "boot.PxeDevice",
            'SANDEVICE': "boot.SanDevice",
            'SDDEVICE': "boot.SdDevice",
            'UEFISHELLDEVICE': "boot.UefiShellDevice",
            'USBDEVICE': "boot.UsbDevice",
            'VMEDIADEVICE': "boot.VmediaDevice",
        },
        ('object_type',): {
            'CDDDEVICE': "boot.CddDevice",
            'HDDDEVICE': "boot.HddDevice",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """BootConfiguredDevice - a model defined in OpenAPI
