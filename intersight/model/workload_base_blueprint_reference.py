...
def lazy_import():
    ...
    globals()['WorkloadBaseBlueprintReferenceAllOf'] = WorkloadBaseBlueprintReferenceAllOf
...
class WorkloadBaseBlueprintReference(ModelComposed):
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """WorkloadBaseBlueprintReference - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              MoBaseComplexType,
              WorkloadBaseBlueprintReferenceAllOf,
          ],
          'oneOf': [
          ],
        }
