...
def lazy_import():
    ...
    globals()['CapabilityChassisDescriptorAllOf'] = CapabilityChassisDescriptorAllOf
...
class CapabilityChassisDescriptor(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CapabilityChassisDescriptor - a model defined in OpenAPI
        ...
        class_id = "capability.ChassisDescriptor" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "capability.ChassisDescriptor")
        object_type = "capability.ChassisDescriptor" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "capability.ChassisDescriptor")
