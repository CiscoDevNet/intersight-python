...
def lazy_import():
    from intersight.model.memory_policy_inventory_list import MemoryPolicyInventoryList
    ...
    globals()['MemoryPolicyInventoryList'] = MemoryPolicyInventoryList
...
class MemoryPolicyInventoryResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'memory.PolicyInventory.List': MemoryPolicyInventoryList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """MemoryPolicyInventoryResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'memory.PolicyInventory' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
