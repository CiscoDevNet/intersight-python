...
class PowerPolicyInventoryAllOf(ModelNormal):
    ...
    read_only_vars = {
        'allocated_budget',  # noqa: E501
        'dynamic_rebalancing',  # noqa: E501
        'extended_power_capacity',  # noqa: E501
        'power_priority',  # noqa: E501
        'power_profiling',  # noqa: E501
        'power_restore_state',  # noqa: E501
        'power_save_mode',  # noqa: E501
        'redundancy_mode',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PowerPolicyInventoryAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "power.PolicyInventory", must be one of ["power.PolicyInventory", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "power.PolicyInventory", must be one of ["power.PolicyInventory", ]  # noqa: E501
            ...
            extended_power_capacity (str): Sets the Extended Power Capacity of the System. This option is only supported for Cisco UCS X series Chassis. * `Enabled` - Set the value to Enabled. * `Disabled` - Set the value to Disabled.. [optional] if omitted the server will use the default value of "Enabled"  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "power.PolicyInventory")
        object_type = kwargs.get('object_type', "power.PolicyInventory")
