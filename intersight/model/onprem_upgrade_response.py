...
def lazy_import():
    ...
    from intersight.model.onprem_upgrade_list import OnpremUpgradeList
    ...
    globals()['OnpremUpgradeList'] = OnpremUpgradeList


class OnpremUpgradeResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'onprem.Upgrade.List': OnpremUpgradeList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """OnpremUpgradeResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'onprem.Upgrade' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
