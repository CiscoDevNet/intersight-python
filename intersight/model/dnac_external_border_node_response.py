...
def lazy_import():
    from intersight.model.dnac_external_border_node_list import DnacExternalBorderNodeList
    ...
    globals()['DnacExternalBorderNodeList'] = DnacExternalBorderNodeList
...
class DnacExternalBorderNodeResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'dnac.ExternalBorderNode.List': DnacExternalBorderNodeList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """DnacExternalBorderNodeResponse - a model defined in OpenAPI
