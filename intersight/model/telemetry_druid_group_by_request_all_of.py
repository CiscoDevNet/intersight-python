...
def lazy_import():
    ...
    from intersight.model.telemetry_druid_virtual_column import TelemetryDruidVirtualColumn
    ...
    globals()['TelemetryDruidVirtualColumn'] = TelemetryDruidVirtualColumn


class TelemetryDruidGroupByRequestAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'virtual_columns': ([TelemetryDruidVirtualColumn],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'virtual_columns': 'virtualColumns',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data_source, dimensions, granularity, intervals, *args, **kwargs):  # noqa: E501
        """TelemetryDruidGroupByRequestAllOf - a model defined in OpenAPI

        Args:
            data_source (TelemetryDruidDataSource):
            dimensions ([TelemetryDruidDimensionSpec]): A JSON list of dimensions to do the groupBy over; or see DimensionSpec for ways to extract dimensions..
    ...
    @convert_js_args_to_python_args
    def __init__(self, data_source, dimensions, granularity, intervals, *args, **kwargs):  # noqa: E501
        """TelemetryDruidGroupByRequestAllOf - a model defined in OpenAPI
