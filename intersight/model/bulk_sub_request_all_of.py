...
class BulkSubRequestAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "bulk.RestSubRequest" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "bulk.RestSubRequest")
        object_type = "bulk.RestSubRequest" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "bulk.RestSubRequest")
