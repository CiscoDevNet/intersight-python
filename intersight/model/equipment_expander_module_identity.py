...
def lazy_import():
    ...
    from intersight.model.equipment_expander_module_identity_all_of import EquipmentExpanderModuleIdentityAllOf
    ...
    globals()['EquipmentExpanderModuleIdentityAllOf'] = EquipmentExpanderModuleIdentityAllOf
...
class EquipmentExpanderModuleIdentity(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentExpanderModuleIdentity - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "equipment.ExpanderModuleIdentity", must be one of ["equipment.ExpanderModuleIdentity", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "equipment.ExpanderModuleIdentity", must be one of ["equipment.ExpanderModuleIdentity", ]  # noqa: E501
            ...
            chassis_id (int): Chassis Identifier of an expander module.. [optional]  # noqa: E501
            ...
            slot_id (int): Chassis slot number of an expander module.. [optional]  # noqa: E501
        ...
        class_id = "equipment.ExpanderModuleIdentity" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "equipment.ExpanderModuleIdentity")
        object_type = "equipment.ExpanderModuleIdentity" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "equipment.ExpanderModuleIdentity")
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              EquipmentExpanderModuleIdentityAllOf,
