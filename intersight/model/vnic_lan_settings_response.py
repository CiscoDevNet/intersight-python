...
def lazy_import():
    ...
    from intersight.model.vnic_lan_settings_list import VnicLanSettingsList
    ...
    globals()['VnicLanSettingsList'] = VnicLanSettingsList


class VnicLanSettingsResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'vnic.LanSettings.List': VnicLanSettingsList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """VnicLanSettingsResponse - a model defined in OpenAPI
