...
class IamUserAllOf(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            email (str): Email of the user. Users are added to Intersight using the email configured in the IdP.. [optional]  # noqa: E501
            first_name (str): First name of the user. This field is populated from the IdP attributes received after authentication.. [optional]  # noqa: E501
            last_login_time (datetime): Last successful login time for user.. [optional]  # noqa: E501
            last_name (str): Last name of the user. This field is populated from the IdP attributes received after authentication.. [optional]  # noqa: E501
            last_role_modified_time (datetime): Last role modification time for user.. [optional]  # noqa: E501
            name (str): Name as configured in the IdP.. [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "iam.User")
        object_type = kwargs.get('object_type', "iam.User")
