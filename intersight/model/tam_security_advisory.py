...
def lazy_import():
    ...
    globals()['TamSecurityAdvisoryAllOf'] = TamSecurityAdvisoryAllOf
    globals()['TamSeverity'] = TamSeverity


class TamSecurityAdvisory(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TamSecurityAdvisory - a model defined in OpenAPI
        ...
        class_id = "tam.SecurityAdvisory" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "tam.SecurityAdvisory")
        object_type = "tam.SecurityAdvisory" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "tam.SecurityAdvisory")
