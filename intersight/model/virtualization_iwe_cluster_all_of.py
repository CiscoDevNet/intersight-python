...
class VirtualizationIweClusterAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'hx_cluster': (StorageBaseClusterRelationship,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VirtualizationIweClusterAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "virtualization.IweCluster", must be one of ["virtualization.IweCluster", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "virtualization.IweCluster", must be one of ["virtualization.IweCluster", ]  # noqa: E501
            ...
            hx_cluster (StorageBaseClusterRelationship): [optional]  # noqa: E501
            registered_device (AssetDeviceRegistrationRelationship): [optional]  # noqa: E501
        """

        class_id = kwargs.get('class_id', "virtualization.IweCluster")
        object_type = kwargs.get('object_type', "virtualization.IweCluster")
