...
def lazy_import():
    ...
    from intersight.model.fabric_abstract_span_dest_port_relationship import FabricAbstractSpanDestPortRelationship
    from intersight.model.fabric_abstract_span_session import FabricAbstractSpanSession
    from intersight.model.fabric_abstract_span_source_port_channel_relationship import FabricAbstractSpanSourcePortChannelRelationship
    from intersight.model.fabric_abstract_span_source_port_relationship import FabricAbstractSpanSourcePortRelationship
    from intersight.model.fabric_abstract_span_source_virtual_if_relationship import FabricAbstractSpanSourceVirtualIfRelationship
    from intersight.model.fabric_span_session_all_of import FabricSpanSessionAllOf
    from intersight.model.fabric_span_source_vlan_relationship import FabricSpanSourceVlanRelationship
    ...
    globals()['FabricAbstractSpanDestPortRelationship'] = FabricAbstractSpanDestPortRelationship
    globals()['FabricAbstractSpanSession'] = FabricAbstractSpanSession
    globals()['FabricAbstractSpanSourcePortChannelRelationship'] = FabricAbstractSpanSourcePortChannelRelationship
    globals()['FabricAbstractSpanSourcePortRelationship'] = FabricAbstractSpanSourcePortRelationship
    globals()['FabricAbstractSpanSourceVirtualIfRelationship'] = FabricAbstractSpanSourceVirtualIfRelationship
    globals()['FabricSpanSessionAllOf'] = FabricSpanSessionAllOf
    globals()['FabricSpanSourceVlanRelationship'] = FabricSpanSourceVlanRelationship
...
class FabricSpanSession(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'dest_ports': ([FabricAbstractSpanDestPortRelationship], none_type,),  # noqa: E501
            'source_port_channels': ([FabricAbstractSpanSourcePortChannelRelationship], none_type,),  # noqa: E501
            'source_ports': ([FabricAbstractSpanSourcePortRelationship], none_type,),  # noqa: E501
            'source_virtual_ifs': ([FabricAbstractSpanSourceVirtualIfRelationship], none_type,),  # noqa: E501
            'source_vlans': ([FabricSpanSourceVlanRelationship], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'source_port_channels': 'SourcePortChannels',  # noqa: E501
        'source_ports': 'SourcePorts',  # noqa: E501
        'source_virtual_ifs': 'SourceVirtualIfs',  # noqa: E501
        'source_vlans': 'SourceVlans',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FabricSpanSession - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "fabric.SpanSession", must be one of ["fabric.SpanSession", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "fabric.SpanSession", must be one of ["fabric.SpanSession", ]  # noqa: E501
            ...
            dest_ports ([FabricAbstractSpanDestPortRelationship], none_type): An array of relationships to fabricAbstractSpanDestPort resources.. [optional]  # noqa: E501
            source_port_channels ([FabricAbstractSpanSourcePortChannelRelationship], none_type): An array of relationships to fabricAbstractSpanSourcePortChannel resources.. [optional]  # noqa: E501
            source_ports ([FabricAbstractSpanSourcePortRelationship], none_type): An array of relationships to fabricAbstractSpanSourcePort resources.. [optional]  # noqa: E501
            source_virtual_ifs ([FabricAbstractSpanSourceVirtualIfRelationship], none_type): An array of relationships to fabricAbstractSpanSourceVirtualIf resources.. [optional]  # noqa: E501
            source_vlans ([FabricSpanSourceVlanRelationship], none_type): An array of relationships to fabricSpanSourceVlan resources.. [optional]  # noqa: E501
