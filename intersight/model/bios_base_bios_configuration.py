...
def lazy_import():
    from intersight.model.bios_c845_server_bios_configuration import BiosC845ServerBiosConfiguration
    from intersight.model.mo_base_complex_type import MoBaseComplexType
    globals()['BiosC845ServerBiosConfiguration'] = BiosC845ServerBiosConfiguration
    globals()['MoBaseComplexType'] = MoBaseComplexType


class BiosBaseBiosConfiguration(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'bios.C845ServerBiosConfiguration': BiosC845ServerBiosConfiguration,
        }
        if not val:
            return None
        return {'class_id': val}
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """BiosBaseBiosConfiguration - a model defined in OpenAPI
