...
def lazy_import():
    ...
    from intersight.model.sdaaci_connection_list import SdaaciConnectionList
    ...
    globals()['SdaaciConnectionList'] = SdaaciConnectionList


class SdaaciConnectionResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'sdaaci.Connection.List': SdaaciConnectionList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """SdaaciConnectionResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'sdaaci.Connection' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
