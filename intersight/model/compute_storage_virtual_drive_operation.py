...
def lazy_import():
    ...
    globals()['ComputeStorageVirtualDriveOperationAllOf'] = ComputeStorageVirtualDriveOperationAllOf
    globals()['MoBaseComplexType'] = MoBaseComplexType


class ComputeStorageVirtualDriveOperation(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ComputeStorageVirtualDriveOperation - a model defined in OpenAPI
        ...
        class_id = "compute.StorageVirtualDriveOperation" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "compute.StorageVirtualDriveOperation")
        object_type = "compute.StorageVirtualDriveOperation" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "compute.StorageVirtualDriveOperation")
