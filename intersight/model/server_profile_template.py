...
def lazy_import():
    ...
    globals()['ServerProfileTemplateAllOf'] = ServerProfileTemplateAllOf
    globals()['UuidpoolPoolRelationship'] = UuidpoolPoolRelationship


class ServerProfileTemplate(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "server.ProfileTemplate" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "server.ProfileTemplate")
        object_type = "server.ProfileTemplate" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "server.ProfileTemplate")
