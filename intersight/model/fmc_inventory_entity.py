...
def lazy_import():
    ...
    from intersight.model.fmc_inventory_entity_all_of import FmcInventoryEntityAllOf
    ...
    globals()['FmcInventoryEntityAllOf'] = FmcInventoryEntityAllOf
...
class FmcInventoryEntity(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'DEVICE': "fmc.Device",
            'DEVICEHAPAIR': "fmc.DeviceHaPair",
            'DOMAIN': "fmc.Domain",
            'PHYSICALINTERFACE': "fmc.PhysicalInterface",
        },
        ('object_type',): {
            'DEVICE': "fmc.Device",
            'DEVICEHAPAIR': "fmc.DeviceHaPair",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """FmcInventoryEntity - a model defined in OpenAPI
