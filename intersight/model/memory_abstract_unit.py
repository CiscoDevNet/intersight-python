...
def lazy_import():
    ...
    globals()['MemoryAbstractUnitAllOf'] = MemoryAbstractUnitAllOf
...
class MemoryAbstractUnit(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'PERSISTENTMEMORYUNIT': "memory.PersistentMemoryUnit",
            'UNIT': "memory.Unit",
        },
        ('object_type',): {
            'PERSISTENTMEMORYUNIT': "memory.PersistentMemoryUnit",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """MemoryAbstractUnit - a model defined in OpenAPI
