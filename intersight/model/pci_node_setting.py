...
def lazy_import():
    ...
    from intersight.model.pci_node_setting_all_of import PciNodeSettingAllOf
    ...
    globals()['PciNodeSettingAllOf'] = PciNodeSettingAllOf


class PciNodeSetting(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'node_op_status': ([ComputeServerOpStatus], none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PciNodeSetting - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "pci.NodeSetting", must be one of ["pci.NodeSetting", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "pci.NodeSetting", must be one of ["pci.NodeSetting", ]  # noqa: E501
            ...
            admin_action (str): User configured action on the PCIe Node. * `None` - Placeholder default value for PCIe Node admin state property. * `Reboot` - PCIe node reboot state property value.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            ...
            name (str): The property used to identify the PCIe node it is associated with.. [optional]  # noqa: E501
            node_op_status ([ComputeServerOpStatus], none_type): [optional]  # noqa: E501
        ...
        class_id = "pci.NodeSetting" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "pci.NodeSetting")
        object_type = "pci.NodeSetting" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "pci.NodeSetting")
