...
def lazy_import():
    ...
    from intersight.model.notification_advisory_mo_condition import NotificationAdvisoryMoCondition
    ...
    globals()['NotificationAdvisoryMoCondition'] = NotificationAdvisoryMoCondition
...
class NotificationAbstractMoCondition(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'ADVISORYMOCONDITION': "notification.AdvisoryMoCondition",
            'ALARMMOCONDITION': "notification.AlarmMoCondition",
            'APPLIANCEUPGRADEMOCONDITION': "notification.ApplianceUpgradeMoCondition",
            'DISTRIBUTABLEMOCONDITION': "notification.DistributableMoCondition",
            'MOCONDITION': "notification.MoCondition",
            'SIMPLEMOCONDITION': "notification.SimpleMoCondition",
            'SOFTWARERELEASEMETAMOCONDITION': "notification.SoftwareReleaseMetaMoCondition",
        },
        ('object_type',): {
            'ADVISORYMOCONDITION': "notification.AdvisoryMoCondition",
            'ALARMMOCONDITION': "notification.AlarmMoCondition",
    ...
    def discriminator():
        lazy_import()
        val = {
            'notification.AdvisoryMoCondition': NotificationAdvisoryMoCondition,
