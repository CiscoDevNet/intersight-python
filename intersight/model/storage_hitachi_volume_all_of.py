...
class StorageHitachiVolumeAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StorageHitachiVolumeAllOf - a model defined in OpenAPI
        ...
        class_id = "storage.HitachiVolume" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "storage.HitachiVolume")
        object_type = "storage.HitachiVolume" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "storage.HitachiVolume")
