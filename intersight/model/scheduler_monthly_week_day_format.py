...
def lazy_import():
    ...
    globals()['SchedulerMonthlyWeekDayFormatAllOf'] = SchedulerMonthlyWeekDayFormatAllOf


class SchedulerMonthlyWeekDayFormat(ModelComposed):
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """SchedulerMonthlyWeekDayFormat - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              MoBaseComplexType,
              SchedulerMonthlyWeekDayFormatAllOf,
          ],
          'oneOf': [
          ],
        }
