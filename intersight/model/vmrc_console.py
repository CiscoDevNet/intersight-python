...
class VmrcConsole(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'vcenter': (VirtualizationVmwareVcenterRelationship,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "vmrc.Console" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "vmrc.Console")
        object_type = "vmrc.Console" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "vmrc.Console")
