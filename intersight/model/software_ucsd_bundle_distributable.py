...
def lazy_import():
    ...
    globals()['SoftwareUcsdBundleDistributableAllOf'] = SoftwareUcsdBundleDistributableAllOf
    globals()['SoftwareUcsdDistributableRelationship'] = SoftwareUcsdDistributableRelationship
...
class SoftwareUcsdBundleDistributable(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'images': ([SoftwareUcsdDistributableRelationship], none_type,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """SoftwareUcsdBundleDistributable - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "software.UcsdBundleDistributable", must be one of ["software.UcsdBundleDistributable", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "software.UcsdBundleDistributable", must be one of ["software.UcsdBundleDistributable", ]  # noqa: E501
            ...
            images ([SoftwareUcsdDistributableRelationship], none_type): An array of relationships to softwareUcsdDistributable resources.. [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "software.UcsdBundleDistributable")
        object_type = kwargs.get('object_type', "software.UcsdBundleDistributable")
