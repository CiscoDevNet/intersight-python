...
def lazy_import():
    from intersight.model.capability_bios_tokens_list import CapabilityBiosTokensList
    ...
    globals()['CapabilityBiosTokensList'] = CapabilityBiosTokensList
...
class CapabilityBiosTokensResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'capability.BiosTokens.List': CapabilityBiosTokensList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CapabilityBiosTokensResponse - a model defined in OpenAPI
