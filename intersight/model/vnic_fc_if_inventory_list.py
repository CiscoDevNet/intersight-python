...
def lazy_import():
    ...
    globals()['VnicFcIfInventoryListAllOf'] = VnicFcIfInventoryListAllOf


class VnicFcIfInventoryList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([VnicFcIfInventory], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """VnicFcIfInventoryList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'vnic.FcIfInventory' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
            results ([VnicFcIfInventory], none_type): The array of 'vnic.FcIfInventory' resources matching the request.. [optional]  # noqa: E501
        """
