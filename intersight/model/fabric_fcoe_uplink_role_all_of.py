...
class FabricFcoeUplinkRoleAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FabricFcoeUplinkRoleAllOf - a model defined in OpenAPI
        ...
        class_id = "fabric.FcoeUplinkRole" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "fabric.FcoeUplinkRole")
        object_type = "fabric.FcoeUplinkRole" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "fabric.FcoeUplinkRole")
