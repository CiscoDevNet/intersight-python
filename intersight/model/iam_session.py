...
def lazy_import():
    ...
    globals()['IamSessionAllOf'] = IamSessionAllOf
...
class IamSession(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'account_permissions': ([IamAccountPermissions], none_type,),  # noqa: E501
            'expiration': (datetime,),  # noqa: E501
            'failed_logins': (int,),  # noqa: E501
            'idle_time_expiration': (datetime,),  # noqa: E501
            'last_login_client': (str,),  # noqa: E501
            'last_login_time': (datetime,),  # noqa: E501
            'login_type': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'account_permissions': 'AccountPermissions',  # noqa: E501
        'expiration': 'Expiration',  # noqa: E501
        'failed_logins': 'FailedLogins',  # noqa: E501
        'idle_time_expiration': 'IdleTimeExpiration',  # noqa: E501
        'last_login_client': 'LastLoginClient',  # noqa: E501
        'last_login_time': 'LastLoginTime',  # noqa: E501
        'login_type': 'LoginType',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'failed_logins',  # noqa: E501
        'idle_time_expiration',  # noqa: E501
        'last_login_client',  # noqa: E501
        'last_login_time',  # noqa: E501
        'login_type',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IamSession - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "iam.Session", must be one of ["iam.Session", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "iam.Session", must be one of ["iam.Session", ]  # noqa: E501
            ...
            account_permissions ([IamAccountPermissions], none_type): [optional]  # noqa: E501
            expiration (datetime): Expiration time for the session.. [optional]  # noqa: E501
            failed_logins (int): Failed logins since last login for admin user.. [optional]  # noqa: E501
            idle_time_expiration (datetime): Idle time expiration for the session.. [optional]  # noqa: E501
            ...
            login_type (str): The type of login that created this session. Indicates whether the session was created through standard web login or JWT token exchange. * `weblogin` - Session created through standard web login process. * `tokenexchange` - Session created through JWT token exchange process.. [optional] if omitted the server will use the default value of "weblogin"  # noqa: E501
            scope (IamSwitchScopePermissions): [optional]  # noqa: E501
            session_id (str): Session token shared with the user agent which is used to identify the user session when API requests are received to perform authorization.. [optional]  # noqa: E501
        ...
        class_id = "iam.Session" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "iam.Session")
        object_type = "iam.Session" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "iam.Session")
