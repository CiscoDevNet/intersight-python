...
def lazy_import():
    ...
    globals()['ApplianceClusterInstallBaseAllOf'] = ApplianceClusterInstallBaseAllOf
...
class ApplianceClusterInstallBase(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            ...
            'CLUSTERWORKERNODE': "appliance.ClusterWorkerNode",
        },
        ('object_type',): {
            'CLUSTERINSTALL': "appliance.ClusterInstall",
            'CLUSTERREPLACENODE': "appliance.ClusterReplaceNode",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """ApplianceClusterInstallBase - a model defined in OpenAPI
