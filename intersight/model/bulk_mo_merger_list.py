...
def lazy_import():
    ...
    from intersight.model.bulk_mo_merger_list_all_of import BulkMoMergerListAllOf
    from intersight.model.mo_base_response import MoBaseResponse
    globals()['BulkMoMerger'] = BulkMoMerger
    globals()['BulkMoMergerListAllOf'] = BulkMoMergerListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class BulkMoMergerList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([BulkMoMerger], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """BulkMoMergerList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'bulk.MoMerger' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
            results ([BulkMoMerger], none_type): The array of 'bulk.MoMerger' resources matching the request.. [optional]  # noqa: E501
        """
