...
class TelemetryDruidSelectorFilterAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dimension, value, *args, **kwargs):  # noqa: E501
        """TelemetryDruidSelectorFilterAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            type (str): defaults to "selector", must be one of ["selector", ]  # noqa: E501
        ...
        type = "selector" if len(kwargs.get('type','').strip()) == 0 else kwargs.get('type', "selector")
    ...
    @convert_js_args_to_python_args
    def __init__(self, dimension, value, *args, **kwargs):  # noqa: E501
        """TelemetryDruidSelectorFilterAllOf - a model defined in OpenAPI
