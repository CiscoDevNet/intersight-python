...
def lazy_import():
    ...
    globals()['VirtualizationVirtualMachineAllOf'] = VirtualizationVirtualMachineAllOf
...
class VirtualizationVirtualMachine(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'gpu_configs': ([InfraBaseGpuConfiguration], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'gpu_configs': 'GpuConfigs',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VirtualizationVirtualMachine - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            cpu (int): Number of vCPUs to be allocated to virtual machine. The upper limit depends on the hypervisor.. [optional]  # noqa: E501
            ...
            gpu_configs ([InfraBaseGpuConfiguration], none_type): [optional]  # noqa: E501
            ...
            memory (int): Virtual machine memory in mebi bytes (one mebibyte, 1MiB, is 1048576 bytes, and 1KiB is 1024 bytes). Input must be a whole number and scientific notation is not acceptable. For example, enter 1730 and not 1.73e03. No upper limit is enforced because hypervisors increase the limit in every release.. [optional]  # noqa: E501
        ...
        class_id = "virtualization.VirtualMachine" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "virtualization.VirtualMachine")
        object_type = "virtualization.VirtualMachine" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "virtualization.VirtualMachine")
