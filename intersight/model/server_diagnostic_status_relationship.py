...
def lazy_import():
    ...
    from intersight.model.server_diagnostic_result import ServerDiagnosticResult
    from intersight.model.server_diagnostic_status import ServerDiagnosticStatus
    from intersight.model.server_diagnostics_relationship import ServerDiagnosticsRelationship
    ...
    globals()['ServerDiagnosticResult'] = ServerDiagnosticResult
    globals()['ServerDiagnosticStatus'] = ServerDiagnosticStatus
    globals()['ServerDiagnosticsRelationship'] = ServerDiagnosticsRelationship
    globals()['WorkflowWorkflowInfoRelationship'] = WorkflowWorkflowInfoRelationship


class ServerDiagnosticStatusRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'diagnostics_type': (str,),  # noqa: E501
            'download_message': (str,),  # noqa: E501
            'download_percentage': (int,),  # noqa: E501
            'download_stage': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'overall_state': (str,),  # noqa: E501
            'progress': (int,),  # noqa: E501
            'result': ([ServerDiagnosticResult], none_type,),  # noqa: E501
            'sd_card_download_error': (str,),  # noqa: E501
            'diagnostics': (ServerDiagnosticsRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'diagnostics_type': 'DiagnosticsType',  # noqa: E501
        ...
        'name': 'Name',  # noqa: E501
        'overall_state': 'OverallState',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ServerDiagnosticStatusRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            diagnostics_type (str): Type of diagnostics to be performed on the server hardware components. * `Quick` - Perform fast and limited diagnostics on server hardware components. * `Comprehensive` - Perform slow and extensive diagnostics on server hardware components.. [optional] if omitted the server will use the default value of "Quick"  # noqa: E501
            ...
            name (str): The name of the diagnostics being run.. [optional]  # noqa: E501
            overall_state (str): The overall state of the diagnostics being run. * `Queued` - The diagnostics are queued. * `InProgress` - The diagnostics are in progress. * `Completed` - The diagnostics are completed. * `Failed` - The diagnostics have failed. * `Terminated` - The diagnostics are terminated.. [optional] if omitted the server will use the default value of "Queued"  # noqa: E501
            progress (int): The progress of the diagnostics being run.. [optional]  # noqa: E501
            result ([ServerDiagnosticResult], none_type): [optional]  # noqa: E501
            sd_card_download_error (str): The error message from the endpoint during the SD card download.. [optional]  # noqa: E501
            diagnostics (ServerDiagnosticsRelationship): [optional]  # noqa: E501
