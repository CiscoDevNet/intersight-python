...
def lazy_import():
    from intersight.model.dnac_transit_list import DnacTransitList
    ...
    globals()['DnacTransitList'] = DnacTransitList
...
class DnacTransitResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'dnac.Transit.List': DnacTransitList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """DnacTransitResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'dnac.Transit' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
