...
def lazy_import():
    ...
    globals()['FabricVlanSetListAllOf'] = FabricVlanSetListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class FabricVlanSetList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([FabricVlanSet], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FabricVlanSetList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'fabric.VlanSet' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
            results ([FabricVlanSet], none_type): The array of 'fabric.VlanSet' resources matching the request.. [optional]  # noqa: E501
        """
