...
class EquipmentDeviceSummaryAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentDeviceSummaryAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "equipment.DeviceSummary", must be one of ["equipment.DeviceSummary", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "equipment.DeviceSummary", must be one of ["equipment.DeviceSummary", ]  # noqa: E501
            ...
            dn (str): The distinguished name that unambiguously identifies an object in the system.. [optional]  # noqa: E501
            model (str): This field identifies the model of the given component.. [optional]  # noqa: E501
            serial (str): This field identifies the serial number of the given component.. [optional]  # noqa: E501
            source_object_type (str): The source object type of the given component.. [optional]  # noqa: E501
        ...
        class_id = "equipment.DeviceSummary" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "equipment.DeviceSummary")
        object_type = "equipment.DeviceSummary" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "equipment.DeviceSummary")
