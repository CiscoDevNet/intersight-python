...
class CapabilitySwitchCapabilityResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CapabilitySwitchCapabilityResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'capability.SwitchCapability' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
