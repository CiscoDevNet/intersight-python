...
def lazy_import():
    ...
    globals()['StorageBaseArrayControllerAllOf'] = StorageBaseArrayControllerAllOf
...
class StorageBaseArrayController(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'HITACHICONTROLLER': "storage.HitachiController",
            'NETAPPNODE': "storage.NetAppNode",
            'PURECONTROLLER': "storage.PureController",
        },
        ('object_type',): {
            'HITACHICONTROLLER': "storage.HitachiController",
            'NETAPPNODE': "storage.NetAppNode",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """StorageBaseArrayController - a model defined in OpenAPI
