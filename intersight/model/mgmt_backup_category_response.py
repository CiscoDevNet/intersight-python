...
def lazy_import():
    from intersight.model.mgmt_backup_category_list import MgmtBackupCategoryList
    ...
    globals()['MgmtBackupCategoryList'] = MgmtBackupCategoryList
...
class MgmtBackupCategoryResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'mgmt.BackupCategory.List': MgmtBackupCategoryList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """MgmtBackupCategoryResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'mgmt.BackupCategory' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
