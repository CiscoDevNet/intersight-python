...
class TelemetryDruidThetaSketchAggregatorAllOf(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, field_name, *args, **kwargs):  # noqa: E501
        """TelemetryDruidThetaSketchAggregatorAllOf - a model defined in OpenAPI
