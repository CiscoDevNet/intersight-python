...
def lazy_import():
    ...
    globals()['VnicServiceEthIfAllOf'] = VnicServiceEthIfAllOf


class VnicServiceEthIf(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VnicServiceEthIf - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "vnic.ServiceEthIf", must be one of ["vnic.ServiceEthIf", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "vnic.ServiceEthIf", must be one of ["vnic.ServiceEthIf", ]  # noqa: E501
        ...
        class_id = "vnic.ServiceEthIf" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "vnic.ServiceEthIf")
        object_type = "vnic.ServiceEthIf" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "vnic.ServiceEthIf")
