...
def lazy_import():
    ...
    globals()['SdcardPolicyInventoryAllOf'] = SdcardPolicyInventoryAllOf


class SdcardPolicyInventory(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'partitions': ([SdcardPartition], none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SdcardPolicyInventory - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "sdcard.PolicyInventory", must be one of ["sdcard.PolicyInventory", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "sdcard.PolicyInventory", must be one of ["sdcard.PolicyInventory", ]  # noqa: E501
            ...
            partitions ([SdcardPartition], none_type): [optional]  # noqa: E501
        ...
        class_id = "sdcard.PolicyInventory" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "sdcard.PolicyInventory")
        object_type = "sdcard.PolicyInventory" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "sdcard.PolicyInventory")
