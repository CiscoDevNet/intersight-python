...
def lazy_import():
    ...
    globals()['NiaapiNibFileDownloaderListAllOf'] = NiaapiNibFileDownloaderListAllOf


class NiaapiNibFileDownloaderList(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """NiaapiNibFileDownloaderList - a model defined in OpenAPI
