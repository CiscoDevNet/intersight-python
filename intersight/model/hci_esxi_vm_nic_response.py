...
def lazy_import():
    from intersight.model.hci_esxi_vm_nic_list import HciEsxiVmNicList
    ...
    globals()['HciEsxiVmNicList'] = HciEsxiVmNicList
...
class HciEsxiVmNicResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'hci.EsxiVmNic.List': HciEsxiVmNicList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """HciEsxiVmNicResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'hci.EsxiVmNic' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
