...
class ApplianceNodeInfoRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'node_ip_v4_config': (CommIpV4Interface,),  # noqa: E501
            'node_ip_v6_config': (CommIpV6Interface,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'node_ip_v4_config': 'NodeIpV4Config',  # noqa: E501
        'node_ip_v6_config': 'NodeIpV6Config',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApplianceNodeInfoRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            deployment_size (str): Current running deployment size for the Intersight Appliance node. Eg. small, medium, large etc.. [optional]  # noqa: E501
            hostname (str): Cluster node's FQDN or IP address.. [optional]  # noqa: E501
            node_id (int): System assigned unique ID of the Intersight Appliance node. The system incrementally assigns identifiers to each node in the Intersight Appliance cluster starting with a value of 1.. [optional]  # noqa: E501
            node_ip_v4_config (CommIpV4Interface): [optional]  # noqa: E501
            node_ip_v6_config (CommIpV6Interface): [optional]  # noqa: E501
            node_type (str): The node type of Intersight Virtual Appliance. * `standalone` - Single Node Intersight Virtual Appliance. * `management` - Management node type when Intersight Virtual Appliance is running as management-worker deployment. * `hamanagement` - Management node type when Intersight Virtual Appliance is running as multi node HA deployment. * `metrics` - Metrics node when Intersight Virtual Appliance is running management-metrics node.. [optional] if omitted the server will use the default value of "standalone"  # noqa: E501
            operational_status (str): Operational status of the Intersight Appliance node. * `Unknown` - The status of the appliance node is unknown. * `Operational` - The appliance node is operational. * `Impaired` - The appliance node is impaired. * `AttentionNeeded` - The appliance node needs attention. * `ReadyToJoin` - The node is ready to be added to a standalone Intersight Appliance to form a cluster. * `OutOfService` - The user has taken this node (part of a cluster) to out of service. * `ReadyForReplacement` - The cluster node is ready to be replaced. * `ReplacementInProgress` - The cluster node replacement is in progress. * `ReplacementFailed` - There was a failure during the cluster node replacement. * `WorkerNodeInstInProgress` - The worker node installation is in progress. * `WorkerNodeInstSuccess` - The worker node installation succeeded. * `WorkerNodeInstFailed` - The worker node installation failed.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
