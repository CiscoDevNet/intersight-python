...
def lazy_import():
    ...
    globals()['VirtualizationBaseNetworkAllOf'] = VirtualizationBaseNetworkAllOf
...
class VirtualizationBaseNetwork(ModelComposed):
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """VirtualizationBaseNetwork - a model defined in OpenAPI
