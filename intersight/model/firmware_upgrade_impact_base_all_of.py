...
class FirmwareUpgradeImpactBaseAllOf(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            'UPGRADEIMPACT': "firmware.UpgradeImpact",
            'UPGRADEIMPACTSTATUS': "firmware.UpgradeImpactStatus",
        },
        ('object_type',): {
            'UPGRADEIMPACT': "firmware.UpgradeImpact",
            'UPGRADEIMPACTSTATUS': "firmware.UpgradeImpactStatus",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """FirmwareUpgradeImpactBaseAllOf - a model defined in OpenAPI
