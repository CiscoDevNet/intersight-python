...
class CapabilityFanModuleDescriptor(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "capability.FanModuleDescriptor" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "capability.FanModuleDescriptor")
        object_type = "capability.FanModuleDescriptor" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "capability.FanModuleDescriptor")
