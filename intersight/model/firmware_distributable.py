...
def lazy_import():
    ...
    globals()['FirmwareDistributableAllOf'] = FirmwareDistributableAllOf
...
class FirmwareDistributable(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'feature_flags': ([str], none_type,),  # noqa: E501
            'file_location': (str,),  # noqa: E501
            'image_category': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'image_category': 'ImageCategory',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FirmwareDistributable - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "firmware.Distributable", must be one of ["firmware.Distributable", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "firmware.Distributable", must be one of ["firmware.Distributable", ]  # noqa: E501
            ...
            feature_flags ([str], none_type): [optional]  # noqa: E501
            file_location (str): The file location of the distributable.. [optional]  # noqa: E501
            image_category (str): The category into which the distributable falls into according to the supported platform series. For e.g.; C-Series/B-Series/Infrastructure.. [optional]  # noqa: E501
            is_beta (bool): Whether this distributable is a beta image and participates in OData filtering so callers can explicitly query beta or non-beta firmware images.. [optional] if omitted the server will use the default value of False  # noqa: E501
            origin (str): The source of the distributable. If it has been created by the user or system. * `System` - The distributable has been created by the System. * `User` - The distributable has been created by the User.. [optional] if omitted the server will use the default value of "System"  # noqa: E501
        ...
        class_id = "firmware.Distributable" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "firmware.Distributable")
        object_type = "firmware.Distributable" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "firmware.Distributable")
