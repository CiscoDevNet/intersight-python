...
def lazy_import():
    ...
    globals()['SearchSuggestItemListAllOf'] = SearchSuggestItemListAllOf


class SearchSuggestItemList(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """SearchSuggestItemList - a model defined in OpenAPI
