...
def lazy_import():
    ...
    globals()['FirmwareRunningFirmwareAllOf'] = FirmwareRunningFirmwareAllOf
...
class FirmwareRunningFirmware(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'equipment_psu': (EquipmentPsuRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'equipment_psu': 'EquipmentPsu',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FirmwareRunningFirmware - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "firmware.RunningFirmware", must be one of ["firmware.RunningFirmware", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "firmware.RunningFirmware", must be one of ["firmware.RunningFirmware", ]  # noqa: E501
            ...
            component (str): Kind of the firmware - boot-booloader/system/kernel.. [optional]  # noqa: E501
            package_version (str): Bundle version which the firmware belongs to.. [optional]  # noqa: E501
            type (str): The type of the firmware.. [optional]  # noqa: E501
            version (str): The version of the firmware.. [optional]  # noqa: E501
            ...
            equipment_psu (EquipmentPsuRelationship): [optional]  # noqa: E501
        ...
        class_id = "firmware.RunningFirmware" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "firmware.RunningFirmware")
        object_type = "firmware.RunningFirmware" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "firmware.RunningFirmware")
