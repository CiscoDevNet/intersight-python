...
class VirtualizationVmwarePhysicalNetworkInterfaceResponse(ModelComposed):
    ...
    def __init__(self, object_type, *args, **kwargs):  # noqa: E501
        """VirtualizationVmwarePhysicalNetworkInterfaceResponse - a model defined in OpenAPI
