...
def lazy_import():
    ...
    globals()['VirtualizationBaseVirtualNetworkInterfaceCardAllOf'] = VirtualizationBaseVirtualNetworkInterfaceCardAllOf


class VirtualizationBaseVirtualNetworkInterfaceCard(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """VirtualizationBaseVirtualNetworkInterfaceCard - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "hyperflex.HxapVirtualMachineNetworkInterface", must be one of ["hyperflex.HxapVirtualMachineNetworkInterface", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "hyperflex.HxapVirtualMachineNetworkInterface")
        object_type = kwargs.get('object_type', "hyperflex.HxapVirtualMachineNetworkInterface")
