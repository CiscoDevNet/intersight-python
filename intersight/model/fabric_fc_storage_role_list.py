...
def lazy_import():
    ...
    globals()['FabricFcStorageRoleListAllOf'] = FabricFcStorageRoleListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class FabricFcStorageRoleList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([FabricFcStorageRole], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FabricFcStorageRoleList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            results ([FabricFcStorageRole], none_type): The array of 'fabric.FcStorageRole' resources matching the request.. [optional]  # noqa: E501
        """
