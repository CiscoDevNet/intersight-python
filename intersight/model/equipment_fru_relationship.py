...
def lazy_import():
    ...
    globals()['EquipmentBaseRelationship'] = EquipmentBaseRelationship
...
class EquipmentFruRelationship(ModelComposed):
    ...
    allowed_values = {
        ...
        ('action',): {
            ...
            'REMOVED': "Removed",
            'REPLACED': "Replaced",
            'REPLACEDWITHALARM': "ReplacedWithAlarm",
        },
        ('object_type',): {
    ...
    def openapi_types():
        ...
        return {
            ...
            'current_fru': (EquipmentBaseRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'current_fru': 'CurrentFru',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """EquipmentFruRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            action (str): This field identifies the action performed on a component. * `None` - No action performed on the FRU. * `Inserted` - A new FRU is inserted or added. * `Removed` - The previous FRU is removed. * `Replaced` - The previous FRU is replaced with a new FRU. * `ReplacedWithAlarm` - The previous FRU is replaced with a new FRU and a alarm is raised.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            current_fru (EquipmentBaseRelationship): [optional]  # noqa: E501
