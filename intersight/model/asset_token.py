...
class AssetToken(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'PARENTCONNECTIONSIGNATURE': "asset.ParentConnectionSignature",
            'TARGETSIGNATURE': "asset.TargetSignature",
            'TOKEN': "asset.Token",
        },
        ('object_type',): {
            'PARENTCONNECTIONSIGNATURE': "asset.ParentConnectionSignature",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """AssetToken - a model defined in OpenAPI
