...
class TelemetryDruidExtractionFunctionInlineLookupAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TelemetryDruidExtractionFunctionInlineLookupAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            type (str): defaults to "lookup", must be one of ["lookup", ]  # noqa: E501
        ...
        type = "lookup" if len(kwargs.get('type','').strip()) == 0 else kwargs.get('type', "lookup")
