...
def lazy_import():
    from intersight.model.functions_function_version_list import FunctionsFunctionVersionList
    ...
    globals()['FunctionsFunctionVersionList'] = FunctionsFunctionVersionList
...
class FunctionsFunctionVersionResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'functions.FunctionVersion.List': FunctionsFunctionVersionList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FunctionsFunctionVersionResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'functions.FunctionVersion' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
