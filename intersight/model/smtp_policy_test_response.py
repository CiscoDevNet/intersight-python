...
def lazy_import():
    ...
    from intersight.model.smtp_policy_test_list import SmtpPolicyTestList
    ...
    globals()['SmtpPolicyTestList'] = SmtpPolicyTestList


class SmtpPolicyTestResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'smtp.PolicyTest.List': SmtpPolicyTestList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """SmtpPolicyTestResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'smtp.PolicyTest' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
