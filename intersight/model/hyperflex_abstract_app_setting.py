...
def lazy_import():
    ...
    globals()['HyperflexAbstractAppSettingAllOf'] = HyperflexAbstractAppSettingAllOf
...
class HyperflexAbstractAppSetting(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'FEATURELIMITENTRY': "hyperflex.FeatureLimitEntry",
            'SERVERMODELENTRY': "hyperflex.ServerModelEntry",
        },
        ('object_type',): {
            'FEATURELIMITENTRY': "hyperflex.FeatureLimitEntry",
            'SERVERMODELENTRY': "hyperflex.ServerModelEntry",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """HyperflexAbstractAppSetting - a model defined in OpenAPI
