...
def lazy_import():
    ...
    globals()['CloudSkuContainerTypeAllOf'] = CloudSkuContainerTypeAllOf
...
class CloudSkuContainerType(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """CloudSkuContainerType - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "cloud.SkuContainerType", must be one of ["cloud.SkuContainerType", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "cloud.SkuContainerType", must be one of ["cloud.SkuContainerType", ]  # noqa: E501
            ...
            cpu_unit (str): The CpuUnit. Will be MILLI_CPU for containers. * `VIRTUAL_CPU` - The CPU unit used for virtual machines. * `MILLI_CPU` - The CPU unit used by containers.. [optional] if omitted the server will use the default value of "VIRTUAL_CPU"  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "cloud.SkuContainerType")
        object_type = kwargs.get('object_type', "cloud.SkuContainerType")
