...
def lazy_import():
    from intersight.model.hci_violation_list import HciViolationList
    ...
    globals()['HciViolationList'] = HciViolationList
...
class HciViolationResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'hci.Violation.List': HciViolationList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """HciViolationResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'hci.Violation' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
