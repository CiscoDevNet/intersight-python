...
def lazy_import():
    from intersight.model.asset_geo_location_list import AssetGeoLocationList
    ...
    globals()['AssetGeoLocationList'] = AssetGeoLocationList
...
class AssetGeoLocationResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'asset.GeoLocation.List': AssetGeoLocationList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """AssetGeoLocationResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'asset.GeoLocation' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
