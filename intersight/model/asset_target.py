...
class AssetTarget(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            external_ip_address (str): ExternalIpAddress is applicable for targets which are managed via an Intersight Device Connector. The value is the IP Address of the target as seen from Intersight. It is either the IP Address of the managed target's interface which has a route to the internet or a NAT IP Addresss when the target is deployed in a private network.. [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "asset.Target")
        object_type = kwargs.get('object_type', "asset.Target")
