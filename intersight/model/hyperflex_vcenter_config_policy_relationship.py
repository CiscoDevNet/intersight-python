...
class HyperflexVcenterConfigPolicyRelationship(ModelComposed):
    ...
    validations = {
        ...
        ('data_center',): {
            'regex': {
                'pattern': r'^[a-zA-Z0-9~!@#$%&*()-_][a-zA-Z0-9~!@#$%&* ()-_]{0,79}$',  # noqa: E501
            },
        },
        ('hostname',): {
            'regex': {
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """HyperflexVcenterConfigPolicyRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            data_center (str): The vCenter datacenter name.. [optional]  # noqa: E501
            hostname (str): The vCenter server FQDN or IP.. [optional]  # noqa: E501
            ...
            password (str): The password for authenticating with vCenter. Follow the corresponding password policy governed by vCenter.. [optional]  # noqa: E501
            sso_url (str): Overrides the default vCenter Single Sign-On URL. Do not specify unless instructed by Cisco TAC.. [optional]  # noqa: E501
            username (str): The vCenter username (e.g. administrator@vsphere.local).. [optional]  # noqa: E501
