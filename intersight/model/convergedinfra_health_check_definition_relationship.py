...
class ConvergedinfraHealthCheckDefinitionRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'label': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'suggested_resolution': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'name': 'Name',  # noqa: E501
        'suggested_resolution': 'SuggestedResolution',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """ConvergedinfraHealthCheckDefinitionRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            execution_mode (str): Execution mode of the health check on converged infrastructure pod. * `OnDemand` - Execute the health check on-demand. * `Periodic` - Execute the health check on a periodic basis.. [optional] if omitted the server will use the default value of "OnDemand"  # noqa: E501
            ...
            suggested_resolution (str): Static information detailing the possible remediation actions that can be taken to remedy the health check failure.. [optional]  # noqa: E501
