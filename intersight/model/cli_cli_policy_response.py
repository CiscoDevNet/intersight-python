...
def lazy_import():
    from intersight.model.cli_cli_policy_list import CliCliPolicyList
    ...
    globals()['CliCliPolicyList'] = CliCliPolicyList
...
class CliCliPolicyResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'cli.CliPolicy.List': CliCliPolicyList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CliCliPolicyResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'cli.CliPolicy' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
