...
def lazy_import():
    ...
    from intersight.model.pci_port_all_of import PciPortAllOf
    ...
    globals()['PciPortAllOf'] = PciPortAllOf
    globals()['PciSwitchRelationship'] = PciSwitchRelationship


class PciPort(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PciPort - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "pci.Port", must be one of ["pci.Port", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "pci.Port", must be one of ["pci.Port", ]  # noqa: E501
        ...
        class_id = "pci.Port" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "pci.Port")
        object_type = "pci.Port" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "pci.Port")
