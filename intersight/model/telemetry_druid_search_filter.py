...
def lazy_import():
    ...
    globals()['TelemetryDruidSearchFilterAllOf'] = TelemetryDruidSearchFilterAllOf


class TelemetryDruidSearchFilter(ModelComposed):
    ...
    def _from_openapi_data(cls, dimension, query, *args, **kwargs):  # noqa: E501
        """TelemetryDruidSearchFilter - a model defined in OpenAPI
