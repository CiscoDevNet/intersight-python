...
def lazy_import():
    from intersight.model.iam_guest_access_settings_list import IamGuestAccessSettingsList
    ...
    globals()['IamGuestAccessSettingsList'] = IamGuestAccessSettingsList
...
class IamGuestAccessSettingsResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'iam.GuestAccessSettings.List': IamGuestAccessSettingsList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """IamGuestAccessSettingsResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'iam.GuestAccessSettings' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
