...
def lazy_import():
    ...
    globals()['TelemetryDruidTimeBoundaryRequestAllOf'] = TelemetryDruidTimeBoundaryRequestAllOf


class TelemetryDruidTimeBoundaryRequest(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, query_type, data_source, *args, **kwargs):  # noqa: E501
        """TelemetryDruidTimeBoundaryRequest - a model defined in OpenAPI
