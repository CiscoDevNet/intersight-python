...
class WorkflowWorkflowMetadataRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'label': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'associated_privilege_sets': ([IamPrivilegeSetRelationship], none_type,),  # noqa: E501
            'associated_roles': ([IamRoleRelationship], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'name': 'Name',  # noqa: E501
        'associated_privilege_sets': 'AssociatedPrivilegeSets',  # noqa: E501
        'associated_roles': 'AssociatedRoles',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """WorkflowWorkflowMetadataRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            label (str): A user friendly short name to identify the workflow metadata. Label can only contain letters (a-z, A-Z), numbers (0-9), hyphen (-), period (.), colon (:), space ( ) or an underscore (_).. [optional]  # noqa: E501
            name (str): The name for this workflow metadata. You can have multiple versions of the workflow with the same name. Name can only contain letters (a-z, A-Z), numbers (0-9), hyphen (-), period (.) or an underscore (_).. [optional]  # noqa: E501
            associated_privilege_sets ([IamPrivilegeSetRelationship], none_type): An array of relationships to iamPrivilegeSet resources.. [optional]  # noqa: E501
            associated_roles ([IamRoleRelationship], none_type): An array of relationships to iamRole resources.. [optional]  # noqa: E501
