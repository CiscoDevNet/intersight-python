...
def lazy_import():
    ...
    from intersight.model.storage_nvme_raid_configuration_list import StorageNvmeRaidConfigurationList
    ...
    globals()['StorageNvmeRaidConfigurationList'] = StorageNvmeRaidConfigurationList


class StorageNvmeRaidConfigurationResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'storage.NvmeRaidConfiguration.List': StorageNvmeRaidConfigurationList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """StorageNvmeRaidConfigurationResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'storage.NvmeRaidConfiguration' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
