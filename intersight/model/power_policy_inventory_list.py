...
def lazy_import():
    ...
    globals()['PowerPolicyInventoryListAllOf'] = PowerPolicyInventoryListAllOf


class PowerPolicyInventoryList(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """PowerPolicyInventoryList - a model defined in OpenAPI
