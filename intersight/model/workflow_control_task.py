...
class WorkflowControlTask(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'DECISIONTASK': "workflow.DecisionTask",
            'FAILUREENDTASK': "workflow.FailureEndTask",
            'FORKTASK': "workflow.ForkTask",
            'JOINTASK': "workflow.JoinTask",
            'LOOPTASK': "workflow.LoopTask",
            'STARTTASK': "workflow.StartTask",
            'SUBWORKFLOWTASK': "workflow.SubWorkflowTask",
            'SUCCESSENDTASK': "workflow.SuccessEndTask",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """WorkflowControlTask - a model defined in OpenAPI
