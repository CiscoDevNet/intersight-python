"""
    ...
    The version of the OpenAPI document: 1.0.11-15830
...
def lazy_import():
    ...
    from intersight.model.acme_drawing_board import AcmeDrawingBoard
    from intersight.model.acme_foo import AcmeFoo
    ...
    globals()['AcmeDrawingBoard'] = AcmeDrawingBoard
    globals()['AcmeFoo'] = AcmeFoo
...
class MoBaseMo(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            ...
            'ACME.DRAWINGBOARD': "acme.DrawingBoard",
            'ACME.FOO': "acme.Foo",
    ...
    def discriminator():
        ...
        val = {
            ...
            'acme.DrawingBoard': AcmeDrawingBoard,
            'acme.Foo': AcmeFoo,
