"""
    ...
    The version of the OpenAPI document: 1.0.11-14237
...
def lazy_import():
    ...
    from intersight.model.hyperflex_health_check_script_downloader import HyperflexHealthCheckScriptDownloader
    ...
    globals()['HyperflexHealthCheckScriptDownloader'] = HyperflexHealthCheckScriptDownloader
...
class MoBaseMo(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            ...
            'HYPERFLEX.HEALTHCHECKSCRIPTDOWNLOADER': "hyperflex.HealthCheckScriptDownloader",
    ...
    def discriminator():
        ...
        val = {
            ...
            'hyperflex.HealthCheckScriptDownloader': HyperflexHealthCheckScriptDownloader,
