...
def lazy_import():
    ...
    globals()['ApicAciPod'] = ApicAciPod
    globals()['ApicApplication'] = ApicApplication
    globals()['ApicApplicationEndpointGroup'] = ApicApplicationEndpointGroup
    globals()['ApicBridgeDomain'] = ApicBridgeDomain
    globals()['ApicExternalRoutedLayerThreeDomain'] = ApicExternalRoutedLayerThreeDomain
    globals()['ApicFabricLeafNode'] = ApicFabricLeafNode
    globals()['ApicFabricLeafNodeInterface'] = ApicFabricLeafNodeInterface
    globals()['ApicInventoryEntity'] = ApicInventoryEntity
    globals()['ApicOut'] = ApicOut
    globals()['ApicSubnet'] = ApicSubnet
    globals()['ApicTenant'] = ApicTenant
    globals()['ApicVpcGroup'] = ApicVpcGroup
    globals()['ApicVrfs'] = ApicVrfs
...
class MoBaseMo(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'apic.AciPod': ApicAciPod,
            'apic.Application': ApicApplication,
            'apic.ApplicationEndpointGroup': ApicApplicationEndpointGroup,
            'apic.BridgeDomain': ApicBridgeDomain,
            'apic.ExternalRoutedLayerThreeDomain': ApicExternalRoutedLayerThreeDomain,
            'apic.FabricLeafNode': ApicFabricLeafNode,
            'apic.FabricLeafNodeInterface': ApicFabricLeafNodeInterface,
            'apic.InventoryEntity': ApicInventoryEntity,
            'apic.Out': ApicOut,
            'apic.Subnet': ApicSubnet,
            'apic.Tenant': ApicTenant,
            'apic.VpcGroup': ApicVpcGroup,
            'apic.Vrfs': ApicVrfs,
