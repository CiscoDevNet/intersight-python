...
def lazy_import():
    from intersight.model.hyperflex_vdisk_config import HyperflexVdiskConfig
    globals()['HyperflexVdiskConfig'] = HyperflexVdiskConfig


class HyperflexVmDiskAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
            'virtual_disk': (HyperflexVdiskConfig,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """HyperflexVmDiskAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "hyperflex.VmDisk", must be one of ["hyperflex.VmDisk", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "hyperflex.VmDisk", must be one of ["hyperflex.VmDisk", ]  # noqa: E501
            ...
            virtual_disk (HyperflexVdiskConfig): [optional]  # noqa: E501
            virtual_disk_reference (str): Virtual disk reference name.. [optional]  # noqa: E501
        """

        class_id = kwargs.get('class_id', "hyperflex.VmDisk")
        object_type = kwargs.get('object_type', "hyperflex.VmDisk")
