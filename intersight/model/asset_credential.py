...
def lazy_import():
    ...
    from intersight.model.asset_splunk_token_credential import AssetSplunkTokenCredential
    ...
    globals()['AssetSplunkTokenCredential'] = AssetSplunkTokenCredential
...
class AssetCredential(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'asset.SplunkTokenCredential': AssetSplunkTokenCredential,
