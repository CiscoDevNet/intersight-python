...
class HyperflexKeyEncryptionKeyAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            is_account_recovery (bool): Account recovery scenario flag determining parameter population from internal MO, with possibility of ignoring of input parameters when this value is true.. [optional] if omitted the server will use the default value of False  # noqa: E501
            ...
            iteration (int): Number of hash iterations to run.. [optional]  # noqa: E501
            kek (str): Key Encryption Key used to encrypt the DEK's on the HyperFlex cluster.. [optional]  # noqa: E501
            key_id (str): Resource ID and time for Kek retrieval.. [optional]  # noqa: E501
            key_state (str): Last known state of the Key Encryption Key. * `NEW` - Newly created Key Encryption Key (KEK). * `ACTIVE` - Deployed Key Encryption Key on active resources. * `INACTIVE` - Inactive and unused Key Encryption Key. * `INPROGRESS` - Unconfirmed Key Encryption Key usage on Intersight platform.. [optional] if omitted the server will use the default value of "NEW"  # noqa: E501
            passphrase (str): Initial passphrase for encryption policy, requiring a minimum of 12 characters, including 1 lowercase, 1 uppercase, and 1 numeric character.. [optional]  # noqa: E501
            resource_type (str): Resource type for key application. * `CLUSTER` - Cluster specific encryption per HyperFlex cluster. * `DATASTORE` - Data store encryption on the HyperFlex cluster. * `DRIVE` - Drive specific encryption on the HyperFlex cluster.. [optional] if omitted the server will use the default value of "CLUSTER"  # noqa: E501
            transit_kek (str): Temporary copy of KEK used for transfer to remote device endpoint, not persisted anywhere.. [optional]  # noqa: E501
