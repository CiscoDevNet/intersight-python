...
def lazy_import():
    from intersight.model.memory_policy_list import MemoryPolicyList
    ...
    globals()['MemoryPolicyList'] = MemoryPolicyList
...
class MemoryPolicyResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'memory.Policy.List': MemoryPolicyList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """MemoryPolicyResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'memory.Policy' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
