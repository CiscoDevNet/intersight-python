...
class ComputePcieEndpointConfigAllOf(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            'ADAPTERUNITCONFIG': "compute.AdapterUnitConfig",
            'GPUCONFIG': "compute.GpuConfig",
        },
        ('object_type',): {
            'ADAPTERUNITCONFIG': "compute.AdapterUnitConfig",
            'GPUCONFIG': "compute.GpuConfig",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """ComputePcieEndpointConfigAllOf - a model defined in OpenAPI
