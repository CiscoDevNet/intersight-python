...
def lazy_import():
    from intersight.model.capability_network_equipment_power_def_list import CapabilityNetworkEquipmentPowerDefList
    ...
    globals()['CapabilityNetworkEquipmentPowerDefList'] = CapabilityNetworkEquipmentPowerDefList
...
class CapabilityNetworkEquipmentPowerDefResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'capability.NetworkEquipmentPowerDef.List': CapabilityNetworkEquipmentPowerDefList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CapabilityNetworkEquipmentPowerDefResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'capability.NetworkEquipmentPowerDef' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
