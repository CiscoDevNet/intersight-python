...
class VirtualizationVmwareTeamingAndFailover(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "virtualization.VmwareTeamingAndFailover" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "virtualization.VmwareTeamingAndFailover")
        object_type = "virtualization.VmwareTeamingAndFailover" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "virtualization.VmwareTeamingAndFailover")
