...
def lazy_import():
    ...
    globals()['StorageBaseHostGroupAllOf'] = StorageBaseHostGroupAllOf
    globals()['StoragePureHostGroup'] = StoragePureHostGroup


class StorageBaseHostGroup(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """StorageBaseHostGroup - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "storage.PureHostGroup", must be one of ["storage.PureHostGroup", ]  # noqa: E501
