...
def lazy_import():
    ...
    globals()['AdapterExtEthInterfaceAllOf'] = AdapterExtEthInterfaceAllOf
...
class AdapterExtEthInterface(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AdapterExtEthInterface - a model defined in OpenAPI
        ...
        class_id = "adapter.ExtEthInterface" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "adapter.ExtEthInterface")
        object_type = "adapter.ExtEthInterface" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "adapter.ExtEthInterface")
