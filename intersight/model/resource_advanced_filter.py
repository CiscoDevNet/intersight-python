...
def lazy_import():
    ...
    from intersight.model.resource_advanced_filter_all_of import ResourceAdvancedFilterAllOf
    ...
    globals()['ResourceAdvancedFilterAllOf'] = ResourceAdvancedFilterAllOf
...
class ResourceAdvancedFilter(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'ADAPTORSRANGEFILTER': "resource.AdaptorsRangeFilter",
            'CHASSISIDRANGEFILTER': "resource.ChassisIdRangeFilter",
            'CPUCORERANGEFILTER': "resource.CpuCoreRangeFilter",
            'CPUSPEEDRANGEFILTER': "resource.CpuSpeedRangeFilter",
            'GPUCONTROLLERSRANGEFILTER': "resource.GpuControllersRangeFilter",
            'MEMORYCAPACITYRANGEFILTER': "resource.MemoryCapacityRangeFilter",
            'MEMORYUNITSRANGEFILTER': "resource.MemoryUnitsRangeFilter",
            'RACKIDRANGEFILTER': "resource.RackIdRangeFilter",
            'SLOTIDRANGEFILTER': "resource.SlotIdRangeFilter",
        },
        ('object_type',): {
            'ADAPTORSRANGEFILTER': "resource.AdaptorsRangeFilter",
            'CHASSISIDRANGEFILTER': "resource.ChassisIdRangeFilter",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """ResourceAdvancedFilter - a model defined in OpenAPI
