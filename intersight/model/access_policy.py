...
class AccessPolicy(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "access.Policy", must be one of ["access.Policy", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "access.Policy", must be one of ["access.Policy", ]  # noqa: E501
            ...
            inband_vlan (int): VLAN to be used for server access over Inband network. When Inband is enabled, only numbers between 4 to 4093 are allowed.. [optional] if omitted the server will use the default value of 0  # noqa: E501
        ...
        class_id = "access.Policy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "access.Policy")
        object_type = "access.Policy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "access.Policy")
