...
def lazy_import():
    from intersight.model.comm_tag_definition_list import CommTagDefinitionList
    ...
    globals()['CommTagDefinitionList'] = CommTagDefinitionList
...
class CommTagDefinitionResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'comm.TagDefinition.List': CommTagDefinitionList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CommTagDefinitionResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'comm.TagDefinition' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
