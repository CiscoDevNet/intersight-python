...
def lazy_import():
    from intersight.model.hci_ahv_vm_list import HciAhvVmList
    ...
    globals()['HciAhvVmList'] = HciAhvVmList
...
class HciAhvVmResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """HciAhvVmResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'hci.AhvVm' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
