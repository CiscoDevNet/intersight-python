...
def lazy_import():
    from intersight.model.apic_subnet_list import ApicSubnetList
    ...
    globals()['ApicSubnetList'] = ApicSubnetList
...
class ApicSubnetResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'apic.Subnet.List': ApicSubnetList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ApicSubnetResponse - a model defined in OpenAPI
