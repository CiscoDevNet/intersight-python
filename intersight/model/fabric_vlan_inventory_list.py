...
def lazy_import():
    ...
    globals()['FabricVlanInventoryListAllOf'] = FabricVlanInventoryListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class FabricVlanInventoryList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([FabricVlanInventory], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FabricVlanInventoryList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'fabric.VlanInventory' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
            results ([FabricVlanInventory], none_type): The array of 'fabric.VlanInventory' resources matching the request.. [optional]  # noqa: E501
        """
