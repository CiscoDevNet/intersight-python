...
def lazy_import():
    from intersight.model.meraki_organization_list import MerakiOrganizationList
    ...
    globals()['MerakiOrganizationList'] = MerakiOrganizationList
...
class MerakiOrganizationResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'meraki.Organization.List': MerakiOrganizationList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """MerakiOrganizationResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'meraki.Organization' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
