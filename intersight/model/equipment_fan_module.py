...
class EquipmentFanModule(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentFanModule - a model defined in OpenAPI
        ...
        class_id = "equipment.FanModule" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "equipment.FanModule")
        object_type = "equipment.FanModule" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "equipment.FanModule")
