...
def lazy_import():
    from intersight.model.mgmt_config_operation_setting_list import MgmtConfigOperationSettingList
    ...
    globals()['MgmtConfigOperationSettingList'] = MgmtConfigOperationSettingList
...
class MgmtConfigOperationSettingResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'mgmt.ConfigOperationSetting.List': MgmtConfigOperationSettingList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """MgmtConfigOperationSettingResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'mgmt.ConfigOperationSetting' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
