...
def lazy_import():
    from intersight.model.catalystsdwan_interface_list import CatalystsdwanInterfaceList
    ...
    globals()['CatalystsdwanInterfaceList'] = CatalystsdwanInterfaceList
...
class CatalystsdwanInterfaceResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'catalystsdwan.Interface.List': CatalystsdwanInterfaceList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CatalystsdwanInterfaceResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'catalystsdwan.Interface' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
