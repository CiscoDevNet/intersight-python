...
def lazy_import():
    ...
    globals()['HyperflexConfigResultEntryAllOf'] = HyperflexConfigResultEntryAllOf
...
class HyperflexConfigResultEntry(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """HyperflexConfigResultEntry - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "hyperflex.ConfigResultEntry", must be one of ["hyperflex.ConfigResultEntry", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "hyperflex.ConfigResultEntry", must be one of ["hyperflex.ConfigResultEntry", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "hyperflex.ConfigResultEntry")
        object_type = kwargs.get('object_type', "hyperflex.ConfigResultEntry")
