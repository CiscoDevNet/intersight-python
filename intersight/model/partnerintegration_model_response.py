...
def lazy_import():
    ...
    from intersight.model.partnerintegration_model_list import PartnerintegrationModelList
    ...
    globals()['PartnerintegrationModelList'] = PartnerintegrationModelList


class PartnerintegrationModelResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'partnerintegration.Model.List': PartnerintegrationModelList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """PartnerintegrationModelResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'partnerintegration.Model' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
