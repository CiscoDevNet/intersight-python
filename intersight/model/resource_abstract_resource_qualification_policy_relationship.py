...
class ResourceAbstractResourceQualificationPolicyRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResourceAbstractResourceQualificationPolicyRelationship - a model defined in OpenAPI
