...
def lazy_import():
    ...
    from intersight.model.telemetry_druid_like_filter_all_of import TelemetryDruidLikeFilterAllOf
    ...
    globals()['TelemetryDruidLikeFilterAllOf'] = TelemetryDruidLikeFilterAllOf


class TelemetryDruidLikeFilter(ModelComposed):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dimension, pattern, *args, **kwargs):  # noqa: E501
        """TelemetryDruidLikeFilter - a model defined in OpenAPI

        Keyword Args:
            type (str): defaults to "like", must be one of ["like", ]  # noqa: E501
            dimension (str): Input column or virtual column name to filter.
            pattern (str): String LIKE pattern, such as \"foo%\" or \"___bar\".
        ...
        type = "like" if len(kwargs.get('type','').strip()) == 0 else kwargs.get('type', "like")
    ...
    @convert_js_args_to_python_args
    def __init__(self, dimension, pattern, *args, **kwargs):  # noqa: E501
        """TelemetryDruidLikeFilter - a model defined in OpenAPI
