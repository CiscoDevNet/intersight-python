...
class StorageEnclosureDiskAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "storage.EnclosureDisk" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "storage.EnclosureDisk")
        object_type = "storage.EnclosureDisk" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "storage.EnclosureDisk")
