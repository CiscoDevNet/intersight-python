...
def lazy_import():
    ...
    globals()['CloudSkuDatabaseTypeAllOf'] = CloudSkuDatabaseTypeAllOf
...
class CloudSkuDatabaseType(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'database_edition': (str,),  # noqa: E501
            'database_engine': (str,),  # noqa: E501
            'license_model': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'database_edition': 'DatabaseEdition',  # noqa: E501
        'database_engine': 'DatabaseEngine',  # noqa: E501
        'license_model': 'LicenseModel',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """CloudSkuDatabaseType - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "cloud.SkuDatabaseType", must be one of ["cloud.SkuDatabaseType", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "cloud.SkuDatabaseType", must be one of ["cloud.SkuDatabaseType", ]  # noqa: E501
            ...
            database_edition (str): The database edition. For e.g. standard or enterprise.. [optional]  # noqa: E501
            database_engine (str): The database engine. For e.g. SQL Server, Oracle, PostgreSQL.. [optional]  # noqa: E501
            license_model (str): The licensing option for the database. For e.g. license required or not.. [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "cloud.SkuDatabaseType")
        object_type = kwargs.get('object_type', "cloud.SkuDatabaseType")
