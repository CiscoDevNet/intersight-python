...
def lazy_import():
    ...
    from intersight.model.onprem_appliance_system_info_list import OnpremApplianceSystemInfoList
    ...
    globals()['OnpremApplianceSystemInfoList'] = OnpremApplianceSystemInfoList


class OnpremApplianceSystemInfoResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'onprem.ApplianceSystemInfo.List': OnpremApplianceSystemInfoList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """OnpremApplianceSystemInfoResponse - a model defined in OpenAPI
