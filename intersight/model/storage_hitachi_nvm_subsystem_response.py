...
def lazy_import():
    ...
    from intersight.model.storage_hitachi_nvm_subsystem_list import StorageHitachiNvmSubsystemList
    ...
    globals()['StorageHitachiNvmSubsystemList'] = StorageHitachiNvmSubsystemList


class StorageHitachiNvmSubsystemResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'storage.HitachiNvmSubsystem.List': StorageHitachiNvmSubsystemList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """StorageHitachiNvmSubsystemResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'storage.HitachiNvmSubsystem' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
