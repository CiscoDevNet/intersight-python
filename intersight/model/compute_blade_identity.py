...
def lazy_import():
    ...
    globals()['ComputeBladeIdentityAllOf'] = ComputeBladeIdentityAllOf
    globals()['ComputeBladeIdentityRelationship'] = ComputeBladeIdentityRelationship
...
class ComputeBladeIdentity(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'discovered_blade_id_in_curr_location': ([ComputeBladeIdentityRelationship], none_type,),  # noqa: E501
            'managed_nodes': ([ComputeBladeIdentityRelationship], none_type,),  # noqa: E501
            'new_blade_id_in_discovered_location': ([ComputeBladeIdentityRelationship], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'discovered_blade_id_in_curr_location': 'DiscoveredBladeIdInCurrLocation',  # noqa: E501
        'managed_nodes': 'ManagedNodes',  # noqa: E501
        'new_blade_id_in_discovered_location': 'NewBladeIdInDiscoveredLocation',  # noqa: E501
        ...
        'reset_to_default': 'ResetToDefault',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'presence',  # noqa: E501
        'slot_id',  # noqa: E501
        'discovered_blade_id_in_curr_location',  # noqa: E501
        'managed_nodes',  # noqa: E501
        'new_blade_id_in_discovered_location',  # noqa: E501
        ...
        'reset_to_default',  # noqa: E501
    }

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ComputeBladeIdentity - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "compute.BladeIdentity", must be one of ["compute.BladeIdentity", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "compute.BladeIdentity", must be one of ["compute.BladeIdentity", ]  # noqa: E501
            ...
            discovered_blade_id_in_curr_location ([ComputeBladeIdentityRelationship], none_type): An array of relationships to computeBladeIdentity resources.. [optional]  # noqa: E501
            managed_nodes ([ComputeBladeIdentityRelationship], none_type): An array of relationships to computeBladeIdentity resources.. [optional]  # noqa: E501
            new_blade_id_in_discovered_location ([ComputeBladeIdentityRelationship], none_type): An array of relationships to computeBladeIdentity resources.. [optional]  # noqa: E501
            ...
            reset_to_default (bool): Specifies whether device configurations need to be reset to default upon first-time discovery or recommission of a server.. [optional]  # noqa: E501
            physical_device_registration (AssetDeviceRegistrationRelationship): [optional]  # noqa: E501
        """

        class_id = "compute.BladeIdentity" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "compute.BladeIdentity")
        object_type = "compute.BladeIdentity" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "compute.BladeIdentity")
