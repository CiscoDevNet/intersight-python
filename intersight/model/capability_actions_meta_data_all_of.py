...
class CapabilityActionsMetaDataAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'max_fw_version': (str,),  # noqa: E501
            'min_fw_version': (str,),  # noqa: E501
            'model': (str,),  # noqa: E501
            'sel_log_path': (str,),  # noqa: E501
            'sel_script_file_path': (str,),  # noqa: E501
            'supported_actions': ([str], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'max_fw_version': 'MaxFwVersion',  # noqa: E501
        'min_fw_version': 'MinFwVersion',  # noqa: E501
        'model': 'Model',  # noqa: E501
        'sel_log_path': 'SelLogPath',  # noqa: E501
        'sel_script_file_path': 'SelScriptFilePath',  # noqa: E501
        'supported_actions': 'SupportedActions',  # noqa: E501
        'target_type': 'TargetType',  # noqa: E501
        'vendor': 'Vendor',  # noqa: E501
    }

    read_only_vars = {
        'sel_log_path',  # noqa: E501
        'sel_script_file_path',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CapabilityActionsMetaDataAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "capability.ActionsMetaData", must be one of ["capability.ActionsMetaData", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "capability.ActionsMetaData", must be one of ["capability.ActionsMetaData", ]  # noqa: E501
            ...
            max_fw_version (str): Maximum firmware version of the server.. [optional]  # noqa: E501
            min_fw_version (str): Minimum firmware version of the server.. [optional]  # noqa: E501
            model (str): Model of the server that supports power or storage operations.. [optional]  # noqa: E501
            sel_log_path (str): Location of Sel log script.. [optional]  # noqa: E501
            sel_script_file_path (str): Location of Sel file script.. [optional]  # noqa: E501
            supported_actions ([str], none_type): [optional]  # noqa: E501
        ...
        class_id = "capability.ActionsMetaData" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "capability.ActionsMetaData")
        object_type = "capability.ActionsMetaData" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "capability.ActionsMetaData")
