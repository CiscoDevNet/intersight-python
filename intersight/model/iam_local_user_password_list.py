...
def lazy_import():
    ...
    from intersight.model.iam_local_user_password_list_all_of import IamLocalUserPasswordListAllOf
    from intersight.model.mo_base_response import MoBaseResponse
    globals()['IamLocalUserPassword'] = IamLocalUserPassword
    globals()['IamLocalUserPasswordListAllOf'] = IamLocalUserPasswordListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class IamLocalUserPasswordList(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """IamLocalUserPasswordList - a model defined in OpenAPI
