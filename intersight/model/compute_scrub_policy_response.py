...
def lazy_import():
    from intersight.model.compute_scrub_policy_list import ComputeScrubPolicyList
    ...
    globals()['ComputeScrubPolicyList'] = ComputeScrubPolicyList
...
class ComputeScrubPolicyResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'compute.ScrubPolicy.List': ComputeScrubPolicyList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ComputeScrubPolicyResponse - a model defined in OpenAPI
