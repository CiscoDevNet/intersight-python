...
def lazy_import():
    ...
    globals()['KubernetesCatalogRelationship'] = KubernetesCatalogRelationship
...
class KubernetesAddonDefinitionRelationship(ModelComposed):
    ...
    allowed_values = {
        ...
        ('default_upgrade_strategy',): {
            ...
            'REINSTALLONFAILURE': "ReinstallOnFailure",
            'ALWAYSREINSTALL': "AlwaysReinstall",
        },
        ('labels',): {
            'None': None,
            'ESSENTIAL': "Essential",
    ...
    def openapi_types():
        ...
        return {
            ...
            'chart_url': (str,),  # noqa: E501
            'default_install_strategy': (str,),  # noqa: E501
            'default_namespace': (str,),  # noqa: E501
            'default_upgrade_strategy': (str,),  # noqa: E501
            'description': (str,),  # noqa: E501
            'digest': (str,),  # noqa: E501
            'icon_url': (str,),  # noqa: E501
            'labels': ([str], none_type,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'overrides': (str,),  # noqa: E501
            'platforms': ([str], none_type,),  # noqa: E501
            'version': (str,),  # noqa: E501
            'catalog': (KubernetesCatalogRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'display_names': 'DisplayNames',  # noqa: E501
        'chart_url': 'ChartUrl',  # noqa: E501
        'default_install_strategy': 'DefaultInstallStrategy',  # noqa: E501
        'default_namespace': 'DefaultNamespace',  # noqa: E501
        'default_upgrade_strategy': 'DefaultUpgradeStrategy',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """KubernetesAddonDefinitionRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            chart_url (str): Description of the addon component.. [optional]  # noqa: E501
            default_install_strategy (str): Default installation strategy for the release. * `None` - Unspecified install strategy. * `NoAction` - No install action performed. * `InstallOnly` - Only install in green field. No action in case of failure or removal. * `Always` - Attempt install if chart is not already installed.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            default_namespace (str): Default namespace to install the release.. [optional]  # noqa: E501
            default_upgrade_strategy (str): Default upgrade strategy for the release. * `None` - Unspecified upgrade strategy. * `NoAction` - This choice enables No upgrades to be performed. * `UpgradeOnly` - Attempt upgrade if chart or overrides options change, no action on upgrade failure. * `ReinstallOnFailure` - Attempt upgrade first. Remove and install on upgrade failure. * `AlwaysReinstall` - Always remove older release and reinstall.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            description (str): Description of the addon component.. [optional]  # noqa: E501
            digest (str): Digest used to verify the integrity of an addon.. [optional]  # noqa: E501
            icon_url (str): Icon used to represent the addon in UI.. [optional]  # noqa: E501
            labels ([str], none_type): [optional]  # noqa: E501
            name (str): Name of an addon component.. [optional]  # noqa: E501
            overrides (str): Properties that can be overridden for an addon.. [optional]  # noqa: E501
            platforms ([str], none_type): [optional]  # noqa: E501
            version (str): Version of the addon component.. [optional]  # noqa: E501
            catalog (KubernetesCatalogRelationship): [optional]  # noqa: E501
