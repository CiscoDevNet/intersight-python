...
class StorageStorageContainerHostMountStatusAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StorageStorageContainerHostMountStatusAllOf - a model defined in OpenAPI
        ...
        class_id = "storage.StorageContainerHostMountStatus" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "storage.StorageContainerHostMountStatus")
        object_type = "storage.StorageContainerHostMountStatus" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "storage.StorageContainerHostMountStatus")
