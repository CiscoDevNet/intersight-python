...
def lazy_import():
    from intersight.model.iam_account_type_base_all_of import IamAccountTypeBaseAllOf
    from intersight.model.iam_account_type_ipmi import IamAccountTypeIpmi
    from intersight.model.iam_account_type_local import IamAccountTypeLocal
    from intersight.model.mo_base_complex_type import MoBaseComplexType
    globals()['IamAccountTypeBaseAllOf'] = IamAccountTypeBaseAllOf
    globals()['IamAccountTypeIpmi'] = IamAccountTypeIpmi
    globals()['IamAccountTypeLocal'] = IamAccountTypeLocal
    globals()['MoBaseComplexType'] = MoBaseComplexType


class IamAccountTypeBase(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'iam.AccountTypeIpmi': IamAccountTypeIpmi,
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """IamAccountTypeBase - a model defined in OpenAPI
