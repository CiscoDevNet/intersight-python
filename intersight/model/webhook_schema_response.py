...
def lazy_import():
    ...
    from intersight.model.webhook_schema_list import WebhookSchemaList
    ...
    globals()['WebhookSchemaList'] = WebhookSchemaList


class WebhookSchemaResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'webhook.Schema.List': WebhookSchemaList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """WebhookSchemaResponse - a model defined in OpenAPI
