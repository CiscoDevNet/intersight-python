...
def lazy_import():
    ...
    globals()['TelemetryDruidTimeSeriesRequestAllOf'] = TelemetryDruidTimeSeriesRequestAllOf


class TelemetryDruidTimeSeriesRequest(ModelComposed):
    ...
    def __init__(self, query_type, data_source, intervals, granularity, *args, **kwargs):  # noqa: E501
        """TelemetryDruidTimeSeriesRequest - a model defined in OpenAPI
