...
class HyperflexNodeProfile(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            node_role (str): The role that this node performs in the HyperFlex cluster. * `Storage` - Cluster of storage nodes used to persist data. * `Compute` - Cluster of compute nodes used to execute business logic. * `Unknown` - This cluster type is Unknown. Expect Compute or Storage as valid values.. [optional] if omitted the server will use the default value of "Storage"  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "hyperflex.NodeProfile")
        object_type = kwargs.get('object_type', "hyperflex.NodeProfile")
