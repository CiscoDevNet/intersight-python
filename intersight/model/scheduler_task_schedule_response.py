...
def lazy_import():
    ...
    from intersight.model.scheduler_task_schedule_list import SchedulerTaskScheduleList
    ...
    globals()['SchedulerTaskScheduleList'] = SchedulerTaskScheduleList


class SchedulerTaskScheduleResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'scheduler.TaskSchedule.List': SchedulerTaskScheduleList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """SchedulerTaskScheduleResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'scheduler.TaskSchedule' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
