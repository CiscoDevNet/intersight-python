...
def lazy_import():
    ...
    globals()['KubernetesBaseVirtualMachineInfraConfigAllOf'] = KubernetesBaseVirtualMachineInfraConfigAllOf
    globals()['KubernetesEsxiVirtualMachineInfraConfig'] = KubernetesEsxiVirtualMachineInfraConfig
    globals()['KubernetesHyperFlexApVirtualMachineInfraConfig'] = KubernetesHyperFlexApVirtualMachineInfraConfig
    globals()['MoBaseComplexType'] = MoBaseComplexType


class KubernetesBaseVirtualMachineInfraConfig(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """KubernetesBaseVirtualMachineInfraConfig - a model defined in OpenAPI
