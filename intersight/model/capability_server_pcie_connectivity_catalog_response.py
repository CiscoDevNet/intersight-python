...
def lazy_import():
    from intersight.model.capability_server_pcie_connectivity_catalog_list import CapabilityServerPcieConnectivityCatalogList
    ...
    globals()['CapabilityServerPcieConnectivityCatalogList'] = CapabilityServerPcieConnectivityCatalogList
...
class CapabilityServerPcieConnectivityCatalogResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'capability.ServerPcieConnectivityCatalog.List': CapabilityServerPcieConnectivityCatalogList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CapabilityServerPcieConnectivityCatalogResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'capability.ServerPcieConnectivityCatalog' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
