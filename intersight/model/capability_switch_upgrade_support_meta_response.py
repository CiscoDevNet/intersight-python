...
def lazy_import():
    from intersight.model.capability_switch_upgrade_support_meta_list import CapabilitySwitchUpgradeSupportMetaList
    ...
    globals()['CapabilitySwitchUpgradeSupportMetaList'] = CapabilitySwitchUpgradeSupportMetaList
...
class CapabilitySwitchUpgradeSupportMetaResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'capability.SwitchUpgradeSupportMeta.List': CapabilitySwitchUpgradeSupportMetaList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CapabilitySwitchUpgradeSupportMetaResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'capability.SwitchUpgradeSupportMeta' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
