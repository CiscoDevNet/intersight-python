...
def lazy_import():
    from intersight.model.dnac_device_list import DnacDeviceList
    ...
    globals()['DnacDeviceList'] = DnacDeviceList
...
class DnacDeviceResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'dnac.Device.List': DnacDeviceList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """DnacDeviceResponse - a model defined in OpenAPI
