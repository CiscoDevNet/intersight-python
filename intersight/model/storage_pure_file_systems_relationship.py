...
class StoragePureFileSystemsRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'destroyed': (bool,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'pod': (str,),  # noqa: E501
            'array': (StoragePureArrayRelationship,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StoragePureFileSystemsRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            created_time (int): The file system creation time, measured in milliseconds since the UNIX epoch.. [optional]  # noqa: E501
            destroyed (bool): A boolean value, if set to true, lists only destroyed objects that are in the eradication pending state. If set to false, lists only objects that are not destroyed.. [optional]  # noqa: E501
            name (str): A globally unique, system-generated ID. The ID cannot be modified and cannot refer to another resource.. [optional]  # noqa: E501
            pod (str): The reference to the pod the file systems belongs to, or null if it is not in a pod.. [optional]  # noqa: E501
