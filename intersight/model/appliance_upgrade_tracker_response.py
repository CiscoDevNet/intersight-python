...
def lazy_import():
    from intersight.model.appliance_upgrade_tracker_list import ApplianceUpgradeTrackerList
    ...
    globals()['ApplianceUpgradeTrackerList'] = ApplianceUpgradeTrackerList
...
class ApplianceUpgradeTrackerResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'appliance.UpgradeTracker.List': ApplianceUpgradeTrackerList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ApplianceUpgradeTrackerResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'appliance.UpgradeTracker' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
