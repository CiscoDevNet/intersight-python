...
def lazy_import():
    from intersight.model.apic_fabric_leaf_node_list import ApicFabricLeafNodeList
    ...
    globals()['ApicFabricLeafNodeList'] = ApicFabricLeafNodeList
...
class ApicFabricLeafNodeResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'apic.FabricLeafNode.List': ApicFabricLeafNodeList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ApicFabricLeafNodeResponse - a model defined in OpenAPI
