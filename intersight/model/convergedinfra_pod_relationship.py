...
def lazy_import():
    ...
    globals()['ResourceGroupRelationship'] = ResourceGroupRelationship
    globals()['WorkflowServiceItemInstanceRelationship'] = WorkflowServiceItemInstanceRelationship


class ConvergedinfraPodRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'interop_status': (str,),  # noqa: E501
            'summary': (ConvergedinfraPodSummary,),  # noqa: E501
            ...
            'pod_resource_group': (ResourceGroupRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'interop_status': 'InteropStatus',  # noqa: E501
        'summary': 'Summary',  # noqa: E501
        'organization': 'Organization',  # noqa: E501
        'pod_compliance': 'PodCompliance',  # noqa: E501
        'pod_resource_group': 'PodResourceGroup',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'interop_status',  # noqa: E501
    }

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConvergedinfraPodRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): Description of the pod. A short note about the nature or purpose of the pod.. [optional]  # noqa: E501
            name (str): Name of the pod. Concrete pod will be created with this name.. [optional]  # noqa: E501
            type (str): Defines the type of the pod. * `FlexPod` - Pod type is FlexPod, an integrated infrastructure solution developed by Cisco and NetApp. * `FlashStack` - Pod type is FlashStack, an integrated infrastructure solution developed by Cisco and Pure Storage.. [optional] if omitted the server will use the default value of "FlexPod"  # noqa: E501
            deployment_type (str): The deployment type for this integrated system. * `FlexPodInfra` - The deployment type for a pod is of Infrastructure. * `FlexPodNG` - The deployment type for a pod is of Nextgen type.. [optional] if omitted the server will use the default value of "FlexPodInfra"  # noqa: E501
            interop_status (str): The interoperability status for this solution pod. * `NotEvaluated` - The interoperability compliance for the component has not be checked. * `Approved` - The component is valid as per the interoperability compliance check. * `NotApproved` - The component is not valid as per the interoperability compliance check. * `Incomplete` - The interoperability compliance check could not be completed for the component due to incomplete data.. [optional] if omitted the server will use the default value of "NotEvaluated"  # noqa: E501
            summary (ConvergedinfraPodSummary): [optional]  # noqa: E501
            ...
            pod_resource_group (ResourceGroupRelationship): [optional]  # noqa: E501
