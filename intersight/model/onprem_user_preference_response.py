...
def lazy_import():
    ...
    from intersight.model.onprem_user_preference_list import OnpremUserPreferenceList
    ...
    globals()['OnpremUserPreferenceList'] = OnpremUserPreferenceList


class OnpremUserPreferenceResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'onprem.UserPreference.List': OnpremUserPreferenceList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """OnpremUserPreferenceResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'onprem.UserPreference' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
