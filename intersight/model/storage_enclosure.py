...
def lazy_import():
    ...
    globals()['StorageEnclosureAllOf'] = StorageEnclosureAllOf
...
class StorageEnclosure(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """StorageEnclosure - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "storage.Enclosure", must be one of ["storage.Enclosure", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "storage.Enclosure", must be one of ["storage.Enclosure", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "storage.Enclosure")
        object_type = kwargs.get('object_type', "storage.Enclosure")
