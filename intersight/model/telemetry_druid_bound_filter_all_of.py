...
class TelemetryDruidBoundFilterAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dimension, *args, **kwargs):  # noqa: E501
        """TelemetryDruidBoundFilterAllOf - a model defined in OpenAPI

        Args:
            dimension (str): Input column or virtual column name to filter.

        Keyword Args:
            type (str): defaults to "bound", must be one of ["bound", ]  # noqa: E501
            ...
            lower (str): The lower bound string match value for the filter.. [optional]  # noqa: E501
            upper (str): The upper bound string match value for the filter.. [optional]  # noqa: E501
        ...
        type = "bound" if len(kwargs.get('type','').strip()) == 0 else kwargs.get('type', "bound")
    ...
    @convert_js_args_to_python_args
    def __init__(self, dimension, *args, **kwargs):  # noqa: E501
        """TelemetryDruidBoundFilterAllOf - a model defined in OpenAPI
