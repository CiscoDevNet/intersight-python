...
def lazy_import():
    ...
    globals()['RecoveryBackupProfileRelationship'] = RecoveryBackupProfileRelationship


class RecoveryBackupConfigPolicyRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'file_name_prefix': (str,),  # noqa: E501
            ...
            'backup_profiles': ([RecoveryBackupProfileRelationship], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'name': 'Name',  # noqa: E501
        'file_name_prefix': 'FileNamePrefix',  # noqa: E501
        ...
        'backup_profiles': 'BackupProfiles',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RecoveryBackupConfigPolicyRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            file_name_prefix (str): Backup image file name prefix with timestamp (e.g., prefix-1572431305418).. [optional]  # noqa: E501
            ...
            location_type (str): Backup storage location (local or remote). * `Network Share` - Backup is stored remotely on a separate server. * `Local Storage` - Backup is stored locally on endpoint.. [optional] if omitted the server will use the default value of "Network Share"  # noqa: E501
            password (str): The backup server password.. [optional]  # noqa: E501
            path (str): File system path for storing backup images, including IP address/hostname (e.g., 172.29.109.234/var/backups/).. [optional]  # noqa: E501
            protocol (str): Protocol for backup transfer to network share. * `SCP` - Secure Copy Protocol (SCP) to access file server. * `SFTP` - SSH File Transfer Protocol (SFTP) to access file server. * `FTP` - File Transfer Protocol (FTP) to access file server.. [optional] if omitted the server will use the default value of "SCP"  # noqa: E501
            retention_count (int): Number of backup copies maintained on local or remote server (older backups overwritten).. [optional] if omitted the server will use the default value of 10  # noqa: E501
            user_name (str): The backup server username.. [optional]  # noqa: E501
            backup_profiles ([RecoveryBackupProfileRelationship], none_type): An array of relationships to recoveryBackupProfile resources.. [optional]  # noqa: E501
