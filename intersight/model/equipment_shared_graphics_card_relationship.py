...
class EquipmentSharedGraphicsCardRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentSharedGraphicsCardRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): The description of the GPU card.. [optional]  # noqa: E501
            device_id (int): The unique device identifier assigned by the vendor to a specific model of GPU.. [optional]  # noqa: E501
            firmware_version (str): The version of the GPU firmware.. [optional]  # noqa: E501
            gpu_id (str): The identifier of the graphics card.. [optional]  # noqa: E501
            oper_reason ([str], none_type): [optional]  # noqa: E501
            oper_state (str): Operational state of graphics card.. [optional]  # noqa: E501
            part_number (str): Part number identifier for the graphics card.. [optional]  # noqa: E501
            pci_slot (str): PCIe slot of the GPU in the PCIe node.. [optional]  # noqa: E501
            pid (str): The unique product ID associated with the GPU card.. [optional]  # noqa: E501
            sub_device_id (int): The subsystem device identifier assigned by the subsystem vendor to a specific model of GPU.. [optional]  # noqa: E501
            sub_vendor_id (int): The unique vendor identifier assigned to the organization which integrates the GPU.. [optional]  # noqa: E501
            vendor_id (int): The unique vendor identifier assigned to the manufacturer of the GPU.. [optional]  # noqa: E501
