...
class OpenapiTaskGenerationRequestRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'endpoint_type': (str,),  # noqa: E501
            'failed_tasks': ([OpenapiFailedTask], none_type,),  # noqa: E501
            'header_parameters': ([OpenapiKeyValuePair], none_type,),  # noqa: E501
            'is_validate_request': (bool,),  # noqa: E501
            'protocol': (str,),  # noqa: E501
            'query_parameters': ([OpenapiKeyValuePair], none_type,),  # noqa: E501
            'selected_apis': ([OpenapiApiInfo], none_type,),  # noqa: E501
            'status': (str,),  # noqa: E501
            'task_prefix': (str,),  # noqa: E501
            'task_tags': ([OpenapiKeyValuePair], none_type,),  # noqa: E501
            'url': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'failed_tasks': 'FailedTasks',  # noqa: E501
        'header_parameters': 'HeaderParameters',  # noqa: E501
        'is_validate_request': 'IsValidateRequest',  # noqa: E501
        'protocol': 'Protocol',  # noqa: E501
        'query_parameters': 'QueryParameters',  # noqa: E501
        'selected_apis': 'SelectedApis',  # noqa: E501
        'status': 'Status',  # noqa: E501
        'task_prefix': 'TaskPrefix',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OpenapiTaskGenerationRequestRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            endpoint_type (str): Indicates if target endpoint is external or internal. An endpoint is internal if the target is an Intersight resource. For instance, configuring an intersight object using a Task. * `External` - Denotes that the target endpoint is an external API endpoint. * `Internal` - Denotes that the target endpoint is a Intersight API endpoint.. [optional] if omitted the server will use the default value of "External"  # noqa: E501
            failed_tasks ([OpenapiFailedTask], none_type): [optional]  # noqa: E501
            header_parameters ([OpenapiKeyValuePair], none_type): [optional]  # noqa: E501
            is_validate_request (bool): When this value is set to true, the task name validations happen and provides the task validation status against each of the selected API on the property selectedApis When this value is set to false, an internal workflow to generate the tasks is submitted,  conflicting task names are created with an incremented version.. [optional]  # noqa: E501
            protocol (str): Specifies the REST API protocol being used, which can be one of HTTP or HTTPS. * `HTTPS` - Denotes that the API call uses the HTTPS protocol type * `HTTP` - Denotes that the API call uses the HTTP protocol type. [optional] if omitted the server will use the default value of "HTTPS"  # noqa: E501
            query_parameters ([OpenapiKeyValuePair], none_type): [optional]  # noqa: E501
            selected_apis ([OpenapiApiInfo], none_type): [optional]  # noqa: E501
            status (str): Depicts the status of the task creation request. * `none` - Indicates the default status. * `InProgress` - Request has been picked up for generating tasks from the OpenAPI Specification file. * `Completed` - All the tasks from the request have been created. * `Failed` - There were failures in generating one or more tasks in the request.. [optional] if omitted the server will use the default value of "none"  # noqa: E501
            task_prefix (str): Optional string that can be prefixed to the name of created tasks.. [optional]  # noqa: E501
            task_tags ([OpenapiKeyValuePair], none_type): [optional]  # noqa: E501
            url (str): Specifies the URL of the endpoint that the created task communicates with. It is defaulted to intersight.com for internal endpoints.. [optional]  # noqa: E501
