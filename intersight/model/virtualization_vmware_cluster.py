...
def lazy_import():
    ...
    globals()['VirtualizationVmwareClusterAllOf'] = VirtualizationVmwareClusterAllOf
    globals()['VirtualizationVmwareDatacenterRelationship'] = VirtualizationVmwareDatacenterRelationship


class VirtualizationVmwareCluster(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'cpu_over_commitment': (int,),  # noqa: E501
            'datastore_count': (int,),  # noqa: E501
            'inventory_path': (str,),  # noqa: E501
            'proactive_ha_enabled': (bool,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'cpu_over_commitment': 'CpuOverCommitment',  # noqa: E501
        'datastore_count': 'DatastoreCount',  # noqa: E501
        'inventory_path': 'InventoryPath',  # noqa: E501
        'proactive_ha_enabled': 'ProactiveHaEnabled',  # noqa: E501
    ...
    read_only_vars = {
        'proactive_ha_enabled',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VirtualizationVmwareCluster - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "virtualization.VmwareCluster", must be one of ["virtualization.VmwareCluster", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "virtualization.VmwareCluster", must be one of ["virtualization.VmwareCluster", ]  # noqa: E501
            ...
            cpu_over_commitment (int): CPU over commitment associated with this cluster.. [optional]  # noqa: E501
            datastore_count (int): Count of all datastores associated with this cluster.. [optional]  # noqa: E501
            inventory_path (str): Inventory path of the cluster.. [optional]  # noqa: E501
            proactive_ha_enabled (bool): Every cluster has an option to enable proactive HA in vCenter. Set to true when the vCenter admin has enabled proactive HA for the cluster.. [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "virtualization.VmwareCluster")
        object_type = kwargs.get('object_type', "virtualization.VmwareCluster")
