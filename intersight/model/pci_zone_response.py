...
def lazy_import():
    ...
    from intersight.model.pci_zone_list import PciZoneList
    ...
    globals()['PciZoneList'] = PciZoneList


class PciZoneResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """PciZoneResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'pci.Zone' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
