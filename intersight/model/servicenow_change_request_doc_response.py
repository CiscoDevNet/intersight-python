...
def lazy_import():
    ...
    from intersight.model.servicenow_change_request_doc_list import ServicenowChangeRequestDocList
    ...
    globals()['ServicenowChangeRequestDocList'] = ServicenowChangeRequestDocList


class ServicenowChangeRequestDocResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'servicenow.ChangeRequestDoc.List': ServicenowChangeRequestDocList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ServicenowChangeRequestDocResponse - a model defined in OpenAPI
