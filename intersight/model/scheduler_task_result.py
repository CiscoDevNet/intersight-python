...
def lazy_import():
    ...
    from intersight.model.scheduler_task_result_all_of import SchedulerTaskResultAllOf
    ...
    globals()['SchedulerTaskResultAllOf'] = SchedulerTaskResultAllOf
...
class SchedulerTaskResult(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'status_detail': (SchedulerTaskResultStatus,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SchedulerTaskResult - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "scheduler.TaskResult", must be one of ["scheduler.TaskResult", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "scheduler.TaskResult", must be one of ["scheduler.TaskResult", ]  # noqa: E501
        ...
        class_id = "scheduler.TaskResult" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "scheduler.TaskResult")
        object_type = "scheduler.TaskResult" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "scheduler.TaskResult")
