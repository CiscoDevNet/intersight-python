...
def lazy_import():
    ...
    from intersight.model.motemplate_sync_error_all_of import MotemplateSyncErrorAllOf
    globals()['MoBaseComplexType'] = MoBaseComplexType
    globals()['MotemplateSyncErrorAllOf'] = MotemplateSyncErrorAllOf


class MotemplateSyncError(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MotemplateSyncError - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "motemplate.SyncError", must be one of ["motemplate.SyncError", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "motemplate.SyncError", must be one of ["motemplate.SyncError", ]  # noqa: E501
