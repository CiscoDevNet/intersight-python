...
def lazy_import():
    ...
    from intersight.model.workflow_solution_action_definition_all_of import WorkflowSolutionActionDefinitionAllOf
    ...
    globals()['WorkflowSolutionActionDefinitionAllOf'] = WorkflowSolutionActionDefinitionAllOf
...
class WorkflowSolutionActionDefinition(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """WorkflowSolutionActionDefinition - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "workflow.SolutionActionDefinition", must be one of ["workflow.SolutionActionDefinition", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "workflow.SolutionActionDefinition", must be one of ["workflow.SolutionActionDefinition", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "workflow.SolutionActionDefinition")
        object_type = kwargs.get('object_type', "workflow.SolutionActionDefinition")
