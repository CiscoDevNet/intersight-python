...
class StorageStoragePolicyAllOf(ModelNormal):
    ...
    validations = {
        ...
        ('secure_jbods',): {
            'regex': {
                'pattern': r'^$|^((((\d+\-\d+)|(\d+))(,((\d+\-\d+)|(\d+)))*)|(a|A)(l|L)(l|L))$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'controller_attached_nvme_slots': (str,),  # noqa: E501
            'default_drive_mode': (str,),  # noqa: E501
            'direct_attached_nvme_slots': (str,),  # noqa: E501
            ...
            'raid_attached_nvme_slots': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'controller_attached_nvme_slots': 'ControllerAttachedNvmeSlots',  # noqa: E501
        'default_drive_mode': 'DefaultDriveMode',  # noqa: E501
        'direct_attached_nvme_slots': 'DirectAttachedNvmeSlots',  # noqa: E501
        'global_hot_spares': 'GlobalHotSpares',  # noqa: E501
        'm2_virtual_drive': 'M2VirtualDrive',  # noqa: E501
        'raid0_drive': 'Raid0Drive',  # noqa: E501
        'raid_attached_nvme_slots': 'RaidAttachedNvmeSlots',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            raid_attached_nvme_slots (str): Only U.3 NVMe drives need to be specified, entered slots will be moved to RAID attached mode. Allowed slots are 1-4, 101-104. Allowed value is a comma or hyphen separated number ranges. Deprecated in favor of controllerAttachedNvmeSlots.. [optional]  # noqa: E501
            secure_jbods (str): JBOD drives specified in this slot range will be encrypted. Allowed values are 'ALL', or a comma or hyphen separated number range. Sample format is ALL or 1, 3 or 4-6, 8. Setting the value to 'ALL' will encrypt all the unused UnconfigureGood/JBOD disks.. [optional]  # noqa: E501
        ...
        class_id = "storage.StoragePolicy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "storage.StoragePolicy")
        object_type = "storage.StoragePolicy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "storage.StoragePolicy")
