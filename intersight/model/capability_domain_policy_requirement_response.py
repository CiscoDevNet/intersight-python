...
def lazy_import():
    from intersight.model.capability_domain_policy_requirement_list import CapabilityDomainPolicyRequirementList
    ...
    globals()['CapabilityDomainPolicyRequirementList'] = CapabilityDomainPolicyRequirementList
...
class CapabilityDomainPolicyRequirementResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'capability.DomainPolicyRequirement.List': CapabilityDomainPolicyRequirementList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CapabilityDomainPolicyRequirementResponse - a model defined in OpenAPI
