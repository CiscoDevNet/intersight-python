...
class IpmioverlanPolicyAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'is_encryption_key_set': (bool,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'is_encryption_key_set': 'IsEncryptionKeySet',  # noqa: E501
    ...
    read_only_vars = {
        'is_encryption_key_set',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IpmioverlanPolicyAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "ipmioverlan.Policy", must be one of ["ipmioverlan.Policy", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "ipmioverlan.Policy", must be one of ["ipmioverlan.Policy", ]  # noqa: E501
        ...
        class_id = "ipmioverlan.Policy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "ipmioverlan.Policy")
        object_type = "ipmioverlan.Policy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "ipmioverlan.Policy")
