...
def lazy_import():
    ...
    globals()['RecoveryBackupConfigPolicyAllOf'] = RecoveryBackupConfigPolicyAllOf
    globals()['RecoveryBackupProfileRelationship'] = RecoveryBackupProfileRelationship


class RecoveryBackupConfigPolicy(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """RecoveryBackupConfigPolicy - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "recovery.BackupConfigPolicy", must be one of ["recovery.BackupConfigPolicy", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "recovery.BackupConfigPolicy", must be one of ["recovery.BackupConfigPolicy", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "recovery.BackupConfigPolicy")
        object_type = kwargs.get('object_type', "recovery.BackupConfigPolicy")
