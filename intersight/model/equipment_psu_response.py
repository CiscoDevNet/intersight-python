...
class EquipmentPsuResponse(ModelComposed):
    ...
    def __init__(self, object_type, *args, **kwargs):  # noqa: E501
        """EquipmentPsuResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'equipment.Psu' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
