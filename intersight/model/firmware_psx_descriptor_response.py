...
def lazy_import():
    from intersight.model.firmware_psx_descriptor_list import FirmwarePsxDescriptorList
    ...
    globals()['FirmwarePsxDescriptorList'] = FirmwarePsxDescriptorList
...
class FirmwarePsxDescriptorResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'firmware.PsxDescriptor.List': FirmwarePsxDescriptorList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FirmwarePsxDescriptorResponse - a model defined in OpenAPI
