...
class HyperflexClusterReplicationNetworkPolicyDeploymentResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """HyperflexClusterReplicationNetworkPolicyDeploymentResponse - a model defined in OpenAPI
