...
def lazy_import():
    ...
    globals()['TamSecurityAdvisoryDetailsAllOf'] = TamSecurityAdvisoryDetailsAllOf


class TamSecurityAdvisoryDetails(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TamSecurityAdvisoryDetails - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "tam.SecurityAdvisoryDetails", must be one of ["tam.SecurityAdvisoryDetails", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "tam.SecurityAdvisoryDetails", must be one of ["tam.SecurityAdvisoryDetails", ]  # noqa: E501
        ...
        class_id = "tam.SecurityAdvisoryDetails" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "tam.SecurityAdvisoryDetails")
        object_type = "tam.SecurityAdvisoryDetails" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "tam.SecurityAdvisoryDetails")
