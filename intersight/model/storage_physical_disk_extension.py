...
def lazy_import():
    ...
    globals()['StoragePhysicalDiskExtensionAllOf'] = StoragePhysicalDiskExtensionAllOf
    globals()['StoragePhysicalDiskRelationship'] = StoragePhysicalDiskRelationship


class StoragePhysicalDiskExtension(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StoragePhysicalDiskExtension - a model defined in OpenAPI
        ...
        class_id = "storage.PhysicalDiskExtension" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "storage.PhysicalDiskExtension")
        object_type = "storage.PhysicalDiskExtension" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "storage.PhysicalDiskExtension")
