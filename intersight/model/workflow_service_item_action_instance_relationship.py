...
class WorkflowServiceItemActionInstanceRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'messages': ([ServiceitemMessage], none_type,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'resourcelifecycle_status': (str,),  # noqa: E501
            'selection_criteria_inputs': ([ServiceitemSelectionCriteriaInput], none_type,),  # noqa: E501
            'service_request_input': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'start_time': (datetime,),  # noqa: E501
            'status': (str,),  # noqa: E501
            'user_id_or_email': (str,),  # noqa: E501
            'action_workflow_info': (WorkflowWorkflowInfoRelationship,),  # noqa: E501
            ...
            'service_item_action_definition': (WorkflowServiceItemActionDefinitionRelationship,),  # noqa: E501
            'service_item_definition': (WorkflowServiceItemDefinitionRelationship,),  # noqa: E501
            'service_item_instance': (WorkflowServiceItemInstanceRelationship,),  # noqa: E501
            'stop_workflow_info': (WorkflowWorkflowInfoRelationship,),  # noqa: E501
            'user': (IamUserRelationship,),  # noqa: E501
            'validation_workflow_info': (WorkflowWorkflowInfoRelationship,),  # noqa: E501
    ...
    read_only_vars = {
        ...
        'service_request_input',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """WorkflowServiceItemActionInstanceRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            action (str): Name of the action that needs to be performed on the service item instance. * `None` - No action is set, this is the default value for action field. * `Validate` - Validate the action instance inputs and run the validation workflows. * `Start` - Start a new execution of the action instance. * `Rerun` - Rerun the service item action instance from the beginning. * `Retry` - Retry the workflow that has failed from the failure point. * `Cancel` - Cancel the core workflow that is in running or waiting state. This action can be used when the workflows are stuck and not progressing. * `Stop` - Stop the action instance which is in progress and didn't complete successfully. Use this action to clear the state and then delete the action instance. A completed action cannot be stopped.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            end_time (datetime): The time when the action was stopped or completed execution last time.. [optional]  # noqa: E501
            input (bool, date, datetime, dict, float, int, list, str, none_type): Inputs for a service item action and the format is specified by input definition of the service item action definition.. [optional]  # noqa: E501
            last_action (str): The last action that was issued on the action definition workflows is saved in this property. * `None` - No action is set, this is the default value for action field. * `Validate` - Validate the action instance inputs and run the validation workflows. * `Start` - Start a new execution of the action instance. * `Rerun` - Rerun the service item action instance from the beginning. * `Retry` - Retry the workflow that has failed from the failure point. * `Cancel` - Cancel the core workflow that is in running or waiting state. This action can be used when the workflows are stuck and not progressing. * `Stop` - Stop the action instance which is in progress and didn't complete successfully. Use this action to clear the state and then delete the action instance. A completed action cannot be stopped.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            messages ([ServiceitemMessage], none_type): [optional]  # noqa: E501
            name (str): Name for the action instance is created in the system by appending name of the service item instance to the name of the action definition.. [optional]  # noqa: E501
            ...
            service_item_action_definition (WorkflowServiceItemActionDefinitionRelationship): [optional]  # noqa: E501
            service_item_definition (WorkflowServiceItemDefinitionRelationship): [optional]  # noqa: E501
            service_item_instance (WorkflowServiceItemInstanceRelationship): [optional]  # noqa: E501
            stop_workflow_info (WorkflowWorkflowInfoRelationship): [optional]  # noqa: E501
            user (IamUserRelationship): [optional]  # noqa: E501
            validation_workflow_info (WorkflowWorkflowInfoRelationship): [optional]  # noqa: E501
