...
def lazy_import():
    ...
    globals()['FabricSanPinGroupListAllOf'] = FabricSanPinGroupListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class FabricSanPinGroupList(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FabricSanPinGroupList - a model defined in OpenAPI
