...
def lazy_import():
    from intersight.model.capability_template_catalog_list import CapabilityTemplateCatalogList
    ...
    globals()['CapabilityTemplateCatalogList'] = CapabilityTemplateCatalogList
...
class CapabilityTemplateCatalogResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'capability.TemplateCatalog.List': CapabilityTemplateCatalogList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CapabilityTemplateCatalogResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'capability.TemplateCatalog' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
