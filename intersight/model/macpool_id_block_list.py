...
def lazy_import():
    ...
    globals()['MacpoolIdBlockListAllOf'] = MacpoolIdBlockListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class MacpoolIdBlockList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([MacpoolIdBlock], none_type,),  # noqa: E501
        }
    ...
    def __init__(self, object_type, *args, **kwargs):  # noqa: E501
        """MacpoolIdBlockList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            results ([MacpoolIdBlock], none_type): The array of 'macpool.IdBlock' resources matching the request.. [optional]  # noqa: E501
        """
