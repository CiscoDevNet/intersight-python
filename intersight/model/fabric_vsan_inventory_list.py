...
def lazy_import():
    ...
    globals()['FabricVsanInventoryListAllOf'] = FabricVsanInventoryListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class FabricVsanInventoryList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([FabricVsanInventory], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FabricVsanInventoryList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            results ([FabricVsanInventory], none_type): The array of 'fabric.VsanInventory' resources matching the request.. [optional]  # noqa: E501
        """
