...
def lazy_import():
    ...
    globals()['EquipmentTpmAllOf'] = EquipmentTpmAllOf
...
class EquipmentTpm(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentTpm - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "equipment.Tpm", must be one of ["equipment.Tpm", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "equipment.Tpm", must be one of ["equipment.Tpm", ]  # noqa: E501
            ...
            activation_status (str): Identifies the activation status of the TPM.. [optional]  # noqa: E501
            admin_state (str): Identifies the admin configured state of the TPM.. [optional]  # noqa: E501
            firmware_version (str): Firmware Version of the Trusted Platform Module.. [optional]  # noqa: E501
            ownership (str): Identifies the ownership information of the TPM.. [optional]  # noqa: E501
            tpm_id (int): Enter  the ID of the trusted platform module.. [optional]  # noqa: E501
            version (str): Identifies the version of the Trusted Platform Module.. [optional]  # noqa: E501
        ...
        class_id = "equipment.Tpm" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "equipment.Tpm")
        object_type = "equipment.Tpm" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "equipment.Tpm")
