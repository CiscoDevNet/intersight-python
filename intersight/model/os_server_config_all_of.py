...
class OsServerConfigAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OsServerConfigAllOf - a model defined in OpenAPI
        ...
        class_id = "os.ServerConfig" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "os.ServerConfig")
        object_type = "os.ServerConfig" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "os.ServerConfig")
