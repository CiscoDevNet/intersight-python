...
class FirmwareDriverDistributableAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'osname': (str,),  # noqa: E501
            'osversion': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'osname': 'Osname',  # noqa: E501
        'osversion': 'Osversion',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FirmwareDriverDistributableAllOf - a model defined in OpenAPI
        ...
        class_id = "firmware.DriverDistributable" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "firmware.DriverDistributable")
        object_type = "firmware.DriverDistributable" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "firmware.DriverDistributable")
