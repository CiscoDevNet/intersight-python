...
class KubernetesNetworkInterfaceAllOf(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            'ETHERNET': "kubernetes.Ethernet",
            'OVSBOND': "kubernetes.OvsBond",
        },
        ('object_type',): {
            'ETHERNET': "kubernetes.Ethernet",
            'OVSBOND': "kubernetes.OvsBond",
    ...
    def openapi_types():
        ...
        return {
            ...
            'ip_v4_configs': ([KubernetesIpV4Config], none_type,),  # noqa: E501
            'mtu': (int,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'routes': ([KubernetesRoute], none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'ip_v4_configs': 'IpV4Configs',  # noqa: E501
        'mtu': 'Mtu',  # noqa: E501
        'name': 'Name',  # noqa: E501
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """KubernetesNetworkInterfaceAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            addresses ([str], none_type): [optional]  # noqa: E501
            gateway (str): Deprecated. This will add a default route as long as the first default route in Routes is not different. If is different, Gateway will be replaced with that default route. If there is no default Route and this is set, then Routes will be updated with the first entry as a default with this default gateway. If there is only one default Route and this gateway becomes empty, then the default routes will all be removed. Do not set if using Ip Pools, as the gateway is configured in the pool. This will be removed in the future.. [optional]  # noqa: E501
            ip_v4_configs ([KubernetesIpV4Config], none_type): [optional]  # noqa: E501
            mtu (int): The MTU to assign to this Network Interface.. [optional]  # noqa: E501
            name (str): Name for this network interface.. [optional]  # noqa: E501
            routes ([KubernetesRoute], none_type): [optional]  # noqa: E501
        """
