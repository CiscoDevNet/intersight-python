...
class TelemetryDruidTimeBoundaryRequestAllOf(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, data_source, *args, **kwargs):  # noqa: E501
        """TelemetryDruidTimeBoundaryRequestAllOf - a model defined in OpenAPI
