...
def lazy_import():
    ...
    globals()['CertificatemanagementPolicyInventoryAllOf'] = CertificatemanagementPolicyInventoryAllOf
...
class CertificatemanagementPolicyInventory(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CertificatemanagementPolicyInventory - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "certificatemanagement.PolicyInventory", must be one of ["certificatemanagement.PolicyInventory", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "certificatemanagement.PolicyInventory", must be one of ["certificatemanagement.PolicyInventory", ]  # noqa: E501
        ...
        class_id = "certificatemanagement.PolicyInventory" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "certificatemanagement.PolicyInventory")
        object_type = "certificatemanagement.PolicyInventory" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "certificatemanagement.PolicyInventory")
