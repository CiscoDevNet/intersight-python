...
def lazy_import():
    ...
    from intersight.model.storage_pure_management_access_policy_list import StoragePureManagementAccessPolicyList
    ...
    globals()['StoragePureManagementAccessPolicyList'] = StoragePureManagementAccessPolicyList


class StoragePureManagementAccessPolicyResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'storage.PureManagementAccessPolicy.List': StoragePureManagementAccessPolicyList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """StoragePureManagementAccessPolicyResponse - a model defined in OpenAPI
