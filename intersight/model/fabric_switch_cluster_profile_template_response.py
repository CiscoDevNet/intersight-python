...
def lazy_import():
    from intersight.model.fabric_switch_cluster_profile_template_list import FabricSwitchClusterProfileTemplateList
    ...
    globals()['FabricSwitchClusterProfileTemplateList'] = FabricSwitchClusterProfileTemplateList
...
class FabricSwitchClusterProfileTemplateResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'fabric.SwitchClusterProfileTemplate.List': FabricSwitchClusterProfileTemplateList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FabricSwitchClusterProfileTemplateResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'fabric.SwitchClusterProfileTemplate' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'oneOf': [
              FabricSwitchClusterProfileTemplateList,
