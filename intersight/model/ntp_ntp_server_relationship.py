...
class NtpNtpServerRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NtpNtpServerRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            poll (int): The default polling interval of the NTP server in seconds.. [optional]  # noqa: E501
            server_ip_address (str): The IP address of the NTP server. Supports both IPv4 or IPv6 address.. [optional]  # noqa: E501
            stratum (int): The stratum level of the NTP server.. [optional]  # noqa: E501
            type (str): It determines whether the IP address configured is server or peer. * `Server` - NTP configured is server type. * `Peer` - NTP configured is peer type.. [optional] if omitted the server will use the default value of "Server"  # noqa: E501
            vrf_name (str): VRF name to be used by NTP Server.. [optional]  # noqa: E501
