...
def lazy_import():
    from intersight.model.mgmt_config_restore_category_summary_list import MgmtConfigRestoreCategorySummaryList
    ...
    globals()['MgmtConfigRestoreCategorySummaryList'] = MgmtConfigRestoreCategorySummaryList
...
class MgmtConfigRestoreCategorySummaryResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'mgmt.ConfigRestoreCategorySummary.List': MgmtConfigRestoreCategorySummaryList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """MgmtConfigRestoreCategorySummaryResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'mgmt.ConfigRestoreCategorySummary' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
