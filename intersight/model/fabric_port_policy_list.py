...
def lazy_import():
    ...
    globals()['FabricPortPolicyListAllOf'] = FabricPortPolicyListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class FabricPortPolicyList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([FabricPortPolicy], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FabricPortPolicyList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            results ([FabricPortPolicy], none_type): The array of 'fabric.PortPolicy' resources matching the request.. [optional]  # noqa: E501
        """
