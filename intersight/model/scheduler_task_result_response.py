...
def lazy_import():
    ...
    from intersight.model.scheduler_task_result_list import SchedulerTaskResultList
    ...
    globals()['SchedulerTaskResultList'] = SchedulerTaskResultList


class SchedulerTaskResultResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'scheduler.TaskResult.List': SchedulerTaskResultList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """SchedulerTaskResultResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'scheduler.TaskResult' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
