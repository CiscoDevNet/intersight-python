...
class HclHyperflexSoftwareCompatibilityInfoAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'max_mgmt_version': (str,),  # noqa: E501
            'min_mgmt_version': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'max_mgmt_version': 'MaxMgmtVersion',  # noqa: E501
        'min_mgmt_version': 'MinMgmtVersion',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """HclHyperflexSoftwareCompatibilityInfoAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "hcl.HyperflexSoftwareCompatibilityInfo", must be one of ["hcl.HyperflexSoftwareCompatibilityInfo", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "hcl.HyperflexSoftwareCompatibilityInfo", must be one of ["hcl.HyperflexSoftwareCompatibilityInfo", ]  # noqa: E501
            ...
            max_mgmt_version (str): Maximum supported HyperFlex Data Platform build version.. [optional]  # noqa: E501
            min_mgmt_version (str): Minimum supported HyperFlex Data Platform build version.. [optional]  # noqa: E501
        ...
        class_id = "hcl.HyperflexSoftwareCompatibilityInfo" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "hcl.HyperflexSoftwareCompatibilityInfo")
        object_type = "hcl.HyperflexSoftwareCompatibilityInfo" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "hcl.HyperflexSoftwareCompatibilityInfo")
