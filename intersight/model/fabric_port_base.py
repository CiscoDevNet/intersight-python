...
def lazy_import():
    ...
    globals()['FabricPortBaseAllOf'] = FabricPortBaseAllOf
...
class FabricPortBase(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'PCMEMBER': "fabric.PcMember",
            'PORTOPERATION': "fabric.PortOperation",
        },
        ('object_type',): {
            'PCMEMBER': "fabric.PcMember",
            'PORTOPERATION': "fabric.PortOperation",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """FabricPortBase - a model defined in OpenAPI
