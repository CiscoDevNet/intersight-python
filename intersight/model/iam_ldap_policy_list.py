...
def lazy_import():
    ...
    globals()['IamLdapPolicyListAllOf'] = IamLdapPolicyListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class IamLdapPolicyList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([IamLdapPolicy], none_type,),  # noqa: E501
        }
    ...
    def __init__(self, object_type, *args, **kwargs):  # noqa: E501
        """IamLdapPolicyList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            results ([IamLdapPolicy], none_type): The array of 'iam.LdapPolicy' resources matching the request.. [optional]  # noqa: E501
        """
