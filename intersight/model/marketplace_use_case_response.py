...
def lazy_import():
    from intersight.model.marketplace_use_case_list import MarketplaceUseCaseList
    ...
    globals()['MarketplaceUseCaseList'] = MarketplaceUseCaseList
...
class MarketplaceUseCaseResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'marketplace.UseCase.List': MarketplaceUseCaseList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """MarketplaceUseCaseResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'marketplace.UseCase' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
