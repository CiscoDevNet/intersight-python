...
class WorkflowPowerShellBatchApiExecutor(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            description (str): A detailed description about the batch APIs.. [optional]  # noqa: E501
            name (str): Name for the batch API task.. [optional]  # noqa: E501
            ...
            output (bool, date, datetime, dict, float, int, list, str, none_type): Intersight Orchestrator allows the extraction of required values from API responses using the API response grammar. These extracted values can be mapped to task output parameters defined in task definition. The mapping of API output parameters to the task output parameters is provided as JSON in this property.. [optional]  # noqa: E501
            retry_from_failed_api (bool): When an execution of a nth API in the Batch fails, Retry from failed API flag indicates if the execution should start from the nth API or the first API during task retry. By default the value is set to false.. [optional]  # noqa: E501
            ...
            ui_rendering_data (bool, date, datetime, dict, float, int, list, str, none_type): This will hold the data needed for task to be rendered in the user interface.. [optional]  # noqa: E501
        """
