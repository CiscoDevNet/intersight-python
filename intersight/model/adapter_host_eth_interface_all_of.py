...
class AdapterHostEthInterfaceAllOf(ModelNormal):
    ...
    allowed_values = {
        ...
        ('veth_action',): {
            ...
            'RESETCONNECTIVITYACTIVE': "ResetConnectivityActive",
            'RESETCONNECTIVITYPASSIVE': "ResetConnectivityPassive",
            'ENABLE': "Enable",
            'DISABLE': "Disable",
    ...
    def openapi_types():
        ...
        return {
            ...
            'active_oper_state': (str,),  # noqa: E501
            'active_veth_oper_state': (str,),  # noqa: E501
            'admin_state': (str,),  # noqa: E501
            'ep_dn': (str,),  # noqa: E501
            'host_eth_interface_id': (int,),  # noqa: E501
            'interface_type': (str,),  # noqa: E501
            'mac_address': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'oper_reason': ([str], none_type,),  # noqa: E501
            'operability': (str,),  # noqa: E501
            'original_mac_address': (str,),  # noqa: E501
            'pci_addr': (str,),  # noqa: E501
            'peer_dn': (str,),  # noqa: E501
            'pin_group_name': (str,),  # noqa: E501
            'qinq_enabled': (bool,),  # noqa: E501
            'qinq_vlan': (int,),  # noqa: E501
            'standby_oper_state': (str,),  # noqa: E501
            'standby_veth_oper_state': (str,),  # noqa: E501
            'standby_vif_id': (int,),  # noqa: E501
            'veth_action': (str,),  # noqa: E501
            'vif_id': (int,),  # noqa: E501
            'virtualization_preference': (str,),  # noqa: E501
            'vnic_dn': (str,),  # noqa: E501
            ...
            'standby_vethernet': (NetworkVethernetRelationship,),  # noqa: E501
            'vethernet': (NetworkVethernetRelationship,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'active_oper_state': 'ActiveOperState',  # noqa: E501
        'active_veth_oper_state': 'ActiveVethOperState',  # noqa: E501
        'admin_state': 'AdminState',  # noqa: E501
        'ep_dn': 'EpDn',  # noqa: E501
        'host_eth_interface_id': 'HostEthInterfaceId',  # noqa: E501
        ...
        'original_mac_address': 'OriginalMacAddress',  # noqa: E501
        'pci_addr': 'PciAddr',  # noqa: E501
        'peer_dn': 'PeerDn',  # noqa: E501
        'pin_group_name': 'PinGroupName',  # noqa: E501
        'qinq_enabled': 'QinqEnabled',  # noqa: E501
        'qinq_vlan': 'QinqVlan',  # noqa: E501
        'standby_oper_state': 'StandbyOperState',  # noqa: E501
        'standby_veth_oper_state': 'StandbyVethOperState',  # noqa: E501
        'standby_vif_id': 'StandbyVifId',  # noqa: E501
        'veth_action': 'VethAction',  # noqa: E501
        'vif_id': 'VifId',  # noqa: E501
        'virtualization_preference': 'VirtualizationPreference',  # noqa: E501
        'vnic_dn': 'VnicDn',  # noqa: E501
        ...
        'standby_vethernet': 'StandbyVethernet',  # noqa: E501
        'vethernet': 'Vethernet',  # noqa: E501
    }

    read_only_vars = {
        'active_oper_state',  # noqa: E501
        'active_veth_oper_state',  # noqa: E501
        'admin_state',  # noqa: E501
        'ep_dn',  # noqa: E501
        'host_eth_interface_id',  # noqa: E501
        'interface_type',  # noqa: E501
        'mac_address',  # noqa: E501
        'name',  # noqa: E501
        'operability',  # noqa: E501
        'original_mac_address',  # noqa: E501
        'pci_addr',  # noqa: E501
        'peer_dn',  # noqa: E501
        'standby_oper_state',  # noqa: E501
        'standby_veth_oper_state',  # noqa: E501
        'standby_vif_id',  # noqa: E501
        'vif_id',  # noqa: E501
        'virtualization_preference',  # noqa: E501
        'vnic_dn',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AdapterHostEthInterfaceAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "adapter.HostEthInterface", must be one of ["adapter.HostEthInterface", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "adapter.HostEthInterface", must be one of ["adapter.HostEthInterface", ]  # noqa: E501
            ...
            active_oper_state (str): The operational state of the Active vNIC. vNIC operational state information is updated by events from the adapter. This operational state is applicable to primary vNIC. If a host is powered off, this property might not be accurate as we may or may not receive events from the adapter. For Intersight Managed Domains Mode domains (IMM), the vNIC's peer object Vethernet will have the current operational state of the connection when a host is powered off.. [optional]  # noqa: E501
            active_veth_oper_state (str): The operational state of the Active Vethernet peer of a vNIC in Intersight Managed Mode. This state is updated by events from Fabric Interconnect or by periodic updates from Fabric Interconnect. When a Fabric Interconnect is not connected to Intersight or if the Fabric Interconnect is powered down, this property will not be updated. This state is not applicable for standalone servers. * `unknown` - The operational state of the Vethernet is not known. * `adminDown` - The operational state of the Vethernet is admin down. * `up` - The operational state of the Vethernet is Up. * `down` - The operational state of the Vethernet is Down. * `noLicense` - The operational state of the Vethernet is no license. * `linkUp` - The operational state of the Vethernet is link up. * `hardwareFailure` - The operational state of the Vethernet is hardware failure. * `softwareFailure` - The operational state of the Vethernet is software failure. * `errorDisabled` - The operational state of the Vethernet is error disabled. * `linkDown` - The operational state of the Vethernet is link down. * `sfpNotPresent` - The operational state of the Vethernet is SFP not present. * `udldAggrDown` - The operational state of the Vethernet is UDLD aggregate down.. [optional] if omitted the server will use the default value of "unknown"  # noqa: E501
            admin_state (str): Admin state of the Host Ethernet Interface.. [optional]  # noqa: E501
            ep_dn (str): The Endpoint Config Dn of the Host Ethernet Interface.. [optional]  # noqa: E501
            host_eth_interface_id (int): Unique Identifier for an Host Ethernet Interface within the adapter object.. [optional]  # noqa: E501
            interface_type (str): Type of External Ethernet Interface.. [optional]  # noqa: E501
            mac_address (str): Mac address of the Host Ethernet Interface.. [optional]  # noqa: E501
            name (str): Name of Host Ethernet Interface.. [optional]  # noqa: E501
            oper_reason ([str], none_type): [optional]  # noqa: E501
            operability (str): Operability status of Host Ethernet Channel Interface.. [optional]  # noqa: E501
            original_mac_address (str): The factory default Mac address of the Host Ethernet Interface.. [optional]  # noqa: E501
            pci_addr (str): The PCI address of the Host Ethernet Interface.. [optional]  # noqa: E501
            peer_dn (str): The distinguished name of the peer endpoint connected to the Host Ethernet interface.. [optional]  # noqa: E501
            pin_group_name (str): Name given for Lan PinGroup.. [optional]  # noqa: E501
            qinq_enabled (bool): Setting qinqEnabled to true if we have QinQ tagging enabled on the vNIC.. [optional]  # noqa: E501
            qinq_vlan (int): The VLAN ID for VIC QinQ (802.1Q) Tunneling.. [optional] if omitted the server will use the default value of 2  # noqa: E501
            standby_oper_state (str): The operational state of the standby vNIC. vNIC operational state information is updated by events from the adapter. This operational state is applicable only to failover vNIC. If a host is powered off, this property might not be accurate as we may or may not receive events from the adapter. For Intersight Managed Mode domains (IMM), the vNIC's peer object Vethernet will have the current operational state of the connection when a host is powered off.. [optional]  # noqa: E501
            standby_veth_oper_state (str): The operational state of the Standby Vethernet peer of a failover vNIC in Intersight Managed Mode. This state is updated by events from Fabric Interconnect or by periodic updates from Fabric Interconnect. When a Fabric Interconnect is not connected to Intersight or if the Fabric Interconnect is powered down, this property will not be updated. This state is not applicable for standalone servers. * `unknown` - The operational state of the Vethernet is not known. * `adminDown` - The operational state of the Vethernet is admin down. * `up` - The operational state of the Vethernet is Up. * `down` - The operational state of the Vethernet is Down. * `noLicense` - The operational state of the Vethernet is no license. * `linkUp` - The operational state of the Vethernet is link up. * `hardwareFailure` - The operational state of the Vethernet is hardware failure. * `softwareFailure` - The operational state of the Vethernet is software failure. * `errorDisabled` - The operational state of the Vethernet is error disabled. * `linkDown` - The operational state of the Vethernet is link down. * `sfpNotPresent` - The operational state of the Vethernet is SFP not present. * `udldAggrDown` - The operational state of the Vethernet is UDLD aggregate down.. [optional] if omitted the server will use the default value of "unknown"  # noqa: E501
            standby_vif_id (int): Identifier of the Standby virtual ethernet interface (Vethernet) on the networking component (e.g., Fabric Interconnect) for the corresponding Host Ethernet Interface (vNIC).. [optional]  # noqa: E501
            veth_action (str): The action to be performed on the vethernet corresponding to the vNIC. * `None` - Default value for vif operation. * `ResetConnectivity` - Resets connectivity on both active and passive vif. * `ResetConnectivityActive` - Resets connectivity on the active vif. * `ResetConnectivityPassive` - Resets connectivity on the passive vif. * `Enable` - Enables the vif on both the FIs. * `Disable` - Disables the vif on both the FIs. * `EnableActive` - Enables the corresponding active vif. * `EnablePassive` - Enables the corresponding standby vif. * `DisableActive` - Disables the corresponding active vif. * `DisablePassive` - Disables the corresponding standby vif.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            vif_id (int): Identifier of the virtual ethernet interface (Vethernet) on the networking component (e.g., Fabric Interconnect) for the corresponding Host Ethernet Interface (vNIC).. [optional]  # noqa: E501
            virtualization_preference (str): Virtualization Preference of the Host Ethernet Interface indicating if virtualization is enabled or not.. [optional]  # noqa: E501
            vnic_dn (str): The Virtual Ethernet Interface DN connected to the Host Ethernet Interface.. [optional]  # noqa: E501
            ...
            standby_vethernet (NetworkVethernetRelationship): [optional]  # noqa: E501
            vethernet (NetworkVethernetRelationship): [optional]  # noqa: E501
        """

        class_id = "adapter.HostEthInterface" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "adapter.HostEthInterface")
        object_type = "adapter.HostEthInterface" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "adapter.HostEthInterface")
