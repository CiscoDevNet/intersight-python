...
def lazy_import():
    ...
    globals()['ApplianceUpgradePolicyAllOf'] = ApplianceUpgradePolicyAllOf
...
class ApplianceUpgradePolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'disruptive_grace_period_week': (int,),  # noqa: E501
            'enable_meta_data_sync': (bool,),  # noqa: E501
            'is_custom_grace_period_enabled': (bool,),  # noqa: E501
            'is_synced': (bool,),  # noqa: E501
            'manual_installation_start_time': (datetime,),  # noqa: E501
            'nondisruptive_grace_period_week': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'disruptive_grace_period_week': 'DisruptiveGracePeriodWeek',  # noqa: E501
        'enable_meta_data_sync': 'EnableMetaDataSync',  # noqa: E501
        'is_custom_grace_period_enabled': 'IsCustomGracePeriodEnabled',  # noqa: E501
        'is_synced': 'IsSynced',  # noqa: E501
        'manual_installation_start_time': 'ManualInstallationStartTime',  # noqa: E501
        'nondisruptive_grace_period_week': 'NondisruptiveGracePeriodWeek',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApplianceUpgradePolicy - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "appliance.UpgradePolicy", must be one of ["appliance.UpgradePolicy", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "appliance.UpgradePolicy", must be one of ["appliance.UpgradePolicy", ]  # noqa: E501
            ...
            auto_upgrade (bool): Updates are installed automatically 2 weeks after detection, or 4 weeks if an appliance reboot is required.. [optional]  # noqa: E501
            blackout_dates_enabled (bool): Appliance will not be updated during the blocked dates.. [optional]  # noqa: E501
            ...
            disruptive_grace_period_week (int): Updates that require an appliance reboot start automatically after the grace period ends.. [optional] if omitted the server will use the default value of 4  # noqa: E501
            ...
            is_custom_grace_period_enabled (bool): Waiting period before major and patch updates are triggered automatically.. [optional]  # noqa: E501
            ...
            nondisruptive_grace_period_week (int): Updates that do not require an appliance reboot start automatically after the grace period ends.. [optional] if omitted the server will use the default value of 4  # noqa: E501
            schedule (OnpremSchedule): [optional]  # noqa: E501
            software_download_type (str): SoftwareDownloadType is used to indicate the kind of software download. * `unknown` - Indicates user setting of upgrade service to unknown. * `connected` - Indicates if the upgrade service is set to upload software to latest version automatically. * `manual` - Indicates if the upgrade service is set to upload software to user picked verison manually.. [optional] if omitted the server will use the default value of "unknown"  # noqa: E501
        ...
        class_id = "appliance.UpgradePolicy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "appliance.UpgradePolicy")
        object_type = "appliance.UpgradePolicy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "appliance.UpgradePolicy")
