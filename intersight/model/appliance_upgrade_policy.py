...
class ApplianceUpgradePolicy(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            disruptive_grace_period_week (int): Updates requiring a reboot will start automatically once the grace period ends.. [optional] if omitted the server will use the default value of 4  # noqa: E501
            ...
            is_custom_grace_period_enabled (bool): Custom grace period for subsequent reboot and non-reboot updates.. [optional]  # noqa: E501
            ...
            nondisruptive_grace_period_week (int): Updates not requiring a reboot will start automatically once the grace period ends.. [optional] if omitted the server will use the default value of 4  # noqa: E501
