...
def lazy_import():
    from intersight.model.apiproxy_allow_list_list import ApiproxyAllowListList
    ...
    globals()['ApiproxyAllowListList'] = ApiproxyAllowListList
...
class ApiproxyAllowListResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'apiproxy.AllowList.List': ApiproxyAllowListList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ApiproxyAllowListResponse - a model defined in OpenAPI
