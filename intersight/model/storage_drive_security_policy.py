...
def lazy_import():
    ...
    globals()['StorageDriveSecurityPolicyAllOf'] = StorageDriveSecurityPolicyAllOf
    globals()['StorageKeySetting'] = StorageKeySetting


class StorageDriveSecurityPolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'key_setting': (StorageKeySetting,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'key_setting': 'KeySetting',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StorageDriveSecurityPolicy - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "storage.DriveSecurityPolicy", must be one of ["storage.DriveSecurityPolicy", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "storage.DriveSecurityPolicy", must be one of ["storage.DriveSecurityPolicy", ]  # noqa: E501
            ...
            key_setting (StorageKeySetting): [optional]  # noqa: E501
        ...
        class_id = "storage.DriveSecurityPolicy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "storage.DriveSecurityPolicy")
        object_type = "storage.DriveSecurityPolicy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "storage.DriveSecurityPolicy")
