...
class BootPchStorageAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BootPchStorageAllOf - a model defined in OpenAPI
        ...
        class_id = "boot.PchStorage" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "boot.PchStorage")
        object_type = "boot.PchStorage" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "boot.PchStorage")
