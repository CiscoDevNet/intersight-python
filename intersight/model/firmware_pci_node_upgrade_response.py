...
def lazy_import():
    from intersight.model.firmware_pci_node_upgrade_list import FirmwarePciNodeUpgradeList
    ...
    globals()['FirmwarePciNodeUpgradeList'] = FirmwarePciNodeUpgradeList
...
class FirmwarePciNodeUpgradeResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'firmware.PciNodeUpgrade.List': FirmwarePciNodeUpgradeList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FirmwarePciNodeUpgradeResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'firmware.PciNodeUpgrade' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
