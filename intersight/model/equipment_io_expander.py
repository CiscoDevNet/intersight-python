...
def lazy_import():
    ...
    globals()['EquipmentIoExpanderAllOf'] = EquipmentIoExpanderAllOf
...
class EquipmentIoExpander(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """EquipmentIoExpander - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "equipment.IoExpander", must be one of ["equipment.IoExpander", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "equipment.IoExpander", must be one of ["equipment.IoExpander", ]  # noqa: E501
            ...
            oper_state (str): Identifies the operational state of I/O expander.. [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "equipment.IoExpander")
        object_type = kwargs.get('object_type', "equipment.IoExpander")
