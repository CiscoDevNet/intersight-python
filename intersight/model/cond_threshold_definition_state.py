...
def lazy_import():
    from intersight.model.metric_threshold_definition_state import MetricThresholdDefinitionState
    from intersight.model.mo_base_complex_type import MoBaseComplexType
    globals()['MetricThresholdDefinitionState'] = MetricThresholdDefinitionState
    globals()['MoBaseComplexType'] = MoBaseComplexType


class CondThresholdDefinitionState(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'metric.ThresholdDefinitionState': MetricThresholdDefinitionState,
        }
        if not val:
            return None
        return {'class_id': val}
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """CondThresholdDefinitionState - a model defined in OpenAPI
