...
def lazy_import():
    ...
    globals()['PciLinkAllOf'] = PciLinkAllOf
    globals()['PciSwitchRelationship'] = PciSwitchRelationship


class PciLink(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'link_status': (str,),  # noqa: E501
            'link_width': (str,),  # noqa: E501
            'pci_slot': (str,),  # noqa: E501
            'slot_status': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'link_status': 'LinkStatus',  # noqa: E501
        'link_width': 'LinkWidth',  # noqa: E501
        'pci_slot': 'PciSlot',  # noqa: E501
        'slot_status': 'SlotStatus',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'link_status',  # noqa: E501
        'link_width',  # noqa: E501
        'pci_slot',  # noqa: E501
        'slot_status',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PciLink - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "pci.Link", must be one of ["pci.Link", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "pci.Link", must be one of ["pci.Link", ]  # noqa: E501
            ...
            adapter (str): The name of the PCI device.. [optional]  # noqa: E501
            link_speed (str): The upstream link speed of the PCI device.. [optional]  # noqa: E501
            link_status (str): The upstream link status of the PCI device.. [optional]  # noqa: E501
            link_width (str): The upstream link width of the PCI device.. [optional]  # noqa: E501
            pci_slot (str): The slot name of the PCI device.. [optional]  # noqa: E501
            slot_status (str): The health information of the PCI device.. [optional]  # noqa: E501
        ...
        class_id = "pci.Link" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "pci.Link")
        object_type = "pci.Link" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "pci.Link")
