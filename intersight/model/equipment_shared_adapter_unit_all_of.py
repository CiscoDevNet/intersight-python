...
class EquipmentSharedAdapterUnitAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentSharedAdapterUnitAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "equipment.SharedAdapterUnit", must be one of ["equipment.SharedAdapterUnit", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "equipment.SharedAdapterUnit", must be one of ["equipment.SharedAdapterUnit", ]  # noqa: E501
        ...
        class_id = "equipment.SharedAdapterUnit" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "equipment.SharedAdapterUnit")
        object_type = "equipment.SharedAdapterUnit" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "equipment.SharedAdapterUnit")
