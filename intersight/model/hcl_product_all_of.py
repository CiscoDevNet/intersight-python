...
class HclProductAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'driver_names': ([str], none_type,),  # noqa: E501
            'error_code': (str,),  # noqa: E501
            'firmwares': ([HclFirmware], none_type,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'model': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'driver_names': 'DriverNames',  # noqa: E501
        'error_code': 'ErrorCode',  # noqa: E501
        'firmwares': 'Firmwares',  # noqa: E501
        'id': 'Id',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """HclProductAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "hcl.Product", must be one of ["hcl.Product", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "hcl.Product", must be one of ["hcl.Product", ]  # noqa: E501
