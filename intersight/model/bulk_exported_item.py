...
def lazy_import():
    from intersight.model.bulk_base_export_relationship import BulkBaseExportRelationship
    ...
    globals()['BulkBaseExportRelationship'] = BulkBaseExportRelationship
...
class BulkExportedItem(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'export': (BulkBaseExportRelationship,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            status (str): Status of the item's export operation. * `` - The operation has not started. * `Ready` - The operation is ready to start. * `ValidationInProgress` - The validation operation is in progress. * `Valid` - The content to be imported is valid. * `InValid` - The content to be imported is not valid and the status message will have the reason. * `InProgress` - The operation is in progress. * `Success` - The operation has succeeded. * `Failed` - The operation has failed. * `RollBackInitiated` - The rollback has been initiated for import failure. * `RollBackFailed` - The rollback has failed for import failure. * `RollbackCompleted` - The rollback has completed for import failure. * `RollbackAborted` - The rollback has been aborted for import failure. * `OperationTimedOut` - The operation has timed out. * `OperationCancelled` - The operation has been canceled. * `CancelInProgress` - The operation is being canceled.. [optional] if omitted the server will use the default value of ""  # noqa: E501
            status_message (str): Progress or error message for the MO's export operation.. [optional]  # noqa: E501
            export (BulkBaseExportRelationship): [optional]  # noqa: E501
