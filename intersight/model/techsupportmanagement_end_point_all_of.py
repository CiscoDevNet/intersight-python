...
class TechsupportmanagementEndPointAllOf(ModelNormal):
    ...
    attribute_map = {
        ...
        'device_moid': 'DeviceMoid',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TechsupportmanagementEndPointAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "techsupportmanagement.EndPoint", must be one of ["techsupportmanagement.EndPoint", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "techsupportmanagement.EndPoint", must be one of ["techsupportmanagement.EndPoint", ]  # noqa: E501
            ...
            device_moid (str): The device registration moid of the endpoint device.. [optional]  # noqa: E501
            device_type (str): The device object type for the managed end point.. [optional]  # noqa: E501
            dn (str): The distinguished name, if any, for the managed end point.. [optional]  # noqa: E501
            pid (str): The product identifier of the managed end point.. [optional]  # noqa: E501
            ...
            serial (str): The serial identifier for the managed end point.. [optional]  # noqa: E501
        ...
        class_id = "techsupportmanagement.EndPoint" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "techsupportmanagement.EndPoint")
        object_type = "techsupportmanagement.EndPoint" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "techsupportmanagement.EndPoint")
