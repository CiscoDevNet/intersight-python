...
def lazy_import():
    ...
    from intersight.model.storage_pure_realm_list import StoragePureRealmList
    ...
    globals()['StoragePureRealmList'] = StoragePureRealmList


class StoragePureRealmResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'storage.PureRealm.List': StoragePureRealmList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """StoragePureRealmResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'storage.PureRealm' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
