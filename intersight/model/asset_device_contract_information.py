...
class AssetDeviceContractInformation(ModelComposed):
    ...
    allowed_values = {
        ...
        ('device_type',): {
            ...
            'CISCOEDGESERVER': "CiscoEdgeServer",
            'CISCOEDGECHASSIS': "CiscoEdgeChassis",
        },
        ('platform_type',): {
            'EMPTY': "",
            'APIC': "APIC",
