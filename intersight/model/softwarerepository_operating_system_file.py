...
def lazy_import():
    ...
    globals()['SoftwarerepositoryOperatingSystemFileAllOf'] = SoftwarerepositoryOperatingSystemFileAllOf
    globals()['SoftwarerepositoryReleaseRelationship'] = SoftwarerepositoryReleaseRelationship


class SoftwarerepositoryOperatingSystemFile(ModelComposed):
    ...
    attribute_map = {
        ...
        'import_progress': 'ImportProgress',  # noqa: E501
        'sample_hashes': 'SampleHashes',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SoftwarerepositoryOperatingSystemFile - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "softwarerepository.OperatingSystemFile", must be one of ["softwarerepository.OperatingSystemFile", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "softwarerepository.OperatingSystemFile", must be one of ["softwarerepository.OperatingSystemFile", ]  # noqa: E501
            ...
            file_name (str): File name of the uploaded image.. [optional]  # noqa: E501
            import_progress (int): The progress percentage for the import operation.. [optional]  # noqa: E501
            sample_hashes (str): File sample hashes at deterministic positions for efficient duplicate detection of large files.. [optional]  # noqa: E501
            vendor (str): The vendor or publisher of this file.. [optional]  # noqa: E501
            ...
            image_type (str): The type of image which the distributable falls into according to the component it can upgrade. For e.g.; Standalone server, Intersight managed server, Unified Edge server. The field is used in private appliance mode, where image does not have description populated from CCO.. [optional]  # noqa: E501
        ...
        class_id = "softwarerepository.OperatingSystemFile" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "softwarerepository.OperatingSystemFile")
        object_type = "softwarerepository.OperatingSystemFile" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "softwarerepository.OperatingSystemFile")
