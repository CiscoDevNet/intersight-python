...
def lazy_import():
    ...
    globals()['OsInstallTargetResponseAllOf'] = OsInstallTargetResponseAllOf
    globals()['OsPhysicalDiskResponse'] = OsPhysicalDiskResponse
    globals()['OsVirtualDriveResponse'] = OsVirtualDriveResponse


class OsInstallTargetResponse(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'PHYSICALDISKRESPONSE': "os.PhysicalDiskResponse",
            'VIRTUALDRIVERESPONSE': "os.VirtualDriveResponse",
        },
        ('object_type',): {
            'PHYSICALDISKRESPONSE': "os.PhysicalDiskResponse",
            'VIRTUALDRIVERESPONSE': "os.VirtualDriveResponse",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """OsInstallTargetResponse - a model defined in OpenAPI
