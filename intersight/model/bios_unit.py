...
def lazy_import():
    ...
    globals()['BiosUnitAllOf'] = BiosUnitAllOf
...
class BiosUnit(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'init_seq': (str,),  # noqa: E501
            'init_ts': (str,),  # noqa: E501
            ...
            'system_boot_order': (BiosSystemBootOrderRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'init_seq': 'InitSeq',  # noqa: E501
        'init_ts': 'InitTs',  # noqa: E501
        ...
        'system_boot_order': 'SystemBootOrder',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """BiosUnit - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "bios.Unit", must be one of ["bios.Unit", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "bios.Unit", must be one of ["bios.Unit", ]  # noqa: E501
            ...
            init_seq (str): The initSeq of the equipment.. [optional]  # noqa: E501
            init_ts (str): The initTs of the equipment.. [optional]  # noqa: E501
            ...
            system_boot_order (BiosSystemBootOrderRelationship): [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "bios.Unit")
        object_type = kwargs.get('object_type', "bios.Unit")
