...
def lazy_import():
    ...
    globals()['KubernetesHttpProxyPolicyAllOf'] = KubernetesHttpProxyPolicyAllOf
...
class KubernetesHttpProxyPolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'http_proxy': (KubernetesProxyConfig,),  # noqa: E501
            'https_proxy': (KubernetesProxyConfig,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """KubernetesHttpProxyPolicy - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "kubernetes.HttpProxyPolicy", must be one of ["kubernetes.HttpProxyPolicy", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "kubernetes.HttpProxyPolicy", must be one of ["kubernetes.HttpProxyPolicy", ]  # noqa: E501
            ...
            http_proxy (KubernetesProxyConfig): [optional]  # noqa: E501
            https_proxy (KubernetesProxyConfig): [optional]  # noqa: E501
        ...
        class_id = "kubernetes.HttpProxyPolicy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "kubernetes.HttpProxyPolicy")
        object_type = "kubernetes.HttpProxyPolicy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "kubernetes.HttpProxyPolicy")
