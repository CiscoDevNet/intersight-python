...
def lazy_import():
    from intersight.model.hcl_data_import_log_list import HclDataImportLogList
    ...
    globals()['HclDataImportLogList'] = HclDataImportLogList
...
class HclDataImportLogResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'hcl.DataImportLog.List': HclDataImportLogList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """HclDataImportLogResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'hcl.DataImportLog' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
