...
def lazy_import():
    ...
    globals()['StorageBaseInitiatorAllOf'] = StorageBaseInitiatorAllOf
...
class StorageBaseInitiator(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'HITACHIINITIATOR': "storage.HitachiInitiator",
            'HYPERFLEXISCSIINITIATOR': "storage.HyperFlexIscsiInitiator",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """StorageBaseInitiator - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            iqn (str): IQN (iSCSI qualified name). Can be up to 255 characters long and has the format iqn.yyyy-mm.naming-authority:unique name.. [optional]  # noqa: E501
            name (str): Name of the initiator represented in the storage array.. [optional]  # noqa: E501
            nqn (str): NQN (NVMe Qualified Name). Can be up to 223 characters long and has the format nqn.yyyy-mm.naming-authority:unique name.. [optional]  # noqa: E501
            type (str): Initiator type, it can be FC or iSCSI. * `FC` - Fibre channel initiator type which contains WWN of an HBA on the host. * `iSCSI` - An iSCSI initiator type which contains the IQN (iSCSI Qualified Name) used by the host. * `NVMe` - NVMe initiator type which contains the NQN (NVMe Qualified Name) used by the host. * `Mixed` - Initiator type for systems using both FC and iSCSI connections.. [optional] if omitted the server will use the default value of "FC"  # noqa: E501
            wwn (str): World wide name, 128 bit address represented in hexadecimal notation. For example, 51:4f:0c:50:14:1f:af:01:51:4f:0c:51:14:1f:af:01.. [optional]  # noqa: E501
        """
