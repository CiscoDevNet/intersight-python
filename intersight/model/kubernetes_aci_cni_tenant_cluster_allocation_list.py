...
def lazy_import():
    ...
    globals()['KubernetesAciCniTenantClusterAllocationListAllOf'] = KubernetesAciCniTenantClusterAllocationListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class KubernetesAciCniTenantClusterAllocationList(ModelComposed):
