...
class SoftwareHyperflexBundleDistributableAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SoftwareHyperflexBundleDistributableAllOf - a model defined in OpenAPI
        ...
        class_id = "software.HyperflexBundleDistributable" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "software.HyperflexBundleDistributable")
        object_type = "software.HyperflexBundleDistributable" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "software.HyperflexBundleDistributable")
