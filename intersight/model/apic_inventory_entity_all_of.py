...
class ApicInventoryEntityAllOf(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            'ACIPOD': "apic.AciPod",
            'APPLICATION': "apic.Application",
            'APPLICATIONENDPOINTGROUP': "apic.ApplicationEndpointGroup",
            'BRIDGEDOMAIN': "apic.BridgeDomain",
            'EXTERNALROUTEDLAYERTHREEDOMAIN': "apic.ExternalRoutedLayerThreeDomain",
            'FABRICLEAFNODE': "apic.FabricLeafNode",
            'FABRICLEAFNODEINTERFACE': "apic.FabricLeafNodeInterface",
            'OUT': "apic.Out",
            'SUBNET': "apic.Subnet",
            'TENANT': "apic.Tenant",
            'VPCGROUP': "apic.VpcGroup",
            'VRFS': "apic.Vrfs",
        },
        ('object_type',): {
            'ACIPOD': "apic.AciPod",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """ApicInventoryEntityAllOf - a model defined in OpenAPI
