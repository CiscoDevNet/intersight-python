...
def lazy_import():
    ...
    globals()['OsBaseInstallConfigAllOf'] = OsBaseInstallConfigAllOf
...
class OsBaseInstallConfig(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OsBaseInstallConfig - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "os.Install", must be one of ["os.Install", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "os.Install", must be one of ["os.Install", ]  # noqa: E501
