...
def lazy_import():
    ...
    from intersight.model.storage_controller_drive_list import StorageControllerDriveList
    ...
    globals()['StorageControllerDriveList'] = StorageControllerDriveList


class StorageControllerDriveResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'storage.ControllerDrive.List': StorageControllerDriveList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """StorageControllerDriveResponse - a model defined in OpenAPI
