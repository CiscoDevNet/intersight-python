...
def lazy_import():
    ...
    from intersight.model.storage_hitachi_remote_copy_pair_tc_list import StorageHitachiRemoteCopyPairTcList
    ...
    globals()['StorageHitachiRemoteCopyPairTcList'] = StorageHitachiRemoteCopyPairTcList


class StorageHitachiRemoteCopyPairTcResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'storage.HitachiRemoteCopyPairTc.List': StorageHitachiRemoteCopyPairTcList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """StorageHitachiRemoteCopyPairTcResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'storage.HitachiRemoteCopyPairTc' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'oneOf': [
              ...
              MoDocumentCount,
              MoTagSummary,
              StorageHitachiRemoteCopyPairTcList,
          ],
        }
