...
def lazy_import():
    ...
    globals()['IaasSystemTaskInfoListAllOf'] = IaasSystemTaskInfoListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class IaasSystemTaskInfoList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([IaasSystemTaskInfo], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """IaasSystemTaskInfoList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'iaas.SystemTaskInfo' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
            results ([IaasSystemTaskInfo], none_type): The array of 'iaas.SystemTaskInfo' resources matching the request.. [optional]  # noqa: E501
        """
