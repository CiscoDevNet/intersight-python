...
class HyperflexProtectedClusterAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'protected_datastore_name': (str,),  # noqa: E501
            'protected_vms_count': (int,),  # noqa: E501
            'source_cluster_name': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'protected_datastore_name': 'ProtectedDatastoreName',  # noqa: E501
        'protected_vms_count': 'ProtectedVmsCount',  # noqa: E501
        'source_cluster_name': 'SourceClusterName',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'protected_datastore_name',  # noqa: E501
        'protected_vms_count',  # noqa: E501
        'source_cluster_name',  # noqa: E501
        'target_cluster_name',  # noqa: E501
        'target_datastore_name',  # noqa: E501
        'target_datastore_utilization',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """HyperflexProtectedClusterAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "hyperflex.ProtectedCluster", must be one of ["hyperflex.ProtectedCluster", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "hyperflex.ProtectedCluster", must be one of ["hyperflex.ProtectedCluster", ]  # noqa: E501
            ...
            hx_version (str): Version of the Hyperflex cluster.. [optional]  # noqa: E501
            hypervisor_version (str): The version of hypervisor running on this cluster.. [optional]  # noqa: E501
            protected_datastore_name (str): Name of the protected datastore.. [optional]  # noqa: E501
            protected_vms_count (int): Number of VMs protected on this cluster.. [optional]  # noqa: E501
            source_cluster_name (str): Name of the source cluster.. [optional]  # noqa: E501
        ...
        class_id = "hyperflex.ProtectedCluster" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "hyperflex.ProtectedCluster")
        object_type = "hyperflex.ProtectedCluster" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "hyperflex.ProtectedCluster")
