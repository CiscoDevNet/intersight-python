...
def lazy_import():
    from intersight.model.firmware_secure_router_upgrade_list import FirmwareSecureRouterUpgradeList
    ...
    globals()['FirmwareSecureRouterUpgradeList'] = FirmwareSecureRouterUpgradeList
...
class FirmwareSecureRouterUpgradeResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'firmware.SecureRouterUpgrade.List': FirmwareSecureRouterUpgradeList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FirmwareSecureRouterUpgradeResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'firmware.SecureRouterUpgrade' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'oneOf': [
              FirmwareSecureRouterUpgradeList,
