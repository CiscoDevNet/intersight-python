...
def lazy_import():
    ...
    from intersight.model.servicenow_incident_list import ServicenowIncidentList
    ...
    globals()['ServicenowIncidentList'] = ServicenowIncidentList


class ServicenowIncidentResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'servicenow.Incident.List': ServicenowIncidentList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ServicenowIncidentResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'servicenow.Incident' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
