...
def lazy_import():
    from intersight.model.compute_download_status_all_of import ComputeDownloadStatusAllOf
    from intersight.model.compute_host_utility_operation_relationship import ComputeHostUtilityOperationRelationship
    ...
    from intersight.model.server_migration_key_details_relationship import ServerMigrationKeyDetailsRelationship
    from intersight.model.workflow_workflow_info_relationship import WorkflowWorkflowInfoRelationship
    globals()['ComputeDownloadStatusAllOf'] = ComputeDownloadStatusAllOf
    globals()['ComputeHostUtilityOperationRelationship'] = ComputeHostUtilityOperationRelationship
    ...
    globals()['ServerMigrationKeyDetailsRelationship'] = ServerMigrationKeyDetailsRelationship
    globals()['WorkflowWorkflowInfoRelationship'] = WorkflowWorkflowInfoRelationship


class ComputeDownloadStatus(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'host_op': (ComputeHostUtilityOperationRelationship,),  # noqa: E501
            'migration_key_details': (ServerMigrationKeyDetailsRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'host_op': 'HostOp',  # noqa: E501
        'migration_key_details': 'MigrationKeyDetails',  # noqa: E501
    ...
    read_only_vars = {
        'download_message',  # noqa: E501
        'download_percentage',  # noqa: E501
        'download_stage',  # noqa: E501
        'sd_card_download_error',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ComputeDownloadStatus - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "compute.DownloadStatus", must be one of ["compute.DownloadStatus", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "compute.DownloadStatus", must be one of ["compute.DownloadStatus", ]  # noqa: E501
            ...
            host_op (ComputeHostUtilityOperationRelationship): [optional]  # noqa: E501
            migration_key_details (ServerMigrationKeyDetailsRelationship): [optional]  # noqa: E501
        ...
        class_id = "compute.DownloadStatus" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "compute.DownloadStatus")
        object_type = "compute.DownloadStatus" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "compute.DownloadStatus")
