...
def lazy_import():
    ...
    from intersight.model.server_diagnostic_status_all_of import ServerDiagnosticStatusAllOf
    ...
    globals()['ServerDiagnosticStatusAllOf'] = ServerDiagnosticStatusAllOf
...
class ServerDiagnosticStatus(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ServerDiagnosticStatus - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "server.DiagnosticStatus", must be one of ["server.DiagnosticStatus", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "server.DiagnosticStatus", must be one of ["server.DiagnosticStatus", ]  # noqa: E501
        ...
        class_id = "server.DiagnosticStatus" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "server.DiagnosticStatus")
        object_type = "server.DiagnosticStatus" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "server.DiagnosticStatus")
