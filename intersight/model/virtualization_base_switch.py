...
def lazy_import():
    ...
    globals()['VirtualizationBaseSwitchAllOf'] = VirtualizationBaseSwitchAllOf
...
class VirtualizationBaseSwitch(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """VirtualizationBaseSwitch - a model defined in OpenAPI
