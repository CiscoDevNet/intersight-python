...
class OsConfigurationFileRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'placeholders': ([OsPlaceHolder], none_type,),  # noqa: E501
            'supported': (bool,),  # noqa: E501
            'catalog': (OsCatalogRelationship,),  # noqa: E501
            'distributions': ([HclOperatingSystemRelationship], none_type,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """OsConfigurationFileRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            description (str): Description of the OS ConfigurationFile.. [optional]  # noqa: E501
            file_content (str): The content of the entire configuration file is stored as value. The content can either be a static file content or a template content. The template is expected to conform to the golang template syntax. The values from os.Answers properties will be used to populate this template.. [optional]  # noqa: E501
            internal (bool): The internal flag is set to true when configuration file is uploaded from OS Install wizard. Internal Configuration files will not be displayed in Answer Management Page.. [optional] if omitted the server will use the default value of False  # noqa: E501
            name (str): The name of the OS ConfigurationFile that uniquely identifies the configuration file.. [optional]  # noqa: E501
            placeholders ([OsPlaceHolder], none_type): [optional]  # noqa: E501
            supported (bool): An internal property that is used to distinguish between the pre-canned OS configuration file entries and user provided entries.. [optional]  # noqa: E501
            catalog (OsCatalogRelationship): [optional]  # noqa: E501
            distributions ([HclOperatingSystemRelationship], none_type): An array of relationships to hclOperatingSystem resources.. [optional]  # noqa: E501
