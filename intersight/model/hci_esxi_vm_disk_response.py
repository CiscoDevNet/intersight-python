...
def lazy_import():
    from intersight.model.hci_esxi_vm_disk_list import HciEsxiVmDiskList
    ...
    globals()['HciEsxiVmDiskList'] = HciEsxiVmDiskList
...
class HciEsxiVmDiskResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'hci.EsxiVmDisk.List': HciEsxiVmDiskList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """HciEsxiVmDiskResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'hci.EsxiVmDisk' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
