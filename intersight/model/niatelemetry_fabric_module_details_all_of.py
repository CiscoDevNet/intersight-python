...
class NiatelemetryFabricModuleDetailsAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NiatelemetryFabricModuleDetailsAllOf - a model defined in OpenAPI
        ...
        class_id = "niatelemetry.FabricModuleDetails" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "niatelemetry.FabricModuleDetails")
        object_type = "niatelemetry.FabricModuleDetails" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "niatelemetry.FabricModuleDetails")
