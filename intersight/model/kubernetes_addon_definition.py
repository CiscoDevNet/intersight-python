...
class KubernetesAddonDefinition(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "kubernetes.AddonDefinition" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "kubernetes.AddonDefinition")
        object_type = "kubernetes.AddonDefinition" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "kubernetes.AddonDefinition")
