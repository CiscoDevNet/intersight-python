...
def lazy_import():
    from intersight.model.fmc_domain_list import FmcDomainList
    ...
    globals()['FmcDomainList'] = FmcDomainList
...
class FmcDomainResponse(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FmcDomainResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'fmc.Domain' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
