...
class FabricLinkAggregationPolicyRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'lacp_rate': (str,),  # noqa: E501
            'suspend_individual': (bool,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'suspend_individual': 'SuspendIndividual',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """FabricLinkAggregationPolicyRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            lacp_rate (str): Flag used to indicate whether LACP PDUs are to be sent 'fast', i.e., every 1 second. * `normal` - The expanded 4th generation UCS Fabric Interconnect with 108 ports. * `fast` - The standard 4th generation UCS Fabric Interconnect with 54 ports.. [optional] if omitted the server will use the default value of "normal"  # noqa: E501
            suspend_individual (bool): Flag tells the switch whether to suspend the port if it didn’t receive LACP PDU.. [optional]  # noqa: E501
