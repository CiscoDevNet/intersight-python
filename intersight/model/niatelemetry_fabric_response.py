...
def lazy_import():
    ...
    from intersight.model.niatelemetry_fabric_list import NiatelemetryFabricList
    ...
    globals()['NiatelemetryFabricList'] = NiatelemetryFabricList


class NiatelemetryFabricResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'niatelemetry.Fabric.List': NiatelemetryFabricList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """NiatelemetryFabricResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'niatelemetry.Fabric' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
