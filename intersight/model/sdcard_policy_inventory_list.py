...
def lazy_import():
    ...
    globals()['SdcardPolicyInventoryListAllOf'] = SdcardPolicyInventoryListAllOf


class SdcardPolicyInventoryList(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """SdcardPolicyInventoryList - a model defined in OpenAPI
