...
def lazy_import():
    ...
    globals()['EquipmentFanControlAllOf'] = EquipmentFanControlAllOf
...
class EquipmentFanControl(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentFanControl - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "equipment.FanControl", must be one of ["equipment.FanControl", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "equipment.FanControl", must be one of ["equipment.FanControl", ]  # noqa: E501
            ...
            mode (str): This field identifies the Fan Control Mode on the endpoint. * `Balanced` - Value of Fan Speed is Balanced. * `LowPower` - Value of Fan Speed is LowPower. * `HighPower` - Value of Fan Speed is HighPower. * `MaximumPower` - Value of Fan Speed is MaximumPower. * `MaximumCooling` - Value of Fan Speed is MaximumCooling. * `Acoustic` - Value of Fan Speed is Acoustic.. [optional] if omitted the server will use the default value of "Balanced"  # noqa: E501
        ...
        class_id = "equipment.FanControl" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "equipment.FanControl")
        object_type = "equipment.FanControl" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "equipment.FanControl")
