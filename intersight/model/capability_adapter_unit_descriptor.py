...
class CapabilityAdapterUnitDescriptor(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'is_placement_applicable': (bool,),  # noqa: E501
            'is_secure_boot_supported': (bool,),  # noqa: E501
            'max_eth_rx_ring_size': (int,),  # noqa: E501
            'max_eth_tx_ring_size': (int,),  # noqa: E501
            'max_rocev2_interfaces': (int,),  # noqa: E501
            'num_dce_ports': (int,),  # noqa: E501
            'number_of_pci_links': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'is_placement_applicable': 'IsPlacementApplicable',  # noqa: E501
        'is_secure_boot_supported': 'IsSecureBootSupported',  # noqa: E501
        'max_eth_rx_ring_size': 'MaxEthRxRingSize',  # noqa: E501
        'max_eth_tx_ring_size': 'MaxEthTxRingSize',  # noqa: E501
        'max_rocev2_interfaces': 'MaxRocev2Interfaces',  # noqa: E501
        'num_dce_ports': 'NumDcePorts',  # noqa: E501
        'number_of_pci_links': 'NumberOfPciLinks',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CapabilityAdapterUnitDescriptor - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "capability.AdapterUnitDescriptor", must be one of ["capability.AdapterUnitDescriptor", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "capability.AdapterUnitDescriptor", must be one of ["capability.AdapterUnitDescriptor", ]  # noqa: E501
            ...
            is_placement_applicable (bool): This field determines whether vNICs can be placed to the adapters. It is mandatory for all adapters. For third-party adapters, this field is set to 'false', meaning they will only be inventoried, and no LCP configuration will be applied.. [optional] if omitted the server will use the default value of True  # noqa: E501
            is_secure_boot_supported (bool): Indicates support for secure boot.. [optional] if omitted the server will use the default value of False  # noqa: E501
            max_eth_rx_ring_size (int): Maximum Ring Size value for vNIC Receive Queue.. [optional] if omitted the server will use the default value of 4096  # noqa: E501
            max_eth_tx_ring_size (int): Maximum Ring Size value for vNIC Transmit Queue.. [optional] if omitted the server will use the default value of 4096  # noqa: E501
            ...
            number_of_pci_links (int): Indicates number of PCI Links of the adapter.. [optional] if omitted the server will use the default value of 1  # noqa: E501
        ...
        class_id = "capability.AdapterUnitDescriptor" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "capability.AdapterUnitDescriptor")
        object_type = "capability.AdapterUnitDescriptor" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "capability.AdapterUnitDescriptor")
