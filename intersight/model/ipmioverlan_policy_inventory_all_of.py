...
class IpmioverlanPolicyInventoryAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IpmioverlanPolicyInventoryAllOf - a model defined in OpenAPI
        ...
        class_id = "ipmioverlan.PolicyInventory" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "ipmioverlan.PolicyInventory")
        object_type = "ipmioverlan.PolicyInventory" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "ipmioverlan.PolicyInventory")
