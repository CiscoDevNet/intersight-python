...
def lazy_import():
    ...
    from intersight.model.resource_shared_resources_info_holder_list import ResourceSharedResourcesInfoHolderList
    ...
    globals()['ResourceSharedResourcesInfoHolderList'] = ResourceSharedResourcesInfoHolderList


class ResourceSharedResourcesInfoHolderResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'resource.SharedResourcesInfoHolder.List': ResourceSharedResourcesInfoHolderList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ResourceSharedResourcesInfoHolderResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'resource.SharedResourcesInfoHolder' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
