...
def lazy_import():
    ...
    globals()['VirtualizationHostAllOf'] = VirtualizationHostAllOf
    globals()['WorkflowWorkflowInfoRelationship'] = WorkflowWorkflowInfoRelationship


class VirtualizationHost(ModelComposed):
    ...
    allowed_values = {
        ...
        ('action',): {
            'NONE': "None",
            'ENTERMAINTENANCEMODE': "EnterMaintenanceMode",
            'EXITMAINTENANCEMODE': "ExitMaintenanceMode",
            'POWEROFFSTORAGECONTROLLER': "PowerOffStorageController",
            'POWERONSTORAGECONTROLLER': "PowerOnStorageController",
        },
        ('hypervisor_type',): {
            'ESXI': "ESXi",
            'HYPER-V': "Hyper-V",
    ...
    def openapi_types():
        ...
        return {
            ...
            'evacuate': (bool,),  # noqa: E501
            'host_config': (VirtualizationBaseHostConfiguration,),  # noqa: E501
            ...
            'inventory': (VirtualizationBaseHostRelationship,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VirtualizationHost - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "virtualization.Host", must be one of ["virtualization.Host", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "virtualization.Host", must be one of ["virtualization.Host", ]  # noqa: E501
            ...
            action (str): Action to be performed on a host (Create, PowerState, Migrate, Clone etc). * `None` - A place holder for the default value. * `EnterMaintenanceMode` - Put a host into maintenance mode. * `ExitMaintenanceMode` - Put a host into active mode. * `PowerOffStorageController` - Power off HyperFlex storage controller node running on selected hypervisor host. * `PowerOnStorageController` - Power on HyperFlex storage controller node running on selected hypervisor host.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            discovered (bool): Flag to indicate whether the configuration is created from inventory object.. [optional]  # noqa: E501
            evacuate (bool): If true, move powered-off and suspended virtual machines to other hosts in the cluster.. [optional]  # noqa: E501
            host_config (VirtualizationBaseHostConfiguration): [optional]  # noqa: E501
            ...
            identity (str): Unique identifier assigned to the hypervisor host.. [optional]  # noqa: E501
            ...
            name (str): Name of the hypervisor host. It must be unique within the target endpoint.. [optional]  # noqa: E501
            ...
            inventory (VirtualizationBaseHostRelationship): [optional]  # noqa: E501
        ...
        class_id = "virtualization.Host" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "virtualization.Host")
        object_type = "virtualization.Host" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "virtualization.Host")
