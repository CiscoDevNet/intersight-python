...
class IamAbstractClientApplicationRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'app_credentials': (IamAppCredentials,),  # noqa: E501
            'auth_type': (str,),  # noqa: E501
            'credentials_action': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'display_names': 'DisplayNames',  # noqa: E501
        'app_credentials': 'AppCredentials',  # noqa: E501
        'auth_type': 'AuthType',  # noqa: E501
        'credentials_action': 'CredentialsAction',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IamAbstractClientApplicationRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            app_credentials (IamAppCredentials): [optional]  # noqa: E501
            auth_type (str): Type of authentication used by the clientApp. * `basic` - The client uses basic username/password authentication. The password is expected to be a JWT token. * `none` - No authentication method specified by the client. * `bearer-token` - The client uses a long-lived bearer token to authenticate. * `auth-code` - The client uses OAuth Authorization Grant Flow without PKCE for authentication. * `client-credentials` - The client uses OAuth Client Credentials Flow for authentication.. [optional] if omitted the server will use the default value of "basic"  # noqa: E501
            credentials_action (str): An action to be performed on the credentials. * `none` - No action to be performed. * `regenerateCredentials` - Allows for revocation and regeneration of a token. The old token associated with the client application. will not be usable and a new token will be generated.. [optional] if omitted the server will use the default value of "none"  # noqa: E501
