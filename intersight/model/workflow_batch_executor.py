...
def lazy_import():
    ...
    globals()['WorkflowBatchExecutorAllOf'] = WorkflowBatchExecutorAllOf
...
class WorkflowBatchExecutor(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'ANSIBLEBATCHEXECUTOR': "workflow.AnsibleBatchExecutor",
            'BATCHAPIEXECUTOR': "workflow.BatchApiExecutor",
            'POWERSHELLBATCHAPIEXECUTOR': "workflow.PowerShellBatchApiExecutor",
            'SSHBATCHEXECUTOR': "workflow.SshBatchExecutor",
        },
        ('object_type',): {
            'ANSIBLEBATCHEXECUTOR': "workflow.AnsibleBatchExecutor",
            'BATCHAPIEXECUTOR': "workflow.BatchApiExecutor",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """WorkflowBatchExecutor - a model defined in OpenAPI
