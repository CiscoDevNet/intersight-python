...
def lazy_import():
    ...
    from intersight.model.workload_workload_deployment_list import WorkloadWorkloadDeploymentList
    ...
    globals()['WorkloadWorkloadDeploymentList'] = WorkloadWorkloadDeploymentList


class WorkloadWorkloadDeploymentResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'workload.WorkloadDeployment.List': WorkloadWorkloadDeploymentList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """WorkloadWorkloadDeploymentResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'workload.WorkloadDeployment' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
