...
def lazy_import():
    ...
    from intersight.model.notification_http_header import NotificationHttpHeader
    globals()['AssetCredential'] = AssetCredential
    globals()['NotificationHttpHeader'] = NotificationHttpHeader
...
class NotificationTriggerWebhookAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'authentication': (AssetCredential,),  # noqa: E501
            'clear_secret': (bool,),  # noqa: E501
            'custom_headers': ([NotificationHttpHeader], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'clear_secret': 'ClearSecret',  # noqa: E501
        'custom_headers': 'CustomHeaders',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            authentication (AssetCredential): [optional]  # noqa: E501
            clear_secret (bool): When set to true on update, the HMAC shared secret is not carried over from the previous stored action when the request omits the write-only ``secret`` field. Use this to clear the signing key without re-sending a secret value. When false or not set, the prior behavior applies: the previous secret is preserved on PATCH if ``secret`` is omitted.. [optional] if omitted the server will use the default value of False  # noqa: E501
            custom_headers ([NotificationHttpHeader], none_type): [optional]  # noqa: E501
