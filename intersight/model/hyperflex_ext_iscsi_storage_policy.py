...
class HyperflexExtIscsiStoragePolicy(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            admin_state (bool): Enable or disable external iSCSI storage configuration.. [optional]  # noqa: E501
        ...
        class_id = "hyperflex.ExtIscsiStoragePolicy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "hyperflex.ExtIscsiStoragePolicy")
        object_type = "hyperflex.ExtIscsiStoragePolicy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "hyperflex.ExtIscsiStoragePolicy")
