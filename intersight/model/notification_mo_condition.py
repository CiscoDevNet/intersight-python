...
def lazy_import():
    ...
    globals()['NotificationMoConditionAllOf'] = NotificationMoConditionAllOf


class NotificationMoCondition(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'odata_filter': (str,),  # noqa: E501
            'enabled': (bool,),  # noqa: E501
            'mo_type': (str,),  # noqa: E501
            'operations': ([str], none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'odata_filter': 'OdataFilter',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            enabled (bool): The condition can be switched on/off with out necessity to change the subscription settings: actions, conditions, etc. Ex.: Subscription MO can be configured, but switched off.. [optional] if omitted the server will use the default value of True  # noqa: E501
            mo_type (str): MoType for which the condition is created.. [optional]  # noqa: E501
            operations ([str], none_type): [optional]  # noqa: E501
        """

        class_id = "notification.MoCondition" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "notification.MoCondition")
        object_type = "notification.MoCondition" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "notification.MoCondition")
