...
class LicenseIwoCustomerOpAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'active_license_type': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'active_license_type': 'ActiveLicenseType',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """LicenseIwoCustomerOpAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "license.IwoCustomerOp", must be one of ["license.IwoCustomerOp", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "license.IwoCustomerOp", must be one of ["license.IwoCustomerOp", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "license.IwoCustomerOp")
        object_type = kwargs.get('object_type', "license.IwoCustomerOp")
