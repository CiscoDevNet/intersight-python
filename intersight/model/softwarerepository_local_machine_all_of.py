...
class SoftwarerepositoryLocalMachineAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SoftwarerepositoryLocalMachineAllOf - a model defined in OpenAPI
        ...
        class_id = "softwarerepository.LocalMachine" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "softwarerepository.LocalMachine")
        object_type = "softwarerepository.LocalMachine" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "softwarerepository.LocalMachine")
