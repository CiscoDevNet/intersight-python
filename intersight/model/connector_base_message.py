...
def lazy_import():
    ...
    from intersight.model.connector_encryption_task_message import ConnectorEncryptionTaskMessage
    ...
    globals()['ConnectorEncryptionTaskMessage'] = ConnectorEncryptionTaskMessage
...
class ConnectorBaseMessage(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'connector.EncryptionTaskMessage': ConnectorEncryptionTaskMessage,
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """ConnectorBaseMessage - a model defined in OpenAPI
