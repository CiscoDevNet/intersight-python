...
def lazy_import():
    from intersight.model.hci_physical_gpu_list import HciPhysicalGpuList
    ...
    globals()['HciPhysicalGpuList'] = HciPhysicalGpuList
...
class HciPhysicalGpuResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'hci.PhysicalGpu.List': HciPhysicalGpuList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """HciPhysicalGpuResponse - a model defined in OpenAPI
