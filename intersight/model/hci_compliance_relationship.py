...
class HciComplianceRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'non_compliance_count': (int,),  # noqa: E501
            'services': ([HciLicensedService], none_type,),  # noqa: E501
            'type': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'non_compliance_count': 'NonComplianceCount',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'non_compliance_count',  # noqa: E501
        'type',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """HciComplianceRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            cluster_ext_id (str): The identifier of a license, usually in LIC-xxxx format.. [optional]  # noqa: E501
            compliance_state (str): The compliance state of the cluster. The compliance state is determined based on the nonComplianceCount and the license enforcement policy. * `NotEnforced` - The license compliance state for a Nutanix cluster is neither in=compliance nor not in-compliance.Typically, when a license is not installed on a cluster, or the license enformancement is explicitlyturned off, the cluster is in this state. * `InCompliance` - The license compliance state for a Nutanix cluster is in compliance. * `NotInCompliance` - The license compliance state for a Nutanix cluster is not in compliance.. [optional] if omitted the server will use the default value of "NotEnforced"  # noqa: E501
            non_compliance_count (int): Total number of services that are not in-compliance. A count of 0 does not necessarily mean in compliance. Depending on 'complianceState', the cluster could be either be in compliance or the license check is not enforced. A synthesized property for the services property for ease of querying.. [optional]  # noqa: E501
            services ([HciLicensedService], none_type): [optional]  # noqa: E501
            type (str): The type of the cluster which could be NUTANIX, VMWARE, or NON_NUTANIX.. [optional]  # noqa: E501
