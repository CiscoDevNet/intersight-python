...
def lazy_import():
    ...
    globals()['FabricConfigResultEntryAllOf'] = FabricConfigResultEntryAllOf
    globals()['FabricConfigResultRelationship'] = FabricConfigResultRelationship
...
class FabricConfigResultEntry(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'config_result': (FabricConfigResultRelationship,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """FabricConfigResultEntry - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "fabric.ConfigResultEntry", must be one of ["fabric.ConfigResultEntry", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "fabric.ConfigResultEntry", must be one of ["fabric.ConfigResultEntry", ]  # noqa: E501
            ...
            config_result (FabricConfigResultRelationship): [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "fabric.ConfigResultEntry")
        object_type = kwargs.get('object_type', "fabric.ConfigResultEntry")
