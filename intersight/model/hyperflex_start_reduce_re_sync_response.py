...
def lazy_import():
    from intersight.model.hyperflex_start_reduce_re_sync_list import HyperflexStartReduceReSyncList
    ...
    globals()['HyperflexStartReduceReSyncList'] = HyperflexStartReduceReSyncList
...
class HyperflexStartReduceReSyncResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'hyperflex.StartReduceReSync.List': HyperflexStartReduceReSyncList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """HyperflexStartReduceReSyncResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'hyperflex.StartReduceReSync' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
