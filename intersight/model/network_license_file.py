...
def lazy_import():
    ...
    globals()['NetworkLicenseFileAllOf'] = NetworkLicenseFileAllOf


class NetworkLicenseFile(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NetworkLicenseFile - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "network.LicenseFile", must be one of ["network.LicenseFile", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "network.LicenseFile", must be one of ["network.LicenseFile", ]  # noqa: E501
            ...
            expiry_date (str): The expiry date of the license feature.. [optional]  # noqa: E501
            feature_name (str): The name of the license feature.. [optional]  # noqa: E501
            file_id (str): The file Id of the license file.. [optional]  # noqa: E501
            host_id (str): The identifier to identify license host Id.. [optional]  # noqa: E501
            vendor (str): The vendor of the license.. [optional]  # noqa: E501
        ...
        class_id = "network.LicenseFile" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "network.LicenseFile")
        object_type = "network.LicenseFile" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "network.LicenseFile")
