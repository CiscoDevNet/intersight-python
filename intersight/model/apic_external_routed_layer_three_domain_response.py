...
def lazy_import():
    from intersight.model.apic_external_routed_layer_three_domain_list import ApicExternalRoutedLayerThreeDomainList
    ...
    globals()['ApicExternalRoutedLayerThreeDomainList'] = ApicExternalRoutedLayerThreeDomainList
...
class ApicExternalRoutedLayerThreeDomainResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'apic.ExternalRoutedLayerThreeDomain.List': ApicExternalRoutedLayerThreeDomainList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ApicExternalRoutedLayerThreeDomainResponse - a model defined in OpenAPI
