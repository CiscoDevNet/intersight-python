...
def lazy_import():
    ...
    globals()['FirmwareChassisUpgradeAllOf'] = FirmwareChassisUpgradeAllOf
...
class FirmwareChassisUpgrade(ModelComposed):
    ...
    allowed_values = {
        ...
        ('xfm_upgrade_option',): {
            ...
            'PARTIAL-SHUTDOWN': "partial-shutdown",
        },
        ('status',): {
            'NONE': "NONE",
    ...
    def openapi_types():
        ...
        return {
            ...
            'chassis_name': (str,),  # noqa: E501
            'exclude_component_list': ([str], none_type,),  # noqa: E501
            'xfm_upgrade_option': (str,),  # noqa: E501
            'chassis': (EquipmentChassisRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'xfm_upgrade_option': 'XfmUpgradeOption',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FirmwareChassisUpgrade - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "firmware.ChassisUpgrade", must be one of ["firmware.ChassisUpgrade", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "firmware.ChassisUpgrade", must be one of ["firmware.ChassisUpgrade", ]  # noqa: E501
            ...
            chassis_name (str): Name of the chassis on which the firmware upgrade operation is performed.. [optional]  # noqa: E501
            exclude_component_list ([str], none_type): [optional]  # noqa: E501
            xfm_upgrade_option (str): XFM upgrade option Full or Partial Disruption. * `none` - If no option is selected for exclusion. * `full-shutdown` - PSX Switch in XFM will be upgraded in single action. * `partial-shutdown` - PSX Switch in XFM will be upgraded one after other.. [optional] if omitted the server will use the default value of "none"  # noqa: E501
        ...
        class_id = "firmware.ChassisUpgrade" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "firmware.ChassisUpgrade")
        object_type = "firmware.ChassisUpgrade" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "firmware.ChassisUpgrade")
