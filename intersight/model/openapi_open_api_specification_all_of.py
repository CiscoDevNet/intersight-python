...
class OpenapiOpenApiSpecificationAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OpenapiOpenApiSpecificationAllOf - a model defined in OpenAPI
        ...
        class_id = "openapi.OpenApiSpecification" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "openapi.OpenApiSpecification")
        object_type = "openapi.OpenApiSpecification" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "openapi.OpenApiSpecification")
