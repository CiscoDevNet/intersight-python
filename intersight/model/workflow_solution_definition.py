...
def lazy_import():
    ...
    from intersight.model.workflow_solution_action_definition_relationship import WorkflowSolutionActionDefinitionRelationship
    from intersight.model.workflow_solution_definition_all_of import WorkflowSolutionDefinitionAllOf
    ...
    globals()['WorkflowSolutionActionDefinitionRelationship'] = WorkflowSolutionActionDefinitionRelationship
    globals()['WorkflowSolutionDefinitionAllOf'] = WorkflowSolutionDefinitionAllOf


class WorkflowSolutionDefinition(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'allow_multiple_solution_instances': (bool,),  # noqa: E501
            ...
            'upgraded_moid': (str,),  # noqa: E501
            'version': (int,),  # noqa: E501
            'action_definitions': ([WorkflowSolutionActionDefinitionRelationship], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'allow_multiple_solution_instances': 'AllowMultipleSolutionInstances',  # noqa: E501
        ...
        'upgraded_moid': 'UpgradedMoid',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """WorkflowSolutionDefinition - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "workflow.SolutionDefinition", must be one of ["workflow.SolutionDefinition", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "workflow.SolutionDefinition", must be one of ["workflow.SolutionDefinition", ]  # noqa: E501
            ...
            allow_multiple_solution_instances (bool): Solution definition can declare that only one instance can be allowed within the customer account.. [optional] if omitted the server will use the default value of True  # noqa: E501
            cvd_id (str): The Cisco Validated Design (CVD) Identifier that this solution provides.. [optional]  # noqa: E501
            delete_instance_on_decommission (bool): The flag to indicate that solution instance will be deleted after the completion of decommission action.. [optional] if omitted the server will use the default value of False  # noqa: E501
            description (str): The description for this solution which provides information on what are the pre-requisites to deploy the solution and what features are supported on the solution.. [optional]  # noqa: E501
            label (str): A user friendly short name to identify the solution. Name can only contain letters (a-z, A-Z), numbers (0-9), hyphen (-), period (.), colon (:), space ( ) or an underscore (_).. [optional]  # noqa: E501
            license_entitlement (str): License entitlement required to run this solution. * `Base` - Base as a License type. It is default license type. * `Essential` - Essential as a License type. * `Standard` - Standard as a License type. * `Advantage` - Advantage as a License type. * `Premier` - Premier as a License type. * `IWO-Essential` - IWO-Essential as a License type. * `IWO-Advantage` - IWO-Advantage as a License type. * `IWO-Premier` - IWO-Premier as a License type. * `IKS-Advantage` - IKS-Advantage as a License type. * `INC-Premier-1GFixed` - Premier 1G Fixed license tier for Intersight Nexus Cloud. * `INC-Premier-10GFixed` - Premier 10G Fixed license tier for Intersight Nexus Cloud. * `INC-Premier-100GFixed` - Premier 100G Fixed license tier for Intersight Nexus Cloud. * `INC-Premier-Mod4Slot` - Premier Modular 4 slot license tier for Intersight Nexus Cloud. * `INC-Premier-Mod8Slot` - Premier Modular 8 slot license tier for Intersight Nexus Cloud. * `INC-Premier-D2OpsFixed` - Premier D2Ops fixed license tier for Intersight Nexus Cloud. * `INC-Premier-D2OpsMod` - Premier D2Ops modular license tier for Intersight Nexus Cloud. * `INC-Premier-CentralizedMod8Slot` - Premier modular license tier of switch type CentralizedMod8Slot for Intersight Nexus Cloud. * `INC-Premier-DistributedMod8Slot` - Premier modular license tier of switch type DistributedMod8Slot for Intersight Nexus Cloud. * `IntersightTrial` - Virtual dummy license type to indicate trial. Used for UI display of trial mode Intersight tiers. * `IWOTrial` - Virtual dummy license type to indicate trial. Used for UI display of trial mode IKS tiers. * `IKSTrial` - Virtual dummy license type to indicate trial. Used for UI display of trial mode IWO tiers. * `INCTrial` - Virtual dummy license type to indicate trial. Used for UI display of trial mode Nexus tiers.. [optional] if omitted the server will use the default value of "Base"  # noqa: E501
            name (str): The name for this solution definition. You can have multiple versions of the solution with the same name. Name can only contain letters (a-z, A-Z), numbers (0-9), hyphen (-), period (.), colon (:) or an underscore (_).. [optional]  # noqa: E501
            output_definition ([WorkflowBaseDataType], none_type): [optional]  # noqa: E501
            upgraded_moid (str): Stores the upgraded Moid for help during future lookups.. [optional]  # noqa: E501
            version (int): The version of the solution to support multiple versions.. [optional] if omitted the server will use the default value of 1  # noqa: E501
            action_definitions ([WorkflowSolutionActionDefinitionRelationship], none_type): An array of relationships to workflowSolutionActionDefinition resources.. [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "workflow.SolutionDefinition")
        object_type = kwargs.get('object_type', "workflow.SolutionDefinition")
