...
def lazy_import():
    ...
    from intersight.model.ether_inter_switch_port_relationship import EtherInterSwitchPortRelationship
    ...
    globals()['EtherInterSwitchPortRelationship'] = EtherInterSwitchPortRelationship
...
class EquipmentSwitchCard(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'inter_switch_port': (EtherInterSwitchPortRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'inter_switch_port': 'InterSwitchPort',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            slot_id (int): Slot identifier of the SwitchCard within the Switch.. [optional]  # noqa: E501
            ...
            stp_mode (str): Spanning Tree Protocol configuration for the switch. * `Disabled` - Spanning Tree Protocol (STP) is disabled. * `STP` - Spanning Tree Protocol (STP) is enabled and operating in STP. * `RSTP` - Spanning Tree Protocol (STP) is enabled and operating in RSTP mode. * `MSTP` - Spanning Tree Protocol (STP) is enabled and operating in MSTP mode. * `PVST+` - Spanning Tree Protocol (STP) is enabled and operating in PVST mode. * `RPVST+` - Spanning Tree Protocol (STP) is enabled and operating in RPVST mode.. [optional] if omitted the server will use the default value of "Disabled"  # noqa: E501
            ...
            inter_switch_port (EtherInterSwitchPortRelationship): [optional]  # noqa: E501
