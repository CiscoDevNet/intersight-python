...
class WorkloadBlueprintInputReference(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'BLUEPRINTINPUTREFERENCE': "workload.BlueprintInputReference",
            'BLUEPRINTREFERENCE': "workload.BlueprintReference",
            'DEPLOYMENTBLUEPRINTINPUTTYPE': "workload.DeploymentBlueprintInputType",
        },
        ('object_type',): {
            'BLUEPRINTINPUTREFERENCE': "workload.BlueprintInputReference",
            'BLUEPRINTREFERENCE': "workload.BlueprintReference",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """WorkloadBlueprintInputReference - a model defined in OpenAPI
