...
def lazy_import():
    ...
    from intersight.model.scheduler_base_monthly_cadence_params_all_of import SchedulerBaseMonthlyCadenceParamsAllOf
    ...
    globals()['SchedulerBaseMonthlyCadenceParamsAllOf'] = SchedulerBaseMonthlyCadenceParamsAllOf
    globals()['SchedulerMonthlyCadenceParams'] = SchedulerMonthlyCadenceParams


class SchedulerBaseMonthlyCadenceParams(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SchedulerBaseMonthlyCadenceParams - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "scheduler.MonthlyCadenceParams", must be one of ["scheduler.MonthlyCadenceParams", ]  # noqa: E501
            ...
            run_every (int): Run every month by default if not specified.. [optional] if omitted the server will use the default value of 1  # noqa: E501
        """
