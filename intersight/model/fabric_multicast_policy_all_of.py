...
class FabricMulticastPolicyAllOf(ModelNormal):
    ...
    attribute_map = {
        ...
        'src_ip_proxy': 'SrcIpProxy',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FabricMulticastPolicyAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            src_ip_proxy (str): Administrative state of the IGMP source IP proxy for this VLAN. * `Enabled` - Admin configured Enabled State. * `Disabled` - Admin configured Disabled State.. [optional] if omitted the server will use the default value of "Enabled"  # noqa: E501
            organization (OrganizationOrganizationRelationship): [optional]  # noqa: E501
        """

        class_id = "fabric.MulticastPolicy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "fabric.MulticastPolicy")
        object_type = "fabric.MulticastPolicy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "fabric.MulticastPolicy")
