...
def lazy_import():
    ...
    globals()['InventoryGenericInventoryHolderAllOf'] = InventoryGenericInventoryHolderAllOf
...
class InventoryGenericInventoryHolder(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """InventoryGenericInventoryHolder - a model defined in OpenAPI
        ...
        class_id = "inventory.GenericInventoryHolder" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "inventory.GenericInventoryHolder")
        object_type = "inventory.GenericInventoryHolder" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "inventory.GenericInventoryHolder")
