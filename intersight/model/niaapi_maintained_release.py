...
def lazy_import():
    ...
    globals()['NiaapiMaintainedReleaseAllOf'] = NiaapiMaintainedReleaseAllOf


class NiaapiMaintainedRelease(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """NiaapiMaintainedRelease - a model defined in OpenAPI
