...
def lazy_import():
    ...
    globals()['BootUefiShellDeviceAllOf'] = BootUefiShellDeviceAllOf
...
class BootUefiShellDevice(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """BootUefiShellDevice - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "boot.UefiShellDevice", must be one of ["boot.UefiShellDevice", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "boot.UefiShellDevice", must be one of ["boot.UefiShellDevice", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "boot.UefiShellDevice")
        object_type = kwargs.get('object_type', "boot.UefiShellDevice")
