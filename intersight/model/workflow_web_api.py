...
def lazy_import():
    ...
    globals()['WorkflowWebApiAllOf'] = WorkflowWebApiAllOf


class WorkflowWebApi(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'cookies': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'endpoint_request_type': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'endpoint_request_type': 'EndpointRequestType',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """WorkflowWebApi - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "workflow.WebApi", must be one of ["workflow.WebApi", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "workflow.WebApi", must be one of ["workflow.WebApi", ]  # noqa: E501
            ...
            cookies (bool, date, datetime, dict, float, int, list, str, none_type): Collection of key value pairs to set in the request header as Cookie list.. [optional]  # noqa: E501
            endpoint_request_type (str): If the target type is Endpoint, this property determines whether the request is to be handled as internal request or external request by the device connector. * `Internal` - The endpoint API executed is an internal request handled by the device connector plugin. * `External` - The endpoint API request is passed through by the device connector.. [optional] if omitted the server will use the default value of "Internal"  # noqa: E501
            ...
            method (str): The HTTP method to be executed in the given URL (GET, POST, PUT, etc). If the value is not specified, GET will be used as default. The supported values are GET, POST, PUT, DELETE, PATCH, HEAD.. [optional]  # noqa: E501
            mo_type (str): The type of the intersight object for which API request is to be made. The property is valid in case of Intersight API calls and the base url is automatically prepended based on the value.. [optional]  # noqa: E501
            protocol (str): The accepted web protocol values are http and https.. [optional]  # noqa: E501
            target_type (str): If the web API is to be executed in a remote device connected to the Intersight through device connector, 'Endpoint' is expected as the value whereas if the API is an Intersight API, 'Local' is expected as the value.. [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "workflow.WebApi")
        object_type = kwargs.get('object_type', "workflow.WebApi")
