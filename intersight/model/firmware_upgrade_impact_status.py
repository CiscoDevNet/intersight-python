...
def lazy_import():
    ...
    globals()['FirmwareUpgradeImpactStatusAllOf'] = FirmwareUpgradeImpactStatusAllOf
    globals()['MoBaseMoRelationship'] = MoBaseMoRelationship
    globals()['MoTag'] = MoTag
    globals()['MoVersionContext'] = MoVersionContext


class FirmwareUpgradeImpactStatus(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """FirmwareUpgradeImpactStatus - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "firmware.UpgradeImpactStatus", must be one of ["firmware.UpgradeImpactStatus", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "firmware.UpgradeImpactStatus", must be one of ["firmware.UpgradeImpactStatus", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "firmware.UpgradeImpactStatus")
        object_type = kwargs.get('object_type', "firmware.UpgradeImpactStatus")
