...
class FirmwareUpgradeImpactStatus(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "firmware.UpgradeImpactStatus" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "firmware.UpgradeImpactStatus")
        object_type = "firmware.UpgradeImpactStatus" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "firmware.UpgradeImpactStatus")
