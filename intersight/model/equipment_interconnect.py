...
def lazy_import():
    ...
    from intersight.model.equipment_interconnect_all_of import EquipmentInterconnectAllOf
    ...
    globals()['EquipmentInterconnectAllOf'] = EquipmentInterconnectAllOf
...
class EquipmentInterconnect(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'interconnect_id': (str,),  # noqa: E501
            'interconnect_type': (str,),  # noqa: E501
            'compute_board': (ComputeBoardRelationship,),  # noqa: E501
            'interconnected_graphics_cards': ([GraphicsCardRelationship], none_type,),  # noqa: E501
            'interconnected_shared_graphics_cards': ([EquipmentSharedGraphicsCardRelationship], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'interconnect_id': 'InterconnectId',  # noqa: E501
        'interconnect_type': 'InterconnectType',  # noqa: E501
        'compute_board': 'ComputeBoard',  # noqa: E501
        'interconnected_graphics_cards': 'InterconnectedGraphicsCards',  # noqa: E501
        'interconnected_shared_graphics_cards': 'InterconnectedSharedGraphicsCards',  # noqa: E501
    ...
    read_only_vars = {
        'interconnect_id',  # noqa: E501
        'interconnect_type',  # noqa: E501
        'interconnected_graphics_cards',  # noqa: E501
        'interconnected_shared_graphics_cards',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentInterconnect - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "equipment.Interconnect", must be one of ["equipment.Interconnect", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "equipment.Interconnect", must be one of ["equipment.Interconnect", ]  # noqa: E501
            ...
            interconnect_id (str): The identifier of the interconnect.. [optional]  # noqa: E501
            interconnect_type (str): Type of interconnectivity provided by this interconnect. * `Unknown` - Interconnect type is unknown. * `NVLink` - Interconnect type is NVLink.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
            compute_board (ComputeBoardRelationship): [optional]  # noqa: E501
            interconnected_graphics_cards ([GraphicsCardRelationship], none_type): An array of relationships to graphicsCard resources.. [optional]  # noqa: E501
            interconnected_shared_graphics_cards ([EquipmentSharedGraphicsCardRelationship], none_type): An array of relationships to equipmentSharedGraphicsCard resources.. [optional]  # noqa: E501
        ...
        class_id = "equipment.Interconnect" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "equipment.Interconnect")
        object_type = "equipment.Interconnect" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "equipment.Interconnect")
