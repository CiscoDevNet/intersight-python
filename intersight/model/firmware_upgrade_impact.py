...
class FirmwareUpgradeImpact(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'network_secure_router': ([NetworkSecureRouterRelationship], none_type,),  # noqa: E501
            'pci_node': ([PciNodeRelationship], none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            network_secure_router ([NetworkSecureRouterRelationship], none_type): An array of relationships to networkSecureRouter resources.. [optional]  # noqa: E501
            pci_node ([PciNodeRelationship], none_type): An array of relationships to pciNode resources.. [optional]  # noqa: E501
        ...
        class_id = "firmware.UpgradeImpact" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "firmware.UpgradeImpact")
        object_type = "firmware.UpgradeImpact" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "firmware.UpgradeImpact")
