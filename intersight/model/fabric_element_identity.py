...
def lazy_import():
    ...
    globals()['FabricElementIdentityAllOf'] = FabricElementIdentityAllOf
...
class FabricElementIdentity(ModelComposed):
    ...
    allowed_values = {
        ...
        ('post_deploy_action',): {
            'None': None,
            'NONE': "None",
            'TRIGGERPRIMARYCHASSISDISCOVERY': "TriggerPrimaryChassisDiscovery",
        },
        ('replacement_type',): {
            'NONE': "None",
        ...
        ('lifecycle',): {
            ...
            'REPLACEMENTPENDINGUSERACTION': "ReplacementPendingUserAction",
            'REMOVED': "Removed",
            'MOVED': "Moved",
            'REPLACED': "Replaced",
            'MOVEDANDREPLACED': "MovedAndReplaced",
            'DOMAINRMAPENDINGUSERACTION': "DomainRmaPendingUserAction",
    ...
    def openapi_types():
        ...
        return {
            ...
            'partial_deployment_status': (str,),  # noqa: E501
            'post_deploy_action': ([str], none_type,),  # noqa: E501
            'replacement_type': (str,),  # noqa: E501
            'switch_id': (str,),  # noqa: E501
            'network_element': (NetworkElementRelationship,),  # noqa: E501
            'replacement_target': (NetworkElementRelationship,),  # noqa: E501
            ...
            'lifecycle_mod_time': (datetime,),  # noqa: E501
            'model': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'partial_deployment_status': 'PartialDeploymentStatus',  # noqa: E501
        'post_deploy_action': 'PostDeployAction',  # noqa: E501
        'replacement_type': 'ReplacementType',  # noqa: E501
        'switch_id': 'SwitchId',  # noqa: E501
        'network_element': 'NetworkElement',  # noqa: E501
        'replacement_target': 'ReplacementTarget',  # noqa: E501
        ...
        'lifecycle_mod_time': 'LifecycleModTime',  # noqa: E501
    ...
    read_only_vars = {
        'domain',  # noqa: E501
        'partial_deployment_status',  # noqa: E501
        'switch_id',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FabricElementIdentity - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "fabric.ElementIdentity", must be one of ["fabric.ElementIdentity", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "fabric.ElementIdentity", must be one of ["fabric.ElementIdentity", ]  # noqa: E501
            ...
            domain (str): Name of the Fabric Interconnect domain.. [optional]  # noqa: E501
            partial_deployment_status (str): Determines if there is partial configuration that has to be deployed on any of the server profiles associated with the server connected to the Fabric Interconnect in cases where one or more server profiles  was deployed when the Fabric Interconnect was down. * `None` - No configuration which is yet to be deployed.The default state of a fabric interconnect which does not have any pending deployment. * `Pending` - There is pending configuration which is yet to be deployed on the fabric interconnect. * `Deploying` - Pending configuration is being deployed on the fabric interconnect.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            post_deploy_action ([str], none_type): [optional]  # noqa: E501
            replacement_type (str): Replacement type specifies whether it is single FI or domain replacement. * `None` - The default action is none. * `Individual` - Replacement of single network element. * `Domain` - Domain indicates the replacement of Fabric Interconnect domain.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            switch_id (str): Switch Identifier that uniquely represents the fabric object. * `A` - Switch Identifier of Fabric Interconnect A. * `B` - Switch Identifier of Fabric Interconnect B.. [optional] if omitted the server will use the default value of "A"  # noqa: E501
            network_element (NetworkElementRelationship): [optional]  # noqa: E501
            replacement_target (NetworkElementRelationship): [optional]  # noqa: E501
        ...
        class_id = "fabric.ElementIdentity" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "fabric.ElementIdentity")
        object_type = "fabric.ElementIdentity" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "fabric.ElementIdentity")
