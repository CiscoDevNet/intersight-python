...
class FabricElementIdentity(ModelComposed):
    ...
    allowed_values = {
        ...
        ('admin_action',): {
            ...
            'REMOVE': "Remove",
            'REPLACE': "Replace",
            'DECOMMISSIONANDREMOVE': "DecommissionAndRemove",
        },
        ('admin_action_state',): {
            'NONE': "None",
            'APPLIED': "Applied",
        ...
        ('lifecycle',): {
            ...
            'RESTORECONFIGINPROGRESS': "RestoreConfigInProgress",
