...
class IamPrivilegeSetRelationship(ModelComposed):
    ...
    validations = {
        ('name',): {
            ...
            'min_length': 1,
            'regex': {
                'pattern': r'^[a-zA-Z0-9_ .:,()&\/-]{1,128}$',  # noqa: E501
            },
        },
        ('uuid',): {
            'max_length': 128,
            'min_length': 0,
            'regex': {
                'pattern': r'^[a-zA-Z0-9_ .:,-]{0,128}$',  # noqa: E501
            },
        },
    }
    ...
    def openapi_types():
        ...
        return {
            ...
            'allow_future_updates': (bool,),  # noqa: E501
            'description': (str,),  # noqa: E501
            'is_privilege_names_updated': (bool,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'privilege_names': ([str], none_type,),  # noqa: E501
            'privilege_set_type': (str,),  # noqa: E501
            'scope': (str,),  # noqa: E501
            'uuid': (str,),  # noqa: E501
            'account': (IamAccountRelationship,),  # noqa: E501
            'associated_privilege_sets': ([IamPrivilegeSetRelationship], none_type,),  # noqa: E501
            'privileges': ([IamPrivilegeRelationship], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'display_names': 'DisplayNames',  # noqa: E501
        'allow_future_updates': 'AllowFutureUpdates',  # noqa: E501
        'description': 'Description',  # noqa: E501
        'is_privilege_names_updated': 'IsPrivilegeNamesUpdated',  # noqa: E501
        'name': 'Name',  # noqa: E501
        'privilege_names': 'PrivilegeNames',  # noqa: E501
        'privilege_set_type': 'PrivilegeSetType',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IamPrivilegeSetRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            allow_future_updates (bool): Flag used by UI to keep track of the user selection option for future updates of privilege sets.. [optional] if omitted the server will use the default value of True  # noqa: E501
            description (str): Description of the privilege set.. [optional]  # noqa: E501
            is_privilege_names_updated (bool): Flag to indicate if the privilege names are updated.. [optional] if omitted the server will use the default value of False  # noqa: E501
            name (str): Name of the privilege set.. [optional]  # noqa: E501
            privilege_names ([str], none_type): [optional]  # noqa: E501
            privilege_set_type (str): Type of the privilege set. * `Internal` - Privilege set is internal to the system. * `SystemPackaged` - Privilege set is packaged by the system and user can use it as a reference for custom privilege set creation. * `SystemDefined` - Privilege set is defined by the system. * `TreeNode` - Privilege set is a tree node in the custom privilege set creation hierarchy. * `TreeRoot` - Privilege set is a tree root in the custom privilege set creation hierarchy. * `TreeLeaf` - Privilege set is a tree leaf in the custom privilege set creation hierarchy. * `UserCreated` - Privilege set is created by the user.. [optional] if omitted the server will use the default value of "Internal"  # noqa: E501
            scope (str): The scope of the privilege set. * `Generic` - Privilege set can be added to account wide permission or organization permissions. * `Account` - Privilege set can be added to account wide permission only.. [optional] if omitted the server will use the default value of "Generic"  # noqa: E501
            uuid (str): UUID of the privilege set.. [optional]  # noqa: E501
            ...
            privileges ([IamPrivilegeRelationship], none_type): An array of relationships to iamPrivilege resources.. [optional]  # noqa: E501
