...
def lazy_import():
    ...
    globals()['AccessIpAddressAllOf'] = AccessIpAddressAllOf
...
class AccessIpAddress(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'oob_ipv4_address': (str,),  # noqa: E501
            'ipv4_lease': (IppoolIpLeaseRelationship,),  # noqa: E501
            'ipv6_lease': (IppoolIpLeaseRelationship,),  # noqa: E501
            'oob_ipv4_lease': (IppoolIpLeaseRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'oob_ipv4_address': 'OobIpv4Address',  # noqa: E501
        'ipv4_lease': 'Ipv4Lease',  # noqa: E501
        'ipv6_lease': 'Ipv6Lease',  # noqa: E501
        'oob_ipv4_lease': 'OobIpv4Lease',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AccessIpAddress - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "access.IpAddress", must be one of ["access.IpAddress", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "access.IpAddress", must be one of ["access.IpAddress", ]  # noqa: E501
            ...
            ipv4_address (str): IPv4 Address leased to this Server Profile for In-Band Deployment.. [optional]  # noqa: E501
            ipv6_address (str): IPv4 Address leased to this Server Profile for In-Band Deployment.. [optional]  # noqa: E501
            oob_ipv4_address (str): IPv4 Address leased to this Server Profile for Out-Of-Band deployment.. [optional]  # noqa: E501
            ipv4_lease (IppoolIpLeaseRelationship): [optional]  # noqa: E501
            ipv6_lease (IppoolIpLeaseRelationship): [optional]  # noqa: E501
            oob_ipv4_lease (IppoolIpLeaseRelationship): [optional]  # noqa: E501
        ...
        class_id = "access.IpAddress" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "access.IpAddress")
        object_type = "access.IpAddress" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "access.IpAddress")
