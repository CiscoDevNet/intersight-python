...
def lazy_import():
    ...
    globals()['NiatelemetrySnmpSrcListAllOf'] = NiatelemetrySnmpSrcListAllOf


class NiatelemetrySnmpSrcList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([NiatelemetrySnmpSrc], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """NiatelemetrySnmpSrcList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'niatelemetry.SnmpSrc' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
            results ([NiatelemetrySnmpSrc], none_type): The array of 'niatelemetry.SnmpSrc' resources matching the request.. [optional]  # noqa: E501
        """
