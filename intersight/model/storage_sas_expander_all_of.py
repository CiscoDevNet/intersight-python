...
class StorageSasExpanderAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'expander_id': (int,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'oper_state': (str,),  # noqa: E501
            'operability': (str,),  # noqa: E501
            'sas_address': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'expander_id': 'ExpanderId',  # noqa: E501
        'name': 'Name',  # noqa: E501
        'oper_state': 'OperState',  # noqa: E501
        'operability': 'Operability',  # noqa: E501
        'sas_address': 'SasAddress',  # noqa: E501
    ...
    read_only_vars = {
        'expander_id',  # noqa: E501
        'oper_state',  # noqa: E501
        'operability',  # noqa: E501
        'sas_address',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StorageSasExpanderAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "storage.SasExpander", must be one of ["storage.SasExpander", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "storage.SasExpander", must be one of ["storage.SasExpander", ]  # noqa: E501
            ...
            expander_id (int): Unique Identifier of the storage expander.. [optional]  # noqa: E501
            name (str): The name  of the installed storage expander.. [optional]  # noqa: E501
            oper_state (str): The operational state of the storage expander.. [optional]  # noqa: E501
            operability (str): The operability status of the storage expander.. [optional]  # noqa: E501
            sas_address (str): The SAS address of the SAS expander.. [optional]  # noqa: E501
        ...
        class_id = "storage.SasExpander" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "storage.SasExpander")
        object_type = "storage.SasExpander" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "storage.SasExpander")
