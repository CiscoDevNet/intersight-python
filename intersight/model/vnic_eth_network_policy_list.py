...
def lazy_import():
    ...
    globals()['VnicEthNetworkPolicyListAllOf'] = VnicEthNetworkPolicyListAllOf


class VnicEthNetworkPolicyList(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """VnicEthNetworkPolicyList - a model defined in OpenAPI
