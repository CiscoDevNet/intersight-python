...
def lazy_import():
    from intersight.model.dnac_fabric_site_list import DnacFabricSiteList
    ...
    globals()['DnacFabricSiteList'] = DnacFabricSiteList
...
class DnacFabricSiteResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'dnac.FabricSite.List': DnacFabricSiteList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """DnacFabricSiteResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'dnac.FabricSite' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
