...
def lazy_import():
    ...
    globals()['PartnerintegrationFileAllOf'] = PartnerintegrationFileAllOf
...
class PartnerintegrationFile(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PartnerintegrationFile - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "partnerintegration.File", must be one of ["partnerintegration.File", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "partnerintegration.File", must be one of ["partnerintegration.File", ]  # noqa: E501
            ...
            file_path (str): Path of the file being uploaded.. [optional]  # noqa: E501
            file_type (str): Type of the file being uploaded. * `None` - Invalid file type for partnerIntegration appliance. * `Model` - Model file of Generic Device. * `Etl` - ETL file of Generic Device. * `Ui` - UI file of Generic Device. * `DeviceConnector` - Generic Device Connector file.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            workspace_name (str): The partner integration workspace to use to upload the File.. [optional] if omitted the server will use the default value of "default"  # noqa: E501
        ...
        class_id = "partnerintegration.File" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "partnerintegration.File")
        object_type = "partnerintegration.File" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "partnerintegration.File")
