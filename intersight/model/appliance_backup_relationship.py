...
class ApplianceBackupRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApplianceBackupRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            backup_download_url (str): Download URL for the backup artifact when available. Only populated for successful local-protocol backups; empty for remote-protocol backups.. [optional]  # noqa: E501
            ...
            force_delete (bool): Set to true to allow deletion of the oldest local backup when local backup retention limit is reached. If false and retention count is reached, the backup operation fails.. [optional]  # noqa: E501
            is_manual (bool): If true, represents a manual backup. Else represents a scheduled backup.. [optional]  # noqa: E501
            ...
            use_policy_settings (bool): Set to true to inherit credentials, protocol, and file server settings from the appliance backup policy. If false, use explicit settings provided in this backup object.. [optional]  # noqa: E501
