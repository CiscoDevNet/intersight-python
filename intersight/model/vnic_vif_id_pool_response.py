...
def lazy_import():
    ...
    from intersight.model.vnic_vif_id_pool_list import VnicVifIdPoolList
    ...
    globals()['VnicVifIdPoolList'] = VnicVifIdPoolList


class VnicVifIdPoolResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'vnic.VifIdPool.List': VnicVifIdPoolList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """VnicVifIdPoolResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'vnic.VifIdPool' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
