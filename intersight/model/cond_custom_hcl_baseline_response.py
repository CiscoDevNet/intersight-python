...
def lazy_import():
    from intersight.model.cond_custom_hcl_baseline_list import CondCustomHclBaselineList
    ...
    globals()['CondCustomHclBaselineList'] = CondCustomHclBaselineList
...
class CondCustomHclBaselineResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'cond.CustomHclBaseline.List': CondCustomHclBaselineList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CondCustomHclBaselineResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'cond.CustomHclBaseline' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
