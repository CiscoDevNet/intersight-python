...
def lazy_import():
    ...
    from intersight.model.workflow_variable_list import WorkflowVariableList
    ...
    globals()['WorkflowVariableList'] = WorkflowVariableList


class WorkflowVariableResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'workflow.Variable.List': WorkflowVariableList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """WorkflowVariableResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'workflow.Variable' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
