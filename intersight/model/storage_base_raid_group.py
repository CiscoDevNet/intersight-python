...
def lazy_import():
    ...
    globals()['StorageBaseRaidGroupAllOf'] = StorageBaseRaidGroupAllOf
    globals()['StorageHitachiParityGroup'] = StorageHitachiParityGroup


class StorageBaseRaidGroup(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """StorageBaseRaidGroup - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "storage.HitachiParityGroup", must be one of ["storage.HitachiParityGroup", ]  # noqa: E501
            ...
            name (str): Human readable name of the RAID group.. [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "storage.HitachiParityGroup")
        object_type = kwargs.get('object_type', "storage.HitachiParityGroup")
