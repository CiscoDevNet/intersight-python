...
def lazy_import():
    ...
    globals()['WorkflowBaseOperationAllOf'] = WorkflowBaseOperationAllOf
...
class WorkflowBaseOperation(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'OPERATIONTYPEDECOMMISSION': "workflow.OperationTypeDecommission",
            'OPERATIONTYPEDEPLOYMENT': "workflow.OperationTypeDeployment",
            'OPERATIONTYPEPOSTDEPLOYMENT': "workflow.OperationTypePostDeployment",
        },
        ('object_type',): {
            'OPERATIONTYPEDECOMMISSION': "workflow.OperationTypeDecommission",
            'OPERATIONTYPEDEPLOYMENT': "workflow.OperationTypeDeployment",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """WorkflowBaseOperation - a model defined in OpenAPI
