...
class BootSanAllOf(ModelNormal):
    ...
    validations = {
        ...
        ('slot',): {
            'regex': {
                'pattern': r'^$|^([1-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5]|MLOM|L1|L2)$',  # noqa: E501
            },
        },
        ('wwpn',): {
            'regex': {
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BootSanAllOf - a model defined in OpenAPI
        ...
        class_id = "boot.San" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "boot.San")
        object_type = "boot.San" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "boot.San")
