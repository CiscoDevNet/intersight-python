...
class TelemetryDruidScanRequestAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data_source, intervals, *args, **kwargs):  # noqa: E501
        """TelemetryDruidScanRequestAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            result_format (str): How the results are represented, list or compactedList.. [optional] if omitted the server will use the default value of "list"  # noqa: E501
            ...
            offset (int): Skip this many rows when returning results. Skipped rows will still need to be generated internally and then discarded, meaning that raising offsets to high values can cause queries to use additional resources. Together, \"limit\" and \"offset\" can be used to implement pagination. However, note that if the underlying datasource is modified in between page fetches in ways that affect overall query results, then the different pages will not necessarily align with each other.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, data_source, intervals, *args, **kwargs):  # noqa: E501
        """TelemetryDruidScanRequestAllOf - a model defined in OpenAPI
