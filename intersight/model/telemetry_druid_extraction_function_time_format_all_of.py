...
class TelemetryDruidExtractionFunctionTimeFormatAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TelemetryDruidExtractionFunctionTimeFormatAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            type (str): defaults to "timeFormat", must be one of ["timeFormat", ]  # noqa: E501
            ...
            format (str): Date time format for the resulting dimension value, in Joda Time DateTimeFormat, or null to use the default ISO8601 format.. [optional]  # noqa: E501
            locale (str): Locale (language and country) to use, given as a IETF BCP 47 language tag, e.g. en-US, en-GB, fr-FR, fr-CA, etc.. [optional]  # noqa: E501
        ...
        type = "timeFormat" if len(kwargs.get('type','').strip()) == 0 else kwargs.get('type', "timeFormat")
