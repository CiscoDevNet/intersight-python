...
def lazy_import():
    ...
    globals()['OpenapiOpenApiSpecificationRelationship'] = OpenapiOpenApiSpecificationRelationship
...
class OpenapiProcessFileRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'file_download_status': (str,),  # noqa: E501
            'file_processing_status': (str,),  # noqa: E501
            'file_validation_status': (str,),  # noqa: E501
            'spec_file_path': (str,),  # noqa: E501
            'file_info': (OpenapiOpenApiSpecificationRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'file_download_status': 'FileDownloadStatus',  # noqa: E501
        'file_processing_status': 'FileProcessingStatus',  # noqa: E501
        'file_validation_status': 'FileValidationStatus',  # noqa: E501
        'spec_file_path': 'SpecFilePath',  # noqa: E501
        'file_info': 'FileInfo',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'file_download_status',  # noqa: E501
        'file_processing_status',  # noqa: E501
        'file_validation_status',  # noqa: E501
    }

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OpenapiProcessFileRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            failure_reason (str): An error message for when download, validation or processing of OpenAPI Specification fails.. [optional]  # noqa: E501
            file_download_status (str): Status of the internal OpenAPI specification fetch operation * `none` - Indicates the default status * `InProgress` - Indicates that operation is in progress * `Completed` - Indicates that the operation is complete * `Failed` - Indicates that the operation has failed. Check the failureReason attribute for more details.. [optional] if omitted the server will use the default value of "none"  # noqa: E501
            file_processing_status (str): Status of the OpenAPI specification processing operation. The OpenAPI specification file is processed to create APIMethod objects. * `none` - Indicates the default status * `InProgress` - Indicates that operation is in progress * `Completed` - Indicates that the operation is complete * `Failed` - Indicates that the operation has failed. Check the failureReason attribute for more details.. [optional] if omitted the server will use the default value of "none"  # noqa: E501
            file_validation_status (str): Status of the OpenAPI specification validation operation. * `none` - Indicates the default status * `InProgress` - Indicates that operation is in progress * `Completed` - Indicates that the operation is complete * `Failed` - Indicates that the operation has failed. Check the failureReason attribute for more details.. [optional] if omitted the server will use the default value of "none"  # noqa: E501
            spec_file_path (str): The location of the previously uploaded OpenAPI specification file.. [optional]  # noqa: E501
            file_info (OpenapiOpenApiSpecificationRelationship): [optional]  # noqa: E501
