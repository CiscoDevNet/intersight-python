...
def lazy_import():
    from intersight.model.marketplace_catalog_list import MarketplaceCatalogList
    ...
    globals()['MarketplaceCatalogList'] = MarketplaceCatalogList
...
class MarketplaceCatalogResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'marketplace.Catalog.List': MarketplaceCatalogList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """MarketplaceCatalogResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'marketplace.Catalog' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
