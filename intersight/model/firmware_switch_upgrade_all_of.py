...
class FirmwareSwitchUpgradeAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'enable_fabric_evacuation': (bool,),  # noqa: E501
            'enable_pdb_fpga_upgrade': (bool,),  # noqa: E501
            'enable_psu_upgrade': (bool,),  # noqa: E501
            'skip_wait_for_io_path_connectivity': (bool,),  # noqa: E501
            'switch_name': (str,),  # noqa: E501
            'wait_time_out': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'enable_fabric_evacuation': 'EnableFabricEvacuation',  # noqa: E501
        'enable_pdb_fpga_upgrade': 'EnablePdbFpgaUpgrade',  # noqa: E501
        'enable_psu_upgrade': 'EnablePsuUpgrade',  # noqa: E501
        'skip_wait_for_io_path_connectivity': 'SkipWaitForIoPathConnectivity',  # noqa: E501
        'switch_name': 'SwitchName',  # noqa: E501
        'wait_time_out': 'WaitTimeOut',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FirmwareSwitchUpgradeAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            enable_pdb_fpga_upgrade (bool): The flag to enable or disable firmware upgrade functionality for the PDB FPGA.. [optional] if omitted the server will use the default value of False  # noqa: E501
            enable_psu_upgrade (bool): The flag to enable or disable firmware upgrade functionality for the Power Supply Unit (PSU).. [optional] if omitted the server will use the default value of False  # noqa: E501
            skip_wait_for_io_path_connectivity (bool): The flag to enable or disable the option to wait for IO paths connectivity during the switch firmware upgrade.. [optional] if omitted the server will use the default value of False  # noqa: E501
            switch_name (str): Name of the Fabric Interconnect on which the firmware upgrade operation is performed.. [optional]  # noqa: E501
            wait_time_out (int): Specifies a timeout period, in minutes, before the firmware upgrade begins. The valid range is -1 to 1000. A value of -1 requires manual user acknowledgment to proceed, 0 starts the upgrade immediately, and values from 1 to 1000 wait the specified number of minutes before starting. The upgrade will automatically begin once the timeout expires, but it can also be initiated manually at any time before the timeout ends. If no value is specified, manual user acknowledgment is required, equivalent to -1.. [optional] if omitted the server will use the default value of -1  # noqa: E501
        ...
        class_id = "firmware.SwitchUpgrade" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "firmware.SwitchUpgrade")
        object_type = "firmware.SwitchUpgrade" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "firmware.SwitchUpgrade")
