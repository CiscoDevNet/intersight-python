...
class IamAccountTypeBaseAllOf(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            'ACCOUNTTYPEIPMI': "iam.AccountTypeIpmi",
            'ACCOUNTTYPELOCAL': "iam.AccountTypeLocal",
        },
        ('object_type',): {
            'ACCOUNTTYPEIPMI': "iam.AccountTypeIpmi",
            'ACCOUNTTYPELOCAL': "iam.AccountTypeLocal",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """IamAccountTypeBaseAllOf - a model defined in OpenAPI
