...
def lazy_import():
    ...
    from intersight.model.resourcepool_membership_reservation_list import ResourcepoolMembershipReservationList
    ...
    globals()['ResourcepoolMembershipReservationList'] = ResourcepoolMembershipReservationList


class ResourcepoolMembershipReservationResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'resourcepool.MembershipReservation.List': ResourcepoolMembershipReservationList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ResourcepoolMembershipReservationResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'resourcepool.MembershipReservation' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
