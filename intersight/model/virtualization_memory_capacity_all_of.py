...
class VirtualizationMemoryCapacityAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "virtualization.MemoryCapacity" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "virtualization.MemoryCapacity")
        object_type = "virtualization.MemoryCapacity" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "virtualization.MemoryCapacity")
