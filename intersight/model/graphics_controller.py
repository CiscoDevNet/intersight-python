...
def lazy_import():
    ...
    globals()['GraphicsControllerAllOf'] = GraphicsControllerAllOf
...
class GraphicsController(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GraphicsController - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "graphics.Controller", must be one of ["graphics.Controller", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "graphics.Controller", must be one of ["graphics.Controller", ]  # noqa: E501
        ...
        class_id = "graphics.Controller" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "graphics.Controller")
        object_type = "graphics.Controller" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "graphics.Controller")
