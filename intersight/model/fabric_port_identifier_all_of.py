...
class FabricPortIdentifierAllOf(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """FabricPortIdentifierAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "fabric.PortIdentifier", must be one of ["fabric.PortIdentifier", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "fabric.PortIdentifier", must be one of ["fabric.PortIdentifier", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "fabric.PortIdentifier")
        object_type = kwargs.get('object_type', "fabric.PortIdentifier")
