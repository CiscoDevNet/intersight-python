...
class SdaaciConnectionRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            aci_l3_out (str): ACI L3Out Name User Input.. [optional]  # noqa: E501
            aci_match_rule_name (str): Name of the Match Rule in Cisco APIC.. [optional]  # noqa: E501
            aci_tenant (str): ACI tenant Name for Selected APIC Target.. [optional]  # noqa: E501
            campus_fabric_site (str): Campus fabric site id in which the border node has configured.. [optional]  # noqa: E501
            epg (str): Application EPG Name of this connection.. [optional]  # noqa: E501
            epg_subnet (str): EPG Subnet Ipv4Cidr which is configured on APIC.. [optional]  # noqa: E501
            firewall_device (str): Device within the selected domain used to configure Firewall.. [optional]  # noqa: E501
            firewall_domain (str): Domain used to configure Firewall.. [optional]  # noqa: E501
            node_profile (str): L3Out Node Profile in Cisco APIC.. [optional]  # noqa: E501
            status (str): Connection status between SDA and ACI. * `NotConnected` - Connection Status NotConnected. * `Connected` - Connection Status Connected.. [optional] if omitted the server will use the default value of "NotConnected"  # noqa: E501
            transit (str): Transit id for given border node.. [optional]  # noqa: E501
            virtual_network (str): Virtual Network of this connection.. [optional]  # noqa: E501
            vn_epg (str): Contains both VN and EPG of this connection.. [optional]  # noqa: E501
            vrf (str): APIC Tenant VRF from APIC.. [optional]  # noqa: E501
