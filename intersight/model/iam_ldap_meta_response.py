...
def lazy_import():
    from intersight.model.iam_ldap_meta_list import IamLdapMetaList
    ...
    globals()['IamLdapMetaList'] = IamLdapMetaList
...
class IamLdapMetaResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'iam.LdapMeta.List': IamLdapMetaList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """IamLdapMetaResponse - a model defined in OpenAPI
