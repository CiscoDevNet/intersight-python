...
def lazy_import():
    ...
    from intersight.model.hci_esxi_vm_all_of import HciEsxiVmAllOf
    from intersight.model.hci_esxi_vm_disk_relationship import HciEsxiVmDiskRelationship
    from intersight.model.hci_esxi_vm_nic_relationship import HciEsxiVmNicRelationship
    ...
    globals()['HciEsxiVmAllOf'] = HciEsxiVmAllOf
    globals()['HciEsxiVmDiskRelationship'] = HciEsxiVmDiskRelationship
    globals()['HciEsxiVmNicRelationship'] = HciEsxiVmNicRelationship
...
class HciEsxiVm(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'guest_tools': (HciEsxiGuestTools,),  # noqa: E501
            'virtual_hardware_version': (int,),  # noqa: E501
            'disks': ([HciEsxiVmDiskRelationship], none_type,),  # noqa: E501
            'nics': ([HciEsxiVmNicRelationship], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'virtual_hardware_version': 'VirtualHardwareVersion',  # noqa: E501
    ...
    read_only_vars = {
        'virtual_hardware_version',  # noqa: E501
        'disks',  # noqa: E501
        'nics',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """HciEsxiVm - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "hci.EsxiVm", must be one of ["hci.EsxiVm", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "hci.EsxiVm", must be one of ["hci.EsxiVm", ]  # noqa: E501
            ...
            guest_tools (HciEsxiGuestTools): [optional]  # noqa: E501
            virtual_hardware_version (int): The virtual hardware version of the VM.. [optional]  # noqa: E501
            disks ([HciEsxiVmDiskRelationship], none_type): An array of relationships to hciEsxiVmDisk resources.. [optional]  # noqa: E501
            nics ([HciEsxiVmNicRelationship], none_type): An array of relationships to hciEsxiVmNic resources.. [optional]  # noqa: E501
        ...
        class_id = "hci.EsxiVm" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "hci.EsxiVm")
        object_type = "hci.EsxiVm" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "hci.EsxiVm")
