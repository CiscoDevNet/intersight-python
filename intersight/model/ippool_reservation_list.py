...
def lazy_import():
    ...
    globals()['IppoolReservationListAllOf'] = IppoolReservationListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class IppoolReservationList(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """IppoolReservationList - a model defined in OpenAPI
