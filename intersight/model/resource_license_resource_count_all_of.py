...
class ResourceLicenseResourceCountAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'resource_count': (int,),  # noqa: E501
            'account': (IamAccountRelationship,),  # noqa: E501
            'license_groups': ([ResourceGroupRelationship], none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'resource_count': 'ResourceCount',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'resource_count',  # noqa: E501
        'license_groups',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResourceLicenseResourceCountAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "resource.LicenseResourceCount", must be one of ["resource.LicenseResourceCount", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "resource.LicenseResourceCount", must be one of ["resource.LicenseResourceCount", ]  # noqa: E501
