...
def lazy_import():
    ...
    globals()['StorageBasePhysicalPortAllOf'] = StorageBasePhysicalPortAllOf
...
class StorageBasePhysicalPort(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'HITACHIPORT': "storage.HitachiPort",
            'NETAPPFCINTERFACE': "storage.NetAppFcInterface",
            'NETAPPFCPORT': "storage.NetAppFcPort",
            'PUREPORT': "storage.PurePort",
        },
        ('object_type',): {
            'HITACHIPORT': "storage.HitachiPort",
            'NETAPPFCINTERFACE': "storage.NetAppFcInterface",
