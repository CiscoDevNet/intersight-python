...
class TamBaseDataSourceAllOf(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            'APIDATASOURCE': "tam.ApiDataSource",
            'S3DATASOURCE': "tam.S3DataSource",
            'TEXTFSMTEMPLATEDATASOURCE': "tam.TextFsmTemplateDataSource",
        },
        ('object_type',): {
            'APIDATASOURCE': "tam.ApiDataSource",
            'S3DATASOURCE': "tam.S3DataSource",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """TamBaseDataSourceAllOf - a model defined in OpenAPI
