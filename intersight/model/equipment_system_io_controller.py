...
def lazy_import():
    ...
    globals()['EquipmentSystemIoControllerAllOf'] = EquipmentSystemIoControllerAllOf
...
class EquipmentSystemIoController(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'managing_instance': (str,),  # noqa: E501
            'oper_state': (str,),  # noqa: E501
            'part_number': (str,),  # noqa: E501
            'pid': (str,),  # noqa: E501
            'system_io_controller_id': (int,),  # noqa: E501
            'cmc': (ManagementControllerRelationship,),  # noqa: E501
            ...
            'shared_io_module': (EquipmentSharedIoModuleRelationship,),  # noqa: E501
    ...
    read_only_vars = {
        ...
        'managing_instance',  # noqa: E501
        'oper_state',  # noqa: E501
        'part_number',  # noqa: E501
        'pid',  # noqa: E501
        'system_io_controller_id',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentSystemIoController - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "equipment.SystemIoController", must be one of ["equipment.SystemIoController", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "equipment.SystemIoController", must be one of ["equipment.SystemIoController", ]  # noqa: E501
            ...
            chassis_id (str): The assigned identifier for a chassis.. [optional]  # noqa: E501
            connection_path (str): Connection Path identifies the data path available between IOModule and FI.. [optional]  # noqa: E501
            connection_status (str): Connection status identifies the status of data path.. [optional]  # noqa: E501
            description (str): This field gives a brief information on systemIOController.. [optional]  # noqa: E501
            managing_instance (str): This field identifies the CIMC that manages the controller.. [optional]  # noqa: E501
            oper_state (str): This field identifies the SIOC operational state.. [optional]  # noqa: E501
            part_number (str): Part Number identifier for the IO module.. [optional]  # noqa: E501
            pid (str): This field identifies the Product ID for systemIOController.. [optional]  # noqa: E501
            system_io_controller_id (int): This represents system I/O Controller identifier.. [optional]  # noqa: E501
            cmc (ManagementControllerRelationship): [optional]  # noqa: E501
            ...
            shared_io_module (EquipmentSharedIoModuleRelationship): [optional]  # noqa: E501
        ...
        class_id = "equipment.SystemIoController" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "equipment.SystemIoController")
        object_type = "equipment.SystemIoController" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "equipment.SystemIoController")
