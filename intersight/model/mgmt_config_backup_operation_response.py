...
def lazy_import():
    from intersight.model.mgmt_config_backup_operation_list import MgmtConfigBackupOperationList
    ...
    globals()['MgmtConfigBackupOperationList'] = MgmtConfigBackupOperationList
...
class MgmtConfigBackupOperationResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'mgmt.ConfigBackupOperation.List': MgmtConfigBackupOperationList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """MgmtConfigBackupOperationResponse - a model defined in OpenAPI
