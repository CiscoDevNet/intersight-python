...
def lazy_import():
    from intersight.model.capability_time_zone_meta_data_list import CapabilityTimeZoneMetaDataList
    ...
    globals()['CapabilityTimeZoneMetaDataList'] = CapabilityTimeZoneMetaDataList
...
class CapabilityTimeZoneMetaDataResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'capability.TimeZoneMetaData.List': CapabilityTimeZoneMetaDataList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CapabilityTimeZoneMetaDataResponse - a model defined in OpenAPI
