...
def lazy_import():
    ...
    globals()['EquipmentPsuControlListAllOf'] = EquipmentPsuControlListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class EquipmentPsuControlList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([EquipmentPsuControl], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """EquipmentPsuControlList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            results ([EquipmentPsuControl], none_type): The array of 'equipment.PsuControl' resources matching the request.. [optional]  # noqa: E501
        """
