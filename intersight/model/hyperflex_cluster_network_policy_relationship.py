...
class HyperflexClusterNetworkPolicyRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'cimc_management_mode': (str,),  # noqa: E501
            'jumbo_frame': (bool,),  # noqa: E501
            'kvm_ip_range': (HyperflexIpAddrRange,),  # noqa: E501
            'mac_prefix_range': (HyperflexMacAddrPrefixRange,),  # noqa: E501
            'mgmt_vlan': (HyperflexNamedVlan,),  # noqa: E501
            'uplink_speed': (str,),  # noqa: E501
            'vm_migration_vlan': (HyperflexNamedVlan,),  # noqa: E501
            'vm_network_vlans': ([HyperflexNamedVlan], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'name': 'Name',  # noqa: E501
        'cimc_management_mode': 'CimcManagementMode',  # noqa: E501
        'jumbo_frame': 'JumboFrame',  # noqa: E501
        ...
        'vm_migration_vlan': 'VmMigrationVlan',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'cimc_management_mode',  # noqa: E501
    }

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """HyperflexClusterNetworkPolicyRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            cimc_management_mode (str): The mode configured on the CIMC management interface. * `OutOfBand` - The server uses out-of-band management, i.e. management traffic traverses through the management interfaces on the UCS Fabric Interconnects. * `InBand` - The server uses in-band management, i.e. management traffic traverses through the data uplink ports on the UCS Fabric Interconnects.. [optional] if omitted the server will use the default value of "OutOfBand"  # noqa: E501
            jumbo_frame (bool): Enable or disable Jumbo Frames (MTU=9000). Jumbo Frames are used by Storage Network, VM Migration Network.. [optional]  # noqa: E501
            kvm_ip_range (HyperflexIpAddrRange): [optional]  # noqa: E501
            mac_prefix_range (HyperflexMacAddrPrefixRange): [optional]  # noqa: E501
            mgmt_vlan (HyperflexNamedVlan): [optional]  # noqa: E501
            uplink_speed (str): Link speed of the server adapter port to the upstream switch. When the policy is attached to a cluster profile with EDGE management platform, the uplink speed can be '1G' or '10G+'. Use '10G+' for link speeds of 10G or above. When the policy is attached to a cluster profile with Fabric Interconnect management platform, the uplink speed can be 'default' only. * `default` - Current default value set on the hardware platform. * `1G` - A link speed of 1 gigabit per second. * `10G` - A link speed of 10 gigabits per second or above.. [optional] if omitted the server will use the default value of "default"  # noqa: E501
            vm_migration_vlan (HyperflexNamedVlan): [optional]  # noqa: E501
            vm_network_vlans ([HyperflexNamedVlan], none_type): [optional]  # noqa: E501
