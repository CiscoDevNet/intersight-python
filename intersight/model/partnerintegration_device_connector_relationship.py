...
def lazy_import():
    ...
    from intersight.model.partnerintegration_dc_logs_relationship import PartnerintegrationDcLogsRelationship
    ...
    globals()['PartnerintegrationDcLogsRelationship'] = PartnerintegrationDcLogsRelationship
    globals()['PartnerintegrationDeviceConnector'] = PartnerintegrationDeviceConnector


class PartnerintegrationDeviceConnectorRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'src_bucket': (str,),  # noqa: E501
            'src_file_name': (str,),  # noqa: E501
            'logs': ([PartnerintegrationDcLogsRelationship], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'name': 'Name',  # noqa: E501
        'src_bucket': 'SrcBucket',  # noqa: E501
        'src_file_name': 'SrcFileName',  # noqa: E501
        'logs': 'Logs',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'src_bucket',  # noqa: E501
        'src_file_name',  # noqa: E501
        'logs',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PartnerintegrationDeviceConnectorRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            action (str): Action to be performed on the device connector recipe. * `None` - Default Value of the action, i.e. do nothing. * `Build` - Build the device connector service image. * `Deploy` - Deploy the device connector service on the appliance. * `Upload` - Upload a file to the Partner Integration Appliance bucket.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            build_start_time (str): Time when build was triggered.. [optional]  # noqa: E501
            build_status (str): Status of build for device connector recipe. * `None` - Default value of the status. i.e. done nothing. * `BackendInProgress` - The backend build is in progress. * `BackendFailed` - The backend build has failed. * `DockerInProgress` - The docker build is in progress. * `DockerFailed` - The docker build has failed. * `Completed` - The operation completed successfully.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            image_name (str): Name of the docker image that is built.. [optional]  # noqa: E501
            name (str): Name of the device connector recipe.. [optional]  # noqa: E501
            src_bucket (str): Name of the bucket to pick up the file from.. [optional]  # noqa: E501
            src_file_name (str): Name of source file to upload.. [optional]  # noqa: E501
            logs ([PartnerintegrationDcLogsRelationship], none_type): An array of relationships to partnerintegrationDcLogs resources.. [optional]  # noqa: E501
