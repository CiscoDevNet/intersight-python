...
def lazy_import():
    ...
    globals()['CertificatemanagementPolicyAllOf'] = CertificatemanagementPolicyAllOf
...
class CertificatemanagementPolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'certificates': ([CertificatemanagementCertificateBase], none_type,),  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """CertificatemanagementPolicy - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "certificatemanagement.Policy", must be one of ["certificatemanagement.Policy", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "certificatemanagement.Policy", must be one of ["certificatemanagement.Policy", ]  # noqa: E501
            ...
            certificates ([CertificatemanagementCertificateBase], none_type): [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "certificatemanagement.Policy")
        object_type = kwargs.get('object_type', "certificatemanagement.Policy")
