...
class ConvergedinfraServerComplianceDetailsRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConvergedinfraServerComplianceDetailsRelationship - a model defined in OpenAPI
