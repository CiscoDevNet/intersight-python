...
def lazy_import():
    from intersight.model.connector_cache_status_all_of import ConnectorCacheStatusAllOf
    ...
    globals()['ConnectorCacheStatusAllOf'] = ConnectorCacheStatusAllOf
...
class ConnectorCacheStatus(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'cache_error': (str,),  # noqa: E501
            'cache_message': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'cache_error': 'CacheError',  # noqa: E501
        'cache_message': 'CacheMessage',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ConnectorCacheStatus - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "firmware.UpgradeStatus", must be one of ["firmware.UpgradeStatus", ]  # noqa: E501
