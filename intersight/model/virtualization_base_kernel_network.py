...
class VirtualizationBaseKernelNetwork(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'VMWAREDISTRIBUTEDNETWORK': "virtualization.VmwareDistributedNetwork",
            'VMWAREKERNELNETWORK': "virtualization.VmwareKernelNetwork",
            'VMWARENETWORK': "virtualization.VmwareNetwork",
        },
        ('object_type',): {
            'VMWAREDISTRIBUTEDNETWORK': "virtualization.VmwareDistributedNetwork",
            'VMWAREKERNELNETWORK': "virtualization.VmwareKernelNetwork",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """VirtualizationBaseKernelNetwork - a model defined in OpenAPI
