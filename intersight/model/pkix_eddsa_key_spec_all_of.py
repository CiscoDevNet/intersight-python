...
class PkixEddsaKeySpecAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PkixEddsaKeySpecAllOf - a model defined in OpenAPI
        ...
        class_id = "pkix.EddsaKeySpec" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "pkix.EddsaKeySpec")
        object_type = "pkix.EddsaKeySpec" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "pkix.EddsaKeySpec")
