...
class ComputeBladeRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            front_panel_lock_state (str): The actual front panel state of the server. * `Unlock` - Front Panel of the server is set to Unlocked state. * `Lock` - Front Panel of the server is set to Locked state.. [optional] if omitted the server will use the default value of "Unlock"  # noqa: E501
