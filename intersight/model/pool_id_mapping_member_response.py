...
def lazy_import():
    ...
    from intersight.model.pool_id_mapping_member_list import PoolIdMappingMemberList
    ...
    globals()['PoolIdMappingMemberList'] = PoolIdMappingMemberList


class PoolIdMappingMemberResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'pool.IdMappingMember.List': PoolIdMappingMemberList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """PoolIdMappingMemberResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'pool.IdMappingMember' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
