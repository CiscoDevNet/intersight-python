...
def lazy_import():
    ...
    globals()['StorageHitachiDiskAllOf'] = StorageHitachiDiskAllOf
    globals()['StorageHitachiParityGroupRelationship'] = StorageHitachiParityGroupRelationship


class StorageHitachiDisk(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'drive_type_code': (str,),  # noqa: E501
            'parity_group_id': (str,),  # noqa: E501
            'type_detail': (str,),  # noqa: E501
            'usage': (str,),  # noqa: E501
            'array': (StorageHitachiArrayRelationship,),  # noqa: E501
            'parity_group': (StorageHitachiParityGroupRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'drive_type_code': 'DriveTypeCode',  # noqa: E501
        'parity_group_id': 'ParityGroupId',  # noqa: E501
        'type_detail': 'TypeDetail',  # noqa: E501
        'usage': 'Usage',  # noqa: E501
        'array': 'Array',  # noqa: E501
        'parity_group': 'ParityGroup',  # noqa: E501
    ...
    read_only_vars = {
        'drive_type_code',  # noqa: E501
        'parity_group_id',  # noqa: E501
        'type_detail',  # noqa: E501
        'usage',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StorageHitachiDisk - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "storage.HitachiDisk", must be one of ["storage.HitachiDisk", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "storage.HitachiDisk", must be one of ["storage.HitachiDisk", ]  # noqa: E501
            ...
            drive_type_code (str): Drive type code of the Hitachi Disk.. [optional]  # noqa: E501
            parity_group_id (str): Parity group number. When the drive does not belong to any parity group, an empty character string is output.. [optional]  # noqa: E501
            type_detail (str): Drive type of the Hitachi Disk. * `N/A` - Drive Type is not available. * `SAS` - SAS stands for Serial Attached SCSI. * `SSD(MLC)` - SSD (MLC) stands for Multiple Level Cell. * `SSD(FMC)` - SSD (FMC) stands for Flash Memory Compressed. * `SSD(FMD)` - SSD (FMD) stands for Flash Module Drive. * `SSD(SLC)` - SSD (SLC) stands for Single Level Cell. * `SSD` - SSD stands for Solid-State Drive. * `SSD(RI)` - SSD (RI) stands for Read Intensive. * `SCM` - SCM stands for Storage Class Memory.. [optional] if omitted the server will use the default value of "N/A"  # noqa: E501
            usage (str): Purpose for which the drive is used.. [optional]  # noqa: E501
            array (StorageHitachiArrayRelationship): [optional]  # noqa: E501
            parity_group (StorageHitachiParityGroupRelationship): [optional]  # noqa: E501
        ...
        class_id = "storage.HitachiDisk" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "storage.HitachiDisk")
        object_type = "storage.HitachiDisk" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "storage.HitachiDisk")
