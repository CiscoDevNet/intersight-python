...
def lazy_import():
    ...
    from intersight.model.workload_rollout_strategy_all_of import WorkloadRolloutStrategyAllOf
    ...
    globals()['WorkloadRolloutStrategyAllOf'] = WorkloadRolloutStrategyAllOf


class WorkloadRolloutStrategy(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'BATCHDEPLOYMENT': "workload.BatchDeployment",
            'CANARYDEPLOYMENT': "workload.CanaryDeployment",
        },
        ('object_type',): {
            'BATCHDEPLOYMENT': "workload.BatchDeployment",
            'CANARYDEPLOYMENT': "workload.CanaryDeployment",
    ...
    read_only_vars = {
        'failure_threshold',  # noqa: E501
    }

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """WorkloadRolloutStrategy - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            failure_threshold (int): Specifies no of errors can be allowed to skip executing next set.. [optional] if omitted the server will use the default value of 10  # noqa: E501
        """
