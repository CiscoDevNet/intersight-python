...
def lazy_import():
    from intersight.model.hci_ahv_vm_disk_list import HciAhvVmDiskList
    ...
    globals()['HciAhvVmDiskList'] = HciAhvVmDiskList
...
class HciAhvVmDiskResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'hci.AhvVmDisk.List': HciAhvVmDiskList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """HciAhvVmDiskResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'hci.AhvVmDisk' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
