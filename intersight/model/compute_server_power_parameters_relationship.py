...
class ComputeServerPowerParametersRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'dn': (str,),  # noqa: E501
            'rn': (str,),  # noqa: E501
            'power_allocation': (int,),  # noqa: E501
            'power_priority': (str,),  # noqa: E501
            'power_profiling': (str,),  # noqa: E501
            'power_restore': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'dn': 'Dn',  # noqa: E501
        'rn': 'Rn',  # noqa: E501
        'power_allocation': 'PowerAllocation',  # noqa: E501
        'power_priority': 'PowerPriority',  # noqa: E501
        'power_profiling': 'PowerProfiling',  # noqa: E501
        'power_restore': 'PowerRestore',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'dn',  # noqa: E501
        'rn',  # noqa: E501
        'power_allocation',  # noqa: E501
        'power_priority',  # noqa: E501
        'power_profiling',  # noqa: E501
        'power_restore',  # noqa: E501
        'processor_package_power_limit',  # noqa: E501
    }

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ComputeServerPowerParametersRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            power_allocation (int): This field identifies the maximum power that has been allocated to the blade by CMC in Watts. Power budget for the chassis is configured by the power policy. That budget is then divided among the blades in the chassis by CMC.. [optional] if omitted the server will use the default value of 0  # noqa: E501
            power_priority (str): Power Priority level of the Server. This priority is used to determine the initial power allocation for servers. This field is only supported for Cisco UCS B series and X series servers. * `Unknown` - Power allocation priority of server is either unknown or not supported on CMC firmware version. * `Low` - Power allocation priority of server is low. * `Medium` - Power allocation priority of server is medium. * `High` - Power allocation priority of server is high.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
            power_profiling (str): Status of Power Profiling setting of the Server. If Enabled, this field allows the power manager to run power profiling utility to determine the power needs of the server. This field is only supported for Cisco UCS X series servers. * `Unknown` - Power Profiling state is either unknown for the server or not supported on BMC firmware version. * `Enabled` - Power Profiling is enabled for the server. * `Disabled` - Power Profiling is either disabled for the server or not supported on BMC firmware version.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
            power_restore (str): Value of the power restore policy for the server. In the absence of Intersight connectivity, the server will use this state to recover the host power after a power loss event. * `Unknown` - Power restore state for the server is either Unknown or not supported on BMC firmware version. * `Always On` - Power restore state for server is set to Always On. * `Always Off` - Power restore state for server is set to Always Off. * `Last State` - Power restore state for server is set to Last State.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
            processor_package_power_limit (str): Processor Package Power Limit (PPL) of a server. PPL refers to the amount of power that a CPU can draw from the power supply. The Processor Package Power Limit (PPL) feature is currently available exclusively on Cisco UCS C225/C245 M8 servers. * `Unknown` - Processor package power limit is either unknown for the server or not supported on BMC firmware version. * `Default` - Processor package power limit is default for the server. * `Maximum` - Processor package power limit is maximum for the server. * `Minimum` - Processor package power limit is minimum for the server.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
