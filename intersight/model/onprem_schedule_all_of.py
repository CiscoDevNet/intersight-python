...
class OnpremScheduleAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "onprem.Schedule" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "onprem.Schedule")
        object_type = "onprem.Schedule" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "onprem.Schedule")
