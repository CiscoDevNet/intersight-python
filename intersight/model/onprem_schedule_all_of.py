...
class OnpremScheduleAllOf(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "onprem.Schedule", must be one of ["onprem.Schedule", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "onprem.Schedule", must be one of ["onprem.Schedule", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "onprem.Schedule")
        object_type = kwargs.get('object_type', "onprem.Schedule")
