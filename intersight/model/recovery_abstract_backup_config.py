...
def lazy_import():
    ...
    globals()['RecoveryAbstractBackupConfigAllOf'] = RecoveryAbstractBackupConfigAllOf
    globals()['RecoveryBackupConfigPolicy'] = RecoveryBackupConfigPolicy
    globals()['RecoveryOnDemandBackup'] = RecoveryOnDemandBackup


class RecoveryAbstractBackupConfig(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'BACKUPCONFIGPOLICY': "recovery.BackupConfigPolicy",
            'ONDEMANDBACKUP': "recovery.OnDemandBackup",
        },
        ('object_type',): {
            'BACKUPCONFIGPOLICY': "recovery.BackupConfigPolicy",
            'ONDEMANDBACKUP': "recovery.OnDemandBackup",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """RecoveryAbstractBackupConfig - a model defined in OpenAPI
