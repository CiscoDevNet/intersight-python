...
def lazy_import():
    ...
    globals()['PkixKeyGenerationSpecAllOf'] = PkixKeyGenerationSpecAllOf
    globals()['PkixRsaAlgorithm'] = PkixRsaAlgorithm


class PkixKeyGenerationSpec(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'ECDSAKEYSPEC': "pkix.EcdsaKeySpec",
            'EDDSAKEYSPEC': "pkix.EddsaKeySpec",
            'RSAALGORITHM': "pkix.RsaAlgorithm",
        },
        ('object_type',): {
            'ECDSAKEYSPEC': "pkix.EcdsaKeySpec",
            'EDDSAKEYSPEC': "pkix.EddsaKeySpec",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """PkixKeyGenerationSpec - a model defined in OpenAPI
