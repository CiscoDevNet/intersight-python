...
def lazy_import():
    ...
    globals()['SoftwareHyperflexDistributableAllOf'] = SoftwareHyperflexDistributableAllOf
...
class SoftwareHyperflexDistributable(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """SoftwareHyperflexDistributable - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "software.HyperflexDistributable", must be one of ["software.HyperflexDistributable", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "software.HyperflexDistributable", must be one of ["software.HyperflexDistributable", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "software.HyperflexDistributable")
        object_type = kwargs.get('object_type', "software.HyperflexDistributable")
