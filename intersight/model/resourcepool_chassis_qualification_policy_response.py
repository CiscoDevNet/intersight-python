...
def lazy_import():
    ...
    from intersight.model.resourcepool_chassis_qualification_policy_list import ResourcepoolChassisQualificationPolicyList
    ...
    globals()['ResourcepoolChassisQualificationPolicyList'] = ResourcepoolChassisQualificationPolicyList


class ResourcepoolChassisQualificationPolicyResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'resourcepool.ChassisQualificationPolicy.List': ResourcepoolChassisQualificationPolicyList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ResourcepoolChassisQualificationPolicyResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'resourcepool.ChassisQualificationPolicy' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'oneOf': [
              ...
              MoDocumentCount,
              MoTagSummary,
              ResourcepoolChassisQualificationPolicyList,
          ],
        }
