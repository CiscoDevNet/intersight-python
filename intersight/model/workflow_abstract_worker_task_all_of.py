...
class WorkflowAbstractWorkerTaskAllOf(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            'SUBWORKFLOWTASK': "workflow.SubWorkflowTask",
            'WAITTASK': "workflow.WaitTask",
            'WORKERTASK': "workflow.WorkerTask",
        },
        ('object_type',): {
            'SUBWORKFLOWTASK': "workflow.SubWorkflowTask",
            'WAITTASK': "workflow.WaitTask",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """WorkflowAbstractWorkerTaskAllOf - a model defined in OpenAPI
