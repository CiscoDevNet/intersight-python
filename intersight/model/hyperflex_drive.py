...
def lazy_import():
    ...
    globals()['HyperflexDriveAllOf'] = HyperflexDriveAllOf
...
class HyperflexDrive(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """HyperflexDrive - a model defined in OpenAPI
        ...
        class_id = "hyperflex.Drive" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "hyperflex.Drive")
        object_type = "hyperflex.Drive" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "hyperflex.Drive")
