...
def lazy_import():
    ...
    globals()['VirtualizationBaseVirtualNetworkInterfaceAllOf'] = VirtualizationBaseVirtualNetworkInterfaceAllOf
    globals()['VirtualizationVmwareVirtualNetworkInterface'] = VirtualizationVmwareVirtualNetworkInterface


class VirtualizationBaseVirtualNetworkInterface(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VirtualizationBaseVirtualNetworkInterface - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "virtualization.VmwareVirtualNetworkInterface", must be one of ["virtualization.VmwareVirtualNetworkInterface", ]  # noqa: E501
            ...
            name (str): Name of the virtual network interface created on a virtual machine.. [optional]  # noqa: E501
        ...
        class_id = "virtualization.VmwareVirtualNetworkInterface" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "virtualization.VmwareVirtualNetworkInterface")
        object_type = "virtualization.VmwareVirtualNetworkInterface" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "virtualization.VmwareVirtualNetworkInterface")
