...
class ApplianceDeviceClaimAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApplianceDeviceClaimAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "appliance.DeviceClaim", must be one of ["appliance.DeviceClaim", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "appliance.DeviceClaim", must be one of ["appliance.DeviceClaim", ]  # noqa: E501
            ...
            device_id (str): Device identifier of the endpoint device.. [optional]  # noqa: E501
            hostname (str): Hostname or IP address of the endpoint device the user wants to claim.. [optional]  # noqa: E501
            ...
            username (str): Username to log in to the endpoint device.. [optional]  # noqa: E501
            account (IamAccountRelationship): [optional]  # noqa: E501
            reservation (ResourceReservationRelationship): [optional]  # noqa: E501
        """

        class_id = "appliance.DeviceClaim" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "appliance.DeviceClaim")
        object_type = "appliance.DeviceClaim" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "appliance.DeviceClaim")
