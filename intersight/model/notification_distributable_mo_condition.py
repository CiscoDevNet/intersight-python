...
def lazy_import():
    ...
    from intersight.model.notification_distributable_mo_condition_all_of import NotificationDistributableMoConditionAllOf
    globals()['NotificationAbstractMoCondition'] = NotificationAbstractMoCondition
    globals()['NotificationDistributableMoConditionAllOf'] = NotificationDistributableMoConditionAllOf


class NotificationDistributableMoCondition(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NotificationDistributableMoCondition - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "notification.DistributableMoCondition", must be one of ["notification.DistributableMoCondition", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "notification.DistributableMoCondition", must be one of ["notification.DistributableMoCondition", ]  # noqa: E501
        ...
        class_id = "notification.DistributableMoCondition" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "notification.DistributableMoCondition")
        object_type = "notification.DistributableMoCondition" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "notification.DistributableMoCondition")
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ...
              NotificationDistributableMoConditionAllOf,
          ],
          'oneOf': [
          ],
        }
