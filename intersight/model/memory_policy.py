...
def lazy_import():
    ...
    from intersight.model.memory_policy_all_of import MemoryPolicyAllOf
    ...
    globals()['MemoryPolicyAllOf'] = MemoryPolicyAllOf
...
class MemoryPolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'enable_dimm_blocklisting': (bool,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'enable_dimm_blocklisting': 'EnableDimmBlocklisting',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MemoryPolicy - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "memory.Policy", must be one of ["memory.Policy", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "memory.Policy", must be one of ["memory.Policy", ]  # noqa: E501
            ...
            enable_dimm_blocklisting (bool): Enable DIMM Blocklisting on the server.. [optional] if omitted the server will use the default value of False  # noqa: E501
        ...
        class_id = "memory.Policy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "memory.Policy")
        object_type = "memory.Policy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "memory.Policy")
