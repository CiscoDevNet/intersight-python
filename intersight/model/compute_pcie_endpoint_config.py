...
def lazy_import():
    ...
    globals()['ComputePcieEndpointConfigAllOf'] = ComputePcieEndpointConfigAllOf
    globals()['MoBaseComplexType'] = MoBaseComplexType


class ComputePcieEndpointConfig(ModelComposed):
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """ComputePcieEndpointConfig - a model defined in OpenAPI
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'allOf': [
              ComputePcieEndpointConfigAllOf,
              MoBaseComplexType,
          ],
          'oneOf': [
          ],
