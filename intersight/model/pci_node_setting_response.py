...
def lazy_import():
    ...
    from intersight.model.pci_node_setting_list import PciNodeSettingList
    ...
    globals()['PciNodeSettingList'] = PciNodeSettingList


class PciNodeSettingResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'pci.NodeSetting.List': PciNodeSettingList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """PciNodeSettingResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'pci.NodeSetting' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
