...
def lazy_import():
    from intersight.model.hci_external_storage_list import HciExternalStorageList
    ...
    globals()['HciExternalStorageList'] = HciExternalStorageList
...
class HciExternalStorageResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'hci.ExternalStorage.List': HciExternalStorageList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """HciExternalStorageResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'hci.ExternalStorage' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
