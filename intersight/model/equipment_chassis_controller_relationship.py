...
class EquipmentChassisControllerRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentChassisControllerRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            equipment_type (str): The type of chassis controller. * `Unknown` - Chassis Controller equipment type is unknown. * `ECMC` - Chassis Controller equipment type is ECMC.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
            oper_reason ([str], none_type): [optional]  # noqa: E501
            oper_state (str): Operational state of chassis controller.. [optional]  # noqa: E501
