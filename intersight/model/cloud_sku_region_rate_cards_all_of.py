...
class CloudSkuRegionRateCardsAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CloudSkuRegionRateCardsAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "cloud.SkuRegionRateCards", must be one of ["cloud.SkuRegionRateCards", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "cloud.SkuRegionRateCards", must be one of ["cloud.SkuRegionRateCards", ]  # noqa: E501
            ...
            sku_name (str): The sku name associated with this rate card.. [optional]  # noqa: E501
            unit (str): The billing unit to use for computing the price. For e.g. when serviceCategory is Compute the unit will be \"Hrs\", for Storage it will be \"GB-Mo\".. [optional]  # noqa: E501
            valid_from (int): The epoch start time from which the price will be applied.. [optional]  # noqa: E501
            valid_to (int): The epoch end time of the current price.. [optional]  # noqa: E501
            region (CloudRegionsRelationship): [optional]  # noqa: E501
            sku (CloudBaseSkuRelationship): [optional]  # noqa: E501
        """

        class_id = "cloud.SkuRegionRateCards" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "cloud.SkuRegionRateCards")
        object_type = "cloud.SkuRegionRateCards" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "cloud.SkuRegionRateCards")
