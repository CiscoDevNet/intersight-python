...
def lazy_import():
    from intersight.model.apic_fabric_leaf_node_interface_list import ApicFabricLeafNodeInterfaceList
    ...
    globals()['ApicFabricLeafNodeInterfaceList'] = ApicFabricLeafNodeInterfaceList
...
class ApicFabricLeafNodeInterfaceResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'apic.FabricLeafNodeInterface.List': ApicFabricLeafNodeInterfaceList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ApicFabricLeafNodeInterfaceResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'apic.FabricLeafNodeInterface' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
