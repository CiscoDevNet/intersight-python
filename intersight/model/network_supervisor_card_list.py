...
def lazy_import():
    ...
    globals()['NetworkSupervisorCardListAllOf'] = NetworkSupervisorCardListAllOf


class NetworkSupervisorCardList(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """NetworkSupervisorCardList - a model defined in OpenAPI
