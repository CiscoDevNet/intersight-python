...
class TelemetryDruidDimensionSpec(ModelComposed):
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            dimension (str): Attributes or fields that provide context for metrics.. [optional]  # noqa: E501
            output_name (str): Name of the output dimension.. [optional]  # noqa: E501
            output_type (str): Type of the output dimension.. [optional] if omitted the server will use the default value of "STRING"  # noqa: E501
