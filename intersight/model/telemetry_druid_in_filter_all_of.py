...
class TelemetryDruidInFilterAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dimension, values, *args, **kwargs):  # noqa: E501
        """TelemetryDruidInFilterAllOf - a model defined in OpenAPI

        Args:
            dimension (str): Input column or virtual column name to filter.
            values ([str]): List of string value to match.

        Keyword Args:
            type (str): defaults to "in", must be one of ["in", ]  # noqa: E501
        ...
        type = "in" if len(kwargs.get('type','').strip()) == 0 else kwargs.get('type', "in")
    ...
    @convert_js_args_to_python_args
    def __init__(self, dimension, values, *args, **kwargs):  # noqa: E501
        """TelemetryDruidInFilterAllOf - a model defined in OpenAPI
