...
def lazy_import():
    ...
    from intersight.model.recommendation_purchase_order_list_list import RecommendationPurchaseOrderListList
    ...
    globals()['RecommendationPurchaseOrderListList'] = RecommendationPurchaseOrderListList


class RecommendationPurchaseOrderListResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'recommendation.PurchaseOrderList.List': RecommendationPurchaseOrderListList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """RecommendationPurchaseOrderListResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'recommendation.PurchaseOrderList' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
