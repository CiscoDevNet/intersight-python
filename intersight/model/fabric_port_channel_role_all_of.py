...
class FabricPortChannelRoleAllOf(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            'APPLIANCEPCROLE': "fabric.AppliancePcRole",
            'FCUPLINKPCROLE': "fabric.FcUplinkPcRole",
            'FCOEUPLINKPCROLE': "fabric.FcoeUplinkPcRole",
            'UPLINKPCROLE': "fabric.UplinkPcRole",
        },
        ('object_type',): {
            'APPLIANCEPCROLE': "fabric.AppliancePcRole",
            'FCUPLINKPCROLE': "fabric.FcUplinkPcRole",
    ...
    def openapi_types():
        ...
        return {
            ...
            'pc_id': (int,),  # noqa: E501
            'ports': ([FabricPortIdentifier], none_type,),  # noqa: E501
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """FabricPortChannelRoleAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            pc_id (int): Unique Identifier of the port-channel, local to this switch.. [optional]  # noqa: E501
            ports ([FabricPortIdentifier], none_type): [optional]  # noqa: E501
