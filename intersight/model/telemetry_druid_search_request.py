...
def lazy_import():
    ...
    globals()['TelemetryDruidAggregateSearchSpec'] = TelemetryDruidAggregateSearchSpec
    ...
    globals()['TelemetryDruidSearchRequestAllOf'] = TelemetryDruidSearchRequestAllOf


class TelemetryDruidSearchRequest(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'search_dimensions': ([str],),  # noqa: E501
            'query': (TelemetryDruidAggregateSearchSpec,),  # noqa: E501
            'limit': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'search_dimensions': 'searchDimensions',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, query_type, data_source, intervals, granularity, *args, **kwargs):  # noqa: E501
        """TelemetryDruidSearchRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            search_dimensions ([str]): The list of dimensions to run the search over. Excluding this means the search is run over all dimensions.. [optional]  # noqa: E501
            query (TelemetryDruidAggregateSearchSpec): [optional]  # noqa: E501
            limit (int): An integer that limits the number of results. The default is unlimited.. [optional]  # noqa: E501
