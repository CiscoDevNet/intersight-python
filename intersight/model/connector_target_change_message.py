...
class ConnectorTargetChangeMessage(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "connector.TargetChangeMessage" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "connector.TargetChangeMessage")
        object_type = "connector.TargetChangeMessage" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "connector.TargetChangeMessage")
