...
def lazy_import():
    ...
    globals()['BootPchStorageDeviceAllOf'] = BootPchStorageDeviceAllOf
...
class BootPchStorageDevice(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BootPchStorageDevice - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "boot.PchStorageDevice", must be one of ["boot.PchStorageDevice", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "boot.PchStorageDevice", must be one of ["boot.PchStorageDevice", ]  # noqa: E501
        ...
        class_id = "boot.PchStorageDevice" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "boot.PchStorageDevice")
        object_type = "boot.PchStorageDevice" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "boot.PchStorageDevice")
