...
class ApplianceDeviceUpgradePolicy(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            disruptive_grace_period_week (int): Updates requiring a reboot will start automatically once the grace period ends.. [optional]  # noqa: E501
            ...
            nondisruptive_grace_period_week (int): Updates not requiring a reboot will start automatically once the grace period ends.. [optional]  # noqa: E501
            ...
            software_download_type (str): UpgradeType is used to indicate the kink of software upload to upgrade. * `unknown` - Indicates user setting of upgrade service to unknown. * `connected` - Indicates if the upgrade service is set to upload software to latest version automatically. * `manual` - Indicates if the upgrade service is set to upload software to user picked verison manually.. [optional] if omitted the server will use the default value of "unknown"  # noqa: E501
        ...
        class_id = "appliance.DeviceUpgradePolicy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "appliance.DeviceUpgradePolicy")
        object_type = "appliance.DeviceUpgradePolicy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "appliance.DeviceUpgradePolicy")
