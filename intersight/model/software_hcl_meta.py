...
class SoftwareHclMeta(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            feature_source (str): The name of the feature to which the uploaded file belongs. * `System` - This indicates system initiated file uploads. * `OpenAPIImport` - This indicates an OpenAPI file upload.. [optional] if omitted the server will use the default value of "System"  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "software.HclMeta")
        object_type = kwargs.get('object_type', "software.HclMeta")
