...
def lazy_import():
    ...
    globals()['SoftwareHclMetaAllOf'] = SoftwareHclMetaAllOf
...
class SoftwareHclMeta(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SoftwareHclMeta - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "software.HclMeta", must be one of ["software.HclMeta", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "software.HclMeta", must be one of ["software.HclMeta", ]  # noqa: E501
            ...
            content_type (str): The type of content that the Json file holds (Incremental or full dump). * `Full` - Indicates that the JSON File does have full content for HCL metadata. * `Incremental` - Indicates that the JSON File does have only the diff of the Hcl meta to be uploaded.. [optional] if omitted the server will use the default value of "Full"  # noqa: E501
        ...
        class_id = "software.HclMeta" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "software.HclMeta")
        object_type = "software.HclMeta" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "software.HclMeta")
