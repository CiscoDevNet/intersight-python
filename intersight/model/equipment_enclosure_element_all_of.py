...
class EquipmentEnclosureElementAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentEnclosureElementAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "equipment.EnclosureElement", must be one of ["equipment.EnclosureElement", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "equipment.EnclosureElement", must be one of ["equipment.EnclosureElement", ]  # noqa: E501
            ...
            description (str): This field is to provide description for the Enclosure module.. [optional]  # noqa: E501
            enclosure_id (str): This field acts as the identifier for this particular Enclosure Module, within the Server or Fabric Interconnect.. [optional]  # noqa: E501
            name (str): The name of the pluggable Enclosure Module.. [optional]  # noqa: E501
            oper_reason ([str], none_type): [optional]  # noqa: E501
            oper_state (str): This field is used to indicate this equipment enclosure's operational state.. [optional]  # noqa: E501
            part_number (str): This field identifies the Part Number for this Enclosure Module.. [optional]  # noqa: E501
            pid (str): This field identifies the Product ID for the Enclosure module.. [optional]  # noqa: E501
            sku (str): This field identifies the Stockkeeping Unit for this Enclosure Module.. [optional]  # noqa: E501
            status (str): This field is to abstract the status of the Enclosure module.. [optional]  # noqa: E501
            type (str): Type of the Enclosure module.. [optional]  # noqa: E501
            vid (str): This field identifies the Vendor ID for this Enclosure Module.. [optional]  # noqa: E501
        ...
        class_id = "equipment.EnclosureElement" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "equipment.EnclosureElement")
        object_type = "equipment.EnclosureElement" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "equipment.EnclosureElement")
