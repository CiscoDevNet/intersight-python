...
def lazy_import():
    from intersight.model.functions_function_list import FunctionsFunctionList
    ...
    globals()['FunctionsFunctionList'] = FunctionsFunctionList
...
class FunctionsFunctionResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'functions.Function.List': FunctionsFunctionList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FunctionsFunctionResponse - a model defined in OpenAPI
