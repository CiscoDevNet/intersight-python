...
class TelemetryDruidTimeSeriesRequestAllOf(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, data_source, intervals, granularity, *args, **kwargs):  # noqa: E501
        """TelemetryDruidTimeSeriesRequestAllOf - a model defined in OpenAPI
