...
def lazy_import():
    ...
    from intersight.model.workload_workload_metadata_list import WorkloadWorkloadMetadataList
    ...
    globals()['WorkloadWorkloadMetadataList'] = WorkloadWorkloadMetadataList


class WorkloadWorkloadMetadataResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'workload.WorkloadMetadata.List': WorkloadWorkloadMetadataList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """WorkloadWorkloadMetadataResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'workload.WorkloadMetadata' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
