...
def lazy_import():
    from intersight.model.appliance_backup_download_list import ApplianceBackupDownloadList
    ...
    globals()['ApplianceBackupDownloadList'] = ApplianceBackupDownloadList
...
class ApplianceBackupDownloadResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'appliance.BackupDownload.List': ApplianceBackupDownloadList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ApplianceBackupDownloadResponse - a model defined in OpenAPI
