...
class KubernetesVirtualMachineInstanceTypeRelationship(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """KubernetesVirtualMachineInstanceTypeRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            cpu (int): Number of CPUs allocated to virtual machine.. [optional] if omitted the server will use the default value of 4  # noqa: E501
            disk_size (int): Ephemeral disk capacity to be provided with units example - 10Gi.. [optional]  # noqa: E501
            memory (int): Virtual machine memory defined in mebibytes (MiB).. [optional] if omitted the server will use the default value of 16384  # noqa: E501
