...
def lazy_import():
    from intersight.model.compute_scrub_policy_all_of import ComputeScrubPolicyAllOf
    ...
    globals()['ComputeScrubPolicyAllOf'] = ComputeScrubPolicyAllOf
...
class ComputeScrubPolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'scrub_targets': ([str], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'scrub_targets': 'ScrubTargets',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ComputeScrubPolicy - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "compute.ScrubPolicy", must be one of ["compute.ScrubPolicy", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "compute.ScrubPolicy", must be one of ["compute.ScrubPolicy", ]  # noqa: E501
            ...
            scrub_targets ([str], none_type): [optional]  # noqa: E501
        ...
        class_id = "compute.ScrubPolicy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "compute.ScrubPolicy")
        object_type = "compute.ScrubPolicy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "compute.ScrubPolicy")
