...
def lazy_import():
    ...
    from intersight.model.iam_ldap_policy_inventory_relationship import IamLdapPolicyInventoryRelationship
    ...
    globals()['IamLdapPolicyInventoryRelationship'] = IamLdapPolicyInventoryRelationship
...
class IamLdapProviderInventoryRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'ldap_policy': (IamLdapPolicyInventoryRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'ldap_policy': 'LdapPolicy',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IamLdapProviderInventoryRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            port (int): LDAP Server Port for connection establishment.. [optional] if omitted the server will use the default value of 389  # noqa: E501
            server (str): LDAP Server Address, such as an IP address or hostname.. [optional]  # noqa: E501
            vendor (str): LDAP server vendor type used for authentication. * `OpenLDAP` - Open source LDAP server for remote authentication. * `MSAD` - Microsoft active directory for remote authentication.. [optional] if omitted the server will use the default value of "OpenLDAP"  # noqa: E501
            ldap_policy (IamLdapPolicyInventoryRelationship): [optional]  # noqa: E501
