...
def lazy_import():
    ...
    from intersight.model.storage_pure_blade_list import StoragePureBladeList
    ...
    globals()['StoragePureBladeList'] = StoragePureBladeList


class StoragePureBladeResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'storage.PureBlade.List': StoragePureBladeList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """StoragePureBladeResponse - a model defined in OpenAPI
