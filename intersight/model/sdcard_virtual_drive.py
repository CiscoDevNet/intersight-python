...
def lazy_import():
    ...
    globals()['SdcardVirtualDriveAllOf'] = SdcardVirtualDriveAllOf


class SdcardVirtualDrive(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'DIAGNOSTICS': "sdcard.Diagnostics",
            'DRIVERS': "sdcard.Drivers",
            'HOSTUPGRADEUTILITY': "sdcard.HostUpgradeUtility",
            'OPERATINGSYSTEM': "sdcard.OperatingSystem",
            'SERVERCONFIGURATIONUTILITY': "sdcard.ServerConfigurationUtility",
            'USERPARTITION': "sdcard.UserPartition",
        },
        ('object_type',): {
            'DIAGNOSTICS': "sdcard.Diagnostics",
            'DRIVERS': "sdcard.Drivers",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """SdcardVirtualDrive - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            enable (bool): Enable the respective virtual drive to be available to the host.. [optional]  # noqa: E501
        """
