...
def lazy_import():
    ...
    from intersight.model.scheduler_schedule_policy_list import SchedulerSchedulePolicyList
    ...
    globals()['SchedulerSchedulePolicyList'] = SchedulerSchedulePolicyList


class SchedulerSchedulePolicyResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'scheduler.SchedulePolicy.List': SchedulerSchedulePolicyList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """SchedulerSchedulePolicyResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'scheduler.SchedulePolicy' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
