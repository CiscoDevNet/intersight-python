...
def lazy_import():
    ...
    globals()['TelemetryDruidSegmentMetadataRequestAllOf'] = TelemetryDruidSegmentMetadataRequestAllOf


class TelemetryDruidSegmentMetadataRequest(ModelComposed):
    ...
    def _from_openapi_data(cls, query_type, data_source, *args, **kwargs):  # noqa: E501
        """TelemetryDruidSegmentMetadataRequest - a model defined in OpenAPI
