...
class HyperflexClusterHealthCheckExecutionSnapshotResponse(ModelComposed):
    ...
    def __init__(self, object_type, *args, **kwargs):  # noqa: E501
        """HyperflexClusterHealthCheckExecutionSnapshotResponse - a model defined in OpenAPI
