...
class HclHardwareCompatibilityProfileAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            version_type (str): Type of the UCS version indicating whether it is a UCSM release vesion or a IMC release. * `UCSM` - The server is managed by UCS Manager. * `IMC` - The server is standalone managed by CIMC. * `IMM` - The server is standalone managed by Intersight.. [optional] if omitted the server will use the default value of "UCSM"  # noqa: E501
        """
