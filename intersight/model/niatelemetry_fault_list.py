...
def lazy_import():
    ...
    globals()['NiatelemetryFaultListAllOf'] = NiatelemetryFaultListAllOf


class NiatelemetryFaultList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([NiatelemetryFault], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """NiatelemetryFaultList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'niatelemetry.Fault' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
            results ([NiatelemetryFault], none_type): The array of 'niatelemetry.Fault' resources matching the request.. [optional]  # noqa: E501
        """
