...
def lazy_import():
    ...
    from intersight.model.sdaaci_connection_detail_list import SdaaciConnectionDetailList
    ...
    globals()['SdaaciConnectionDetailList'] = SdaaciConnectionDetailList


class SdaaciConnectionDetailResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'sdaaci.ConnectionDetail.List': SdaaciConnectionDetailList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """SdaaciConnectionDetailResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'sdaaci.ConnectionDetail' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
