...
class EquipmentFex(ModelComposed):
    ...
    attribute_map = {
        ...
        'discovery_state': 'DiscoveryState',  # noqa: E501
        'fans': 'Fans',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentFex - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "equipment.Fex", must be one of ["equipment.Fex", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "equipment.Fex", must be one of ["equipment.Fex", ]  # noqa: E501
            ...
            connection_path (str): Switch Id to which the FEX is connected to. The value can be A or B or AB in case of active-active topology.. [optional]  # noqa: E501
            discovery_state (str): Discovery state of IO card or fabric extender.. [optional]  # noqa: E501
        ...
        class_id = "equipment.Fex" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "equipment.Fex")
        object_type = "equipment.Fex" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "equipment.Fex")
