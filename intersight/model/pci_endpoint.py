...
def lazy_import():
    ...
    from intersight.model.pci_endpoint_all_of import PciEndpointAllOf
    ...
    from intersight.model.pci_zone_relationship import PciZoneRelationship
...
class PciEndpoint(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'device_enclosure_id': (int,),  # noqa: E501
            ...
            'pci_switch': (PciSwitchRelationship,),  # noqa: E501
            'pci_switch_port': (PciPortRelationship,),  # noqa: E501
            'pci_zone': (PciZoneRelationship,),  # noqa: E501
            'processor_unit': (ProcessorUnitRelationship,),  # noqa: E501
            'registered_device': (AssetDeviceRegistrationRelationship,),  # noqa: E501
            'shared_adapter_unit': (EquipmentSharedAdapterUnitRelationship,),  # noqa: E501
            'shared_graphics_card': (EquipmentSharedGraphicsCardRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'device_enclosure_id': 'DeviceEnclosureId',  # noqa: E501
        ...
        'pci_switch_port': 'PciSwitchPort',  # noqa: E501
        'pci_zone': 'PciZone',  # noqa: E501
        'processor_unit': 'ProcessorUnit',  # noqa: E501
        'registered_device': 'RegisteredDevice',  # noqa: E501
        'shared_adapter_unit': 'SharedAdapterUnit',  # noqa: E501
        'shared_graphics_card': 'SharedGraphicsCard',  # noqa: E501
    ...
    read_only_vars = {
        'device_enclosure_id',  # noqa: E501
        'device_id',  # noqa: E501
        'device_type',  # noqa: E501
        'endpoint_id',  # noqa: E501
        'name',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PciEndpoint - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "pci.Endpoint", must be one of ["pci.Endpoint", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "pci.Endpoint", must be one of ["pci.Endpoint", ]  # noqa: E501
            ...
            device_enclosure_id (int): The identifier of the enclosure device of the actual physical device to which the logical PCIe endpoint is pointing to.. [optional]  # noqa: E501
            device_id (int): The identifier of the actual physical device to which the logical PCIe endpoint is pointing to.. [optional]  # noqa: E501
            device_type (str): The type of the actual physical device to which the logical PCIe endpoint is pointing to. * `Unknown` - The device type of the physical device is unknown. * `NetworkAdapter` - The device type of the physical device is a NIC adapter. * `CPU` - The device type of the physical device is CPU. * `GPU` - The device type of the physical device is GPU.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
            endpoint_id (str): The identifier of the PCIe endpoint within a X-Fabric module PCIe switch.. [optional]  # noqa: E501
            name (str): The name of the PCIe endpoint, as reported by the XFM platform software (BMC).. [optional]  # noqa: E501
            oper_reason ([str], none_type): [optional]  # noqa: E501
            oper_state (str): Operational state of the PCIe endpoint.. [optional]  # noqa: E501
            inventory_device_info (InventoryDeviceInfoRelationship): [optional]  # noqa: E501
            pci_switch (PciSwitchRelationship): [optional]  # noqa: E501
            pci_switch_port (PciPortRelationship): [optional]  # noqa: E501
            pci_zone (PciZoneRelationship): [optional]  # noqa: E501
            processor_unit (ProcessorUnitRelationship): [optional]  # noqa: E501
            registered_device (AssetDeviceRegistrationRelationship): [optional]  # noqa: E501
            shared_adapter_unit (EquipmentSharedAdapterUnitRelationship): [optional]  # noqa: E501
            shared_graphics_card (EquipmentSharedGraphicsCardRelationship): [optional]  # noqa: E501
        ...
        class_id = "pci.Endpoint" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "pci.Endpoint")
        object_type = "pci.Endpoint" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "pci.Endpoint")
