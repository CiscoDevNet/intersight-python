...
def lazy_import():
    from intersight.model.catalystsdwan_port_channel_list import CatalystsdwanPortChannelList
    ...
    globals()['CatalystsdwanPortChannelList'] = CatalystsdwanPortChannelList
...
class CatalystsdwanPortChannelResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'catalystsdwan.PortChannel.List': CatalystsdwanPortChannelList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CatalystsdwanPortChannelResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'catalystsdwan.PortChannel' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
