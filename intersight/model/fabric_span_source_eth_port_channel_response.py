...
def lazy_import():
    from intersight.model.fabric_span_source_eth_port_channel_list import FabricSpanSourceEthPortChannelList
    ...
    globals()['FabricSpanSourceEthPortChannelList'] = FabricSpanSourceEthPortChannelList
...
class FabricSpanSourceEthPortChannelResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'fabric.SpanSourceEthPortChannel.List': FabricSpanSourceEthPortChannelList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FabricSpanSourceEthPortChannelResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'fabric.SpanSourceEthPortChannel' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
