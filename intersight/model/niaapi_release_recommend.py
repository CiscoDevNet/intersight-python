...
def lazy_import():
    ...
    globals()['NiaapiReleaseRecommendAllOf'] = NiaapiReleaseRecommendAllOf


class NiaapiReleaseRecommend(ModelComposed):
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """NiaapiReleaseRecommend - a model defined in OpenAPI
