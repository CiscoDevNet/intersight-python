...
def lazy_import():
    ...
    globals()['CloudInstanceTypeAllOf'] = CloudInstanceTypeAllOf
    globals()['MoBaseComplexType'] = MoBaseComplexType


class CloudInstanceType(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CloudInstanceType - a model defined in OpenAPI
        ...
        class_id = "cloud.InstanceType" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "cloud.InstanceType")
        object_type = "cloud.InstanceType" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "cloud.InstanceType")
