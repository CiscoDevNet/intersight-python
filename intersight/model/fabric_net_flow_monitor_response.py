...
def lazy_import():
    from intersight.model.fabric_net_flow_monitor_list import FabricNetFlowMonitorList
    ...
    globals()['FabricNetFlowMonitorList'] = FabricNetFlowMonitorList
...
class FabricNetFlowMonitorResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'fabric.NetFlowMonitor.List': FabricNetFlowMonitorList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """FabricNetFlowMonitorResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'fabric.NetFlowMonitor' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
