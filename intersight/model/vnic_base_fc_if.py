...
def lazy_import():
    ...
    from intersight.model.vnic_base_fc_if_all_of import VnicBaseFcIfAllOf
    ...
    globals()['VnicBaseFcIfAllOf'] = VnicBaseFcIfAllOf
...
class VnicBaseFcIf(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'FCIF': "vnic.FcIf",
            'VHBATEMPLATE': "vnic.VhbaTemplate",
        },
        ('object_type',): {
            'FCIF': "vnic.FcIf",
            'VHBATEMPLATE': "vnic.VhbaTemplate",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """VnicBaseFcIf - a model defined in OpenAPI
