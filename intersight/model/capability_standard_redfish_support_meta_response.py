...
def lazy_import():
    from intersight.model.capability_standard_redfish_support_meta_list import CapabilityStandardRedfishSupportMetaList
    ...
    globals()['CapabilityStandardRedfishSupportMetaList'] = CapabilityStandardRedfishSupportMetaList
...
class CapabilityStandardRedfishSupportMetaResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'capability.StandardRedfishSupportMeta.List': CapabilityStandardRedfishSupportMetaList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CapabilityStandardRedfishSupportMetaResponse - a model defined in OpenAPI
