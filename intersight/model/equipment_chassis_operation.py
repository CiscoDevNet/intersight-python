...
def lazy_import():
    ...
    globals()['EquipmentChassisOperationAllOf'] = EquipmentChassisOperationAllOf
...
class EquipmentChassisOperation(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'admin_power_cycle_expander_module_slot_id': (int,),  # noqa: E501
            'admin_power_cycle_slot_id': (int,),  # noqa: E501
            'admin_reset_config_slot_id': (int,),  # noqa: E501
            'chassis_operation_status': ([EquipmentChassisOperationStatus], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'admin_power_cycle_expander_module_slot_id': 'AdminPowerCycleExpanderModuleSlotId',  # noqa: E501
        'admin_power_cycle_slot_id': 'AdminPowerCycleSlotId',  # noqa: E501
        'admin_reset_config_slot_id': 'AdminResetConfigSlotId',  # noqa: E501
        'chassis_operation_status': 'ChassisOperationStatus',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentChassisOperation - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            admin_power_cycle_expander_module_slot_id (int): Slot id of the expander module slot within chassis that needs to be power cycled.. [optional]  # noqa: E501
            admin_power_cycle_slot_id (int): Slot id of the chassis slot that needs to be power cycled.. [optional]  # noqa: E501
            admin_reset_config_slot_id (int): Slot id of the chassis slot that needs to have its configuration reset.. [optional]  # noqa: E501
            chassis_operation_status ([EquipmentChassisOperationStatus], none_type): [optional]  # noqa: E501
        ...
        class_id = "equipment.ChassisOperation" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "equipment.ChassisOperation")
        object_type = "equipment.ChassisOperation" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "equipment.ChassisOperation")
