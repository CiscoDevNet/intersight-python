...
def lazy_import():
    ...
    globals()['WorkflowCliCommandAllOf'] = WorkflowCliCommandAllOf
    globals()['WorkflowExpectPrompt'] = WorkflowExpectPrompt


class WorkflowCliCommand(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'end_prompt': (str,),  # noqa: E501
            'expect_prompts': ([WorkflowExpectPrompt], none_type,),  # noqa: E501
            'expected_exit_codes': ([int], none_type,),  # noqa: E501
            'skip_status_check': (bool,),  # noqa: E501
            'terminal_end': (bool,),  # noqa: E501
            'terminal_start': (bool,),  # noqa: E501
            'type': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'end_prompt': 'EndPrompt',  # noqa: E501
        'expect_prompts': 'ExpectPrompts',  # noqa: E501
        'expected_exit_codes': 'ExpectedExitCodes',  # noqa: E501
        'skip_status_check': 'SkipStatusCheck',  # noqa: E501
        'terminal_end': 'TerminalEnd',  # noqa: E501
        'terminal_start': 'TerminalStart',  # noqa: E501
        'type': 'Type',  # noqa: E501
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """WorkflowCliCommand - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "workflow.CliCommand", must be one of ["workflow.CliCommand", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "workflow.CliCommand", must be one of ["workflow.CliCommand", ]  # noqa: E501
            ...
            command (str): The command to run on the device connector.. [optional]  # noqa: E501
            end_prompt (str): The regex string that identifies the end of the command response.. [optional]  # noqa: E501
            expect_prompts ([WorkflowExpectPrompt], none_type): [optional]  # noqa: E501
            expected_exit_codes ([int], none_type): [optional]  # noqa: E501
            skip_status_check (bool): Skips the execution status check of the terminal command. One use case for this is while exiting the terminal session from esxi host.. [optional]  # noqa: E501
            terminal_end (bool): If this flag is set, it marks the end of the terminal session where the previous commands were executed.. [optional]  # noqa: E501
            terminal_start (bool): If this flag is set, the execution of this command initiates a terminal session in which the subsequent CLI commands are executed until a command with terminalEnd flag is encountered or the end of the batch.. [optional]  # noqa: E501
            type (str): The type of the command - can be interactive or non-interactive. * `NonInteractive` - The CLI command is not an interactive command. * `Interactive` - The CLI command is executed in interactive mode and the command must provide the expects andanswers.. [optional] if omitted the server will use the default value of "NonInteractive"  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "workflow.CliCommand")
        object_type = kwargs.get('object_type', "workflow.CliCommand")
