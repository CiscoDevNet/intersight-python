...
def lazy_import():
    ...
    from intersight.model.partnerintegration_device_connector_list import PartnerintegrationDeviceConnectorList
    ...
    globals()['PartnerintegrationDeviceConnectorList'] = PartnerintegrationDeviceConnectorList


class PartnerintegrationDeviceConnectorResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'partnerintegration.DeviceConnector.List': PartnerintegrationDeviceConnectorList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """PartnerintegrationDeviceConnectorResponse - a model defined in OpenAPI
