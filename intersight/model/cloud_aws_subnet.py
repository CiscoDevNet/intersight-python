...
def lazy_import():
    ...
    globals()['CloudAwsSubnetAllOf'] = CloudAwsSubnetAllOf
...
class CloudAwsSubnet(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """CloudAwsSubnet - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "cloud.AwsSubnet", must be one of ["cloud.AwsSubnet", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "cloud.AwsSubnet", must be one of ["cloud.AwsSubnet", ]  # noqa: E501
