...
class ServicenowInventoryEntityAllOf(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            'CHANGEREQUEST': "servicenow.ChangeRequest",
            'CHANGEREQUESTDOC': "servicenow.ChangeRequestDoc",
            'INCIDENT': "servicenow.Incident",
            'INCIDENTDOC': "servicenow.IncidentDoc",
        },
        ('object_type',): {
            'CHANGEREQUEST': "servicenow.ChangeRequest",
            'CHANGEREQUESTDOC': "servicenow.ChangeRequestDoc",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """ServicenowInventoryEntityAllOf - a model defined in OpenAPI
