...
class FirmwareBaseDistributableRelationship(ModelComposed):
    ...
    allowed_values = {
        ...
        ('import_state',): {
            ...
            'IMPORTING': "Importing",
            'IMPORTED': "Imported",
            'COMPUTINGMETADATA': "ComputingMetadata",
