...
def lazy_import():
    ...
    from intersight.model.storage_pure_directory_export_relationship import StoragePureDirectoryExportRelationship
    from intersight.model.storage_pure_directory_quota_relationship import StoragePureDirectoryQuotaRelationship
    from intersight.model.storage_pure_file_systems_relationship import StoragePureFileSystemsRelationship
    ...
    globals()['StoragePureDirectoryExportRelationship'] = StoragePureDirectoryExportRelationship
    globals()['StoragePureDirectoryQuotaRelationship'] = StoragePureDirectoryQuotaRelationship
    globals()['StoragePureFileSystemsRelationship'] = StoragePureFileSystemsRelationship


class StoragePureDirectoryRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data_reduction': (int,),  # noqa: E501
            'destroyed': (bool,),  # noqa: E501
            'directory_name': (str,),  # noqa: E501
            'export_policy_list': ([str], none_type,),  # noqa: E501
            'file_system_name': (str,),  # noqa: E501
            'member_name': (str,),  # noqa: E501
            'member_resource_type': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'path': (str,),  # noqa: E501
            'policy_resource_type': (str,),  # noqa: E501
            'quota_policy_names': ([str], none_type,),  # noqa: E501
            'snapshots': (int,),  # noqa: E501
            'thin_provisioning': (int,),  # noqa: E501
            'total_physical': (int,),  # noqa: E501
            'total_reduction': (int,),  # noqa: E501
            'total_used': (int,),  # noqa: E501
            'unique': (int,),  # noqa: E501
            'array': (StoragePureArrayRelationship,),  # noqa: E501
            'export_policies': ([StoragePureDirectoryExportRelationship], none_type,),  # noqa: E501
            'file_systems': (StoragePureFileSystemsRelationship,),  # noqa: E501
            'quota_policies': ([StoragePureDirectoryQuotaRelationship], none_type,),  # noqa: E501
    ...
    read_only_vars = {
        ...
        'file_system_name',  # noqa: E501
        'member_name',  # noqa: E501
        'member_resource_type',  # noqa: E501
        'name',  # noqa: E501
        'path',  # noqa: E501
        'policy_resource_type',  # noqa: E501
        'snapshots',  # noqa: E501
        'thin_provisioning',  # noqa: E501
        'total_physical',  # noqa: E501
        'total_reduction',  # noqa: E501
        'total_used',  # noqa: E501
        'unique',  # noqa: E501
        'export_policies',  # noqa: E501
        'quota_policies',  # noqa: E501
    }

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StoragePureDirectoryRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            created_time (datetime): The managed directory creation time, measured in milliseconds since the UNIX epoch.. [optional]  # noqa: E501
            data_reduction (int): The ratio of mapped sectors within a volume versus the amount of physical space the data occupies after data compression and deduplication. The data reduction ratio does not include thin provisioning savings. For example, a data reduction ratio of 5:1 means that for every 5 MB the host writes to the array, 1 MB is stored on the array's flash modules.. [optional]  # noqa: E501
            ...
            directory_name (str): The managed directory name without the file system name prefix.. [optional]  # noqa: E501
            export_policy_list ([str], none_type): [optional]  # noqa: E501
            file_system_name (str): Name of file syetem associated with the directory.. [optional]  # noqa: E501
            member_name (str): Absolute path of the managed directory in the file system.. [optional]  # noqa: E501
            member_resource_type (str): Absolute path of the managed directory in the file system.. [optional]  # noqa: E501
            name (str): A user-specified name. The name must be locally unique and can be changed.. [optional]  # noqa: E501
            path (str): Absolute path of the managed directory in the file system.. [optional]  # noqa: E501
            policy_resource_type (str): Absolute path of the managed directory in the file system.. [optional]  # noqa: E501
            quota_policy_names ([str], none_type): [optional]  # noqa: E501
            snapshots (int): The physical space occupied by data unique to one or more snapshots. Measured in bytes.. [optional]  # noqa: E501
            thin_provisioning (int): The percentage of volume sectors that do not contain host-written data because the hosts have not written data to them or the sectors have been explicitly trimmed.. [optional]  # noqa: E501
            total_physical (int): The total physical space occupied by system, shared space, volume, and snapshot data. Measured in bytes.. [optional]  # noqa: E501
            total_reduction (int): The ratio of provisioned sectors within a volume versus the amount of physical space the data occupies after reduction via data compression and deduplication and with thin provisioning savings. Total reduction is data reduction with thin provisioning savings. For example, a total reduction ratio of 10:1 means that for every 10 MB of provisioned space, 1 MB is stored on the array's flash modules.. [optional]  # noqa: E501
            total_used (int): The total space contributed by customer data, measured in bytes.. [optional]  # noqa: E501
            unique (int): The unique physical space occupied by customer data. Unique physical space does not include shared space, snapshots, and internal array metadata. Measured in bytes. On Evergreen//One arrays, this is the effective space contributed by unique customer data, measured in bytes. Unique data does not include shared space, snapshots, and internal array metadata.. [optional]  # noqa: E501
            array (StoragePureArrayRelationship): [optional]  # noqa: E501
            export_policies ([StoragePureDirectoryExportRelationship], none_type): An array of relationships to storagePureDirectoryExport resources.. [optional]  # noqa: E501
            file_systems (StoragePureFileSystemsRelationship): [optional]  # noqa: E501
            quota_policies ([StoragePureDirectoryQuotaRelationship], none_type): An array of relationships to storagePureDirectoryQuota resources.. [optional]  # noqa: E501
