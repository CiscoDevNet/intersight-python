...
def lazy_import():
    ...
    globals()['NiatelemetryFabricPodSsAllOf'] = NiatelemetryFabricPodSsAllOf


class NiatelemetryFabricPodSs(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NiatelemetryFabricPodSs - a model defined in OpenAPI
        ...
        class_id = "niatelemetry.FabricPodSs" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "niatelemetry.FabricPodSs")
        object_type = "niatelemetry.FabricPodSs" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "niatelemetry.FabricPodSs")
