...
def lazy_import():
    ...
    from intersight.model.niatelemetry_mds_auto_claim_list import NiatelemetryMdsAutoClaimList
    ...
    globals()['NiatelemetryMdsAutoClaimList'] = NiatelemetryMdsAutoClaimList


class NiatelemetryMdsAutoClaimResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'niatelemetry.MdsAutoClaim.List': NiatelemetryMdsAutoClaimList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """NiatelemetryMdsAutoClaimResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'niatelemetry.MdsAutoClaim' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
