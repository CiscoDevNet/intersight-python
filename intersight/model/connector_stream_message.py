...
def lazy_import():
    ...
    from intersight.model.connector_stream_message_all_of import ConnectorStreamMessageAllOf
    ...
    globals()['ConnectorStreamMessageAllOf'] = ConnectorStreamMessageAllOf


class ConnectorStreamMessage(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'CLOSESTREAMMESSAGE': "connector.CloseStreamMessage",
            'FETCHSTREAMMESSAGE': "connector.FetchStreamMessage",
            'STARTSTREAM': "connector.StartStream",
            'STARTSTREAMFROMDEVICE': "connector.StartStreamFromDevice",
            'STREAMACKNOWLEDGE': "connector.StreamAcknowledge",
            'STREAMINPUT': "connector.StreamInput",
            'STREAMKEEPALIVE': "connector.StreamKeepalive",
        },
        ('object_type',): {
            'CLOSESTREAMMESSAGE': "connector.CloseStreamMessage",
            'FETCHSTREAMMESSAGE': "connector.FetchStreamMessage",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """ConnectorStreamMessage - a model defined in OpenAPI
