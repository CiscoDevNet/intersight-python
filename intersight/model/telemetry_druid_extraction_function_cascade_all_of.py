...
class TelemetryDruidExtractionFunctionCascadeAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TelemetryDruidExtractionFunctionCascadeAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            type (str): defaults to "cascade", must be one of ["cascade", ]  # noqa: E501
        ...
        type = "cascade" if len(kwargs.get('type','').strip()) == 0 else kwargs.get('type', "cascade")
