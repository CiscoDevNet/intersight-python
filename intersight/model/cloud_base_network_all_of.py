...
class CloudBaseNetworkAllOf(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """CloudBaseNetworkAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "cloud.AwsSubnet", must be one of ["cloud.AwsSubnet", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "cloud.AwsSubnet", must be one of ["cloud.AwsSubnet", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "cloud.AwsSubnet")
        object_type = kwargs.get('object_type', "cloud.AwsSubnet")
