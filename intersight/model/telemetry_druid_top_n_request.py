...
def lazy_import():
    ...
    globals()['TelemetryDruidTopNRequestAllOf'] = TelemetryDruidTopNRequestAllOf


class TelemetryDruidTopNRequest(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, query_type, data_source, intervals, granularity, dimension, threshold, metric, *args, **kwargs):  # noqa: E501
        """TelemetryDruidTopNRequest - a model defined in OpenAPI
