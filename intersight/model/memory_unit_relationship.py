...
class MemoryUnitRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MemoryUnitRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            admin_state (str): This represents the administrative state of the memory unit on a server.. [optional]  # noqa: E501
            array_id (int): This represents the memory array to which the memory unit belongs to.. [optional]  # noqa: E501
            bank (int): This represents the memory bank of the memory unit on a server.. [optional]  # noqa: E501
            capacity (str): This represents the memory capacity in MiB of the memory unit on a server.. [optional]  # noqa: E501
            clock (str): This represents the clock of the memory unit on a server.. [optional]  # noqa: E501
            form_factor (str): This represents the form factor of the memory unit on a server.. [optional]  # noqa: E501
            latency (str): This represents the latency of the memory unit on a server.. [optional]  # noqa: E501
            location (str): This represents the location of the memory unit on a server.. [optional]  # noqa: E501
            oper_power_state (str): This represents the operational power state of the memory unit on a server.. [optional]  # noqa: E501
            oper_reason ([str], none_type): [optional]  # noqa: E501
            oper_state (str): This represents the operational state of the memory unit on a server.. [optional]  # noqa: E501
            operability (str): This represents the operability of the memory unit on a server.. [optional]  # noqa: E501
            set (int): This represents the set of the memory unit on a server.. [optional]  # noqa: E501
            speed (str): This represents the speed of the memory unit on a server.. [optional]  # noqa: E501
            thermal (str): This represents the thremal state of the memory unit on a server.. [optional]  # noqa: E501
            type (str): This represents the memory type of the memory unit on a server.. [optional]  # noqa: E501
            visibility (str): This represents the visibility of the memory unit on a server.. [optional]  # noqa: E501
            width (str): This represents the width of the memory unit on a server.. [optional]  # noqa: E501
            description (str): This field displays the description of the DIMM.. [optional]  # noqa: E501
            is_platform_supported (bool): This field indicates whether the DIMM is supported on the server or not.. [optional] if omitted the server will use the default value of True  # noqa: E501
            memory_id (int): This represents the ID of a regular DIMM on a server.. [optional]  # noqa: E501
            part_number (str): This field displays the part number of the DIMM.. [optional]  # noqa: E501
            pid (str): This field displays the product ID of the DIMM.. [optional]  # noqa: E501
