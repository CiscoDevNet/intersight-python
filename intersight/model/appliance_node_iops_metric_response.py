...
def lazy_import():
    from intersight.model.appliance_node_iops_metric_list import ApplianceNodeIopsMetricList
    ...
    globals()['ApplianceNodeIopsMetricList'] = ApplianceNodeIopsMetricList
...
class ApplianceNodeIopsMetricResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'appliance.NodeIopsMetric.List': ApplianceNodeIopsMetricList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ApplianceNodeIopsMetricResponse - a model defined in OpenAPI
