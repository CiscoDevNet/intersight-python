...
class KubernetesNodeAddressAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """KubernetesNodeAddressAllOf - a model defined in OpenAPI
        ...
        class_id = "kubernetes.NodeAddress" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "kubernetes.NodeAddress")
        object_type = "kubernetes.NodeAddress" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "kubernetes.NodeAddress")
