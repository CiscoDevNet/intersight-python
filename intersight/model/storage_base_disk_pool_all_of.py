...
class StorageBaseDiskPoolAllOf(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            'HITACHIPOOL': "storage.HitachiPool",
            'NETAPPAGGREGATE': "storage.NetAppAggregate",
        },
        ('object_type',): {
            'HITACHIPOOL': "storage.HitachiPool",
            'NETAPPAGGREGATE': "storage.NetAppAggregate",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """StorageBaseDiskPoolAllOf - a model defined in OpenAPI
