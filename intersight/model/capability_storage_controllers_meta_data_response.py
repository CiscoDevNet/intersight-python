...
def lazy_import():
    from intersight.model.capability_storage_controllers_meta_data_list import CapabilityStorageControllersMetaDataList
    ...
    globals()['CapabilityStorageControllersMetaDataList'] = CapabilityStorageControllersMetaDataList
...
class CapabilityStorageControllersMetaDataResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'capability.StorageControllersMetaData.List': CapabilityStorageControllersMetaDataList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CapabilityStorageControllersMetaDataResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'capability.StorageControllersMetaData' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'oneOf': [
              CapabilityStorageControllersMetaDataList,
