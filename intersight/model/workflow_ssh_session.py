...
class WorkflowSshSession(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'capture_complete_response': (str,),  # noqa: E501
            'expected_exit_codes': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'file_transfer_to_remote': (WorkflowFileTransfer,),  # noqa: E501
            'message_type': (str,),  # noqa: E501
            'ssh_command': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'capture_complete_response': 'CaptureCompleteResponse',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            capture_complete_response (str): Flag to allow capturing entire command response as batch API output.. [optional]  # noqa: E501
            expected_exit_codes (bool, date, datetime, dict, float, int, list, str, none_type): Optional array of integer values to specify the expected exit codes of a SSH command execution. SSH command execution is marked success upon receiving any of the expected exit code from command execution. If not set, success exit code of 0 is expected from command execution.. [optional]  # noqa: E501
            file_transfer_to_remote (WorkflowFileTransfer): [optional]  # noqa: E501
            message_type (str): The type of SSH message to be sent to the remote server. * `ExecuteCommand` - Execute a SSH command on the remote server. * `NewSession` - Open a new SSH connection to the remote server. * `FileTransfer` - Transfer a file from Intersight connected device to the remote server. * `CloseSession` - Close the SSH connection to the remote server.. [optional] if omitted the server will use the default value of "ExecuteCommand"  # noqa: E501
            ssh_command (bool, date, datetime, dict, float, int, list, str, none_type): SSH command to execute on the remote server.. [optional]  # noqa: E501
            ssh_configuration (WorkflowSshConfig): [optional]  # noqa: E501
            ssh_op_timeout (str): SSH operation timeout value in seconds. The provided string value should be able to convert to respective integer value.. [optional]  # noqa: E501
        ...
        class_id = "workflow.SshSession" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "workflow.SshSession")
        object_type = "workflow.SshSession" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "workflow.SshSession")
