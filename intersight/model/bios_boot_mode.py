...
def lazy_import():
    ...
    globals()['BiosBootModeAllOf'] = BiosBootModeAllOf
...
class BiosBootMode(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BiosBootMode - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "bios.BootMode", must be one of ["bios.BootMode", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "bios.BootMode", must be one of ["bios.BootMode", ]  # noqa: E501
        ...
        class_id = "bios.BootMode" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "bios.BootMode")
        object_type = "bios.BootMode" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "bios.BootMode")
