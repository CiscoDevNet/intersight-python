...
class WorkflowWorkerTaskAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """WorkflowWorkerTaskAllOf - a model defined in OpenAPI
        ...
        class_id = "workflow.WorkerTask" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "workflow.WorkerTask")
        object_type = "workflow.WorkerTask" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "workflow.WorkerTask")
