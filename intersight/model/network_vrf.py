...
def lazy_import():
    ...
    globals()['NetworkVrfAllOf'] = NetworkVrfAllOf


class NetworkVrf(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NetworkVrf - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "network.Vrf", must be one of ["network.Vrf", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "network.Vrf", must be one of ["network.Vrf", ]  # noqa: E501
            ...
            admin_state (str): This field identifies the adminState of the given component.. [optional]  # noqa: E501
            name (str): This field identifies the name of the given component.. [optional]  # noqa: E501
            vrf_id (str): This field identifies the id of the given component.. [optional]  # noqa: E501
        ...
        class_id = "network.Vrf" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "network.Vrf")
        object_type = "network.Vrf" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "network.Vrf")
