...
def lazy_import():
    from intersight.model.hci_cluster_list import HciClusterList
    ...
    globals()['HciClusterList'] = HciClusterList
...
class HciClusterResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'hci.Cluster.List': HciClusterList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """HciClusterResponse - a model defined in OpenAPI
