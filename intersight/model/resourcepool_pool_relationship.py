...
def lazy_import():
    ...
    from intersight.model.resourcepool_qualification_policy_relationship import ResourcepoolQualificationPolicyRelationship
    ...
    globals()['ResourcepoolQualificationPolicyRelationship'] = ResourcepoolQualificationPolicyRelationship
...
class ResourcepoolPoolRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'qualification_policies': ([ResourcepoolQualificationPolicyRelationship], none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            assignment_order (str): Assignment order decides the order in which the next identifier is allocated. * `sequential` - Identifiers are assigned in a sequential order. * `default` - Assignment order is decided by the system.. [optional] if omitted the server will use the default value of "sequential"  # noqa: E501
            ...
            resource_type (str): The type of the resource present in the pool, example 'server' its combination of RackUnit and Blade. * `Server` - Resource Pool holds the server kind of resources, example - RackServer, Blade. * `None` - The resource cannot consider for Resource Pool.. [optional] if omitted the server will use the default value of "Server"  # noqa: E501
            ...
            qualification_policies ([ResourcepoolQualificationPolicyRelationship], none_type): An array of relationships to resourcepoolQualificationPolicy resources.. [optional]  # noqa: E501
