...
def lazy_import():
    ...
    from intersight.model.resourcepool_reservation_relationship import ResourcepoolReservationRelationship
    ...
    globals()['ResourcepoolReservationRelationship'] = ResourcepoolReservationRelationship
...
class ResourcepoolPoolRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'name': (str,),  # noqa: E501
            'assigned': (int,),  # noqa: E501
            'assignment_order': (str,),  # noqa: E501
            'reserved': (int,),  # noqa: E501
            'size': (int,),  # noqa: E501
            'action': (str,),  # noqa: E501
            'exported_selectors': ([ResourceSelector], none_type,),  # noqa: E501
            'pool_type': (str,),  # noqa: E501
            'resource_evaluation_status': (ResourcepoolResourceEvaluationStatus,),  # noqa: E501
            'resource_pool_parameters': (ResourcepoolResourcePoolParameters,),  # noqa: E501
            'resource_type': (str,),  # noqa: E501
            'selectors': ([ResourceSelector], none_type,),  # noqa: E501
            ...
            'reservations': ([ResourcepoolReservationRelationship], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'assignment_order': 'AssignmentOrder',  # noqa: E501
        'reserved': 'Reserved',  # noqa: E501
        'size': 'Size',  # noqa: E501
        'action': 'Action',  # noqa: E501
        'exported_selectors': 'ExportedSelectors',  # noqa: E501
        'pool_type': 'PoolType',  # noqa: E501
        'resource_evaluation_status': 'ResourceEvaluationStatus',  # noqa: E501
        'resource_pool_parameters': 'ResourcePoolParameters',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ResourcepoolPoolRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            assigned (int): Number of IDs that are currently assigned (in use).. [optional]  # noqa: E501
            assignment_order (str): Property is deprecated. Sequential is the only assignment order supported. * `sequential` - Identifiers are assigned in a sequential order. * `default` - Assignment order is decided by the system.. [optional] if omitted the server will use the default value of "sequential"  # noqa: E501
            reserved (int): Number of IDs that are currently reserved (and not in use).. [optional]  # noqa: E501
            size (int): Total number of identifiers in this pool.. [optional]  # noqa: E501
            action (str): The pool is evaluated for resources with associated policies based on action. This action will help users to re-sync the resources for a pool. * `None` - The pool will not be considered for evaluation. * `ReEvaluate` - The resources in the pool will be re-evaluated against the server pool qualification associated with it.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            exported_selectors ([ResourceSelector], none_type): [optional]  # noqa: E501
            pool_type (str): The resource management type in the pool, it can be either static or dynamic. * `Static` - The resources in the pool will not be changed until user manually update it. * `Dynamic` - The resources in the pool will be updated dynamically based on the condition. * `Hybrid` - The resources in the pool can be added by the user statically or dynamically, based on the matching conditions of the qualification policy. If the pool contains both statically added resources and resources added based on the qualification policy, the pool type can be classified as hybrid.. [optional] if omitted the server will use the default value of "Static"  # noqa: E501
            resource_evaluation_status (ResourcepoolResourceEvaluationStatus): [optional]  # noqa: E501
            resource_pool_parameters (ResourcepoolResourcePoolParameters): [optional]  # noqa: E501
            resource_type (str): The type of the resource present in the pool, example 'server' its combination of RackUnit and Blade. * `Server` - Resource Pool holds the server kind of resources, example - RackServer, Blade. * `Mixed` - Resource Pool holds the resources like Rack Server, Blade or Chassis. * `None` - The resource cannot consider for Resource Pool.. [optional] if omitted the server will use the default value of "Server"  # noqa: E501
            ...
            reservations ([ResourcepoolReservationRelationship], none_type): An array of relationships to resourcepoolReservation resources.. [optional]  # noqa: E501
