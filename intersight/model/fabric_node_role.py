...
def lazy_import():
    ...
    from intersight.model.fabric_node_role_all_of import FabricNodeRoleAllOf
    ...
    globals()['FabricNodeRoleAllOf'] = FabricNodeRoleAllOf
...
class FabricNodeRole(ModelComposed):
    ...
    attribute_map = {
        ...
        'node_slot_id': 'NodeSlotId',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FabricNodeRole - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "fabric.SecureRouterRole", must be one of ["fabric.SecureRouterRole", ]  # noqa: E501
            ...
            node_slot_id (int): Chassis slot identifier where the node is physically installed.. [optional] if omitted the server will use the default value of 1  # noqa: E501
        ...
        class_id = "fabric.SecureRouterRole" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "fabric.SecureRouterRole")
        object_type = "fabric.SecureRouterRole" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "fabric.SecureRouterRole")
