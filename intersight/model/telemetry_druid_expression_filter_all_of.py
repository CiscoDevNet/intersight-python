...
class TelemetryDruidExpressionFilterAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, expression, *args, **kwargs):  # noqa: E501
        """TelemetryDruidExpressionFilterAllOf - a model defined in OpenAPI

        Args:
            expression (str): Expression string to evaluate into true or false. See the Druid expression system for more details.
