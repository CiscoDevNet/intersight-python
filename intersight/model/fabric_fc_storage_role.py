...
def lazy_import():
    ...
    globals()['FabricFcStorageRoleAllOf'] = FabricFcStorageRoleAllOf
...
class FabricFcStorageRole(ModelComposed):
    ...
    validations = {
        ...
        ('user_label',): {
            ...
            'min_length': 0,
            'regex': {
                'pattern': r'^[ !#$%\s+&\(\)\*\+,\-\.\/:;\?@\[\]_\{\|\}~a-zA-Z0-9]*$',  # noqa: E501
            },
        },
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """FabricFcStorageRole - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "fabric.FcStorageRole", must be one of ["fabric.FcStorageRole", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "fabric.FcStorageRole", must be one of ["fabric.FcStorageRole", ]  # noqa: E501
            ...
            admin_speed (str): Admin configured speed for the port. * `16Gbps` - Admin configurable speed 16Gbps. * `8Gbps` - Admin configurable speed 8Gbps. * `32Gbps` - Admin configurable speed 32Gbps. * `64Gbps` - Admin configurable speed 64Gbps. * `Auto` - Admin configurable speed AUTO ( default ).. [optional] if omitted the server will use the default value of "16Gbps"  # noqa: E501
            vsan_id (int): Virtual San Identifier associated to the FC port.. [optional]  # noqa: E501
            ...
            user_label (str): The user defined label assigned to a Port.. [optional]  # noqa: E501
            port_policy (FabricPortPolicyRelationship): [optional]  # noqa: E501
        """

        class_id = "fabric.FcStorageRole" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "fabric.FcStorageRole")
        object_type = "fabric.FcStorageRole" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "fabric.FcStorageRole")
