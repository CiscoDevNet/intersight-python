...
class InfraBasePciConfigurationAllOf(ModelNormal):
    ...
    allowed_values = {
        ('class_id',): {
            'GPUCONFIGURATION': "infra.GpuConfiguration",
            'MIGGPUCONFIGURATION': "infra.MigGpuConfiguration",
        },
        ('object_type',): {
            'GPUCONFIGURATION': "infra.GpuConfiguration",
            'MIGGPUCONFIGURATION': "infra.MigGpuConfiguration",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """InfraBasePciConfigurationAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            device_id (int): The device Id of the GPU device.. [optional]  # noqa: E501
            vendor_id (int): The vendor Id of the GPU device.. [optional]  # noqa: E501
        """
