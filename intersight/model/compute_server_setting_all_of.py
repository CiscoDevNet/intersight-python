...
class ComputeServerSettingAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'host_init_configuration': (str,),  # noqa: E501
            ...
            'personality_setting': (ComputePersonalitySetting,),  # noqa: E501
            'reset_memory_errors': (str,),  # noqa: E501
            ...
            'storage_utility_image_operation': (ComputeStorageUtilityImageOperation,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'host_init_configuration': 'HostInitConfiguration',  # noqa: E501
        ...
        'personality_setting': 'PersonalitySetting',  # noqa: E501
        'reset_memory_errors': 'ResetMemoryErrors',  # noqa: E501
        ...
        'storage_utility_image_operation': 'StorageUtilityImageOperation',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            front_panel_lock_state (str): The allowed actions on the Front Panel Lock. * `None` - Front Panel of the server is set to None state. It is required so that the next frontPanelLockState operation can be triggered. * `Lock` - Front Panel of the server is set to Locked state. * `Unlock` - Front Panel of the server is set to Unlocked state.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            host_init_configuration (str): The JSON formatted host initialization configuration containing the basic information for doing an initial boot. The information will be sent to CIMC and stored in host-init.json file on the server. The stored file can only be access using IPMI tool on the host OS.. [optional]  # noqa: E501
            ...
            personality_setting (ComputePersonalitySetting): [optional]  # noqa: E501
            reset_memory_errors (str): Reset Correctable and Uncorrectable ECC errors on all the DIMMs present in the server. * `Ready` - Reset memory errors operation is allowed on the server in this state. * `Reset` - Trigger reset memory errors operation on a server.. [optional] if omitted the server will use the default value of "Ready"  # noqa: E501
            ...
            storage_utility_image_operation (ComputeStorageUtilityImageOperation): [optional]  # noqa: E501
        ...
        class_id = "compute.ServerSetting" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "compute.ServerSetting")
        object_type = "compute.ServerSetting" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "compute.ServerSetting")
