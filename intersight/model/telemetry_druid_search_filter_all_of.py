...
class TelemetryDruidSearchFilterAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dimension, query, *args, **kwargs):  # noqa: E501
        """TelemetryDruidSearchFilterAllOf - a model defined in OpenAPI

        Args:
            dimension (str): Input column or virtual column name to filter.
            query (TelemetryDruidQuerySpec):

        Keyword Args:
            type (str): defaults to "search", must be one of ["search", ]  # noqa: E501
        ...
        type = "search" if len(kwargs.get('type','').strip()) == 0 else kwargs.get('type', "search")
    ...
    @convert_js_args_to_python_args
    def __init__(self, dimension, query, *args, **kwargs):  # noqa: E501
        """TelemetryDruidSearchFilterAllOf - a model defined in OpenAPI
