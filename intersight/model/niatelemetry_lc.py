...
def lazy_import():
    ...
    globals()['NiatelemetryLcAllOf'] = NiatelemetryLcAllOf


class NiatelemetryLc(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """NiatelemetryLc - a model defined in OpenAPI
        ...
        class_id = "niatelemetry.Lc" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "niatelemetry.Lc")
        object_type = "niatelemetry.Lc" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "niatelemetry.Lc")
