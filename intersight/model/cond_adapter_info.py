...
def lazy_import():
    ...
    from intersight.model.cond_adapter_info_all_of import CondAdapterInfoAllOf
...
class CondAdapterInfo(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'cond.AdapterDetail': CondAdapterDetail,
            'cond.AdapterInstance': CondAdapterInstance,
        }
        if not val:
            return None
        return {'class_id': val}
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """CondAdapterInfo - a model defined in OpenAPI
