...
def lazy_import():
    ...
    from intersight.model.notification_eol_advisory_filter import NotificationEolAdvisoryFilter
    from intersight.model.notification_field_notice_advisory_filter import NotificationFieldNoticeAdvisoryFilter
    from intersight.model.notification_security_advisory_filter import NotificationSecurityAdvisoryFilter
    globals()['MoBaseComplexType'] = MoBaseComplexType
    globals()['NotificationEolAdvisoryFilter'] = NotificationEolAdvisoryFilter
    globals()['NotificationFieldNoticeAdvisoryFilter'] = NotificationFieldNoticeAdvisoryFilter
    globals()['NotificationSecurityAdvisoryFilter'] = NotificationSecurityAdvisoryFilter


class NotificationAbstractAdvisoryFilter(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'notification.EolAdvisoryFilter': NotificationEolAdvisoryFilter,
            'notification.FieldNoticeAdvisoryFilter': NotificationFieldNoticeAdvisoryFilter,
            'notification.SecurityAdvisoryFilter': NotificationSecurityAdvisoryFilter,
        }
        if not val:
            return None
        return {'class_id': val}
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """NotificationAbstractAdvisoryFilter - a model defined in OpenAPI
