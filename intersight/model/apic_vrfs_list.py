...
def lazy_import():
    ...
    from intersight.model.apic_vrfs_list_all_of import ApicVrfsListAllOf
    from intersight.model.mo_base_response import MoBaseResponse
    globals()['ApicVrfs'] = ApicVrfs
    globals()['ApicVrfsListAllOf'] = ApicVrfsListAllOf
    globals()['MoBaseResponse'] = MoBaseResponse


class ApicVrfsList(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'count': (int,),  # noqa: E501
            'results': ([ApicVrfs], none_type,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ApicVrfsList - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'apic.Vrfs' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
            results ([ApicVrfs], none_type): The array of 'apic.Vrfs' resources matching the request.. [optional]  # noqa: E501
        """
