...
class ChassisConfigResultEntryAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ChassisConfigResultEntryAllOf - a model defined in OpenAPI
        ...
        class_id = "chassis.ConfigResultEntry" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "chassis.ConfigResultEntry")
        object_type = "chassis.ConfigResultEntry" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "chassis.ConfigResultEntry")
