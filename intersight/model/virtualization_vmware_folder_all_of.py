...
class VirtualizationVmwareFolderAllOf(ModelNormal):
    ...
    allowed_values = {
        ...
        ('typeof_folder',): {
            'UNKNOWN': "Unknown",
            'VMTEMPLATEFOLDER': "VMTemplateFolder",
            'STORAGEFOLDER': "StorageFolder",
            'HOSTCLUSTERFOLDER': "HostClusterFolder",
    ...
    def openapi_types():
        ...
        return {
            ...
            'vmware_folder': (VirtualizationVmwareFolderRelationship,),  # noqa: E501
        }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """VirtualizationVmwareFolderAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "virtualization.VmwareFolder", must be one of ["virtualization.VmwareFolder", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "virtualization.VmwareFolder", must be one of ["virtualization.VmwareFolder", ]  # noqa: E501
            ...
            vmware_folder (VirtualizationVmwareFolderRelationship): [optional]  # noqa: E501
        """
