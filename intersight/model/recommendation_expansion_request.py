...
def lazy_import():
    ...
    globals()['RecommendationExpansionRequestAllOf'] = RecommendationExpansionRequestAllOf
    globals()['RecommendationHardwareExpansionRequest'] = RecommendationHardwareExpansionRequest


class RecommendationExpansionRequest(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RecommendationExpansionRequest - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "recommendation.HardwareExpansionRequest", must be one of ["recommendation.HardwareExpansionRequest", ]  # noqa: E501
            ...
            name (str): The name of the expansion specification.. [optional]  # noqa: E501
            request_time (datetime): The time when the expansion was requested.. [optional]  # noqa: E501
        ...
        class_id = "recommendation.HardwareExpansionRequest" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "recommendation.HardwareExpansionRequest")
        object_type = "recommendation.HardwareExpansionRequest" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "recommendation.HardwareExpansionRequest")
