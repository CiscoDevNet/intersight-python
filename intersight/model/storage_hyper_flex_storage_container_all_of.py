...
class StorageHyperFlexStorageContainerAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StorageHyperFlexStorageContainerAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "storage.HyperFlexStorageContainer", must be one of ["storage.HyperFlexStorageContainer", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "storage.HyperFlexStorageContainer", must be one of ["storage.HyperFlexStorageContainer", ]  # noqa: E501
            ...
            data_block_size (int): Storage Container data block size. [optional]  # noqa: E501
            ...
            provisioned_capacity (int): Provisioned Capacity of the Storage container.. [optional]  # noqa: E501
        ...
        class_id = "storage.HyperFlexStorageContainer" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "storage.HyperFlexStorageContainer")
        object_type = "storage.HyperFlexStorageContainer" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "storage.HyperFlexStorageContainer")
