...
def lazy_import():
    from intersight.model.equipment_shared_graphics_card_list import EquipmentSharedGraphicsCardList
    ...
    globals()['EquipmentSharedGraphicsCardList'] = EquipmentSharedGraphicsCardList
...
class EquipmentSharedGraphicsCardResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'equipment.SharedGraphicsCard.List': EquipmentSharedGraphicsCardList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """EquipmentSharedGraphicsCardResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'equipment.SharedGraphicsCard' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'oneOf': [
              EquipmentSharedGraphicsCardList,
