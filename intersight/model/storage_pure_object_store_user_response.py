...
def lazy_import():
    ...
    from intersight.model.storage_pure_object_store_user_list import StoragePureObjectStoreUserList
    ...
    globals()['StoragePureObjectStoreUserList'] = StoragePureObjectStoreUserList


class StoragePureObjectStoreUserResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'storage.PureObjectStoreUser.List': StoragePureObjectStoreUserList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """StoragePureObjectStoreUserResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'storage.PureObjectStoreUser' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'oneOf': [
              ...
              MoDocumentCount,
              MoTagSummary,
              StoragePureObjectStoreUserList,
          ],
        }
