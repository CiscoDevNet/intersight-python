...
class TelemetryDruidSegmentMetadataRequestAllOf(ModelNormal):
    ...
    def __init__(self, data_source, *args, **kwargs):  # noqa: E501
        """TelemetryDruidSegmentMetadataRequestAllOf - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            intervals ([str]): A JSON Object representing ISO-8601 Intervals. This defines the time ranges to run the query over. If an interval is not specified, the query will use a default interval that spans a configurable period before the end time of the most recent segment.. [optional]  # noqa: E501
