...
def lazy_import():
    ...
    globals()['ApplianceBackupAllOf'] = ApplianceBackupAllOf
...
class ApplianceBackup(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApplianceBackup - a model defined in OpenAPI
        ...
        class_id = "appliance.Backup" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "appliance.Backup")
        object_type = "appliance.Backup" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "appliance.Backup")
