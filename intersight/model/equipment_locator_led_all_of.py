...
class EquipmentLocatorLedAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """EquipmentLocatorLedAllOf - a model defined in OpenAPI
        ...
        class_id = "equipment.LocatorLed" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "equipment.LocatorLed")
        object_type = "equipment.LocatorLed" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "equipment.LocatorLed")
