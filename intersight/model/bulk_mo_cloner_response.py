...
def lazy_import():
    from intersight.model.bulk_mo_cloner_list import BulkMoClonerList
    ...
    globals()['BulkMoClonerList'] = BulkMoClonerList
...
class BulkMoClonerResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'bulk.MoCloner.List': BulkMoClonerList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """BulkMoClonerResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'bulk.MoCloner' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
