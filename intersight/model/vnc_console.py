...
def lazy_import():
    ...
    from intersight.model.vnc_console_all_of import VncConsoleAllOf
    ...
    globals()['VncConsoleAllOf'] = VncConsoleAllOf


class VncConsole(ModelComposed):
    ...
    read_only_vars = {
        ...
        'client_url',  # noqa: E501
    }

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VncConsole - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "vnc.Console", must be one of ["vnc.Console", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "vnc.Console", must be one of ["vnc.Console", ]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "vnc.Console")
        object_type = kwargs.get('object_type', "vnc.Console")
