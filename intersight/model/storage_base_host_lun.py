...
def lazy_import():
    ...
    globals()['StorageBaseHostLunAllOf'] = StorageBaseHostLunAllOf
...
class StorageBaseHostLun(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'HITACHIHOSTLUN': "storage.HitachiHostLun",
            'NETAPPLUNMAP': "storage.NetAppLunMap",
            'PUREHOSTLUN': "storage.PureHostLun",
        },
        ('object_type',): {
            'HITACHIHOSTLUN': "storage.HitachiHostLun",
            'NETAPPLUNMAP': "storage.NetAppLunMap",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """StorageBaseHostLun - a model defined in OpenAPI
