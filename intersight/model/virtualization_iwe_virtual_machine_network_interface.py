...
def lazy_import():
    ...
    from intersight.model.virtualization_iwe_virtual_machine_network_interface_all_of import VirtualizationIweVirtualMachineNetworkInterfaceAllOf
    from intersight.model.virtualization_iwe_virtual_machine_relationship import VirtualizationIweVirtualMachineRelationship
    ...
    globals()['VirtualizationIweVirtualMachineNetworkInterfaceAllOf'] = VirtualizationIweVirtualMachineNetworkInterfaceAllOf
    globals()['VirtualizationIweVirtualMachineRelationship'] = VirtualizationIweVirtualMachineRelationship


class VirtualizationIweVirtualMachineNetworkInterface(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'primary_ip_address': (str,),  # noqa: E501
            'status': (str,),  # noqa: E501
            'virtual_machine_name': (str,),  # noqa: E501
            'cluster': (VirtualizationIweClusterRelationship,),  # noqa: E501
            'network': (VirtualizationIweNetworkRelationship,),  # noqa: E501
            'virtual_machine': (VirtualizationIweVirtualMachineRelationship,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'primary_ip_address': 'PrimaryIpAddress',  # noqa: E501
        'status': 'Status',  # noqa: E501
        'virtual_machine_name': 'VirtualMachineName',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VirtualizationIweVirtualMachineNetworkInterface - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "virtualization.IweVirtualMachineNetworkInterface", must be one of ["virtualization.IweVirtualMachineNetworkInterface", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "virtualization.IweVirtualMachineNetworkInterface", must be one of ["virtualization.IweVirtualMachineNetworkInterface", ]  # noqa: E501
            ...
            interface_name (str): Operating system assigned name for network interface.. [optional]  # noqa: E501
            ip_address ([str], none_type): [optional]  # noqa: E501
            primary_ip_address (str): Primary IP address of the network interface.. [optional]  # noqa: E501
            status (str): Current status of virtual network interface status. * `Up` - Virtual network interface is up and running. * `Down` - Virtual network interface is down and not running.. [optional] if omitted the server will use the default value of "Up"  # noqa: E501
            virtual_machine_name (str): A reference to the virtual machine where this network object is attached to.. [optional]  # noqa: E501
            ...
            virtual_machine (VirtualizationIweVirtualMachineRelationship): [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "virtualization.IweVirtualMachineNetworkInterface")
        object_type = kwargs.get('object_type', "virtualization.IweVirtualMachineNetworkInterface")
