...
def lazy_import():
    ...
    from intersight.model.task_workflow_action_list import TaskWorkflowActionList
    ...
    globals()['TaskWorkflowActionList'] = TaskWorkflowActionList


class TaskWorkflowActionResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'task.WorkflowAction.List': TaskWorkflowActionList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """TaskWorkflowActionResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'task.WorkflowAction' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
