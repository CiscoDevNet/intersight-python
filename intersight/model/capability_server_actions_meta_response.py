...
def lazy_import():
    from intersight.model.capability_server_actions_meta_list import CapabilityServerActionsMetaList
    ...
    globals()['CapabilityServerActionsMetaList'] = CapabilityServerActionsMetaList
...
class CapabilityServerActionsMetaResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'capability.ServerActionsMeta.List': CapabilityServerActionsMetaList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CapabilityServerActionsMetaResponse - a model defined in OpenAPI
