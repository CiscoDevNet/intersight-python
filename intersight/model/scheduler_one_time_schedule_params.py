...
class SchedulerOneTimeScheduleParams(ModelComposed):
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """SchedulerOneTimeScheduleParams - a model defined in OpenAPI
