...
def lazy_import():
    ...
    from intersight.model.telemetry_druid_range_filter_all_of import TelemetryDruidRangeFilterAllOf
    globals()['TelemetryDruidBaseFilter'] = TelemetryDruidBaseFilter
    globals()['TelemetryDruidRangeFilterAllOf'] = TelemetryDruidRangeFilterAllOf


class TelemetryDruidRangeFilter(ModelComposed):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, column, match_value_type, *args, **kwargs):  # noqa: E501
        """TelemetryDruidRangeFilter - a model defined in OpenAPI

        Keyword Args:
            type (str): defaults to "range", must be one of ["range", ]  # noqa: E501
        ...
        type = "range" if len(kwargs.get('type','').strip()) == 0 else kwargs.get('type', "range")
        ...
        required_args = {
            'type': type,
            'column': column,
            'match_value_type': match_value_type,
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, column, match_value_type, *args, **kwargs):  # noqa: E501
        """TelemetryDruidRangeFilter - a model defined in OpenAPI
