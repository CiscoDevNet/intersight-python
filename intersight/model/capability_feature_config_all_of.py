...
class CapabilityFeatureConfigAllOf(ModelNormal):
    ...
    allowed_values = {
        ...
        ('feature_name',): {
            ...
            'AZURE_STACK_HOST_QOS': "Azure Stack Host QOS",
            'GENEVE_OFFLOAD': "GENEVE Offload",
            'QINQ': "QinQ",
            'SRIOV': "SRIOV",
            'ETHER_CHANNEL_PINNING': "Ether Channel Pinning",
        },
    ...
    def openapi_types():
        ...
        return {
            ...
            'min_adapter_fw_version': (str,),  # noqa: E501
            ...
            'unsupported_feature_matrix': ([CapabilityUnsupportedFeatureConfig], none_type,),  # noqa: E501
            'validation_action': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'min_adapter_fw_version': 'MinAdapterFwVersion',  # noqa: E501
        ...
        'unsupported_feature_matrix': 'UnsupportedFeatureMatrix',  # noqa: E501
        'validation_action': 'ValidationAction',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            unsupported_feature_matrix ([CapabilityUnsupportedFeatureConfig], none_type): [optional]  # noqa: E501
            validation_action (str): Action to be taken when validation does not succeed. * `Error` - Stop workflow execution by throwing error. * `Skip` - Remove the feature from configuration and continue workflow execution.. [optional] if omitted the server will use the default value of "Error"  # noqa: E501
        """

        class_id = "capability.FeatureConfig" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "capability.FeatureConfig")
        object_type = "capability.FeatureConfig" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "capability.FeatureConfig")
