...
def lazy_import():
    ...
    globals()['WorkflowTaskInfoAllOf'] = WorkflowTaskInfoAllOf
...
class WorkflowTaskInfo(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """WorkflowTaskInfo - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            input (bool, date, datetime, dict, float, int, list, str, none_type): The input data that was sent to the task at the start of execution.. [optional]  # noqa: E501
            ...
            output (bool, date, datetime, dict, float, int, list, str, none_type): The output data that was generated by this task.. [optional]  # noqa: E501
            ref_name (str): The task reference name to ensure its unique inside a workflow.. [optional]  # noqa: E501
            retry_count (int): A counter for number of retries.. [optional]  # noqa: E501
        ...
        class_id = kwargs.get('class_id', "workflow.TaskInfo")
        object_type = kwargs.get('object_type', "workflow.TaskInfo")
