...
class RecommendationHardwareExpansionRequestItemRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RecommendationHardwareExpansionRequestItemRelationship - a model defined in OpenAPI
