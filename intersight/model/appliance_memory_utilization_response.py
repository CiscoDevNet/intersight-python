...
def lazy_import():
    from intersight.model.appliance_memory_utilization_list import ApplianceMemoryUtilizationList
    ...
    globals()['ApplianceMemoryUtilizationList'] = ApplianceMemoryUtilizationList
...
class ApplianceMemoryUtilizationResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'appliance.MemoryUtilization.List': ApplianceMemoryUtilizationList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ApplianceMemoryUtilizationResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'appliance.MemoryUtilization' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'oneOf': [
              ApplianceMemoryUtilizationList,
