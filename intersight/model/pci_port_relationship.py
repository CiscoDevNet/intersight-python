...
class PciPortRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PciPortRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): The name of the PCIe Switch Port. Name will be of the format 'PCIe Port <$id>'.. [optional]  # noqa: E501
            oper_reason ([str], none_type): [optional]  # noqa: E501
            oper_state (str): The operational status of the PCIe switch port.. [optional]  # noqa: E501
            port_id (int): The identifier of the PCIe switch port.. [optional]  # noqa: E501
            role (str): The current role of the PCIe switch port. * `Unconfigured` - Indicates that the PCIe switch port role is currently unconfigured. * `Downstream` - Indicates that the PCIe switch port role is currently downstream. A downstream port connects to a PCIe peripheral device such as a GPU or a network adapter. * `Upstream` - Indicates that the PCIe switch port role is currently upstream. An upstream port connects to a PCIe root complex such as a CPU. * `Unknown` - Indicates that the PCIe switch port role is currently unknown.. [optional] if omitted the server will use the default value of "Unconfigured"  # noqa: E501
            width (int): The link width of the PCIe switch port.. [optional]  # noqa: E501
