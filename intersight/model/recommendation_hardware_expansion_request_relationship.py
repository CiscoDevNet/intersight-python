...
def lazy_import():
    ...
    globals()['RecommendationHardwareExpansionRequestItemRelationship'] = RecommendationHardwareExpansionRequestItemRelationship


class RecommendationHardwareExpansionRequestRelationship(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'hw_expansion_request_items': ([RecommendationHardwareExpansionRequestItemRelationship], none_type,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'hw_expansion_request_items': 'HwExpansionRequestItems',  # noqa: E501
    ...
    read_only_vars = {
        ...
        'message',  # noqa: E501
        'status',  # noqa: E501
        'hw_expansion_request_items',  # noqa: E501
    }

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """RecommendationHardwareExpansionRequestRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            action (str): Action to be triggered for computing recommendation. Default value is None. * `None` - The Enum value None represents that no action is triggered on the forecast Instance managed object. * `Evaluate` - The Enum value Evaluate represents that a re-evaluation of the forecast needs to be triggered.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            message (str): User visible error message for the Hardware Expansion request.. [optional]  # noqa: E501
            status (str): Status of the Hardware Expansion request. * `None` - The Enum value None represents the default status value before any API call is made. * `Success` - The Enum value Success represents that the API call returned with success. * `Fail` - The Enum value Fail represents that the API call returned with a failure.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
            hw_expansion_request_items ([RecommendationHardwareExpansionRequestItemRelationship], none_type): An array of relationships to recommendationHardwareExpansionRequestItem resources.. [optional]  # noqa: E501
