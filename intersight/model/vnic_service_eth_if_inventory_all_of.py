...
class VnicServiceEthIfInventoryAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VnicServiceEthIfInventoryAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "vnic.ServiceEthIfInventory", must be one of ["vnic.ServiceEthIfInventory", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "vnic.ServiceEthIfInventory", must be one of ["vnic.ServiceEthIfInventory", ]  # noqa: E501
            ...
            adapter_id (str): Adapter Information for server.. [optional]  # noqa: E501
            name (str): Name of the service virtual ethernet interface.. [optional]  # noqa: E501
            ...
            vif_id (int): The Vif Id should be same as the channel number of the vethernet created on switch in order to set up the data path. The property is applicable only for Fabric Interconnect attached servers where a vethernet is created on the switch for every vNIC.. [optional]  # noqa: E501
        """

        class_id = "vnic.ServiceEthIfInventory" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "vnic.ServiceEthIfInventory")
        object_type = "vnic.ServiceEthIfInventory" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "vnic.ServiceEthIfInventory")
