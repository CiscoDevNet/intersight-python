...
class ApplianceSetupInfo(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'min_cpu': (int,),  # noqa: E501
            'min_ram': (int,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'min_cpu': 'MinCpu',  # noqa: E501
        'min_ram': 'MinRam',  # noqa: E501
    ...
    read_only_vars = {
        'build_type',  # noqa: E501
        'cloud_url',  # noqa: E501
        'deployment_mode',  # noqa: E501
        'end_time',  # noqa: E501
        'latest_version',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "appliance.SetupInfo", must be one of ["appliance.SetupInfo", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "appliance.SetupInfo", must be one of ["appliance.SetupInfo", ]  # noqa: E501
            ...
            min_cpu (int): The minimum cpu required of the node in cluster.. [optional]  # noqa: E501
            min_ram (int): The minimum ram required of the node in cluster.. [optional]  # noqa: E501
        ...
        class_id = "appliance.SetupInfo" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "appliance.SetupInfo")
        object_type = "appliance.SetupInfo" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "appliance.SetupInfo")
