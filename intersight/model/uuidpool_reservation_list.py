...
def lazy_import():
    ...
    globals()['UuidpoolReservationListAllOf'] = UuidpoolReservationListAllOf


class UuidpoolReservationList(ModelComposed):
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """UuidpoolReservationList - a model defined in OpenAPI
