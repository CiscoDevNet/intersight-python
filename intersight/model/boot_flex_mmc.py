...
def lazy_import():
    ...
    from intersight.model.boot_flex_mmc_all_of import BootFlexMmcAllOf
    globals()['BootDeviceBase'] = BootDeviceBase
    globals()['BootFlexMmcAllOf'] = BootFlexMmcAllOf


class BootFlexMmc(ModelComposed):
    ...
    allowed_values = {
        ...
        ('subtype',): {
            'NONE': "None",
            'FLEXMMC-MAPPED-DVD': "flexmmc-mapped-dvd",
            'FLEXMMC-MAPPED-HDD': "flexmmc-mapped-hdd",
        },
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """BootFlexMmc - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "boot.FlexMmc", must be one of ["boot.FlexMmc", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "boot.FlexMmc", must be one of ["boot.FlexMmc", ]  # noqa: E501
            ...
            subtype (str): The subtype for the selected device type. * `None` - No sub type for FlexMMC boot device. * `flexmmc-mapped-dvd` - Use of FlexMMC DVD as subtype for embedded storage. * `flexmmc-mapped-hdd` - Use of FlexMMC HDD as subtype for embedded storage.. [optional] if omitted the server will use the default value of "None"  # noqa: E501
