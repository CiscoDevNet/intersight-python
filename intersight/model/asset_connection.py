...
def lazy_import():
    ...
    globals()['AssetConnectionAllOf'] = AssetConnectionAllOf
...
class AssetConnection(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'CLOUDCONNECTION': "asset.CloudConnection",
            'HTTPCONNECTION': "asset.HttpConnection",
            'INTERSIGHTDEVICECONNECTORCONNECTION': "asset.IntersightDeviceConnectorConnection",
        },
        ('object_type',): {
            'CLOUDCONNECTION': "asset.CloudConnection",
            'HTTPCONNECTION': "asset.HttpConnection",
    ...
    def __init__(self, class_id, object_type, *args, **kwargs):  # noqa: E501
        """AssetConnection - a model defined in OpenAPI
