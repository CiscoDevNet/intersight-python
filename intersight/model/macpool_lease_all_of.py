...
class MacpoolLeaseAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'preferred_mac_address': (str,),  # noqa: E501
            'reservation': (MacpoolReservationReference,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'preferred_mac_address': 'PreferredMacAddress',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """MacpoolLeaseAllOf - a model defined in OpenAPI
        ...
        class_id = "macpool.Lease" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "macpool.Lease")
        object_type = "macpool.Lease" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "macpool.Lease")
