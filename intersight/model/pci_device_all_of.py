...
class PciDeviceAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PciDeviceAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "pci.Device", must be one of ["pci.Device", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "pci.Device", must be one of ["pci.Device", ]  # noqa: E501
            ...
            device_id (str): The PCI device id of the PCI device.. [optional]  # noqa: E501
            firmware_version (str): The running firmware version of the PCI device.. [optional]  # noqa: E501
            pid (str): The product identifier of the PCI device.. [optional]  # noqa: E501
            slot_id (str): The PCI slot id of the PCI device.. [optional]  # noqa: E501
        ...
        class_id = "pci.Device" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "pci.Device")
        object_type = "pci.Device" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "pci.Device")
