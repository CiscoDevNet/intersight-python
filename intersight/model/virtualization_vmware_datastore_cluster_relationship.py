...
class VirtualizationVmwareDatastoreClusterRelationship(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """VirtualizationVmwareDatastoreClusterRelationship - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            datastore_count (int): Number of datastores present in this datastore cluster.. [optional]  # noqa: E501
            host_count (int): Number of hosts attached to or supported-by this datastore cluster.. [optional]  # noqa: E501
            identity (str): The internally generated identity of this datastore cluster. This entity is not manipulated by users. It aids in uniquely identifying the datastore cluster object. For VMware, this is an MOR (managed object reference).. [optional]  # noqa: E501
            name (str): Name of the Datastore Cluster.. [optional]  # noqa: E501
            type (str): Type of the Datastore Cluster. * `Unknown` - The nature of the file system is unknown. * `VMFS` - It is a Virtual Machine Filesystem. * `NFS` - It is a Network File System. * `vSAN` - It is a virtual Storage Area Network file system. * `VirtualVolume` - A Virtual Volume datastore represents a storage container in a hypervisor server.. [optional] if omitted the server will use the default value of "Unknown"  # noqa: E501
            vm_count (int): Number of virtual machines relying on (using) this datastore cluster.. [optional]  # noqa: E501
