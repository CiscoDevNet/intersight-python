...
def lazy_import():
    ...
    globals()['AdapterConfigPolicyAllOf'] = AdapterConfigPolicyAllOf
...
class AdapterConfigPolicy(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'settings': ([AdapterAdapterConfig], none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AdapterConfigPolicy - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "adapter.ConfigPolicy", must be one of ["adapter.ConfigPolicy", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "adapter.ConfigPolicy", must be one of ["adapter.ConfigPolicy", ]  # noqa: E501
            ...
            settings ([AdapterAdapterConfig], none_type): [optional]  # noqa: E501
        ...
        class_id = "adapter.ConfigPolicy" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "adapter.ConfigPolicy")
        object_type = "adapter.ConfigPolicy" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "adapter.ConfigPolicy")
