...
def lazy_import():
    ...
    globals()['TelemetryDruidJoinDataSourceAllOf'] = TelemetryDruidJoinDataSourceAllOf


class TelemetryDruidJoinDataSource(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, left, right, right_prefix, condition, join_type, *args, **kwargs):  # noqa: E501
        """TelemetryDruidJoinDataSource - a model defined in OpenAPI
