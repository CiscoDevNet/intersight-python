...
class CapabilityServerActionsMetaAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CapabilityServerActionsMetaAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "capability.ServerActionsMeta", must be one of ["capability.ServerActionsMeta", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "capability.ServerActionsMeta", must be one of ["capability.ServerActionsMeta", ]  # noqa: E501
            ...
            action_name (str): Action which will be supported using the HSU.. [optional]  # noqa: E501
            min_supported_version (str): Firmware version below which host operation is not supported.. [optional]  # noqa: E501
        ...
        class_id = "capability.ServerActionsMeta" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "capability.ServerActionsMeta")
        object_type = "capability.ServerActionsMeta" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "capability.ServerActionsMeta")
