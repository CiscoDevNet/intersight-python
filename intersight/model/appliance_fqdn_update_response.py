...
def lazy_import():
    from intersight.model.appliance_fqdn_update_list import ApplianceFqdnUpdateList
    ...
    globals()['ApplianceFqdnUpdateList'] = ApplianceFqdnUpdateList
...
class ApplianceFqdnUpdateResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'appliance.FqdnUpdate.List': ApplianceFqdnUpdateList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ApplianceFqdnUpdateResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'appliance.FqdnUpdate' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
