...
class PciSwitchAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "pci.Switch" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "pci.Switch")
        object_type = "pci.Switch" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "pci.Switch")
