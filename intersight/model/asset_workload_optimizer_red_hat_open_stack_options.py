...
def lazy_import():
    ...
    globals()['AssetWorkloadOptimizerRedHatOpenStackOptionsAllOf'] = AssetWorkloadOptimizerRedHatOpenStackOptionsAllOf


class AssetWorkloadOptimizerRedHatOpenStackOptions(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        class_id = "asset.WorkloadOptimizerRedHatOpenStackOptions" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "asset.WorkloadOptimizerRedHatOpenStackOptions")
        object_type = "asset.WorkloadOptimizerRedHatOpenStackOptions" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "asset.WorkloadOptimizerRedHatOpenStackOptions")
