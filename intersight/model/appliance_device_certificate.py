...
def lazy_import():
    ...
    globals()['ApplianceDeviceCertificateAllOf'] = ApplianceDeviceCertificateAllOf
...
class ApplianceDeviceCertificate(ModelComposed):
    ...
    read_only_vars = {
        'ca_certificate',  # noqa: E501
        'ca_certificate_expiry_time',  # noqa: E501
        'certificate_renewal_expiry_time',  # noqa: E501
        'end_time',  # noqa: E501
        'last_success_poll_time',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ApplianceDeviceCertificate - a model defined in OpenAPI
        ...
        class_id = "appliance.DeviceCertificate" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "appliance.DeviceCertificate")
        object_type = "appliance.DeviceCertificate" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "appliance.DeviceCertificate")
