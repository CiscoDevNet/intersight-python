...
def lazy_import():
    from intersight.model.capability_vic_descriptor_list import CapabilityVicDescriptorList
    ...
    globals()['CapabilityVicDescriptorList'] = CapabilityVicDescriptorList
...
class CapabilityVicDescriptorResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'capability.VicDescriptor.List': CapabilityVicDescriptorList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """CapabilityVicDescriptorResponse - a model defined in OpenAPI
