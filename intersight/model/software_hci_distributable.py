...
def lazy_import():
    ...
    from intersight.model.software_hci_distributable_all_of import SoftwareHciDistributableAllOf
    ...
    globals()['SoftwareHciDistributableAllOf'] = SoftwareHciDistributableAllOf
...
class SoftwareHciDistributable(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'meta_info': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SoftwareHciDistributable - a model defined in OpenAPI

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data.. defaults to "software.HciDistributable", must be one of ["software.HciDistributable", ]  # noqa: E501
            object_type (str): The fully-qualified name of the instantiated, concrete type. The value should be the same as the 'ClassId' property.. defaults to "software.HciDistributable", must be one of ["software.HciDistributable", ]  # noqa: E501
            ...
            meta_info (bool, date, datetime, dict, float, int, list, str, none_type): Additional information associated with the distributable object. This data is provided as a JSON blob by Nutanix, a partner vendor, and the format is not fixed.. [optional]  # noqa: E501
        ...
        class_id = "software.HciDistributable" if len(kwargs.get('class_id','').strip()) == 0 else kwargs.get('class_id', "software.HciDistributable")
        object_type = "software.HciDistributable" if len(kwargs.get('object_type','').strip()) == 0 else kwargs.get('object_type', "software.HciDistributable")
