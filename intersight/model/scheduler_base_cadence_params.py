...
def lazy_import():
    ...
    from intersight.model.scheduler_yearly_cadence_params import SchedulerYearlyCadenceParams
    ...
    globals()['SchedulerYearlyCadenceParams'] = SchedulerYearlyCadenceParams
...
class SchedulerBaseCadenceParams(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'scheduler.YearlyCadenceParams': SchedulerYearlyCadenceParams,
        }
        if not val:
            return None
        return {'class_id': val}
