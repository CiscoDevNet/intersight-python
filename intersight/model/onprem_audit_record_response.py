...
def lazy_import():
    ...
    from intersight.model.onprem_audit_record_list import OnpremAuditRecordList
    ...
    globals()['OnpremAuditRecordList'] = OnpremAuditRecordList


class OnpremAuditRecordResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'onprem.AuditRecord.List': OnpremAuditRecordList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """OnpremAuditRecordResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'onprem.AuditRecord' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
