...
class VirtualizationBaseVswitch(ModelComposed):
    ...
    allowed_values = {
        ('class_id',): {
            'IWEDVSWITCH': "virtualization.IweDvswitch",
            'IWEHOSTVSWITCH': "virtualization.IweHostVswitch",
            'VMWAREDISTRIBUTEDSWITCH': "virtualization.VmwareDistributedSwitch",
            'VMWAREVIRTUALSWITCH': "virtualization.VmwareVirtualSwitch",
        },
        ('object_type',): {
            'IWEDVSWITCH': "virtualization.IweDvswitch",
            'IWEHOSTVSWITCH': "virtualization.IweHostVswitch",
    ...
    def _from_openapi_data(cls, class_id, object_type, *args, **kwargs):  # noqa: E501
        """VirtualizationBaseVswitch - a model defined in OpenAPI
