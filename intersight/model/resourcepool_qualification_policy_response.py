...
def lazy_import():
    ...
    from intersight.model.resourcepool_qualification_policy_list import ResourcepoolQualificationPolicyList
    ...
    globals()['ResourcepoolQualificationPolicyList'] = ResourcepoolQualificationPolicyList


class ResourcepoolQualificationPolicyResponse(ModelComposed):
    ...
    def discriminator():
        ...
        val = {
            ...
            'resourcepool.QualificationPolicy.List': ResourcepoolQualificationPolicyList,
        }
        if not val:
            return None
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """ResourcepoolQualificationPolicyResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'resourcepool.QualificationPolicy' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'oneOf': [
              ...
              MoDocumentCount,
              MoTagSummary,
              ResourcepoolQualificationPolicyList,
          ],
        }
