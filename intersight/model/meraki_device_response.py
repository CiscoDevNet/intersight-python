...
def lazy_import():
    from intersight.model.meraki_device_list import MerakiDeviceList
    ...
    globals()['MerakiDeviceList'] = MerakiDeviceList
...
class MerakiDeviceResponse(ModelComposed):
    ...
    def discriminator():
        lazy_import()
        val = {
            'meraki.Device.List': MerakiDeviceList,
    ...
    def _from_openapi_data(cls, object_type, *args, **kwargs):  # noqa: E501
        """MerakiDeviceResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            count (int): The total number of 'meraki.Device' resources matching the request, accross all pages. The 'Count' attribute is included when the HTTP GET request includes the '$inlinecount' parameter.. [optional]  # noqa: E501
