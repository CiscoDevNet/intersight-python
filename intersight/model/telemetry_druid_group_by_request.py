...
def lazy_import():
    ...
    globals()['TelemetryDruidGroupByRequestAllOf'] = TelemetryDruidGroupByRequestAllOf
...
class TelemetryDruidGroupByRequest(ModelComposed):
    ...
    @convert_js_args_to_python_args
    def __init__(self, query_type, data_source, dimensions, granularity, intervals, *args, **kwargs):  # noqa: E501
        """TelemetryDruidGroupByRequest - a model defined in OpenAPI
