...
class SoftwarerepositoryBaseDistributableAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SoftwarerepositoryBaseDistributableAllOf - a model defined in OpenAPI

        Args:

        Keyword Args:
            class_id (str): The fully-qualified name of the instantiated, concrete type. This property is used as a discriminator to identify the type of the payload when marshaling and unmarshaling data. The enum values provides the list of concrete types that can be instantiated from this abstract type.. defaults to "softwarerepository.OperatingSystemFile", must be one of ["softwarerepository.OperatingSystemFile", ]  # noqa: E501
