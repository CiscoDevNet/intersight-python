...
from intersight.model.ntp_policy_inventory_response import NtpPolicyInventoryResponse
...
class NtpApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_ntp_policy_endpoint = _Endpoint(
            settings={
        ...
        self.delete_ntp_policy_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
        ...
        self.get_ntp_ntp_server_by_moid_endpoint = _Endpoint(
            settings={
                'response_type': (NtpNtpServer,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/ntp/NtpServers/{Moid}',
                'operation_id': 'get_ntp_ntp_server_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_ntp_ntp_server_list_endpoint = _Endpoint(
            settings={
                'response_type': (NtpNtpServerResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/ntp/NtpServers',
                'operation_id': 'get_ntp_ntp_server_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_ntp_policy_by_moid_endpoint = _Endpoint(
            settings={
                'response_type': (NtpPolicy,),
                'auth': [
                    'cookieAuth',
        ...
        self.get_ntp_policy_inventory_by_moid_endpoint = _Endpoint(
            settings={
                'response_type': (NtpPolicyInventory,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/ntp/PolicyInventories/{Moid}',
                'operation_id': 'get_ntp_policy_inventory_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_ntp_policy_inventory_list_endpoint = _Endpoint(
            settings={
                'response_type': (NtpPolicyInventoryResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/ntp/PolicyInventories',
                'operation_id': 'get_ntp_policy_inventory_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_ntp_policy_list_endpoint = _Endpoint(
            settings={
        ...
        self.patch_ntp_policy_endpoint = _Endpoint(
            settings={
                'response_type': (NtpPolicy,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_ntp_policy_endpoint = _Endpoint(
            settings={
                'response_type': (NtpPolicy,),
                'auth': [
                    'cookieAuth',
    ...
    def create_ntp_policy(
        ...
        **kwargs
        ...
        kwargs['ntp_policy'] = \
            ntp_policy
        return self.create_ntp_policy_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_ntp_policy(
        ...
        **kwargs
        ...
        kwargs['moid'] = \
            moid
        return self.delete_ntp_policy_endpoint.call_with_http_info(**kwargs)

    def get_ntp_ntp_server_by_moid(
        self,
        moid,
        **kwargs
    ):
        """Read a 'ntp.NtpServer' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_ntp_ntp_server_by_moid(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.get_ntp_ntp_server_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_ntp_ntp_server_list(
        self,
        **kwargs
    ):
        """Read a 'ntp.NtpServer' resource.  # noqa: E501
        ...
        >>> thread = api.get_ntp_ntp_server_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_ntp_ntp_server_list_endpoint.call_with_http_info(**kwargs)

    def get_ntp_policy_by_moid(
        self,
        moid,
        **kwargs
    ):
        ...
        kwargs['moid'] = \
            moid
        return self.get_ntp_policy_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_ntp_policy_inventory_by_moid(
        self,
        moid,
        **kwargs
    ):
        """Read a 'ntp.PolicyInventory' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_ntp_policy_inventory_by_moid(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.get_ntp_policy_inventory_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_ntp_policy_inventory_list(
        self,
        **kwargs
    ):
        """Read a 'ntp.PolicyInventory' resource.  # noqa: E501
        ...
        >>> thread = api.get_ntp_policy_inventory_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_ntp_policy_inventory_list_endpoint.call_with_http_info(**kwargs)

    def get_ntp_policy_list(
        self,
        **kwargs
    ):
        """Read a 'ntp.Policy' resource.  # noqa: E501
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_ntp_policy_list_endpoint.call_with_http_info(**kwargs)

    def patch_ntp_policy(
        self,
        moid,
        ntp_policy,
        **kwargs
        ...
        kwargs['ntp_policy'] = \
            ntp_policy
        return self.patch_ntp_policy_endpoint.call_with_http_info(**kwargs)
    ...
    def update_ntp_policy(
        ...
        **kwargs
        ...
        kwargs['ntp_policy'] = \
            ntp_policy
        return self.update_ntp_policy_endpoint.call_with_http_info(**kwargs)
