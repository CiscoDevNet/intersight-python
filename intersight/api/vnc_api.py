...
from intersight.model.vnc_console_response import VncConsoleResponse
...
class VncApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_vnc_console_endpoint = _Endpoint(
            settings={
                'response_type': (VncConsole,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/vnc/Consoles',
                'operation_id': 'create_vnc_console',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.get_vnc_console_by_moid_endpoint = _Endpoint(
            settings={
                'response_type': (VncConsole,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/vnc/Consoles/{Moid}',
                'operation_id': 'get_vnc_console_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_vnc_console_list_endpoint = _Endpoint(
            settings={
                'response_type': (VncConsoleResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/vnc/Consoles',
                'operation_id': 'get_vnc_console_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_vnc_console_endpoint = _Endpoint(
            settings={
                'response_type': (VncConsole,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/vnc/Consoles/{Moid}',
                'operation_id': 'patch_vnc_console',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.update_vnc_console_endpoint = _Endpoint(
            settings={
                'response_type': (VncConsole,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/vnc/Consoles/{Moid}',
                'operation_id': 'update_vnc_console',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def create_vnc_console(
        ...
        **kwargs
        ...
        """Create a 'vnc.Console' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_vnc_console(vnc_console, async_req=True)
        >>> result = thread.get()

        Args:
            vnc_console (VncConsole): The 'vnc.Console' resource to create.
        ...
        kwargs['vnc_console'] = \
            vnc_console
        return self.create_vnc_console_endpoint.call_with_http_info(**kwargs)

    def get_vnc_console_by_moid(
        self,
        moid,
        **kwargs
    ):
        """Read a 'vnc.Console' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_vnc_console_by_moid(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.get_vnc_console_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_vnc_console_list(
        self,
        **kwargs
    ):
        """Read a 'vnc.Console' resource.  # noqa: E501
        ...
        >>> thread = api.get_vnc_console_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_vnc_console_list_endpoint.call_with_http_info(**kwargs)

    def patch_vnc_console(
        self,
        moid,
        vnc_console,
        **kwargs
    ):
        """Update a 'vnc.Console' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_vnc_console(moid, vnc_console, async_req=True)
        >>> result = thread.get()

        Args:
            moid (str): The unique Moid identifier of a resource instance.
            vnc_console (VncConsole): The 'vnc.Console' resource to update.
        ...
        kwargs['vnc_console'] = \
            vnc_console
        return self.patch_vnc_console_endpoint.call_with_http_info(**kwargs)

    def update_vnc_console(
        self,
        moid,
        vnc_console,
        **kwargs
        ...
        >>> thread = api.update_vnc_console(moid, vnc_console, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['vnc_console'] = \
            vnc_console
        return self.update_vnc_console_endpoint.call_with_http_info(**kwargs)
