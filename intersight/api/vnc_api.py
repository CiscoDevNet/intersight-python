...
class VncApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_vnc_console = _Endpoint(
            settings={
            ...
            callable=__create_vnc_console
        )

        def __get_vnc_console_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_vnc_console_by_moid = _Endpoint(
            settings={
                'response_type': (VncConsole,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__get_vnc_console_by_moid
        )

        def __get_vnc_console_list(
            self,
            **kwargs
        ):
            """Read a 'vnc.Console' resource.  # noqa: E501
        ...
        self.get_vnc_console_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_vnc_console_list
        )

        def __patch_vnc_console(
            self,
            moid,
            vnc_console,
            **kwargs
        ...
        self.patch_vnc_console = _Endpoint(
            settings={
                'response_type': (VncConsole,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_vnc_console
        )

        def __update_vnc_console(
            self,
            moid,
            vnc_console,
            **kwargs
        ...
        self.update_vnc_console = _Endpoint(
            settings={
                'response_type': (VncConsole,),
                'auth': [
                    'cookieAuth',
