...
class RackApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_rack_unit_personality_by_moid_endpoint = _Endpoint(
            settings={
                'response_type': (RackUnitPersonality,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/rack/UnitPersonalities/{Moid}',
                'operation_id': 'get_rack_unit_personality_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_rack_unit_personality_list_endpoint = _Endpoint(
            settings={
                'response_type': (RackUnitPersonalityResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/rack/UnitPersonalities',
                'operation_id': 'get_rack_unit_personality_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_rack_unit_personality_endpoint = _Endpoint(
            settings={
                'response_type': (RackUnitPersonality,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/rack/UnitPersonalities/{Moid}',
                'operation_id': 'patch_rack_unit_personality',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.update_rack_unit_personality_endpoint = _Endpoint(
            settings={
                'response_type': (RackUnitPersonality,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/rack/UnitPersonalities/{Moid}',
                'operation_id': 'update_rack_unit_personality',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_rack_unit_personality_by_moid(
        self,
        moid,
        **kwargs
    ):
        """Read a 'rack.UnitPersonality' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_rack_unit_personality_by_moid(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.get_rack_unit_personality_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_rack_unit_personality_list(
        self,
        **kwargs
    ):
        """Read a 'rack.UnitPersonality' resource.  # noqa: E501
        ...
        >>> thread = api.get_rack_unit_personality_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_rack_unit_personality_list_endpoint.call_with_http_info(**kwargs)

    def patch_rack_unit_personality(
        self,
        moid,
        rack_unit_personality,
        **kwargs
    ):
        """Update a 'rack.UnitPersonality' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_rack_unit_personality(moid, rack_unit_personality, async_req=True)
        >>> result = thread.get()

        Args:
            moid (str): The unique Moid identifier of a resource instance.
            rack_unit_personality (RackUnitPersonality): The 'rack.UnitPersonality' resource to update.
        ...
        kwargs['moid'] = \
            moid
        kwargs['rack_unit_personality'] = \
            rack_unit_personality
        return self.patch_rack_unit_personality_endpoint.call_with_http_info(**kwargs)

    def update_rack_unit_personality(
        self,
        moid,
        rack_unit_personality,
        **kwargs
        ...
        >>> thread = api.update_rack_unit_personality(moid, rack_unit_personality, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['rack_unit_personality'] = \
            rack_unit_personality
        return self.update_rack_unit_personality_endpoint.call_with_http_info(**kwargs)
