...
class RackApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_rack_unit_personality_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_rack_unit_personality_by_moid = _Endpoint(
            settings={
            ...
            callable=__get_rack_unit_personality_by_moid
        )

        def __get_rack_unit_personality_list(
            self,
            **kwargs
        ):
            """Read a 'rack.UnitPersonality' resource.  # noqa: E501
        ...
        self.get_rack_unit_personality_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_rack_unit_personality_list
        )

        def __patch_rack_unit_personality(
            self,
            moid,
        ...
        self.patch_rack_unit_personality = _Endpoint(
            settings={
                'response_type': (RackUnitPersonality,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_rack_unit_personality
        )

        def __update_rack_unit_personality(
            self,
            moid,
            rack_unit_personality,
            **kwargs
        ...
        self.update_rack_unit_personality = _Endpoint(
            settings={
                'response_type': (RackUnitPersonality,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__update_rack_unit_personality
        )
