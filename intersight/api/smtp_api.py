...
class SmtpApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_smtp_policy = _Endpoint(
            settings={
            ...
            callable=__create_smtp_policy
        )

        def __delete_smtp_policy(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_smtp_policy = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__delete_smtp_policy
        )

        def __get_smtp_policy_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_smtp_policy_by_moid = _Endpoint(
            settings={
                'response_type': (SmtpPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__get_smtp_policy_by_moid
        )

        def __get_smtp_policy_list(
            self,
            **kwargs
        ):
            """Read a 'smtp.Policy' resource.  # noqa: E501
        ...
        self.get_smtp_policy_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_smtp_policy_list
        )

        def __patch_smtp_policy(
            self,
            moid,
            smtp_policy,
            **kwargs
        ...
        self.patch_smtp_policy = _Endpoint(
            settings={
                'response_type': (SmtpPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_smtp_policy
        )

        def __update_smtp_policy(
            self,
            moid,
            smtp_policy,
            **kwargs
        ...
        self.update_smtp_policy = _Endpoint(
            settings={
                'response_type': (SmtpPolicy,),
                'auth': [
                    'cookieAuth',
