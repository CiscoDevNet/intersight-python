...
class VmediaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_vmedia_policy = _Endpoint(
            settings={
            ...
            callable=__create_vmedia_policy
        )

        def __delete_vmedia_policy(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_vmedia_policy = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__delete_vmedia_policy
        )

        def __get_vmedia_policy_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_vmedia_policy_by_moid = _Endpoint(
            settings={
                'response_type': (VmediaPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__get_vmedia_policy_by_moid
        )

        def __get_vmedia_policy_list(
            self,
            **kwargs
        ):
            """Read a 'vmedia.Policy' resource.  # noqa: E501
        ...
        self.get_vmedia_policy_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_vmedia_policy_list
        )

        def __patch_vmedia_policy(
            self,
            moid,
            vmedia_policy,
            **kwargs
        ...
        self.patch_vmedia_policy = _Endpoint(
            settings={
                'response_type': (VmediaPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_vmedia_policy
        )

        def __update_vmedia_policy(
            self,
            moid,
            vmedia_policy,
            **kwargs
        ...
        self.update_vmedia_policy = _Endpoint(
            settings={
                'response_type': (VmediaPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__update_vmedia_policy
        )
