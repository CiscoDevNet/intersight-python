...
class SshApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_ssh_policy = _Endpoint(
            settings={
        ...
        self.delete_ssh_policy = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
        ...
        self.get_ssh_policy_by_moid = _Endpoint(
            settings={
                'response_type': (SshPolicy,),
                'auth': [
                    'cookieAuth',
        ...
        self.get_ssh_policy_list = _Endpoint(
            settings={
        ...
        self.patch_ssh_policy = _Endpoint(
            settings={
                'response_type': (SshPolicy,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_ssh_policy = _Endpoint(
            settings={
                'response_type': (SshPolicy,),
                'auth': [
                    'cookieAuth',
