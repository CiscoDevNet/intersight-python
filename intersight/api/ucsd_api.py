...
class UcsdApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_ucsd_backup_info = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
            ...
            callable=__delete_ucsd_backup_info
        )

        def __get_ucsd_backup_info_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_ucsd_backup_info_by_moid = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_ucsd_backup_info_by_moid
        )

        def __get_ucsd_backup_info_list(
            self,
            **kwargs
        ):
            """Read a 'ucsd.BackupInfo' resource.  # noqa: E501
        ...
        self.get_ucsd_backup_info_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_ucsd_backup_info_list
        )
