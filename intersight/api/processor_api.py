...
class ProcessorApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_processor_unit_by_moid = _Endpoint(
            settings={
        ...
        self.get_processor_unit_list = _Endpoint(
            settings={
        ...
        self.patch_processor_unit = _Endpoint(
            settings={
                'response_type': (ProcessorUnit,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_processor_unit = _Endpoint(
            settings={
                'response_type': (ProcessorUnit,),
                'auth': [
                    'cookieAuth',
