...
class ProcessorApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_processor_unit_by_moid_endpoint = _Endpoint(
            settings={
        ...
        self.get_processor_unit_list_endpoint = _Endpoint(
            settings={
        ...
        self.patch_processor_unit_endpoint = _Endpoint(
            settings={
                'response_type': (ProcessorUnit,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_processor_unit_endpoint = _Endpoint(
            settings={
                'response_type': (ProcessorUnit,),
                'auth': [
                    'cookieAuth',
    ...
    def get_processor_unit_by_moid(
        self,
        moid,
        **kwargs
    ):
        ...
        kwargs['moid'] = \
            moid
        return self.get_processor_unit_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_processor_unit_list(
        self,
        **kwargs
    ):
        """Read a 'processor.Unit' resource.  # noqa: E501
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_processor_unit_list_endpoint.call_with_http_info(**kwargs)

    def patch_processor_unit(
        self,
        moid,
        processor_unit,
        **kwargs
        ...
        kwargs['processor_unit'] = \
            processor_unit
        return self.patch_processor_unit_endpoint.call_with_http_info(**kwargs)

    def update_processor_unit(
        self,
        moid,
        processor_unit,
        **kwargs
        ...
        kwargs['processor_unit'] = \
            processor_unit
        return self.update_processor_unit_endpoint.call_with_http_info(**kwargs)
