...
class AccessApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_access_policy = _Endpoint(
            settings={
            ...
            callable=__create_access_policy
        )

        def __delete_access_policy(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_access_policy = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__delete_access_policy
        )

        def __get_access_policy_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_access_policy_by_moid = _Endpoint(
            settings={
                'response_type': (AccessPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__get_access_policy_by_moid
        )

        def __get_access_policy_list(
            self,
            **kwargs
        ):
            """Read a 'access.Policy' resource.  # noqa: E501
        ...
        self.get_access_policy_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_access_policy_list
        )

        def __patch_access_policy(
            self,
            moid,
            access_policy,
            **kwargs
        ...
        self.patch_access_policy = _Endpoint(
            settings={
                'response_type': (AccessPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_access_policy
        )

        def __update_access_policy(
            self,
            moid,
            access_policy,
            **kwargs
        ...
        self.update_access_policy = _Endpoint(
            settings={
                'response_type': (AccessPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__update_access_policy
        )
