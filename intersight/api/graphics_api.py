...
class GraphicsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_graphics_card_by_moid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/graphics/Cards/{Moid}',
                'operation_id': 'get_graphics_card_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_graphics_card_list_endpoint = _Endpoint(
            settings={
                'response_type': (GraphicsCardResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/graphics/Cards',
                'operation_id': 'get_graphics_card_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_graphics_controller_by_moid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/graphics/Controllers/{Moid}',
                'operation_id': 'get_graphics_controller_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_graphics_controller_list_endpoint = _Endpoint(
            settings={
                'response_type': (GraphicsControllerResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/graphics/Controllers',
                'operation_id': 'get_graphics_controller_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_graphics_card_endpoint = _Endpoint(
            settings={
                'response_type': (GraphicsCard,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/graphics/Cards/{Moid}',
                'operation_id': 'patch_graphics_card',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.patch_graphics_controller_endpoint = _Endpoint(
            settings={
                'response_type': (GraphicsController,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/graphics/Controllers/{Moid}',
                'operation_id': 'patch_graphics_controller',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.update_graphics_card_endpoint = _Endpoint(
            settings={
                'response_type': (GraphicsCard,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/graphics/Cards/{Moid}',
                'operation_id': 'update_graphics_card',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.update_graphics_controller_endpoint = _Endpoint(
            settings={
                'response_type': (GraphicsController,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/graphics/Controllers/{Moid}',
                'operation_id': 'update_graphics_controller',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_graphics_card_by_moid(
        ...
        **kwargs
        ...
        kwargs['moid'] = \
            moid
        return self.get_graphics_card_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_graphics_card_list(
        self,
        **kwargs
    ):
        """Read a 'graphics.Card' resource.  # noqa: E501
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_graphics_card_list_endpoint.call_with_http_info(**kwargs)

    def get_graphics_controller_by_moid(
        self,
        moid,
        **kwargs
    ):
        ...
        kwargs['moid'] = \
            moid
        return self.get_graphics_controller_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_graphics_controller_list(
        self,
        **kwargs
    ):
        """Read a 'graphics.Controller' resource.  # noqa: E501
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_graphics_controller_list_endpoint.call_with_http_info(**kwargs)

    def patch_graphics_card(
        self,
        moid,
        graphics_card,
        **kwargs
        ...
        Args:
            moid (str): The unique Moid identifier of a resource instance.
            graphics_card (GraphicsCard): The 'graphics.Card' resource to update.
        ...
        kwargs['moid'] = \
            moid
        kwargs['graphics_card'] = \
            graphics_card
        return self.patch_graphics_card_endpoint.call_with_http_info(**kwargs)

    def patch_graphics_controller(
        self,
        moid,
        graphics_controller,
        **kwargs
        ...
        Args:
            moid (str): The unique Moid identifier of a resource instance.
            graphics_controller (GraphicsController): The 'graphics.Controller' resource to update.
        ...
        kwargs['moid'] = \
            moid
        kwargs['graphics_controller'] = \
            graphics_controller
        return self.patch_graphics_controller_endpoint.call_with_http_info(**kwargs)

    def update_graphics_card(
        self,
        moid,
        graphics_card,
        **kwargs
        ...
        kwargs['graphics_card'] = \
            graphics_card
        return self.update_graphics_card_endpoint.call_with_http_info(**kwargs)

    def update_graphics_controller(
        self,
        moid,
        graphics_controller,
        **kwargs
        ...
        kwargs['graphics_controller'] = \
            graphics_controller
        return self.update_graphics_controller_endpoint.call_with_http_info(**kwargs)
