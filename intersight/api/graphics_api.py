...
class GraphicsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_graphics_card_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_graphics_card_by_moid = _Endpoint(
            settings={
            ...
            callable=__get_graphics_card_by_moid
        )

        def __get_graphics_card_list(
            self,
            **kwargs
        ):
            """Read a 'graphics.Card' resource.  # noqa: E501
        ...
        self.get_graphics_card_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_graphics_card_list
        )

        def __get_graphics_controller_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_graphics_controller_by_moid = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_graphics_controller_by_moid
        )

        def __get_graphics_controller_list(
            self,
            **kwargs
        ):
            """Read a 'graphics.Controller' resource.  # noqa: E501
        ...
        self.get_graphics_controller_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_graphics_controller_list
        )

        def __patch_graphics_card(
            self,
            moid,
            graphics_card,
            **kwargs
        ...
        self.patch_graphics_card = _Endpoint(
            settings={
                'response_type': (GraphicsCard,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_graphics_card
        )

        def __patch_graphics_controller(
            self,
            moid,
            graphics_controller,
            **kwargs
        ...
        self.patch_graphics_controller = _Endpoint(
            settings={
                'response_type': (GraphicsController,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_graphics_controller
        )

        def __update_graphics_card(
            self,
            moid,
            graphics_card,
            **kwargs
        ...
        self.update_graphics_card = _Endpoint(
            settings={
                'response_type': (GraphicsCard,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__update_graphics_card
        )

        def __update_graphics_controller(
            self,
            moid,
            graphics_controller,
            **kwargs
        ...
        self.update_graphics_controller = _Endpoint(
            settings={
                'response_type': (GraphicsController,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__update_graphics_controller
        )
