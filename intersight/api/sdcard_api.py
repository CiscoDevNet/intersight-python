...
class SdcardApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_sdcard_policy = _Endpoint(
            settings={
            ...
            callable=__create_sdcard_policy
        )

        def __delete_sdcard_policy(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_sdcard_policy = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__delete_sdcard_policy
        )

        def __get_sdcard_policy_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_sdcard_policy_by_moid = _Endpoint(
            settings={
                'response_type': (SdcardPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__get_sdcard_policy_by_moid
        )

        def __get_sdcard_policy_list(
            self,
            **kwargs
        ):
            """Read a 'sdcard.Policy' resource.  # noqa: E501
        ...
        self.get_sdcard_policy_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_sdcard_policy_list
        )

        def __patch_sdcard_policy(
            self,
            moid,
            sdcard_policy,
            **kwargs
        ...
        self.patch_sdcard_policy = _Endpoint(
            settings={
                'response_type': (SdcardPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_sdcard_policy
        )

        def __update_sdcard_policy(
            self,
            moid,
            sdcard_policy,
            **kwargs
        ...
        self.update_sdcard_policy = _Endpoint(
            settings={
                'response_type': (SdcardPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__update_sdcard_policy
        )
