...
class VrfApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_vrf_vrf_endpoint = _Endpoint(
            settings={
                'response_type': (VrfVrf,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/vrf/Vrves',
                'operation_id': 'create_vrf_vrf',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_vrf_vrf_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/vrf/Vrves/{Moid}',
                'operation_id': 'delete_vrf_vrf',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_vrf_vrf_by_moid_endpoint = _Endpoint(
            settings={
                'response_type': (VrfVrf,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/vrf/Vrves/{Moid}',
                'operation_id': 'get_vrf_vrf_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_vrf_vrf_list_endpoint = _Endpoint(
            settings={
                'response_type': (VrfVrfResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
        ...
        self.patch_vrf_vrf_endpoint = _Endpoint(
            settings={
                'response_type': (VrfVrf,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_vrf_vrf_endpoint = _Endpoint(
            settings={
                'response_type': (VrfVrf,),
                'auth': [
                    'cookieAuth',
    ...
    def create_vrf_vrf(
        ...
        **kwargs
        ...
        """Create a 'vrf.Vrf' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_vrf_vrf(vrf_vrf, async_req=True)
        >>> result = thread.get()

        Args:
            vrf_vrf (VrfVrf): The 'vrf.Vrf' resource to create.
        ...
        kwargs['vrf_vrf'] = \
            vrf_vrf
        return self.create_vrf_vrf_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_vrf_vrf(
        ...
        **kwargs
        ...
        """Delete a 'vrf.Vrf' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_vrf_vrf(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.delete_vrf_vrf_endpoint.call_with_http_info(**kwargs)

    def get_vrf_vrf_by_moid(
        self,
        moid,
        **kwargs
    ):
        """Read a 'vrf.Vrf' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_vrf_vrf_by_moid(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.get_vrf_vrf_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_vrf_vrf_list(
        self,
        **kwargs
    ):
        """Read a 'vrf.Vrf' resource.  # noqa: E501
        ...
        >>> thread = api.get_vrf_vrf_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_vrf_vrf_list_endpoint.call_with_http_info(**kwargs)
    ...
    def patch_vrf_vrf(
        ...
        **kwargs
        ...
        """Update a 'vrf.Vrf' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_vrf_vrf(moid, vrf_vrf, async_req=True)
        >>> result = thread.get()

        Args:
            moid (str): The unique Moid identifier of a resource instance.
            vrf_vrf (VrfVrf): The 'vrf.Vrf' resource to update.
        ...
        kwargs['vrf_vrf'] = \
            vrf_vrf
        return self.patch_vrf_vrf_endpoint.call_with_http_info(**kwargs)
    ...
    def update_vrf_vrf(
        ...
        **kwargs
        ...
        >>> thread = api.update_vrf_vrf(moid, vrf_vrf, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['vrf_vrf'] = \
            vrf_vrf
        return self.update_vrf_vrf_endpoint.call_with_http_info(**kwargs)
