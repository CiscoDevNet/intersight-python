...
class VrfApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_vrf_vrf = _Endpoint(
            ...
            callable=__create_vrf_vrf
        )

        def __delete_vrf_vrf(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_vrf_vrf = _Endpoint(
            ...
            api_client=api_client,
            callable=__delete_vrf_vrf
        )

        def __get_vrf_vrf_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_vrf_vrf_by_moid = _Endpoint(
            settings={
                'response_type': (VrfVrf,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__get_vrf_vrf_by_moid
        )

        def __get_vrf_vrf_list(
            self,
            **kwargs
        ):
            """Read a 'vrf.Vrf' resource.  # noqa: E501
        ...
        self.get_vrf_vrf_list = _Endpoint(
            settings={
        ...
        self.patch_vrf_vrf = _Endpoint(
            ...
            api_client=api_client,
            callable=__patch_vrf_vrf
        )

        def __update_vrf_vrf(
            self,
            moid,
            vrf_vrf,
            **kwargs
