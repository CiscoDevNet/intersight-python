...
class FaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_fault_instance_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_fault_instance_by_moid = _Endpoint(
            settings={
            ...
            callable=__get_fault_instance_by_moid
        )

        def __get_fault_instance_list(
            self,
            **kwargs
        ):
            """Read a 'fault.Instance' resource.  # noqa: E501
        ...
        self.get_fault_instance_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_fault_instance_list
        )

        def __patch_fault_instance(
            self,
            moid,
            fault_instance,
            **kwargs
        ...
        self.patch_fault_instance = _Endpoint(
            settings={
                'response_type': (FaultInstance,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_fault_instance
        )

        def __update_fault_instance(
            self,
            moid,
            fault_instance,
            **kwargs
        ...
        self.update_fault_instance = _Endpoint(
            settings={
                'response_type': (FaultInstance,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__update_fault_instance
        )
