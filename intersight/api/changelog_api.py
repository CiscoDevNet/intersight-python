...
from intersight.model.changelog_item_response import ChangelogItemResponse
...
class ChangelogApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_changelog_item_endpoint = _Endpoint(
            settings={
                'response_type': (ChangelogItem,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/changelog/Items',
                'operation_id': 'create_changelog_item',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_changelog_item_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/changelog/Items/{Moid}',
                'operation_id': 'delete_changelog_item',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_changelog_item_by_moid_endpoint = _Endpoint(
            settings={
                'response_type': (ChangelogItem,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/changelog/Items/{Moid}',
                'operation_id': 'get_changelog_item_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_changelog_item_list_endpoint = _Endpoint(
            settings={
                'response_type': (ChangelogItemResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/changelog/Items',
                'operation_id': 'get_changelog_item_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_changelog_item_endpoint = _Endpoint(
            settings={
                'response_type': (ChangelogItem,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/changelog/Items/{Moid}',
                'operation_id': 'patch_changelog_item',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.update_changelog_item_endpoint = _Endpoint(
            settings={
                'response_type': (ChangelogItem,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/changelog/Items/{Moid}',
                'operation_id': 'update_changelog_item',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def create_changelog_item(
        self,
        changelog_item,
        **kwargs
    ):
        """Create a 'changelog.Item' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_changelog_item(changelog_item, async_req=True)
        >>> result = thread.get()

        Args:
            changelog_item (ChangelogItem): The 'changelog.Item' resource to create.
        ...
        kwargs['changelog_item'] = \
            changelog_item
        return self.create_changelog_item_endpoint.call_with_http_info(**kwargs)

    def delete_changelog_item(
        self,
        moid,
        **kwargs
    ):
        """Delete a 'changelog.Item' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_changelog_item(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.delete_changelog_item_endpoint.call_with_http_info(**kwargs)

    def get_changelog_item_by_moid(
        self,
        moid,
        **kwargs
    ):
        """Read a 'changelog.Item' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_changelog_item_by_moid(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.get_changelog_item_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_changelog_item_list(
        self,
        **kwargs
    ):
        """Read a 'changelog.Item' resource.  # noqa: E501
        ...
        >>> thread = api.get_changelog_item_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_changelog_item_list_endpoint.call_with_http_info(**kwargs)

    def patch_changelog_item(
        self,
        moid,
        changelog_item,
        **kwargs
    ):
        """Update a 'changelog.Item' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_changelog_item(moid, changelog_item, async_req=True)
        >>> result = thread.get()

        Args:
            moid (str): The unique Moid identifier of a resource instance.
            changelog_item (ChangelogItem): The 'changelog.Item' resource to update.
        ...
        kwargs['changelog_item'] = \
            changelog_item
        return self.patch_changelog_item_endpoint.call_with_http_info(**kwargs)

    def update_changelog_item(
        self,
        moid,
        changelog_item,
        **kwargs
        ...
        >>> thread = api.update_changelog_item(moid, changelog_item, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['changelog_item'] = \
            changelog_item
        return self.update_changelog_item_endpoint.call_with_http_info(**kwargs)
