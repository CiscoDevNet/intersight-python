...
class ViewApi(object):
    ...
    def get_view_health_status_by_moid(
        self,
        moid,
        **kwargs
    ):
        """Read a 'view.HealthStatus' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_view_health_status_by_moid(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.get_view_health_status_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_view_health_status_list(
        self,
        **kwargs
    ):
        """Read a 'view.HealthStatus' resource.  # noqa: E501
        ...
        >>> thread = api.get_view_health_status_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_view_health_status_list_endpoint.call_with_http_info(**kwargs)

    def get_view_server_by_moid(
        self,
        moid,
        **kwargs
    ):
        """Read a 'view.Server' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_view_server_by_moid(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.get_view_server_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_view_server_list(
        self,
        **kwargs
    ):
        """Read a 'view.Server' resource.  # noqa: E501
        ...
        >>> thread = api.get_view_server_list(async_req=True)
        >>> result = thread.get()
