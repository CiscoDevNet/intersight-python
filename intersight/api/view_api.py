...
class ViewApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_view_server_by_moid = _Endpoint(
            settings={
            ...
            callable=__get_view_server_by_moid
        )

        def __get_view_server_list(
            self,
            **kwargs
        ):
            """Read a 'view.Server' resource.  # noqa: E501
        ...
        self.get_view_server_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_view_server_list
        )
