...
class AssetApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_asset_cluster_member_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
                ...
                'operation_id': 'delete_asset_cluster_member',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def delete_asset_cluster_member(
        self,
        moid,
        **kwargs
    ):
        """Delete a 'asset.ClusterMember' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_asset_cluster_member(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.delete_asset_cluster_member_endpoint.call_with_http_info(**kwargs)
