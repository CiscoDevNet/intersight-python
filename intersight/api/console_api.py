...
class ConsoleApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_console_console_config_by_moid_endpoint = _Endpoint(
            settings={
                'response_type': (ConsoleConsoleConfig,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/console/ConsoleConfigs/{Moid}',
                'operation_id': 'get_console_console_config_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_console_console_config_list_endpoint = _Endpoint(
            settings={
                'response_type': (ConsoleConsoleConfigResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/console/ConsoleConfigs',
                'operation_id': 'get_console_console_config_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def get_console_console_config_by_moid(
        self,
        moid,
        **kwargs
    ):
        """Read a 'console.ConsoleConfig' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_console_console_config_by_moid(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.get_console_console_config_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_console_console_config_list(
        self,
        **kwargs
    ):
        """Read a 'console.ConsoleConfig' resource.  # noqa: E501
        ...
        >>> thread = api.get_console_console_config_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_console_console_config_list_endpoint.call_with_http_info(**kwargs)
