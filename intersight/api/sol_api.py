...
class SolApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_sol_policy = _Endpoint(
            settings={
            ...
            callable=__create_sol_policy
        )

        def __delete_sol_policy(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_sol_policy = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__delete_sol_policy
        )

        def __get_sol_policy_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_sol_policy_by_moid = _Endpoint(
            settings={
                'response_type': (SolPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__get_sol_policy_by_moid
        )

        def __get_sol_policy_list(
            self,
            **kwargs
        ):
            """Read a 'sol.Policy' resource.  # noqa: E501
        ...
        self.get_sol_policy_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_sol_policy_list
        )

        def __patch_sol_policy(
            self,
            moid,
            sol_policy,
            **kwargs
        ...
        self.patch_sol_policy = _Endpoint(
            settings={
                'response_type': (SolPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_sol_policy
        )

        def __update_sol_policy(
            self,
            moid,
            sol_policy,
            **kwargs
        ...
        self.update_sol_policy = _Endpoint(
            settings={
                'response_type': (SolPolicy,),
                'auth': [
                    'cookieAuth',
