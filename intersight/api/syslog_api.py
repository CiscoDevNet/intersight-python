...
class SyslogApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_syslog_policy = _Endpoint(
            settings={
            ...
            callable=__create_syslog_policy
        )

        def __delete_syslog_policy(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_syslog_policy = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__delete_syslog_policy
        )

        def __get_syslog_policy_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_syslog_policy_by_moid = _Endpoint(
            settings={
                'response_type': (SyslogPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__get_syslog_policy_by_moid
        )

        def __get_syslog_policy_list(
            self,
            **kwargs
        ):
            """Read a 'syslog.Policy' resource.  # noqa: E501
        ...
        self.get_syslog_policy_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_syslog_policy_list
        )

        def __patch_syslog_policy(
            self,
            moid,
            syslog_policy,
            **kwargs
        ...
        self.patch_syslog_policy = _Endpoint(
            settings={
                'response_type': (SyslogPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_syslog_policy
        )

        def __update_syslog_policy(
            self,
            moid,
            syslog_policy,
            **kwargs
        ...
        self.update_syslog_policy = _Endpoint(
            settings={
                'response_type': (SyslogPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__update_syslog_policy
        )
