...
class SnmpApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_snmp_policy = _Endpoint(
            settings={
            ...
            callable=__create_snmp_policy
        )

        def __delete_snmp_policy(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_snmp_policy = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__delete_snmp_policy
        )

        def __get_snmp_policy_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_snmp_policy_by_moid = _Endpoint(
            settings={
                'response_type': (SnmpPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__get_snmp_policy_by_moid
        )

        def __get_snmp_policy_list(
            self,
            **kwargs
        ):
            """Read a 'snmp.Policy' resource.  # noqa: E501
        ...
        self.get_snmp_policy_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_snmp_policy_list
        )

        def __patch_snmp_policy(
            self,
            moid,
            snmp_policy,
            **kwargs
        ...
        self.patch_snmp_policy = _Endpoint(
            settings={
                'response_type': (SnmpPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_snmp_policy
        )

        def __update_snmp_policy(
            self,
            moid,
            snmp_policy,
            **kwargs
        ...
        self.update_snmp_policy = _Endpoint(
            settings={
                'response_type': (SnmpPolicy,),
                'auth': [
                    'cookieAuth',
