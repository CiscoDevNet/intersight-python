...
class SecurityApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_security_unit_by_moid_endpoint = _Endpoint(
            settings={
                'response_type': (SecurityUnit,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/security/Units/{Moid}',
                'operation_id': 'get_security_unit_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_security_unit_list_endpoint = _Endpoint(
            settings={
                'response_type': (SecurityUnitResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/security/Units',
                'operation_id': 'get_security_unit_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_security_unit_endpoint = _Endpoint(
            settings={
                'response_type': (SecurityUnit,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/security/Units/{Moid}',
                'operation_id': 'patch_security_unit',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.update_security_unit_endpoint = _Endpoint(
            settings={
                'response_type': (SecurityUnit,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/security/Units/{Moid}',
                'operation_id': 'update_security_unit',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_security_unit_by_moid(
        self,
        moid,
        **kwargs
    ):
        """Read a 'security.Unit' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_security_unit_by_moid(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.get_security_unit_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_security_unit_list(
        self,
        **kwargs
    ):
        """Read a 'security.Unit' resource.  # noqa: E501
        ...
        >>> thread = api.get_security_unit_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_security_unit_list_endpoint.call_with_http_info(**kwargs)

    def patch_security_unit(
        self,
        moid,
        security_unit,
        **kwargs
    ):
        """Update a 'security.Unit' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_security_unit(moid, security_unit, async_req=True)
        >>> result = thread.get()

        Args:
            moid (str): The unique Moid identifier of a resource instance.
            security_unit (SecurityUnit): The 'security.Unit' resource to update.
        ...
        kwargs['moid'] = \
            moid
        kwargs['security_unit'] = \
            security_unit
        return self.patch_security_unit_endpoint.call_with_http_info(**kwargs)

    def update_security_unit(
        self,
        moid,
        security_unit,
        **kwargs
        ...
        >>> thread = api.update_security_unit(moid, security_unit, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['security_unit'] = \
            security_unit
        return self.update_security_unit_endpoint.call_with_http_info(**kwargs)
