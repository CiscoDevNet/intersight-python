...
class SecurityApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_security_unit_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_security_unit_by_moid = _Endpoint(
            settings={
            ...
            callable=__get_security_unit_by_moid
        )

        def __get_security_unit_list(
            self,
            **kwargs
        ):
            """Read a 'security.Unit' resource.  # noqa: E501
        ...
        self.get_security_unit_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_security_unit_list
        )

        def __patch_security_unit(
            self,
            moid,
            security_unit,
            **kwargs
        ...
        self.patch_security_unit = _Endpoint(
            settings={
                'response_type': (SecurityUnit,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_security_unit
        )

        def __update_security_unit(
            self,
            moid,
            security_unit,
            **kwargs
        ...
        self.update_security_unit = _Endpoint(
            settings={
                'response_type': (SecurityUnit,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__update_security_unit
        )
