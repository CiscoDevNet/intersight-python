...
class AaaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_aaa_audit_record_by_moid = _Endpoint(
            settings={
            ...
            callable=__get_aaa_audit_record_by_moid
        )

        def __get_aaa_audit_record_list(
            self,
            **kwargs
        ):
            """Read a 'aaa.AuditRecord' resource.  # noqa: E501
        ...
        self.get_aaa_audit_record_list = _Endpoint(
            settings={
