...
class TerminalApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_terminal_audit_log_by_moid(
            self,
            moid,
            **kwargs
        ):
            ...
            >>> thread = api.get_terminal_audit_log_by_moid(moid, async_req=True)
            >>> result = thread.get()
        ...
        self.get_terminal_audit_log_by_moid = _Endpoint(
            settings={
                'response_type': (TerminalAuditLog,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/terminal/AuditLogs/{Moid}',
                'operation_id': 'get_terminal_audit_log_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__get_terminal_audit_log_by_moid
        )

        def __get_terminal_audit_log_list(
            self,
            **kwargs
        ):
            """Read a 'terminal.AuditLog' resource.  # noqa: E501
            ...
            >>> thread = api.get_terminal_audit_log_list(async_req=True)
            >>> result = thread.get()
        ...
        self.get_terminal_audit_log_list = _Endpoint(
            settings={
                'response_type': (TerminalAuditLogResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/terminal/AuditLogs',
                'operation_id': 'get_terminal_audit_log_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_terminal_audit_log_list
        )
