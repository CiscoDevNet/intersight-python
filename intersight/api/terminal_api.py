...
class TerminalApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_terminal_audit_log_by_moid_endpoint = _Endpoint(
            settings={
        ...
        self.get_terminal_audit_log_list_endpoint = _Endpoint(
            settings={
    ...
    def get_terminal_audit_log_by_moid(
        self,
        moid,
        **kwargs
    ):
        ...
        kwargs['moid'] = \
            moid
        return self.get_terminal_audit_log_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_terminal_audit_log_list(
        self,
        **kwargs
    ):
        """Read a 'terminal.AuditLog' resource.  # noqa: E501
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_terminal_audit_log_list_endpoint.call_with_http_info(**kwargs)
