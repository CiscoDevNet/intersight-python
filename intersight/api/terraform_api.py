...
class TerraformApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_terraform_executor(
            self,
            terraform_executor,
            **kwargs
        ):
        ...
        self.create_terraform_executor = _Endpoint(
            settings={
            ...
            callable=__create_terraform_executor
        )

        def __delete_terraform_executor(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_terraform_executor = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__delete_terraform_executor
        )

        def __get_terraform_executor_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_terraform_executor_by_moid = _Endpoint(
            settings={
                'response_type': (TerraformExecutor,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__get_terraform_executor_by_moid
        )

        def __get_terraform_executor_list(
            self,
            **kwargs
        ):
            """Read a 'terraform.Executor' resource.  # noqa: E501
        ...
        self.get_terraform_executor_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_terraform_executor_list
        )

        def __patch_terraform_executor(
            self,
            moid,
            terraform_executor,
            **kwargs
        ...
        self.patch_terraform_executor = _Endpoint(
            settings={
                'response_type': (TerraformExecutor,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_terraform_executor
        )

        def __update_terraform_executor(
            self,
            moid,
            terraform_executor,
            **kwargs
        ...
        self.update_terraform_executor = _Endpoint(
            settings={
                'response_type': (TerraformExecutor,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__update_terraform_executor
        )
