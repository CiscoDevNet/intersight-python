...
class TopApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_top_system_by_moid_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/top/Systems/{Moid}',
                'operation_id': 'get_top_system_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_top_system_list_endpoint = _Endpoint(
            settings={
                'response_type': (TopSystemResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/top/Systems',
                'operation_id': 'get_top_system_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_top_system_endpoint = _Endpoint(
            settings={
                'response_type': (TopSystem,),
                'auth': [
                    'cookieAuth',
        ...
        self.update_top_system_endpoint = _Endpoint(
            settings={
                'response_type': (TopSystem,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/top/Systems/{Moid}',
                'operation_id': 'update_top_system',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_top_system_by_moid(
        ...
        **kwargs
        ...
        kwargs['moid'] = \
            moid
        return self.get_top_system_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_top_system_list(
        self,
        **kwargs
    ):
        """Read a 'top.System' resource.  # noqa: E501
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_top_system_list_endpoint.call_with_http_info(**kwargs)

    def patch_top_system(
        self,
        moid,
        top_system,
        **kwargs
        ...
        Args:
            moid (str): The unique Moid identifier of a resource instance.
            top_system (TopSystem): The 'top.System' resource to update.
        ...
        kwargs['top_system'] = \
            top_system
        return self.patch_top_system_endpoint.call_with_http_info(**kwargs)

    def update_top_system(
        self,
        moid,
        top_system,
        **kwargs
        ...
        kwargs['top_system'] = \
            top_system
        return self.update_top_system_endpoint.call_with_http_info(**kwargs)
