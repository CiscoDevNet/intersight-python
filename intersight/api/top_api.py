...
class TopApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_top_system_by_moid = _Endpoint(
            settings={
            ...
            callable=__get_top_system_by_moid
        )

        def __get_top_system_list(
            self,
            **kwargs
        ):
            """Read a 'top.System' resource.  # noqa: E501
        ...
        self.get_top_system_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_top_system_list
        )

        def __patch_top_system(
            self,
            moid,
            top_system,
            **kwargs
        ...
        self.patch_top_system = _Endpoint(
            settings={
                'response_type': (TopSystem,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_top_system
        )

        def __update_top_system(
            self,
            moid,
            top_system,
            **kwargs
        ...
        self.update_top_system = _Endpoint(
            settings={
                'response_type': (TopSystem,),
                'auth': [
                    'cookieAuth',
