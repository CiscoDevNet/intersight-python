...
class VmrcApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_vmrc_console = _Endpoint(
            settings={
            ...
            callable=__create_vmrc_console
        )

        def __get_vmrc_console_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_vmrc_console_by_moid = _Endpoint(
            settings={
                'response_type': (VmrcConsole,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__get_vmrc_console_by_moid
        )

        def __get_vmrc_console_list(
            self,
            **kwargs
        ):
            """Read a 'vmrc.Console' resource.  # noqa: E501
        ...
        self.get_vmrc_console_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_vmrc_console_list
        )

        def __patch_vmrc_console(
            self,
            moid,
            vmrc_console,
            **kwargs
        ...
        self.patch_vmrc_console = _Endpoint(
            settings={
                'response_type': (VmrcConsole,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_vmrc_console
        )

        def __update_vmrc_console(
            self,
            moid,
            vmrc_console,
            **kwargs
        ...
        self.update_vmrc_console = _Endpoint(
            settings={
                'response_type': (VmrcConsole,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__update_vmrc_console
        )
