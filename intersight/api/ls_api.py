...
class LsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_ls_service_profile_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_ls_service_profile_by_moid = _Endpoint(
            settings={
                'response_type': (LsServiceProfile,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/ls/ServiceProfiles/{Moid}',
                'operation_id': 'get_ls_service_profile_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__get_ls_service_profile_by_moid
        )

        def __get_ls_service_profile_list(
            self,
            **kwargs
        ):
            """Read a 'ls.ServiceProfile' resource.  # noqa: E501
        ...
        self.get_ls_service_profile_list = _Endpoint(
            settings={
                'response_type': (LsServiceProfileResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/ls/ServiceProfiles',
                'operation_id': 'get_ls_service_profile_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_ls_service_profile_list
        )

        def __patch_ls_service_profile(
            self,
            moid,
            ls_service_profile,
            **kwargs
            ...
            Args:
                moid (str): The unique Moid identifier of a resource instance.
                ls_service_profile (LsServiceProfile): The 'ls.ServiceProfile' resource to update.
            ...
            kwargs['moid'] = \
                moid
            kwargs['ls_service_profile'] = \
                ls_service_profile
            return self.call_with_http_info(**kwargs)

        self.patch_ls_service_profile = _Endpoint(
            settings={
                'response_type': (LsServiceProfile,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/ls/ServiceProfiles/{Moid}',
                'operation_id': 'patch_ls_service_profile',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__patch_ls_service_profile
        )

        def __update_ls_service_profile(
            self,
            moid,
            ls_service_profile,
            **kwargs
        ...
        self.update_ls_service_profile = _Endpoint(
            settings={
                'response_type': (LsServiceProfile,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/ls/ServiceProfiles/{Moid}',
                'operation_id': 'update_ls_service_profile',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__update_ls_service_profile
        )
