...
class MetaApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_meta_definition = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/meta/Definitions/{Moid}',
                'operation_id': 'delete_meta_definition',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            callable=__delete_meta_definition
        )

        def __get_meta_definition_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_meta_definition_by_moid = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/meta/Definitions/{Moid}',
                'operation_id': 'get_meta_definition_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_meta_definition_by_moid
        )

        def __get_meta_definition_list(
            self,
            **kwargs
        ):
            """Read a 'meta.Definition' resource.  # noqa: E501
        ...
        self.get_meta_definition_list = _Endpoint(
            settings={
                'response_type': (MetaDefinitionResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/meta/Definitions',
                'operation_id': 'get_meta_definition_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_meta_definition_list
        )
