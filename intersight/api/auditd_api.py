...
class AuditdApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_auditd_policy_endpoint = _Endpoint(
            settings={
                'response_type': (AuditdPolicy,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/auditd/Policies',
                'operation_id': 'create_auditd_policy',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.delete_auditd_policy_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/auditd/Policies/{Moid}',
                'operation_id': 'delete_auditd_policy',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.get_auditd_policy_by_moid_endpoint = _Endpoint(
            settings={
                'response_type': (AuditdPolicy,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/auditd/Policies/{Moid}',
                'operation_id': 'get_auditd_policy_by_moid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_auditd_policy_list_endpoint = _Endpoint(
            settings={
                'response_type': (AuditdPolicyResponse,),
                'auth': [
                    'cookieAuth',
                    'http_signature',
                    'oAuth2',
                ...
                'endpoint_path': '/api/v1/auditd/Policies',
                'operation_id': 'get_auditd_policy_list',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.patch_auditd_policy_endpoint = _Endpoint(
            settings={
                'response_type': (AuditdPolicy,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/auditd/Policies/{Moid}',
                'operation_id': 'patch_auditd_policy',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
        ...
        self.update_auditd_policy_endpoint = _Endpoint(
            settings={
                'response_type': (AuditdPolicy,),
                'auth': [
                    'cookieAuth',
                ...
                'endpoint_path': '/api/v1/auditd/Policies/{Moid}',
                'operation_id': 'update_auditd_policy',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def create_auditd_policy(
        self,
        auditd_policy,
        **kwargs
    ):
        """Create a 'auditd.Policy' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_auditd_policy(auditd_policy, async_req=True)
        >>> result = thread.get()

        Args:
            auditd_policy (AuditdPolicy): The 'auditd.Policy' resource to create.
        ...
        kwargs['auditd_policy'] = \
            auditd_policy
        return self.create_auditd_policy_endpoint.call_with_http_info(**kwargs)

    def delete_auditd_policy(
        self,
        moid,
        **kwargs
    ):
        """Delete a 'auditd.Policy' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_auditd_policy(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.delete_auditd_policy_endpoint.call_with_http_info(**kwargs)

    def get_auditd_policy_by_moid(
        self,
        moid,
        **kwargs
    ):
        """Read a 'auditd.Policy' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_auditd_policy_by_moid(moid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['moid'] = \
            moid
        return self.get_auditd_policy_by_moid_endpoint.call_with_http_info(**kwargs)

    def get_auditd_policy_list(
        self,
        **kwargs
    ):
        """Read a 'auditd.Policy' resource.  # noqa: E501
        ...
        >>> thread = api.get_auditd_policy_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_auditd_policy_list_endpoint.call_with_http_info(**kwargs)

    def patch_auditd_policy(
        self,
        moid,
        auditd_policy,
        **kwargs
    ):
        """Update a 'auditd.Policy' resource.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.patch_auditd_policy(moid, auditd_policy, async_req=True)
        >>> result = thread.get()

        Args:
            moid (str): The unique Moid identifier of a resource instance.
            auditd_policy (AuditdPolicy): The 'auditd.Policy' resource to update.
        ...
        kwargs['auditd_policy'] = \
            auditd_policy
        return self.patch_auditd_policy_endpoint.call_with_http_info(**kwargs)

    def update_auditd_policy(
        self,
        moid,
        auditd_policy,
        **kwargs
        ...
        >>> thread = api.update_auditd_policy(moid, auditd_policy, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['auditd_policy'] = \
            auditd_policy
        return self.update_auditd_policy_endpoint.call_with_http_info(**kwargs)
