...
class ThermalApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_thermal_policy = _Endpoint(
            settings={
            ...
            callable=__create_thermal_policy
        )

        def __delete_thermal_policy(
            self,
            moid,
            **kwargs
        ):
        ...
        self.delete_thermal_policy = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__delete_thermal_policy
        )

        def __get_thermal_policy_by_moid(
            self,
            moid,
            **kwargs
        ):
        ...
        self.get_thermal_policy_by_moid = _Endpoint(
            settings={
                'response_type': (ThermalPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__get_thermal_policy_by_moid
        )

        def __get_thermal_policy_list(
            self,
            **kwargs
        ):
            """Read a 'thermal.Policy' resource.  # noqa: E501
        ...
        self.get_thermal_policy_list = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__get_thermal_policy_list
        )

        def __patch_thermal_policy(
            self,
            moid,
            thermal_policy,
            **kwargs
        ...
        self.patch_thermal_policy = _Endpoint(
            settings={
                'response_type': (ThermalPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__patch_thermal_policy
        )

        def __update_thermal_policy(
            self,
            moid,
            thermal_policy,
            **kwargs
        ...
        self.update_thermal_policy = _Endpoint(
            settings={
                'response_type': (ThermalPolicy,),
                'auth': [
                    'cookieAuth',
            ...
            api_client=api_client,
            callable=__update_thermal_policy
        )
