...
model_init_errors = set()

def set_model_init_error(error_message):
    model_init_errors.add(error_message)

def print_model_init_errors():
    if len(model_init_errors) > 0:
        for error in model_init_errors:
            print(error)
        model_init_errors.clear()
