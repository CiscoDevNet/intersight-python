...
class HttpSigningConfiguration(object):
    ...
    :param private_key_passphrase: A string value specifying the passphrase to decrypt
        the private key.
    :param private_key_string: Specify the Private key as string.
    ...
    def __init__(self, key_id, signing_scheme, private_key_path=None,
        ...
        private_key_path_exists = False
        if private_key_path and os.path.exists(private_key_path):
            private_key_path_exists =True
        if not private_key_path_exists and private_key_string is None:
        	raise Exception("Private key file or private key string not provided.")
